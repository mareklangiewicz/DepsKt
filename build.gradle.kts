...
plugins {
  ...
  id("pl.mareklangiewicz.sourcefun") version "0.4.31" // https://plugins.gradle.org/search?term=mareklangiewicz
}
...
val details = myLibDetails(
  ...
  version = Ver(0, 3, 94), // also sync it in ./src/main/kotlin/deps/Vers.kt
