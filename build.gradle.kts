...
plugins {
  ...
  id("pl.mareklangiewicz.sourcefun") version "0.4.40" // https://plugins.gradle.org/search?term=mareklangiewicz
}
...
val details = myLibDetails(
  ...
  version = Ver(0, 4, 10), // also sync it in ./src/main/kotlin/deps/Vers.kt
