...
object Vers {
    ...
    const val composeDesktopVerMain = "1.0.0-rc3"
    const val composeDesktopVerEdge = "1.0.0-rc3"
    ...
    const val composeAndroid = "1.1.0-beta03"
...
//    const val androidxLifecycle = "2.4.0-rc01"
    ...
    const val upue = "0.0.08"
    // https://github.com/langara/upue/releases

    const val kommandLine = "0.0.02"
