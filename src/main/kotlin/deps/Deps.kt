...
object Io {
    ...
    object Insert_koin {
        val koin_android = Dep("io.insert-koin", "koin-android", Ver("3.5.3", 0), Ver("3.6.0-wasm-alpha2", 300))
        val koin_android_compat = Dep("io.insert-koin", "koin-android-compat", Ver("3.5.3", 0), Ver("3.6.0-wasm-alpha2", 300))
        val koin_androidx_compose = Dep("io.insert-koin", "koin-androidx-compose", Ver("3.5.3", 0), Ver("3.6.0-wasm-alpha2", 300))
        val koin_androidx_navigation = Dep("io.insert-koin", "koin-androidx-navigation", Ver("3.5.3", 0), Ver("3.6.0-wasm-alpha2", 300))
        val koin_androidx_workmanager = Dep("io.insert-koin", "koin-androidx-workmanager", Ver("3.5.3", 0), Ver("3.6.0-wasm-alpha2", 300))
        val koin_core = Dep("io.insert-koin", "koin-core", Ver("3.5.3", 0), Ver("3.6.0-wasm-alpha2", 300))
        val koin_ktor = Dep("io.insert-koin", "koin-ktor", Ver("3.5.3", 0), Ver("3.6.0-wasm-alpha2", 300))
        val koin_logger_slf4j = Dep("io.insert-koin", "koin-logger-slf4j", Ver("3.5.3", 0), Ver("3.6.0-wasm-alpha2", 300))
        val koin_test = Dep("io.insert-koin", "koin-test", Ver("3.5.3", 0), Ver("3.6.0-wasm-alpha2", 300))
        val koin_test_junit4 = Dep("io.insert-koin", "koin-test-junit4", Ver("3.5.3", 0), Ver("3.6.0-wasm-alpha2", 300))
        val koin_test_junit5 = Dep("io.insert-koin", "koin-test-junit5", Ver("3.5.3", 0), Ver("3.6.0-wasm-alpha2", 300))
    }
    object Kotest {
    ...
    object Ktor {
        val client_android = Dep("io.ktor", "ktor-client-android", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val client_apache = Dep("io.ktor", "ktor-client-apache", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val client_auth = Dep("io.ktor", "ktor-client-auth", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val client_cio = Dep("io.ktor", "ktor-client-cio", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val client_content_negotiation = Dep("io.ktor", "ktor-client-content-negotiation", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val client_content_negotiation_tests = Dep("io.ktor", "ktor-client-content-negotiation-tests", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val client_core = Dep("io.ktor", "ktor-client-core", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val client_curl = Dep("io.ktor", "ktor-client-curl", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val client_darwin = Dep("io.ktor", "ktor-client-darwin", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val client_encoding = Dep("io.ktor", "ktor-client-encoding", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val client_gson = Dep("io.ktor", "ktor-client-gson", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val client_jackson = Dep("io.ktor", "ktor-client-jackson", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val client_java = Dep("io.ktor", "ktor-client-java", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val client_jetty = Dep("io.ktor", "ktor-client-jetty", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val client_json = Dep("io.ktor", "ktor-client-json", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val client_json_tests = Dep("io.ktor", "ktor-client-json-tests", Ver("2.3.8", 0))
        val client_logging = Dep("io.ktor", "ktor-client-logging", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val client_mock = Dep("io.ktor", "ktor-client-mock", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val client_okhttp = Dep("io.ktor", "ktor-client-okhttp", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val client_resources = Dep("io.ktor", "ktor-client-resources", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val client_serialization = Dep("io.ktor", "ktor-client-serialization", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val client_tests = Dep("io.ktor", "ktor-client-tests", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val events = Dep("io.ktor", "ktor-events", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val http = Dep("io.ktor", "ktor-http", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val http_cio = Dep("io.ktor", "ktor-http-cio", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val io = Dep("io.ktor", "ktor-io", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val network = Dep("io.ktor", "ktor-network", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val network_tls = Dep("io.ktor", "ktor-network-tls", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val network_tls_certificates = Dep("io.ktor", "ktor-network-tls-certificates", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val resources = Dep("io.ktor", "ktor-resources", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val serialization = Dep("io.ktor", "ktor-serialization", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val serialization_gson = Dep("io.ktor", "ktor-serialization-gson", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val serialization_jackson = Dep("io.ktor", "ktor-serialization-jackson", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val serialization_kotlinx = Dep("io.ktor", "ktor-serialization-kotlinx", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val serialization_kotlinx_cbor = Dep("io.ktor", "ktor-serialization-kotlinx-cbor", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val serialization_kotlinx_json = Dep("io.ktor", "ktor-serialization-kotlinx-json", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val serialization_kotlinx_tests = Dep("io.ktor", "ktor-serialization-kotlinx-tests", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val serialization_kotlinx_xml = Dep("io.ktor", "ktor-serialization-kotlinx-xml", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val server = Dep("io.ktor", "ktor-server", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val server_auth = Dep("io.ktor", "ktor-server-auth", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val server_auth_jwt = Dep("io.ktor", "ktor-server-auth-jwt", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val server_auth_ldap = Dep("io.ktor", "ktor-server-auth-ldap", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val server_auto_head_response = Dep("io.ktor", "ktor-server-auto-head-response", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val server_caching_headers = Dep("io.ktor", "ktor-server-caching-headers", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val server_call_id = Dep("io.ktor", "ktor-server-call-id", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val server_call_logging = Dep("io.ktor", "ktor-server-call-logging", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val server_cio = Dep("io.ktor", "ktor-server-cio", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val server_compression = Dep("io.ktor", "ktor-server-compression", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val server_conditional_headers = Dep("io.ktor", "ktor-server-conditional-headers", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val server_content_negotiation = Dep("io.ktor", "ktor-server-content-negotiation", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val server_core = Dep("io.ktor", "ktor-server-core", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val server_cors = Dep("io.ktor", "ktor-server-cors", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val server_data_conversion = Dep("io.ktor", "ktor-server-data-conversion", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val server_default_headers = Dep("io.ktor", "ktor-server-default-headers", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val server_double_receive = Dep("io.ktor", "ktor-server-double-receive", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val server_forwarded_header = Dep("io.ktor", "ktor-server-forwarded-header", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val server_freemarker = Dep("io.ktor", "ktor-server-freemarker", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val server_host_common = Dep("io.ktor", "ktor-server-host-common", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val server_hsts = Dep("io.ktor", "ktor-server-hsts", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val server_html_builder = Dep("io.ktor", "ktor-server-html-builder", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val server_http_redirect = Dep("io.ktor", "ktor-server-http-redirect", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val server_jetty = Dep("io.ktor", "ktor-server-jetty", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val server_jte = Dep("io.ktor", "ktor-server-jte", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val server_locations = Dep("io.ktor", "ktor-server-locations", Ver("2.3.8", 0))
        val server_method_override = Dep("io.ktor", "ktor-server-method-override", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val server_metrics = Dep("io.ktor", "ktor-server-metrics", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val server_metrics_micrometer = Dep("io.ktor", "ktor-server-metrics-micrometer", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val server_mustache = Dep("io.ktor", "ktor-server-mustache", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val server_netty = Dep("io.ktor", "ktor-server-netty", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val server_partial_content = Dep("io.ktor", "ktor-server-partial-content", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val server_pebble = Dep("io.ktor", "ktor-server-pebble", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val server_resources = Dep("io.ktor", "ktor-server-resources", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val server_servlet = Dep("io.ktor", "ktor-server-servlet", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val server_sessions = Dep("io.ktor", "ktor-server-sessions", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val server_status_pages = Dep("io.ktor", "ktor-server-status-pages", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val server_test_host = Dep("io.ktor", "ktor-server-test-host", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val server_test_suites = Dep("io.ktor", "ktor-server-test-suites", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val server_thymeleaf = Dep("io.ktor", "ktor-server-thymeleaf", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val server_tomcat = Dep("io.ktor", "ktor-server-tomcat", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val server_velocity = Dep("io.ktor", "ktor-server-velocity", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val server_webjars = Dep("io.ktor", "ktor-server-webjars", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val server_websockets = Dep("io.ktor", "ktor-server-websockets", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val test_dispatcher = Dep("io.ktor", "ktor-test-dispatcher", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val utils = Dep("io.ktor", "ktor-utils", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val websocket_serialization = Dep("io.ktor", "ktor-websocket-serialization", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
        val websockets = Dep("io.ktor", "ktor-websockets", Ver("2.3.8", 0), Ver("3.0.0-beta-1", 200))
    }
    object MockK {
...
object Org {
    ...
    object JetBrains {
        ...
        object KotlinX {
            ...
            val dataframe = Dep("org.jetbrains.kotlinx", "dataframe", Ver("0.13.0", 0), Ver("0.13.1-dev-2874", 320))
            val dataframe_arrow = Dep("org.jetbrains.kotlinx", "dataframe-arrow", Ver("0.13.0", 0), Ver("0.13.1-dev-2874", 320))
            val dataframe_core = Dep("org.jetbrains.kotlinx", "dataframe-core", Ver("0.13.0", 0), Ver("0.13.1-dev-2874", 320))
            val dataframe_excel = Dep("org.jetbrains.kotlinx", "dataframe-excel", Ver("0.13.0", 0), Ver("0.13.1-dev-2874", 320))
        ...
        object Kotlin_Wrappers {
            val bom = Dep("org.jetbrains.kotlin-wrappers", "kotlin-wrappers-bom", Ver("1.0.0-pre.707", 0))
            val kotlin_actions_toolkit = Dep("org.jetbrains.kotlin-wrappers", "kotlin-actions-toolkit", Ver("0.0.1-pre.707", 0))
            val kotlin_browser = Dep("org.jetbrains.kotlin-wrappers", "kotlin-browser", Ver("1.0.0-pre.707", 0))
            val kotlin_cesium = Dep("org.jetbrains.kotlin-wrappers", "kotlin-cesium", Ver("1.115.0-pre.707", 0))
            val kotlin_css = Dep("org.jetbrains.kotlin-wrappers", "kotlin-css", Ver("1.0.0-pre.707", 0))
            val kotlin_csstype = Dep("org.jetbrains.kotlin-wrappers", "kotlin-csstype", Ver("3.1.3-pre.707", 0))
            val kotlin_emotion = Dep("org.jetbrains.kotlin-wrappers", "kotlin-emotion", Ver("11.11.1-pre.707", 0))
            val kotlin_history = Dep("org.jetbrains.kotlin-wrappers", "kotlin-history", Ver("5.3.0-pre.506-compat", 0))
            val kotlin_js = Dep("org.jetbrains.kotlin-wrappers", "kotlin-js", Ver("1.0.0-pre.707", 0))
            ...
            val kotlin_node = Dep("org.jetbrains.kotlin-wrappers", "kotlin-node", Ver("20.11.5-pre.707", 0))
            val kotlin_popper = Dep("org.jetbrains.kotlin-wrappers", "kotlin-popper", Ver("2.11.8-pre.707", 0))
            val kotlin_react = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react", Ver("18.2.0-pre.707", 0))
            val kotlin_react_beautiful_dnd = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-beautiful-dnd", Ver("13.1.1-pre.707", 0))
            val kotlin_react_core = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-core", Ver("18.2.0-pre.707", 0))
            val kotlin_react_dom = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-dom", Ver("18.2.0-pre.707", 0))
            val kotlin_react_dom_legacy = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-dom-legacy", Ver("18.2.0-pre.707", 0))
            val kotlin_react_dom_test_utils = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-dom-test-utils", Ver("18.2.0-pre.707", 0))
            val kotlin_react_legacy = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-legacy", Ver("18.2.0-pre.707", 0))
            val kotlin_react_popper = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-popper", Ver("2.3.0-pre.707", 0))
            val kotlin_react_redux = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-redux", Ver("7.2.6-pre.707", 0))
            val kotlin_react_router = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-router", Ver("6.22.1-pre.707", 0))
            val kotlin_react_router_dom = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-router-dom", Ver("6.22.1-pre.707", 0))
            val kotlin_react_select = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-select", Ver("5.8.0-pre.707", 0))
            val kotlin_react_use = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-use", Ver("17.4.0-pre.707", 0))
            val kotlin_redux = Dep("org.jetbrains.kotlin-wrappers", "kotlin-redux", Ver("4.1.2-pre.707", 0))
            val kotlin_remix_run_router = Dep("org.jetbrains.kotlin-wrappers", "kotlin-remix-run-router", Ver("1.15.1-pre.707", 0))
            val kotlin_ring_ui = Dep("org.jetbrains.kotlin-wrappers", "kotlin-ring-ui", Ver("4.1.5-pre.707", 0))
            val kotlin_styled = Dep("org.jetbrains.kotlin-wrappers", "kotlin-styled", Ver("5.3.11-pre.707", 0))
            val kotlin_styled_next = Dep("org.jetbrains.kotlin-wrappers", "kotlin-styled-next", Ver("1.2.4-pre.707", 0))
            val kotlin_tanstack_query_core = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-query-core", Ver("5.24.1-pre.707", 0))
            val kotlin_tanstack_react_query = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-react-query", Ver("5.24.1-pre.707", 0))
            val kotlin_tanstack_react_query_devtools = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-react-query-devtools", Ver("5.24.1-pre.707", 0))
            val kotlin_tanstack_react_table = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-react-table", Ver("8.13.2-pre.707", 0))
            val kotlin_tanstack_react_virtual = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-react-virtual", Ver("3.1.3-pre.707", 0))
            val kotlin_tanstack_table_core = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-table-core", Ver("8.13.2-pre.707", 0))
            val kotlin_tanstack_virtual_core = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-virtual-core", Ver("3.1.3-pre.707", 0))
            val kotlin_typescript = Dep("org.jetbrains.kotlin-wrappers", "kotlin-typescript", Ver("5.3.3-pre.691", 0), Ver("5.4.1-rc-pre.707", 100))
            val kotlin_web = Dep("org.jetbrains.kotlin-wrappers", "kotlin-web", Ver("1.0.0-pre.707", 0))
        }
    }
    object Kodein {
        object Di {
...
object Pl {
    object MarekLangiewicz {
        ...
        val kground = Dep("pl.mareklangiewicz", "kground", Ver("0.0.39", 0))
        val kground_io = Dep("pl.mareklangiewicz", "kground-io", Ver("0.0.39", 0))
        val kground_io_js = Dep("pl.mareklangiewicz", "kground-io-js", Ver("0.0.39", 0))
        val kground_io_jvm = Dep("pl.mareklangiewicz", "kground-io-jvm", Ver("0.0.39", 0))
        val kground_js = Dep("pl.mareklangiewicz", "kground-js", Ver("0.0.39", 0))
        val kground_jvm = Dep("pl.mareklangiewicz", "kground-jvm", Ver("0.0.39", 0))
        val kgroundx = Dep("pl.mareklangiewicz", "kgroundx", Ver("0.0.39", 0))
        val kgroundx_io = Dep("pl.mareklangiewicz", "kgroundx-io", Ver("0.0.39", 0))
        val kgroundx_io_js = Dep("pl.mareklangiewicz", "kgroundx-io-js", Ver("0.0.39", 0))
        val kgroundx_io_jvm = Dep("pl.mareklangiewicz", "kgroundx-io-jvm", Ver("0.0.39", 0))
        val kgroundx_js = Dep("pl.mareklangiewicz", "kgroundx-js", Ver("0.0.39", 0))
        val kgroundx_jupyter = Dep("pl.mareklangiewicz", "kgroundx-jupyter", Ver("0.0.39", 0))
        val kgroundx_jupyter_jvm = Dep("pl.mareklangiewicz", "kgroundx-jupyter-jvm", Ver("0.0.39", 0))
        val kgroundx_jvm = Dep("pl.mareklangiewicz", "kgroundx-jvm", Ver("0.0.39", 0))
        val kgroundx_maintenance = Dep("pl.mareklangiewicz", "kgroundx-maintenance", Ver("0.0.39", 0))
        val kgroundx_maintenance_js = Dep("pl.mareklangiewicz", "kgroundx-maintenance-js")
        val kgroundx_maintenance_jvm = Dep("pl.mareklangiewicz", "kgroundx-maintenance-jvm", Ver("0.0.39", 0))
        val kommandjupyter = Dep("pl.mareklangiewicz", "kommandjupyter", Ver("0.0.44", 0))
        val kommandjupyter_jvm = Dep("pl.mareklangiewicz", "kommandjupyter-jvm", Ver("0.0.44", 0))
        val kommandline = Dep("pl.mareklangiewicz", "kommandline", Ver("0.0.44", 0))
        val kommandline_js = Dep("pl.mareklangiewicz", "kommandline-js", Ver("0.0.44", 0))
        val kommandline_jvm = Dep("pl.mareklangiewicz", "kommandline-jvm", Ver("0.0.44", 0))
        val kommandsamples = Dep("pl.mareklangiewicz", "kommandsamples", Ver("0.0.44", 0))
        val kommandsamples_js = Dep("pl.mareklangiewicz", "kommandsamples-js", Ver("0.0.44", 0))
        val kommandsamples_jvm = Dep("pl.mareklangiewicz", "kommandsamples-jvm", Ver("0.0.44", 0))
