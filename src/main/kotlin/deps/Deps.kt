...
object AndroidX {
    ...
    object Annotation {
        ...
        val experimental = Dep("androidx.annotation", "annotation-experimental", Ver("1.2.0-alpha01", 300), Ver("1.3.1", 0), Ver("1.4.0-beta01", 200))
    }
    object AppCompat {
    ...
    object Compose {
        ...
        object Animation {
            val animation = Dep("androidx.compose.animation", "animation", Ver("1.0.0-beta06", 200), Ver("1.5.4", 0), Ver("1.6.0-beta03", 200))
            val core = Dep("androidx.compose.animation", "animation-core", Ver("1.0.0-beta06", 200), Ver("1.5.4", 0), Ver("1.6.0-beta03", 200))
            val graphics = Dep("androidx.compose.animation", "animation-graphics", Ver("1.5.4", 0), Ver("1.6.0-beta03", 200))
        }
        object Compiler {
            val compiler = Dep("androidx.compose.compiler", "compiler", Ver("1.0.0-beta06", 200), Ver("1.5.7", 0))
        }
        object Foundation {
            val foundation = Dep("androidx.compose.foundation", "foundation", Ver("1.0.0-beta06", 200), Ver("1.5.4", 0), Ver("1.6.0-beta03", 200))
            val layout = Dep("androidx.compose.foundation", "foundation-layout", Ver("1.0.0-beta06", 200), Ver("1.5.4", 0), Ver("1.6.0-beta03", 200))
        }
        object Material {
            val icons_core = Dep("androidx.compose.material", "material-icons-core", Ver("1.0.0-beta06", 200), Ver("1.5.4", 0), Ver("1.6.0-beta03", 200))
            val icons_extended = Dep("androidx.compose.material", "material-icons-extended", Ver("1.0.0-beta06", 200), Ver("1.5.4", 0), Ver("1.6.0-beta03", 200))
            val material = Dep("androidx.compose.material", "material", Ver("1.0.0-beta06", 200), Ver("1.5.4", 0), Ver("1.6.0-beta03", 200))
            val ripple = Dep("androidx.compose.material", "material-ripple", Ver("1.0.0-beta06", 200), Ver("1.5.4", 0), Ver("1.6.0-beta03", 200))
        }
        object Material3 {
            val material3 = Dep("androidx.compose.material3", "material3", Ver("1.1.2", 0), Ver("1.2.0-beta01", 200))
            val window_size_class = Dep("androidx.compose.material3", "material3-window-size-class", Ver("1.1.2", 0), Ver("1.2.0-beta01", 200))
        }
        object Runtime {
            val dispatch = Dep("androidx.compose.runtime", "runtime-dispatch", Ver("1.0.0-alpha12", 300))
            val livedata = Dep("androidx.compose.runtime", "runtime-livedata", Ver("1.5.4", 0), Ver("1.6.0-beta03", 200))
            val runtime = Dep("androidx.compose.runtime", "runtime", Ver("1.0.0-beta06", 200), Ver("1.5.4", 0), Ver("1.6.0-beta03", 200))
            val rxjava2 = Dep("androidx.compose.runtime", "runtime-rxjava2", Ver("1.5.4", 0), Ver("1.6.0-beta03", 200))
            val rxjava3 = Dep("androidx.compose.runtime", "runtime-rxjava3", Ver("1.5.4", 0), Ver("1.6.0-beta03", 200))
            val saveable = Dep("androidx.compose.runtime", "runtime-saveable", Ver("1.0.0-beta06", 200), Ver("1.5.4", 0), Ver("1.6.0-beta03", 200))
            val tracing = Dep("androidx.compose.runtime", "runtime-tracing", Ver("1.0.0-beta01", 200))
        }
        object Ui {
            val geometry = Dep("androidx.compose.ui", "ui-geometry", Ver("1.0.0-beta06", 200), Ver("1.5.4", 0), Ver("1.6.0-beta03", 200))
            val graphics = Dep("androidx.compose.ui", "ui-graphics", Ver("1.0.0-beta06", 200), Ver("1.5.4", 0), Ver("1.6.0-beta03", 200))
            val test = Dep("androidx.compose.ui", "ui-test", Ver("1.0.0-beta06", 200), Ver("1.5.4", 0), Ver("1.6.0-beta03", 200))
            val test_junit4 = Dep("androidx.compose.ui", "ui-test-junit4", Ver("1.0.0-beta06", 200), Ver("1.5.4", 0), Ver("1.6.0-beta03", 200))
            val test_manifest = Dep("androidx.compose.ui", "ui-test-manifest", Ver("1.5.4", 0), Ver("1.6.0-beta03", 200))
            val text = Dep("androidx.compose.ui", "ui-text", Ver("1.0.0-beta06", 200), Ver("1.5.4", 0), Ver("1.6.0-beta03", 200))
            val text_google_fonts = Dep("androidx.compose.ui", "ui-text-google-fonts", Ver("1.5.4", 0), Ver("1.6.0-beta03", 200))
            val tooling = Dep("androidx.compose.ui", "ui-tooling", Ver("1.5.4", 0), Ver("1.6.0-beta03", 200))
            val tooling_data = Dep("androidx.compose.ui", "ui-tooling-data", Ver("1.5.4", 0), Ver("1.6.0-beta03", 200))
            val tooling_preview = Dep("androidx.compose.ui", "ui-tooling-preview", Ver("1.5.4", 0), Ver("1.6.0-beta03", 200))
            val ui = Dep("androidx.compose.ui", "ui", Ver("1.0.0-beta06", 200), Ver("1.5.4", 0), Ver("1.6.0-beta03", 200))
            val unit = Dep("androidx.compose.ui", "ui-unit", Ver("1.0.0-beta06", 200), Ver("1.5.4", 0), Ver("1.6.0-beta03", 200))
            val util = Dep("androidx.compose.ui", "ui-util", Ver("1.0.0-beta06", 200), Ver("1.5.4", 0), Ver("1.6.0-beta03", 200))
            val viewbinding = Dep("androidx.compose.ui", "ui-viewbinding", Ver("1.5.4", 0), Ver("1.6.0-beta03", 200))
        }
    }
    object Concurrent {
    ...
    object Core {
        ...
        val performance = Dep("androidx.core", "core-performance", Ver("1.0.0-rc01", 100))
    ...
    object Lifecycle {
        val common = Dep("androidx.lifecycle", "lifecycle-common", Ver("2.6.2", 0), Ver("2.7.0-rc02", 100))
        val common_java8 = Dep("androidx.lifecycle", "lifecycle-common-java8", Ver("2.6.2", 0), Ver("2.7.0-rc02", 100))
        val compiler = Dep("androidx.lifecycle", "lifecycle-compiler", Ver("2.6.2", 0), Ver("2.7.0-rc02", 100))
        val extensions = Dep("androidx.lifecycle", "lifecycle-extensions", Ver("2.2.0", 0))
        val livedata = Dep("androidx.lifecycle", "lifecycle-livedata", Ver("2.6.2", 0), Ver("2.7.0-rc02", 100))
        val livedata_ktx = Dep("androidx.lifecycle", "lifecycle-livedata-ktx", Ver("2.6.2", 0), Ver("2.7.0-rc02", 100))
        val process = Dep("androidx.lifecycle", "lifecycle-process", Ver("2.6.2", 0), Ver("2.7.0-rc02", 100))
        val reactivestreams = Dep("androidx.lifecycle", "lifecycle-reactivestreams", Ver("2.6.2", 0), Ver("2.7.0-rc02", 100))
        val reactivestreams_ktx = Dep("androidx.lifecycle", "lifecycle-reactivestreams-ktx", Ver("2.6.2", 0), Ver("2.7.0-rc02", 100))
        val runtime = Dep("androidx.lifecycle", "lifecycle-runtime", Ver("2.6.2", 0), Ver("2.7.0-rc02", 100))
        val runtime_compose = Dep("androidx.lifecycle", "lifecycle-runtime-compose", Ver("2.6.2", 0), Ver("2.7.0-rc02", 100))
        val runtime_ktx = Dep("androidx.lifecycle", "lifecycle-runtime-ktx", Ver("2.6.2", 0), Ver("2.7.0-rc02", 100))
        val runtime_testing = Dep("androidx.lifecycle", "lifecycle-runtime-testing", Ver("2.6.2", 0), Ver("2.7.0-rc02", 100))
        val service = Dep("androidx.lifecycle", "lifecycle-service", Ver("2.6.2", 0), Ver("2.7.0-rc02", 100))
        val viewmodel = Dep("androidx.lifecycle", "lifecycle-viewmodel", Ver("2.6.2", 0), Ver("2.7.0-rc02", 100))
        val viewmodel_compose = Dep("androidx.lifecycle", "lifecycle-viewmodel-compose", Ver("1.0.0-alpha06", 300), Ver("2.6.2", 0), Ver("2.7.0-rc02", 100))
        val viewmodel_ktx = Dep("androidx.lifecycle", "lifecycle-viewmodel-ktx", Ver("2.6.2", 0), Ver("2.7.0-rc02", 100))
        val viewmodel_savedstate = Dep("androidx.lifecycle", "lifecycle-viewmodel-savedstate", Ver("2.6.2", 0), Ver("2.7.0-rc02", 100))
    }
    object Loader {
    ...
    object Media2 {
        val common = Dep("androidx.media2", "media2-common", Ver("1.2.1", 0), Ver("1.3.0-rc01", 100))
        val exoplayer = Dep("androidx.media2", "media2-exoplayer", Ver("1.2.1", 0), Ver("1.3.0-rc01", 100))
        val player = Dep("androidx.media2", "media2-player", Ver("1.2.1", 0), Ver("1.3.0-rc01", 100))
        val session = Dep("androidx.media2", "media2-session", Ver("1.2.1", 0), Ver("1.3.0-rc01", 100))
        val widget = Dep("androidx.media2", "media2-widget", Ver("1.2.1", 0), Ver("1.3.0-rc01", 100))
    }
    object Media3 {
    ...
    object Versionedparcelable {
        val versionedparcelable = Dep("androidx.versionedparcelable", "versionedparcelable", Ver("1.1.1", 0), Ver("1.2.0-rc01", 100))
    }
    object ViewPager {
    ...
    object Wear {
        ...
        object Compose {
            val foundation = Dep("androidx.wear.compose", "compose-foundation", Ver("1.0.0-alpha01", 300), Ver("1.2.1", 0), Ver("1.3.0-beta02", 200))
            val material = Dep("androidx.wear.compose", "compose-material", Ver("1.0.0-alpha01", 300), Ver("1.2.1", 0), Ver("1.3.0-beta02", 200))
            val navigation = Dep("androidx.wear.compose", "compose-navigation", Ver("1.2.1", 0), Ver("1.3.0-beta02", 200))
        }
        object Tiles {
            val material = Dep("androidx.wear.tiles", "tiles-material", Ver("1.2.0", 0), Ver("1.3.0-alpha04", 300))
            val renderer = Dep("androidx.wear.tiles", "tiles-renderer", Ver("1.2.0", 0), Ver("1.3.0-alpha04", 300))
            val testing = Dep("androidx.wear.tiles", "tiles-testing", Ver("1.2.0", 0), Ver("1.3.0-alpha04", 300))
            val tiles = Dep("androidx.wear.tiles", "tiles", Ver("1.2.0", 0), Ver("1.3.0-alpha04", 300))
        }
        object Watchface {
    ...
    object WebKit {
        val webkit = Dep("androidx.webkit", "webkit", Ver("1.9.0", 0), Ver("1.10.0-beta01", 200))
    }
    object Window {
...
object Com {
    object Android {
        ...
        object Tools {
            ...
            val r8 = Dep("com.android.tools", "r8", Ver("8.2.33", 0))
            object Build {
                val gradle = Dep("com.android.tools.build", "gradle", Ver("2.3.0", 0), Ver("2.3.3", 0), Ver("2.4.0-alpha7", 300), Ver("2.5.0-alpha-preview-02", 400), Ver("8.2.0", 0), Ver("8.3.0-alpha18", 300))
            }
        }
    }
    ...
    object Google {
        ...
        object Android {
            ...
            object Horologist {
                val audio = Dep("com.google.android.horologist", "horologist-audio", Ver("0.5.16", 0))
                val audio_ui = Dep("com.google.android.horologist", "horologist-audio-ui", Ver("0.5.16", 0))
                val composables = Dep("com.google.android.horologist", "horologist-composables", Ver("0.5.16", 0))
                val compose_layout = Dep("com.google.android.horologist", "horologist-compose-layout", Ver("0.5.16", 0))
                val compose_tools = Dep("com.google.android.horologist", "horologist-compose-tools", Ver("0.5.16", 0))
                val datalayer = Dep("com.google.android.horologist", "horologist-datalayer", Ver("0.5.16", 0))
                val media = Dep("com.google.android.horologist", "horologist-media", Ver("0.5.16", 0))
                val media3_backend = Dep("com.google.android.horologist", "horologist-media3-backend", Ver("0.5.16", 0))
                val media_data = Dep("com.google.android.horologist", "horologist-media-data", Ver("0.5.16", 0))
                val media_ui = Dep("com.google.android.horologist", "horologist-media-ui", Ver("0.5.16", 0))
                val network_awareness = Dep("com.google.android.horologist", "horologist-network-awareness", Ver("0.5.16", 0))
                val tiles = Dep("com.google.android.horologist", "horologist-tiles", Ver("0.5.16", 0))
            }
            object Libraries {
                object Places {
            ...
            object Material {
                ...
                val material = Dep("com.google.android.material", "material", Ver("1.11.0", 0), Ver("1.12.0-alpha02", 300))
            }
            object Play {
    ...
    object Rickclephas {
        object Kmp {
            val nativecoroutines_annotations = Dep("com.rickclephas.kmp", "kmp-nativecoroutines-annotations", Ver("0.13.3", 0), Ver("1.0.0-ALPHA-23-kotlin-2.0.0-Beta2", 300))
            val nativecoroutines_compiler = Dep("com.rickclephas.kmp", "kmp-nativecoroutines-compiler", Ver("0.13.3", 0), Ver("1.0.0-ALPHA-23-kotlin-2.0.0-Beta2", 300))
            val nativecoroutines_compiler_embeddable = Dep("com.rickclephas.kmp", "kmp-nativecoroutines-compiler-embeddable", Ver("0.13.3", 0), Ver("1.0.0-ALPHA-23-kotlin-2.0.0-Beta2", 300))
            val nativecoroutines_core = Dep("com.rickclephas.kmp", "kmp-nativecoroutines-core", Ver("0.13.3", 0), Ver("1.0.0-ALPHA-23-kotlin-2.0.0-Beta2", 300))
            val nativecoroutines_gradle_plugin = Dep("com.rickclephas.kmp", "kmp-nativecoroutines-gradle-plugin", Ver("0.13.3", 0), Ver("1.0.0-ALPHA-23-kotlin-2.0.0-Beta2", 300))
        }
    }
    object Russhwolf {
...
object Io {
    ...
    object GitHub {
        ...
        object TypeSafeGitHub {
            val github_workflows_kt = Dep("io.github.typesafegithub", "github-workflows-kt", Ver("1.7.0", 0))
        }
    }
    object Insert_koin {
    ...
    object Projectreactor {
        val reactor_test = Dep("io.projectreactor", "reactor-test", Ver("3.6.1", 0))
        object Kotlin {
...
object Org {
    ...
    object Http4k {
        val aws = Dep("org.http4k", "http4k-aws", Ver("5.11.1.0", 0))
        val bom = Dep("org.http4k", "http4k-bom", Ver("5.11.1.0", 0))
        val client_apache = Dep("org.http4k", "http4k-client-apache", Ver("5.11.1.0", 0))
        val client_apache4 = Dep("org.http4k", "http4k-client-apache4", Ver("5.11.1.0", 0))
        val client_apache4_async = Dep("org.http4k", "http4k-client-apache4-async", Ver("5.11.1.0", 0))
        val client_apache_async = Dep("org.http4k", "http4k-client-apache-async", Ver("5.11.1.0", 0))
        val client_jetty = Dep("org.http4k", "http4k-client-jetty", Ver("5.11.1.0", 0))
        val client_okhttp = Dep("org.http4k", "http4k-client-okhttp", Ver("5.11.1.0", 0))
        val client_websocket = Dep("org.http4k", "http4k-client-websocket", Ver("5.11.1.0", 0))
        val cloudnative = Dep("org.http4k", "http4k-cloudnative", Ver("5.11.1.0", 0))
        val contract = Dep("org.http4k", "http4k-contract", Ver("5.11.1.0", 0))
        val core = Dep("org.http4k", "http4k-core", Ver("5.11.1.0", 0))
        val format_argo = Dep("org.http4k", "http4k-format-argo", Ver("5.11.1.0", 0))
        val format_core = Dep("org.http4k", "http4k-format-core", Ver("5.11.1.0", 0))
        val format_gson = Dep("org.http4k", "http4k-format-gson", Ver("5.11.1.0", 0))
        val format_jackson = Dep("org.http4k", "http4k-format-jackson", Ver("5.11.1.0", 0))
        val format_jackson_xml = Dep("org.http4k", "http4k-format-jackson-xml", Ver("5.11.1.0", 0))
        val format_jackson_yaml = Dep("org.http4k", "http4k-format-jackson-yaml", Ver("5.11.1.0", 0))
        val format_klaxon = Dep("org.http4k", "http4k-format-klaxon", Ver("5.11.1.0", 0))
        val format_kotlinx_serialization = Dep("org.http4k", "http4k-format-kotlinx-serialization", Ver("5.11.1.0", 0))
        val format_moshi = Dep("org.http4k", "http4k-format-moshi", Ver("5.11.1.0", 0))
        val format_xml = Dep("org.http4k", "http4k-format-xml", Ver("5.11.1.0", 0))
        val graphql = Dep("org.http4k", "http4k-graphql", Ver("5.11.1.0", 0))
        val incubator = Dep("org.http4k", "http4k-incubator", Ver("5.11.1.0", 0))
        val jsonrpc = Dep("org.http4k", "http4k-jsonrpc", Ver("5.11.1.0", 0))
        val metrics_micrometer = Dep("org.http4k", "http4k-metrics-micrometer", Ver("5.11.1.0", 0))
        val multipart = Dep("org.http4k", "http4k-multipart", Ver("5.11.1.0", 0))
        val opentelemetry = Dep("org.http4k", "http4k-opentelemetry", Ver("5.11.1.0", 0))
        val realtime_core = Dep("org.http4k", "http4k-realtime-core", Ver("5.11.1.0", 0))
        val resilience4j = Dep("org.http4k", "http4k-resilience4j", Ver("5.11.1.0", 0))
        val security_oauth = Dep("org.http4k", "http4k-security-oauth", Ver("5.11.1.0", 0))
        val server_apache = Dep("org.http4k", "http4k-server-apache", Ver("5.11.1.0", 0))
        val server_apache4 = Dep("org.http4k", "http4k-server-apache4", Ver("5.11.1.0", 0))
        val server_jetty = Dep("org.http4k", "http4k-server-jetty", Ver("5.11.1.0", 0))
        val server_ktorcio = Dep("org.http4k", "http4k-server-ktorcio", Ver("5.11.1.0", 0))
        val server_ktornetty = Dep("org.http4k", "http4k-server-ktornetty", Ver("5.11.1.0", 0))
        val server_netty = Dep("org.http4k", "http4k-server-netty", Ver("5.11.1.0", 0))
        val server_ratpack = Dep("org.http4k", "http4k-server-ratpack", Ver("5.11.1.0", 0))
        val server_undertow = Dep("org.http4k", "http4k-server-undertow", Ver("5.11.1.0", 0))
        val serverless_alibaba = Dep("org.http4k", "http4k-serverless-alibaba", Ver("5.11.1.0", 0))
        val serverless_azure = Dep("org.http4k", "http4k-serverless-azure", Ver("5.11.1.0", 0))
        val serverless_gcf = Dep("org.http4k", "http4k-serverless-gcf", Ver("5.11.1.0", 0))
        val serverless_lambda = Dep("org.http4k", "http4k-serverless-lambda", Ver("5.11.1.0", 0))
        val serverless_lambda_runtime = Dep("org.http4k", "http4k-serverless-lambda-runtime", Ver("5.11.1.0", 0))
        val serverless_openwhisk = Dep("org.http4k", "http4k-serverless-openwhisk", Ver("5.11.1.0", 0))
        val serverless_tencent = Dep("org.http4k", "http4k-serverless-tencent", Ver("5.11.1.0", 0))
        val template_core = Dep("org.http4k", "http4k-template-core", Ver("5.11.1.0", 0))
        val template_dust = Dep("org.http4k", "http4k-template-dust", Ver("4.48.0.0", 0))
        val template_freemarker = Dep("org.http4k", "http4k-template-freemarker", Ver("5.11.1.0", 0))
        val template_handlebars = Dep("org.http4k", "http4k-template-handlebars", Ver("5.11.1.0", 0))
        val template_jade4j = Dep("org.http4k", "http4k-template-jade4j", Ver("5.11.1.0", 0))
        val template_pebble = Dep("org.http4k", "http4k-template-pebble", Ver("5.11.1.0", 0))
        val template_thymeleaf = Dep("org.http4k", "http4k-template-thymeleaf", Ver("5.11.1.0", 0))
        val testing_approval = Dep("org.http4k", "http4k-testing-approval", Ver("5.11.1.0", 0))
        val testing_chaos = Dep("org.http4k", "http4k-testing-chaos", Ver("5.11.1.0", 0))
        val testing_hamkrest = Dep("org.http4k", "http4k-testing-hamkrest", Ver("5.11.1.0", 0))
        val testing_kotest = Dep("org.http4k", "http4k-testing-kotest", Ver("5.11.1.0", 0))
        val testing_servirtium = Dep("org.http4k", "http4k-testing-servirtium", Ver("5.11.1.0", 0))
        val testing_strikt = Dep("org.http4k", "http4k-testing-strikt", Ver("5.11.1.0", 0))
        val testing_webdriver = Dep("org.http4k", "http4k-testing-webdriver", Ver("5.11.1.0", 0))
    }
    object JUnit {
    ...
    object JetBrains {
        object Compose {
            ...
            object Compiler {
                val compiler = Dep("org.jetbrains.compose.compiler", "compiler", Ver("1.5.4", 0), Ver("1.5.6-dev1-kt2.0.0-Beta2", 320))
            }
        }
        object Exposed {
        ...
        object Kotlin {
            val script_runtime = Dep("org.jetbrains.kotlin", "kotlin-script-runtime", Ver("1.9.21", 0), Ver("1.9.22", 0), Ver("2.0.0-Beta2", 200))
            val stdlib = Dep("org.jetbrains.kotlin", "kotlin-stdlib", Ver("1.9.21", 0), Ver("1.9.22", 0), Ver("2.0.0-Beta2", 200))
            val stdlib_common = Dep("org.jetbrains.kotlin", "kotlin-stdlib-common", Ver("1.9.21", 0), Ver("1.9.22", 0), Ver("2.0.0-Beta2", 200))
            val stdlib_jdk7 = Dep("org.jetbrains.kotlin", "kotlin-stdlib-jdk7", Ver("1.9.21", 0), Ver("1.9.22", 0), Ver("2.0.0-Beta2", 200))
            val stdlib_jdk8 = Dep("org.jetbrains.kotlin", "kotlin-stdlib-jdk8", Ver("1.9.21", 0), Ver("1.9.22", 0), Ver("2.0.0-Beta2", 200))
            val stdlib_js = Dep("org.jetbrains.kotlin", "kotlin-stdlib-js", Ver("1.9.22", 0), Ver("2.0.0-Beta2", 200))
            val test = Dep("org.jetbrains.kotlin", "kotlin-test", Ver("1.9.21", 0), Ver("1.9.22", 0), Ver("2.0.0-Beta2", 200))
            val test_annotations_common = Dep("org.jetbrains.kotlin", "kotlin-test-annotations-common", Ver("1.9.21", 0), Ver("1.9.22", 0), Ver("2.0.0-Beta2", 200))
            val test_common = Dep("org.jetbrains.kotlin", "kotlin-test-common", Ver("1.9.21", 0), Ver("1.9.22", 0), Ver("2.0.0-Beta2", 200))
            val test_js = Dep("org.jetbrains.kotlin", "kotlin-test-js", Ver("1.9.22", 0), Ver("2.0.0-Beta2", 200))
            val test_js_runner = Dep("org.jetbrains.kotlin", "kotlin-test-js-runner", Ver("1.9.21", 0), Ver("1.9.22", 0), Ver("2.0.0-Beta2", 200))
            val test_junit = Dep("org.jetbrains.kotlin", "kotlin-test-junit", Ver("1.9.21", 0), Ver("1.9.22", 0), Ver("2.0.0-Beta2", 200))
            val test_junit5 = Dep("org.jetbrains.kotlin", "kotlin-test-junit5", Ver("1.9.21", 0), Ver("1.9.22", 0), Ver("2.0.0-Beta2", 200))
        ...
        object KotlinX {
            ...
            val coroutines_android = Dep("org.jetbrains.kotlinx", "kotlinx-coroutines-android", Ver("1.7.3", 0), Ver("1.8.0-RC", 100), Ver("1.8.0-RC2", 100))
            val coroutines_bom = Dep("org.jetbrains.kotlinx", "kotlinx-coroutines-bom", Ver("1.7.3", 0), Ver("1.8.0-RC", 100), Ver("1.8.0-RC2", 100))
            val coroutines_core = Dep("org.jetbrains.kotlinx", "kotlinx-coroutines-core", Ver("1.7.3", 0), Ver("1.8.0-RC", 100), Ver("1.8.0-RC2", 100))
            val coroutines_debug = Dep("org.jetbrains.kotlinx", "kotlinx-coroutines-debug", Ver("1.7.3", 0), Ver("1.8.0-RC", 100), Ver("1.8.0-RC2", 100))
            val coroutines_guava = Dep("org.jetbrains.kotlinx", "kotlinx-coroutines-guava", Ver("1.7.3", 0), Ver("1.8.0-RC", 100), Ver("1.8.0-RC2", 100))
            val coroutines_javafx = Dep("org.jetbrains.kotlinx", "kotlinx-coroutines-javafx", Ver("1.7.3", 0), Ver("1.8.0-RC2", 100))
            val coroutines_jdk8 = Dep("org.jetbrains.kotlinx", "kotlinx-coroutines-jdk8", Ver("1.7.3", 0), Ver("1.8.0-RC", 100), Ver("1.8.0-RC2", 100))
            val coroutines_jdk9 = Dep("org.jetbrains.kotlinx", "kotlinx-coroutines-jdk9", Ver("1.7.3", 0), Ver("1.8.0-RC2", 100))
            val coroutines_play_services = Dep("org.jetbrains.kotlinx", "kotlinx-coroutines-play-services", Ver("1.7.3", 0), Ver("1.8.0-RC", 100), Ver("1.8.0-RC2", 100))
            val coroutines_reactive = Dep("org.jetbrains.kotlinx", "kotlinx-coroutines-reactive", Ver("1.7.3", 0), Ver("1.8.0-RC", 100), Ver("1.8.0-RC2", 100))
            val coroutines_reactor = Dep("org.jetbrains.kotlinx", "kotlinx-coroutines-reactor", Ver("1.7.3", 0), Ver("1.8.0-RC", 100), Ver("1.8.0-RC2", 100))
            val coroutines_rx2 = Dep("org.jetbrains.kotlinx", "kotlinx-coroutines-rx2", Ver("1.7.3", 0), Ver("1.8.0-RC", 100), Ver("1.8.0-RC2", 100))
            val coroutines_rx3 = Dep("org.jetbrains.kotlinx", "kotlinx-coroutines-rx3", Ver("1.7.3", 0), Ver("1.8.0-RC", 100), Ver("1.8.0-RC2", 100))
            val coroutines_slf4j = Dep("org.jetbrains.kotlinx", "kotlinx-coroutines-slf4j", Ver("1.7.3", 0), Ver("1.8.0-RC", 100), Ver("1.8.0-RC2", 100))
            val coroutines_swing = Dep("org.jetbrains.kotlinx", "kotlinx-coroutines-swing", Ver("1.7.3", 0), Ver("1.8.0-RC", 100), Ver("1.8.0-RC2", 100))
            val coroutines_test = Dep("org.jetbrains.kotlinx", "kotlinx-coroutines-test", Ver("1.7.3", 0), Ver("1.8.0-RC", 100), Ver("1.8.0-RC2", 100))
        ...
        object Kotlin_Wrappers {
            ...
            val kotlin_css = Dep("org.jetbrains.kotlin-wrappers", "kotlin-css", Ver("1.0.0-pre.668", 0))
            val kotlin_csstype = Dep("org.jetbrains.kotlin-wrappers", "kotlin-csstype", Ver("3.1.3-pre.668", 0))
            val kotlin_emotion = Dep("org.jetbrains.kotlin-wrappers", "kotlin-emotion", Ver("11.11.1-pre.668", 0))
            val kotlin_history = Dep("org.jetbrains.kotlin-wrappers", "kotlin-history", Ver("5.3.0-pre.506-compat", 0))
            val kotlin_js = Dep("org.jetbrains.kotlin-wrappers", "kotlin-js", Ver("1.0.0-pre.668", 0))
            ...
            val kotlin_node = Dep("org.jetbrains.kotlin-wrappers", "kotlin-node", Ver("18.16.12-pre.668", 0))
            val kotlin_popper = Dep("org.jetbrains.kotlin-wrappers", "kotlin-popper", Ver("2.11.8-pre.668", 0))
            val kotlin_react = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react", Ver("18.2.0-pre.668", 0))
            val kotlin_react_beautiful_dnd = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-beautiful-dnd", Ver("13.1.1-pre.668", 0))
            val kotlin_react_core = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-core", Ver("18.2.0-pre.668", 0))
            val kotlin_react_dom = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-dom", Ver("18.2.0-pre.668", 0))
            val kotlin_react_dom_legacy = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-dom-legacy", Ver("18.2.0-pre.668", 0))
            val kotlin_react_dom_test_utils = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-dom-test-utils", Ver("18.2.0-pre.668", 0))
            val kotlin_react_legacy = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-legacy", Ver("18.2.0-pre.668", 0))
            val kotlin_react_popper = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-popper", Ver("2.3.0-pre.668", 0))
            val kotlin_react_redux = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-redux", Ver("7.2.6-pre.668", 0))
            val kotlin_react_router = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-router", Ver("6.20.1-pre.668", 0))
            val kotlin_react_router_dom = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-router-dom", Ver("6.20.1-pre.668", 0))
            val kotlin_react_select = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-select", Ver("5.8.0-pre.668", 0))
            val kotlin_react_use = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-use", Ver("17.4.0-pre.668", 0))
            val kotlin_redux = Dep("org.jetbrains.kotlin-wrappers", "kotlin-redux", Ver("4.1.2-pre.668", 0))
            val kotlin_remix_run_router = Dep("org.jetbrains.kotlin-wrappers", "kotlin-remix-run-router", Ver("1.13.1-pre.668", 0))
            val kotlin_ring_ui = Dep("org.jetbrains.kotlin-wrappers", "kotlin-ring-ui", Ver("4.1.5-pre.668", 0))
            val kotlin_styled = Dep("org.jetbrains.kotlin-wrappers", "kotlin-styled", Ver("5.3.11-pre.668", 0))
            val kotlin_styled_next = Dep("org.jetbrains.kotlin-wrappers", "kotlin-styled-next", Ver("1.2.3-pre.668", 0))
            val kotlin_tanstack_query_core = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-query-core", Ver("5.14.1-pre.668", 0))
            val kotlin_tanstack_react_query = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-react-query", Ver("5.14.1-pre.668", 0))
            val kotlin_tanstack_react_query_devtools = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-react-query-devtools", Ver("5.14.1-pre.668", 0))
            val kotlin_tanstack_react_table = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-react-table", Ver("8.11.0-pre.668", 0))
            val kotlin_tanstack_react_virtual = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-react-virtual", Ver("3.0.1-pre.668", 0))
            val kotlin_tanstack_table_core = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-table-core", Ver("8.11.0-pre.668", 0))
            val kotlin_tanstack_virtual_core = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-virtual-core", Ver("3.0.1-pre.668", 0))
            val kotlin_typescript = Dep("org.jetbrains.kotlin-wrappers", "kotlin-typescript", Ver("4.9.5-pre.668", 0))
            val kotlin_web = Dep("org.jetbrains.kotlin-wrappers", "kotlin-web", Ver("1.0.0-pre.668", 0))
        }
    }
    object Kodein {
        object Di {
            val kodein_di_conf_js = Dep("org.kodein.di", "kodein-di-conf-js", Ver("7.21.1", 0))
            val kodein_di_conf_jvm = Dep("org.kodein.di", "kodein-di-conf-jvm", Ver("7.21.1", 0))
            val kodein_di_framework_android_core = Dep("org.kodein.di", "kodein-di-framework-android-core", Ver("7.21.1", 0))
            val kodein_di_framework_android_support = Dep("org.kodein.di", "kodein-di-framework-android-support", Ver("7.21.1", 0))
            val kodein_di_framework_android_x = Dep("org.kodein.di", "kodein-di-framework-android-x", Ver("7.21.1", 0))
            val kodein_di_framework_ktor_server_jvm = Dep("org.kodein.di", "kodein-di-framework-ktor-server-jvm", Ver("7.21.1", 0))
            val kodein_di_framework_tornadofx_jvm = Dep("org.kodein.di", "kodein-di-framework-tornadofx-jvm", Ver("7.21.1", 0))
            val kodein_di_js = Dep("org.kodein.di", "kodein-di-js", Ver("7.21.1", 0))
            val kodein_di_jxinject_jvm = Dep("org.kodein.di", "kodein-di-jxinject-jvm", Ver("7.21.1", 0))
        }
    }
    object Mockito {
        val android = Dep("org.mockito", "mockito-android", Ver("5.8.0", 0))
        val core = Dep("org.mockito", "mockito-core", Ver("5.8.0", 0))
        val errorprone = Dep("org.mockito", "mockito-errorprone", Ver("5.8.0", 0))
        val inline = Dep("org.mockito", "mockito-inline", Ver("5.2.0", 0))
        val junit_jupiter = Dep("org.mockito", "mockito-junit-jupiter", Ver("5.8.0", 0))
        object Kotlin {
    ...
    object SpringFramework {
        ...
        object Boot {
            val spring_boot_configuration_processor = Dep("org.springframework.boot", "spring-boot-configuration-processor", Ver("3.2.0", 0), Ver("3.2.1", 0))
            val spring_boot_dependencies = Dep("org.springframework.boot", "spring-boot-dependencies", Ver("3.2.0", 0), Ver("3.2.1", 0))
            val spring_boot_devtools = Dep("org.springframework.boot", "spring-boot-devtools", Ver("3.2.0", 0), Ver("3.2.1", 0))
            val spring_boot_starter_activemq = Dep("org.springframework.boot", "spring-boot-starter-activemq", Ver("3.2.0", 0), Ver("3.2.1", 0))
            val spring_boot_starter_actuator = Dep("org.springframework.boot", "spring-boot-starter-actuator", Ver("3.2.0", 0), Ver("3.2.1", 0))
            val spring_boot_starter_amqp = Dep("org.springframework.boot", "spring-boot-starter-amqp", Ver("3.2.0", 0), Ver("3.2.1", 0))
            val spring_boot_starter_artemis = Dep("org.springframework.boot", "spring-boot-starter-artemis", Ver("3.2.1", 0))
            val spring_boot_starter_batch = Dep("org.springframework.boot", "spring-boot-starter-batch", Ver("3.2.0", 0), Ver("3.2.1", 0))
            val spring_boot_starter_cache = Dep("org.springframework.boot", "spring-boot-starter-cache", Ver("3.2.0", 0), Ver("3.2.1", 0))
            ...
            val spring_boot_starter_data_jdbc = Dep("org.springframework.boot", "spring-boot-starter-data-jdbc", Ver("3.2.0", 0), Ver("3.2.1", 0))
            val spring_boot_starter_data_jpa = Dep("org.springframework.boot", "spring-boot-starter-data-jpa", Ver("3.2.0", 0), Ver("3.2.1", 0))
            val spring_boot_starter_data_ldap = Dep("org.springframework.boot", "spring-boot-starter-data-ldap", Ver("3.2.1", 0))
            val spring_boot_starter_data_mongodb = Dep("org.springframework.boot", "spring-boot-starter-data-mongodb", Ver("3.2.0", 0), Ver("3.2.1", 0))
            ...
            val spring_boot_starter_data_redis = Dep("org.springframework.boot", "spring-boot-starter-data-redis", Ver("3.2.0", 0), Ver("3.2.1", 0))
            ...
            val spring_boot_starter_data_rest = Dep("org.springframework.boot", "spring-boot-starter-data-rest", Ver("3.2.0", 0), Ver("3.2.1", 0))
            val spring_boot_starter_data_solr = Dep("org.springframework.boot", "spring-boot-starter-data-solr", Ver("2.4.13", 0))
            val spring_boot_starter_freemarker = Dep("org.springframework.boot", "spring-boot-starter-freemarker", Ver("3.2.0", 0), Ver("3.2.1", 0))
            val spring_boot_starter_groovy_templates = Dep("org.springframework.boot", "spring-boot-starter-groovy-templates", Ver("3.2.1", 0))
            val spring_boot_starter_hateoas = Dep("org.springframework.boot", "spring-boot-starter-hateoas", Ver("3.2.0", 0), Ver("3.2.1", 0))
            val spring_boot_starter_integration = Dep("org.springframework.boot", "spring-boot-starter-integration", Ver("3.2.0", 0), Ver("3.2.1", 0))
            val spring_boot_starter_jdbc = Dep("org.springframework.boot", "spring-boot-starter-jdbc", Ver("3.2.0", 0), Ver("3.2.1", 0))
            val spring_boot_starter_jersey = Dep("org.springframework.boot", "spring-boot-starter-jersey", Ver("3.2.0", 0), Ver("3.2.1", 0))
            val spring_boot_starter_jooq = Dep("org.springframework.boot", "spring-boot-starter-jooq", Ver("3.2.1", 0))
            val spring_boot_starter_mail = Dep("org.springframework.boot", "spring-boot-starter-mail", Ver("3.2.0", 0), Ver("3.2.1", 0))
            val spring_boot_starter_mustache = Dep("org.springframework.boot", "spring-boot-starter-mustache", Ver("3.2.1", 0))
            val spring_boot_starter_oauth2_client = Dep("org.springframework.boot", "spring-boot-starter-oauth2-client", Ver("3.2.0", 0), Ver("3.2.1", 0))
            val spring_boot_starter_oauth2_resource_server = Dep("org.springframework.boot", "spring-boot-starter-oauth2-resource-server", Ver("3.2.0", 0), Ver("3.2.1", 0))
            val spring_boot_starter_quartz = Dep("org.springframework.boot", "spring-boot-starter-quartz", Ver("3.2.0", 0), Ver("3.2.1", 0))
            val spring_boot_starter_rsocket = Dep("org.springframework.boot", "spring-boot-starter-rsocket", Ver("3.2.1", 0))
            val spring_boot_starter_security = Dep("org.springframework.boot", "spring-boot-starter-security", Ver("3.2.0", 0), Ver("3.2.1", 0))
            val spring_boot_starter_test = Dep("org.springframework.boot", "spring-boot-starter-test", Ver("3.2.0", 0), Ver("3.2.1", 0))
            val spring_boot_starter_thymeleaf = Dep("org.springframework.boot", "spring-boot-starter-thymeleaf", Ver("3.2.0", 0), Ver("3.2.1", 0))
            val spring_boot_starter_validation = Dep("org.springframework.boot", "spring-boot-starter-validation", Ver("3.2.0", 0), Ver("3.2.1", 0))
            val spring_boot_starter_web = Dep("org.springframework.boot", "spring-boot-starter-web", Ver("3.2.0", 0), Ver("3.2.1", 0))
            val spring_boot_starter_web_services = Dep("org.springframework.boot", "spring-boot-starter-web-services", Ver("3.2.0", 0), Ver("3.2.1", 0))
            val spring_boot_starter_webflux = Dep("org.springframework.boot", "spring-boot-starter-webflux", Ver("3.2.0", 0), Ver("3.2.1", 0))
            val spring_boot_starter_websocket = Dep("org.springframework.boot", "spring-boot-starter-websocket", Ver("3.2.0", 0), Ver("3.2.1", 0))
        }
        object Cloud {
            ...
            val spring_cloud_starter_gateway = Dep("org.springframework.cloud", "spring-cloud-starter-gateway", Ver("4.1.0", 0))
        ...
        object Data {
            val spring_data_rest_hal_explorer = Dep("org.springframework.data", "spring-data-rest-hal-explorer", Ver("4.2.1", 0))
        }
        object Geode {
...
object Pl {
    object MarekLangiewicz {
        ...
        val kground = Dep("pl.mareklangiewicz", "kground", Ver("0.0.33", 0))
        val kground_io = Dep("pl.mareklangiewicz", "kground-io", Ver("0.0.33", 0))
        val kground_io_js = Dep("pl.mareklangiewicz", "kground-io-js", Ver("0.0.33", 0))
        val kground_io_jvm = Dep("pl.mareklangiewicz", "kground-io-jvm", Ver("0.0.33", 0))
        val kground_js = Dep("pl.mareklangiewicz", "kground-js", Ver("0.0.33", 0))
        val kground_jvm = Dep("pl.mareklangiewicz", "kground-jvm", Ver("0.0.33", 0))
        val kgroundx = Dep("pl.mareklangiewicz", "kgroundx", Ver("0.0.33", 0))
        val kgroundx_io = Dep("pl.mareklangiewicz", "kgroundx-io", Ver("0.0.33", 0))
        val kgroundx_io_js = Dep("pl.mareklangiewicz", "kgroundx-io-js", Ver("0.0.33", 0))
        val kgroundx_io_jvm = Dep("pl.mareklangiewicz", "kgroundx-io-jvm", Ver("0.0.33", 0))
        val kgroundx_js = Dep("pl.mareklangiewicz", "kgroundx-js", Ver("0.0.33", 0))
        val kgroundx_jvm = Dep("pl.mareklangiewicz", "kgroundx-jvm", Ver("0.0.33", 0))
        val kgroundx_maintenance = Dep("pl.mareklangiewicz", "kgroundx-maintenance", Ver("0.0.33", 0))
        val kgroundx_maintenance_jvm = Dep("pl.mareklangiewicz", "kgroundx-maintenance-jvm", Ver("0.0.33", 0))
        val kommandjupyter = Dep("pl.mareklangiewicz", "kommandjupyter", Ver("0.0.39", 0))
        val kommandjupyter_jvm = Dep("pl.mareklangiewicz", "kommandjupyter-jvm", Ver("0.0.39", 0))
        val kommandline = Dep("pl.mareklangiewicz", "kommandline", Ver("0.0.39", 0))
        val kommandline_js = Dep("pl.mareklangiewicz", "kommandline-js", Ver("0.0.39", 0))
        val kommandline_jvm = Dep("pl.mareklangiewicz", "kommandline-jvm", Ver("0.0.39", 0))
        val kommandsamples = Dep("pl.mareklangiewicz", "kommandsamples", Ver("0.0.39", 0))
        val kommandsamples_js = Dep("pl.mareklangiewicz", "kommandsamples-js", Ver("0.0.39", 0))
        val kommandsamples_jvm = Dep("pl.mareklangiewicz", "kommandsamples-jvm", Ver("0.0.39", 0))
