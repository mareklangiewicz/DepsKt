...
object Com {
  object Android {
    ...
    object Tools {
      ...
      object Build {
        val gradle = "com.android.tools.build" d "gradle" w "2.3.0" w "8.9.0" w "8.10.0-beta01" w "8.11.0-alpha02"
      }
    }
  }
...
object Io {
  ...
  object Insert_koin {
    val koin_android = "io.insert-koin" d "koin-android" w "4.0.2" w "4.0.3-RC1" w "4.1.0-Beta5"
    val koin_android_compat = "io.insert-koin" d "koin-android-compat" w "4.0.2" w "4.0.3-RC1" w "4.1.0-Beta5"
    val koin_androidx_compose = "io.insert-koin" d "koin-androidx-compose" w "4.0.2" w "4.0.3-RC1" w "4.1.0-Beta5"
    val koin_androidx_navigation = "io.insert-koin" d "koin-androidx-navigation" w "4.0.2" w "4.0.3-RC1" w "4.1.0-Beta5"
    val koin_androidx_workmanager = "io.insert-koin" d "koin-androidx-workmanager" w "4.0.2" w "4.0.3-RC1" w "4.1.0-Beta5"
    val koin_core = "io.insert-koin" d "koin-core" w "4.0.2" w "4.0.3-RC1" w "4.1.0-Beta5"
    val koin_ktor = "io.insert-koin" d "koin-ktor" w "4.0.2" w "4.0.3-RC1" w "4.1.0-Beta5"
    val koin_logger_slf4j = "io.insert-koin" d "koin-logger-slf4j" w "4.0.2" w "4.0.3-RC1" w "4.1.0-Beta5"
    val koin_test = "io.insert-koin" d "koin-test" w "4.0.2" w "4.0.3-RC1" w "4.1.0-Beta5"
    val koin_test_junit4 = "io.insert-koin" d "koin-test-junit4" w "4.0.2" w "4.0.3-RC1" w "4.1.0-Beta5"
    val koin_test_junit5 = "io.insert-koin" d "koin-test-junit5" w "4.0.2" w "4.0.3-RC1" w "4.1.0-Beta5"
  }
  object Kotest {
...
object Org {
  ...
  object JUnit {
    val bom = "org.junit" d "junit-bom" w "5.12.1" w "5.13.0-M1"
    object Jupiter {
      val junit_jupiter = "org.junit.jupiter" d "junit-jupiter" w "5.12.1" w "5.13.0-M1"
      val junit_jupiter_api = "org.junit.jupiter" d "junit-jupiter-api" w "5.12.1" w "5.13.0-M1"
      val junit_jupiter_engine = "org.junit.jupiter" d "junit-jupiter-engine" w "5.12.1" w "5.13.0-M1"
      val junit_jupiter_migrationsupport = "org.junit.jupiter" d "junit-jupiter-migrationsupport" w "5.12.1" w "5.13.0-M1"
      val junit_jupiter_params = "org.junit.jupiter" d "junit-jupiter-params" w "5.12.1" w "5.13.0-M1"
    }
  }
  object JetBrains {
    object AndroidX {
    ...
    object Kotlin_Wrappers {
      val bom = "org.jetbrains.kotlin-wrappers" d "kotlin-wrappers-bom" w "2025.3.18"
      val kotlin_actions_toolkit = "org.jetbrains.kotlin-wrappers" d "kotlin-actions-toolkit" w "2025.3.18"
      val kotlin_browser = "org.jetbrains.kotlin-wrappers" d "kotlin-browser" w "2025.3.18"
      val kotlin_cesium = "org.jetbrains.kotlin-wrappers" d "kotlin-cesium" w "1.115.0-pre.711"
      val kotlin_css = "org.jetbrains.kotlin-wrappers" d "kotlin-css" w "2025.3.18"
      val kotlin_csstype = "org.jetbrains.kotlin-wrappers" d "kotlin-csstype" w "2025.3.18-3.1.3"
      val kotlin_emotion = "org.jetbrains.kotlin-wrappers" d "kotlin-emotion" w "2025.3.18"
      val kotlin_history = "org.jetbrains.kotlin-wrappers" d "kotlin-history" w "5.3.0-pre.506-compat"
      val kotlin_js = "org.jetbrains.kotlin-wrappers" d "kotlin-js" w "2025.3.18"
      ...
      val kotlin_node = "org.jetbrains.kotlin-wrappers" d "kotlin-node" w "2025.3.18-22.13.10"
      val kotlin_popper = "org.jetbrains.kotlin-wrappers" d "kotlin-popper" w "2.11.8-pre.792"
      val kotlin_react = "org.jetbrains.kotlin-wrappers" d "kotlin-react" w "2025.3.18-19.0.0"
      val kotlin_react_beautiful_dnd = "org.jetbrains.kotlin-wrappers" d "kotlin-react-beautiful-dnd" w "2025.3.18-13.1.1"
      val kotlin_react_core = "org.jetbrains.kotlin-wrappers" d "kotlin-react-core" w "2025.3.18-19.0.0"
      val kotlin_react_dom = "org.jetbrains.kotlin-wrappers" d "kotlin-react-dom" w "2025.3.18-19.0.0"
      val kotlin_react_dom_legacy = "org.jetbrains.kotlin-wrappers" d "kotlin-react-dom-legacy" w "2025.3.18-19.0.0"
      val kotlin_react_dom_test_utils = "org.jetbrains.kotlin-wrappers" d "kotlin-react-dom-test-utils" w "2025.3.18-19.0.0"
      val kotlin_react_legacy = "org.jetbrains.kotlin-wrappers" d "kotlin-react-legacy" w "2025.3.18-19.0.0"
      val kotlin_react_popper = "org.jetbrains.kotlin-wrappers" d "kotlin-react-popper" w "2025.3.18-2.3.0"
      val kotlin_react_redux = "org.jetbrains.kotlin-wrappers" d "kotlin-react-redux" w "7.2.6-pre.785"
      val kotlin_react_router = "org.jetbrains.kotlin-wrappers" d "kotlin-react-router" w "2025.3.18-6.28.2"
      val kotlin_react_router_dom = "org.jetbrains.kotlin-wrappers" d "kotlin-react-router-dom" w "2025.1.6-6.28.0"
      val kotlin_react_select = "org.jetbrains.kotlin-wrappers" d "kotlin-react-select" w "2025.3.18-5.10.1"
      val kotlin_react_use = "org.jetbrains.kotlin-wrappers" d "kotlin-react-use" w "2025.3.18"
      ...
      val kotlin_styled_next = "org.jetbrains.kotlin-wrappers" d "kotlin-styled-next" w "2025.3.18"
      val kotlin_tanstack_query_core = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-query-core" w "2025.3.18-5.69.0"
      val kotlin_tanstack_react_query = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-react-query" w "2025.3.18-5.69.0"
      val kotlin_tanstack_react_query_devtools = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-react-query-devtools" w "2025.3.18-5.69.0"
      val kotlin_tanstack_react_table = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-react-table" w "2025.3.18-8.21.2"
      val kotlin_tanstack_react_virtual = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-react-virtual" w "2025.3.18-3.13.4"
      val kotlin_tanstack_table_core = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-table-core" w "2025.3.18-8.21.2"
      val kotlin_tanstack_virtual_core = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-virtual-core" w "2025.3.18-3.13.4"
      val kotlin_typescript = "org.jetbrains.kotlin-wrappers" d "kotlin-typescript" w "2025.3.18-5.7.2"
      val kotlin_web = "org.jetbrains.kotlin-wrappers" d "kotlin-web" w "2025.3.18"
    }
  }
  object Kodein {
    object Di {
