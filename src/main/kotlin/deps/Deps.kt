...
object Com {
  object Android {
    ...
    object Tools {
      ...
      object Build {
        val gradle = "com.android.tools.build" d "gradle" w "2.3.0" w "8.8.2" w "8.9.0-rc02" w "8.10.0-alpha07"
      }
    }
  }
  ...
  object Google {
    ...
    object Maps {
      object Android {
        ...
        val maps_utils = "com.google.maps.android" d "android-maps-utils" w "3.11.0"
...
object Org {
  ...
  object Http4k {
    ...
    val bom = "org.http4k" d "http4k-bom" w "6.0.1.0"
    val client_apache = "org.http4k" d "http4k-client-apache" w "6.0.1.0"
    val client_apache4 = "org.http4k" d "http4k-client-apache4" w "6.0.1.0"
    val client_apache4_async = "org.http4k" d "http4k-client-apache4-async" w "6.0.1.0"
    val client_apache_async = "org.http4k" d "http4k-client-apache-async" w "6.0.1.0"
    val client_jetty = "org.http4k" d "http4k-client-jetty" w "6.0.1.0"
    val client_okhttp = "org.http4k" d "http4k-client-okhttp" w "6.0.1.0"
    val client_websocket = "org.http4k" d "http4k-client-websocket" w "6.0.1.0"
    val cloudnative = "org.http4k" d "http4k-cloudnative" w "5.47.0.0"
    val contract = "org.http4k" d "http4k-contract" w "5.47.0.0"
    val core = "org.http4k" d "http4k-core" w "6.0.1.0"
    val format_argo = "org.http4k" d "http4k-format-argo" w "6.0.1.0"
    val format_core = "org.http4k" d "http4k-format-core" w "6.0.1.0"
    val format_gson = "org.http4k" d "http4k-format-gson" w "6.0.1.0"
    val format_jackson = "org.http4k" d "http4k-format-jackson" w "6.0.1.0"
    val format_jackson_xml = "org.http4k" d "http4k-format-jackson-xml" w "6.0.1.0"
    val format_jackson_yaml = "org.http4k" d "http4k-format-jackson-yaml" w "6.0.1.0"
    val format_klaxon = "org.http4k" d "http4k-format-klaxon" w "6.0.1.0"
    val format_kotlinx_serialization = "org.http4k" d "http4k-format-kotlinx-serialization" w "6.0.1.0"
    val format_moshi = "org.http4k" d "http4k-format-moshi" w "6.0.1.0"
    val format_xml = "org.http4k" d "http4k-format-xml" w "6.0.1.0"
    val graphql = "org.http4k" d "http4k-graphql" w "5.47.0.0"
    val incubator = "org.http4k" d "http4k-incubator" w "6.0.1.0"
    ...
    val multipart = "org.http4k" d "http4k-multipart" w "6.0.1.0"
    val opentelemetry = "org.http4k" d "http4k-opentelemetry" w "5.47.0.0"
    val realtime_core = "org.http4k" d "http4k-realtime-core" w "6.0.1.0"
    val resilience4j = "org.http4k" d "http4k-resilience4j" w "5.47.0.0"
    val security_oauth = "org.http4k" d "http4k-security-oauth" w "6.0.1.0"
    val server_apache = "org.http4k" d "http4k-server-apache" w "6.0.1.0"
    val server_apache4 = "org.http4k" d "http4k-server-apache4" w "6.0.1.0"
    val server_jetty = "org.http4k" d "http4k-server-jetty" w "6.0.1.0"
    val server_ktorcio = "org.http4k" d "http4k-server-ktorcio" w "6.0.1.0"
    val server_ktornetty = "org.http4k" d "http4k-server-ktornetty" w "6.0.1.0"
    val server_netty = "org.http4k" d "http4k-server-netty" w "6.0.1.0"
    val server_ratpack = "org.http4k" d "http4k-server-ratpack" w "6.0.1.0"
    val server_undertow = "org.http4k" d "http4k-server-undertow" w "6.0.1.0"
    val serverless_alibaba = "org.http4k" d "http4k-serverless-alibaba" w "6.0.1.0"
    val serverless_azure = "org.http4k" d "http4k-serverless-azure" w "6.0.1.0"
    val serverless_gcf = "org.http4k" d "http4k-serverless-gcf" w "6.0.1.0"
    val serverless_lambda = "org.http4k" d "http4k-serverless-lambda" w "6.0.1.0"
    val serverless_lambda_runtime = "org.http4k" d "http4k-serverless-lambda-runtime" w "6.0.1.0"
    val serverless_openwhisk = "org.http4k" d "http4k-serverless-openwhisk" w "6.0.1.0"
    val serverless_tencent = "org.http4k" d "http4k-serverless-tencent" w "6.0.1.0"
    val template_core = "org.http4k" d "http4k-template-core" w "6.0.1.0"
    val template_dust = "org.http4k" d "http4k-template-dust" w "4.48.2.0"
    val template_freemarker = "org.http4k" d "http4k-template-freemarker" w "6.0.1.0"
    val template_handlebars = "org.http4k" d "http4k-template-handlebars" w "6.0.1.0"
    val template_jade4j = "org.http4k" d "http4k-template-jade4j" w "5.12.2.1"
    val template_pebble = "org.http4k" d "http4k-template-pebble" w "6.0.1.0"
    val template_thymeleaf = "org.http4k" d "http4k-template-thymeleaf" w "6.0.1.0"
    val testing_approval = "org.http4k" d "http4k-testing-approval" w "6.0.1.0"
    val testing_chaos = "org.http4k" d "http4k-testing-chaos" w "6.0.1.0"
    val testing_hamkrest = "org.http4k" d "http4k-testing-hamkrest" w "6.0.1.0"
    val testing_kotest = "org.http4k" d "http4k-testing-kotest" w "6.0.1.0"
    val testing_servirtium = "org.http4k" d "http4k-testing-servirtium" w "6.0.1.0"
    val testing_strikt = "org.http4k" d "http4k-testing-strikt" w "6.0.1.0"
    val testing_webdriver = "org.http4k" d "http4k-testing-webdriver" w "6.0.1.0"
  }
  object JUnit {
  ...
  object JetBrains {
    object AndroidX {
      object Lifecycle {
        val common = "org.jetbrains.androidx.lifecycle" d "lifecycle-common" w "2.8.4" w "2.9.0-alpha03"
        val common_js = "org.jetbrains.androidx.lifecycle" d "lifecycle-common-js" w "2.8.4" w "2.9.0-alpha03"
        val common_wasm_js = "org.jetbrains.androidx.lifecycle" d "lifecycle-common-wasm-js" w "2.8.4" w "2.9.0-alpha03"
        val runtime = "org.jetbrains.androidx.lifecycle" d "lifecycle-runtime" w "2.8.4" w "2.9.0-alpha03"
        val runtime_compose = "org.jetbrains.androidx.lifecycle" d "lifecycle-runtime-compose" w "2.8.4" w "2.9.0-alpha03"
        val runtime_compose_js = "org.jetbrains.androidx.lifecycle" d "lifecycle-runtime-compose-js" w "2.8.4" w "2.9.0-alpha03"
        val runtime_compose_wasm_js = "org.jetbrains.androidx.lifecycle" d "lifecycle-runtime-compose-wasm-js" w "2.8.4" w "2.9.0-alpha03"
        val runtime_js = "org.jetbrains.androidx.lifecycle" d "lifecycle-runtime-js" w "2.8.4" w "2.9.0-alpha03"
        val runtime_wasm_js = "org.jetbrains.androidx.lifecycle" d "lifecycle-runtime-wasm-js" w "2.8.4" w "2.9.0-alpha03"
        val viewmodel = "org.jetbrains.androidx.lifecycle" d "lifecycle-viewmodel" w "2.8.4" w "2.9.0-alpha03"
        val viewmodel_compose = "org.jetbrains.androidx.lifecycle" d "lifecycle-viewmodel-compose" w "2.8.4" w "2.9.0-alpha03"
        val viewmodel_compose_js = "org.jetbrains.androidx.lifecycle" d "lifecycle-viewmodel-compose-js" w "2.8.4" w "2.9.0-alpha03"
        val viewmodel_compose_wasm_js = "org.jetbrains.androidx.lifecycle" d "lifecycle-viewmodel-compose-wasm-js" w "2.8.4" w "2.9.0-alpha03"
        val viewmodel_js = "org.jetbrains.androidx.lifecycle" d "lifecycle-viewmodel-js" w "2.8.4" w "2.9.0-alpha03"
        val viewmodel_savedstate = "org.jetbrains.androidx.lifecycle" d "lifecycle-viewmodel-savedstate" w "2.8.4" w "2.9.0-alpha03"
        val viewmodel_savedstate_js = "org.jetbrains.androidx.lifecycle" d "lifecycle-viewmodel-savedstate-js" w "2.8.4" w "2.9.0-alpha03"
        val viewmodel_savedstate_wasm_js = "org.jetbrains.androidx.lifecycle" d "lifecycle-viewmodel-savedstate-wasm-js" w "2.8.4" w "2.9.0-alpha03"
        val viewmodel_wasm_js = "org.jetbrains.androidx.lifecycle" d "lifecycle-viewmodel-wasm-js" w "2.8.4" w "2.9.0-alpha03"
      }
    }
    object Compose {
      val full = "org.jetbrains.compose" d "compose-full" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
      val gradle_plugin = "org.jetbrains.compose" d "compose-gradle-plugin" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
      val preview_rpc = "org.jetbrains.compose" d "preview-rpc" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
      val preview_runtime_desktop = "org.jetbrains.compose" d "compose-preview-runtime-desktop" w "0.5.0-build228"
      object Animation {
        val animation = "org.jetbrains.compose.animation" d "animation" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val core = "org.jetbrains.compose.animation" d "animation-core" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val core_js = "org.jetbrains.compose.animation" d "animation-core-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val core_wasm_js = "org.jetbrains.compose.animation" d "animation-core-wasm-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val graphics = "org.jetbrains.compose.animation" d "animation-graphics" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val graphics_js = "org.jetbrains.compose.animation" d "animation-graphics-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val graphics_wasm_js = "org.jetbrains.compose.animation" d "animation-graphics-wasm-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val js = "org.jetbrains.compose.animation" d "animation-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val wasm_js = "org.jetbrains.compose.animation" d "animation-wasm-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
      }
      object Compiler {
      ...
      object Components {
        val animatedimage = "org.jetbrains.compose.components" d "components-animatedimage" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val resources = "org.jetbrains.compose.components" d "components-resources" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val resources_js = "org.jetbrains.compose.components" d "components-resources-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val resources_wasmjs = "org.jetbrains.compose.components" d "components-resources-wasmJs" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val splitpane = "org.jetbrains.compose.components" d "components-splitpane" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val ui_tooling_preview = "org.jetbrains.compose.components" d "components-ui-tooling-preview" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val ui_tooling_preview_js = "org.jetbrains.compose.components" d "components-ui-tooling-preview-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val ui_tooling_preview_wasmjs = "org.jetbrains.compose.components" d "components-ui-tooling-preview-wasmJs" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
      }
      object Desktop {
        val desktop = "org.jetbrains.compose.desktop" d "desktop" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val jvm = "org.jetbrains.compose.desktop" d "desktop-jvm" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
      }
      object Foundation {
        val foundation = "org.jetbrains.compose.foundation" d "foundation" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val js = "org.jetbrains.compose.foundation" d "foundation-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val layout = "org.jetbrains.compose.foundation" d "foundation-layout" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val layout_js = "org.jetbrains.compose.foundation" d "foundation-layout-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val layout_wasm_js = "org.jetbrains.compose.foundation" d "foundation-layout-wasm-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val wasm_js = "org.jetbrains.compose.foundation" d "foundation-wasm-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
      }
      object Html {
        val benchmark_core = "org.jetbrains.compose.html" d "html-benchmark-core" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val benchmark_core_js = "org.jetbrains.compose.html" d "html-benchmark-core-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val core = "org.jetbrains.compose.html" d "html-core" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val core_js = "org.jetbrains.compose.html" d "html-core-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val core_jvm = "org.jetbrains.compose.html" d "html-core-jvm" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val svg = "org.jetbrains.compose.html" d "html-svg" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val svg_js = "org.jetbrains.compose.html" d "html-svg-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val test_utils = "org.jetbrains.compose.html" d "html-test-utils" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val test_utils_js = "org.jetbrains.compose.html" d "html-test-utils-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
      }
      object Material {
        ...
        val js = "org.jetbrains.compose.material" d "material-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val material = "org.jetbrains.compose.material" d "material" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val navigation = "org.jetbrains.compose.material" d "material-navigation" w "1.7.0-beta02" w "1.7.0-beta02+build1807-release-1.7.0-beta02" w "1.8.0-alpha03"
        val navigation_js = "org.jetbrains.compose.material" d "material-navigation-js" w "1.7.0-beta02" w "1.7.0-beta02+build1807-release-1.7.0-beta02" w "1.8.0-alpha03"
        val navigation_wasm_js = "org.jetbrains.compose.material" d "material-navigation-wasm-js" w "1.7.0-beta02" w "1.7.0-beta02+build1807-release-1.7.0-beta02" w "1.8.0-alpha03"
        val ripple = "org.jetbrains.compose.material" d "material-ripple" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val ripple_js = "org.jetbrains.compose.material" d "material-ripple-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val ripple_wasm_js = "org.jetbrains.compose.material" d "material-ripple-wasm-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val wasm_js = "org.jetbrains.compose.material" d "material-wasm-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
      }
      object Material3 {
        val js = "org.jetbrains.compose.material3" d "material3-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val material3 = "org.jetbrains.compose.material3" d "material3" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val wasm_js = "org.jetbrains.compose.material3" d "material3-wasm-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val window_size_class = "org.jetbrains.compose.material3" d "material3-window-size-class" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val window_size_class_js = "org.jetbrains.compose.material3" d "material3-window-size-class-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val window_size_class_wasm_js = "org.jetbrains.compose.material3" d "material3-window-size-class-wasm-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
      }
      object Runtime {
        val js = "org.jetbrains.compose.runtime" d "runtime-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val runtime = "org.jetbrains.compose.runtime" d "runtime" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val saveable = "org.jetbrains.compose.runtime" d "runtime-saveable" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val saveable_js = "org.jetbrains.compose.runtime" d "runtime-saveable-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val saveable_wasm_js = "org.jetbrains.compose.runtime" d "runtime-saveable-wasm-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val wasm_js = "org.jetbrains.compose.runtime" d "runtime-wasm-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
      }
      object Ui {
        val geometry = "org.jetbrains.compose.ui" d "ui-geometry" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val geometry_js = "org.jetbrains.compose.ui" d "ui-geometry-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val geometry_wasm_js = "org.jetbrains.compose.ui" d "ui-geometry-wasm-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val graphics = "org.jetbrains.compose.ui" d "ui-graphics" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val graphics_js = "org.jetbrains.compose.ui" d "ui-graphics-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val graphics_wasm_js = "org.jetbrains.compose.ui" d "ui-graphics-wasm-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val js = "org.jetbrains.compose.ui" d "ui-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val test = "org.jetbrains.compose.ui" d "ui-test" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val test_js = "org.jetbrains.compose.ui" d "ui-test-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val test_junit4 = "org.jetbrains.compose.ui" d "ui-test-junit4" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val test_wasm_js = "org.jetbrains.compose.ui" d "ui-test-wasm-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val text = "org.jetbrains.compose.ui" d "ui-text" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val text_js = "org.jetbrains.compose.ui" d "ui-text-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val text_wasm_js = "org.jetbrains.compose.ui" d "ui-text-wasm-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val tooling = "org.jetbrains.compose.ui" d "ui-tooling" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val tooling_preview = "org.jetbrains.compose.ui" d "ui-tooling-preview" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val ui = "org.jetbrains.compose.ui" d "ui" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val unit = "org.jetbrains.compose.ui" d "ui-unit" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val unit_js = "org.jetbrains.compose.ui" d "ui-unit-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val unit_wasm_js = "org.jetbrains.compose.ui" d "ui-unit-wasm-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
        val wasm_js = "org.jetbrains.compose.ui" d "ui-wasm-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha03"
      }
    }
    object Exposed {
      val core = "org.jetbrains.exposed" d "exposed-core" w "0.59.0"
      val dao = "org.jetbrains.exposed" d "exposed-dao" w "0.59.0"
      val jdbc = "org.jetbrains.exposed" d "exposed-jdbc" w "0.59.0"
    }
    object Kotlin {
    ...
    object KotlinX {
      ...
      val dataframe = "org.jetbrains.kotlinx" d "dataframe" w "0.15.0" w "0.16.0-dev-5963"
      val dataframe_arrow = "org.jetbrains.kotlinx" d "dataframe-arrow" w "0.15.0" w "0.16.0-dev-5963"
      val dataframe_core = "org.jetbrains.kotlinx" d "dataframe-core" w "0.15.0" w "0.16.0-dev-5963"
      val dataframe_excel = "org.jetbrains.kotlinx" d "dataframe-excel" w "0.15.0" w "0.16.0-dev-5963"
    ...
    object Kotlin_Wrappers {
      val bom = "org.jetbrains.kotlin-wrappers" d "kotlin-wrappers-bom" w "2025.2.11"
      val kotlin_actions_toolkit = "org.jetbrains.kotlin-wrappers" d "kotlin-actions-toolkit" w "2025.2.11"
      val kotlin_browser = "org.jetbrains.kotlin-wrappers" d "kotlin-browser" w "2025.2.11"
      val kotlin_cesium = "org.jetbrains.kotlin-wrappers" d "kotlin-cesium" w "1.115.0-pre.711"
      val kotlin_css = "org.jetbrains.kotlin-wrappers" d "kotlin-css" w "2025.2.11"
      val kotlin_csstype = "org.jetbrains.kotlin-wrappers" d "kotlin-csstype" w "2025.2.11-3.1.3"
      val kotlin_emotion = "org.jetbrains.kotlin-wrappers" d "kotlin-emotion" w "2025.2.11"
      val kotlin_history = "org.jetbrains.kotlin-wrappers" d "kotlin-history" w "5.3.0-pre.506-compat"
      val kotlin_js = "org.jetbrains.kotlin-wrappers" d "kotlin-js" w "2025.2.11"
      ...
      val kotlin_node = "org.jetbrains.kotlin-wrappers" d "kotlin-node" w "2025.2.11-22.13.1"
      val kotlin_popper = "org.jetbrains.kotlin-wrappers" d "kotlin-popper" w "2.11.8-pre.792"
      val kotlin_react = "org.jetbrains.kotlin-wrappers" d "kotlin-react" w "2025.2.11-19.0.0"
      val kotlin_react_beautiful_dnd = "org.jetbrains.kotlin-wrappers" d "kotlin-react-beautiful-dnd" w "2025.2.11-13.1.1"
      val kotlin_react_core = "org.jetbrains.kotlin-wrappers" d "kotlin-react-core" w "2025.2.11-19.0.0"
      val kotlin_react_dom = "org.jetbrains.kotlin-wrappers" d "kotlin-react-dom" w "2025.2.11-19.0.0"
      val kotlin_react_dom_legacy = "org.jetbrains.kotlin-wrappers" d "kotlin-react-dom-legacy" w "2025.2.11-19.0.0"
      val kotlin_react_dom_test_utils = "org.jetbrains.kotlin-wrappers" d "kotlin-react-dom-test-utils" w "2025.2.11-19.0.0"
      val kotlin_react_legacy = "org.jetbrains.kotlin-wrappers" d "kotlin-react-legacy" w "2025.2.11-19.0.0"
      val kotlin_react_popper = "org.jetbrains.kotlin-wrappers" d "kotlin-react-popper" w "2025.2.11-2.3.0"
      val kotlin_react_redux = "org.jetbrains.kotlin-wrappers" d "kotlin-react-redux" w "7.2.6-pre.785"
      val kotlin_react_router = "org.jetbrains.kotlin-wrappers" d "kotlin-react-router" w "2025.2.11-6.28.2"
      val kotlin_react_router_dom = "org.jetbrains.kotlin-wrappers" d "kotlin-react-router-dom" w "2025.1.6-6.28.0"
      val kotlin_react_select = "org.jetbrains.kotlin-wrappers" d "kotlin-react-select" w "2025.2.11-5.10.0"
      val kotlin_react_use = "org.jetbrains.kotlin-wrappers" d "kotlin-react-use" w "2025.2.11"
      ...
      val kotlin_styled_next = "org.jetbrains.kotlin-wrappers" d "kotlin-styled-next" w "2025.2.11"
      val kotlin_tanstack_query_core = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-query-core" w "2025.2.11-5.66.4"
      val kotlin_tanstack_react_query = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-react-query" w "2025.2.11-5.66.9"
      val kotlin_tanstack_react_query_devtools = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-react-query-devtools" w "2025.2.11-5.66.9"
      val kotlin_tanstack_react_table = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-react-table" w "2025.2.11-8.21.2"
      val kotlin_tanstack_react_virtual = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-react-virtual" w "2025.2.11-3.13.2"
      val kotlin_tanstack_table_core = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-table-core" w "2025.2.11-8.21.2"
      val kotlin_tanstack_virtual_core = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-virtual-core" w "2025.2.11-3.13.2"
      val kotlin_typescript = "org.jetbrains.kotlin-wrappers" d "kotlin-typescript" w "2025.2.11-5.7.2"
      val kotlin_web = "org.jetbrains.kotlin-wrappers" d "kotlin-web" w "2025.2.11"
    }
  }
  object Kodein {
    object Di {
  ...
  object Mockito {
    val android = "org.mockito" d "mockito-android" w "5.15.2"
    val core = "org.mockito" d "mockito-core" w "5.15.2"
    val errorprone = "org.mockito" d "mockito-errorprone" w "5.15.2"
    val inline = "org.mockito" d "mockito-inline" w "5.2.0"
    val junit_jupiter = "org.mockito" d "mockito-junit-jupiter" w "5.15.2"
    object Kotlin {
