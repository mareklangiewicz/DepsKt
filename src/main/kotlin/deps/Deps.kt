...
object Io {
  ...
  object Ktor {
    val client_android = "io.ktor" d "ktor-client-android" w "3.0.3"
    val client_apache = "io.ktor" d "ktor-client-apache" w "3.0.3"
    val client_auth = "io.ktor" d "ktor-client-auth" w "3.0.3"
    val client_cio = "io.ktor" d "ktor-client-cio" w "3.0.3"
    val client_content_negotiation = "io.ktor" d "ktor-client-content-negotiation" w "3.0.3"
    val client_content_negotiation_tests = "io.ktor" d "ktor-client-content-negotiation-tests" w "3.0.3"
    val client_core = "io.ktor" d "ktor-client-core" w "3.0.3"
    val client_curl = "io.ktor" d "ktor-client-curl" w "3.0.3"
    val client_darwin = "io.ktor" d "ktor-client-darwin" w "3.0.3"
    val client_encoding = "io.ktor" d "ktor-client-encoding" w "3.0.3"
    val client_gson = "io.ktor" d "ktor-client-gson" w "3.0.3"
    val client_jackson = "io.ktor" d "ktor-client-jackson" w "3.0.3"
    val client_java = "io.ktor" d "ktor-client-java" w "3.0.3"
    val client_jetty = "io.ktor" d "ktor-client-jetty" w "3.0.3"
    val client_json = "io.ktor" d "ktor-client-json" w "3.0.3"
    val client_json_tests = "io.ktor" d "ktor-client-json-tests" w "2.3.13"
    val client_logging = "io.ktor" d "ktor-client-logging" w "3.0.3"
    val client_mock = "io.ktor" d "ktor-client-mock" w "3.0.3"
    val client_okhttp = "io.ktor" d "ktor-client-okhttp" w "3.0.3"
    val client_resources = "io.ktor" d "ktor-client-resources" w "3.0.3"
    val client_serialization = "io.ktor" d "ktor-client-serialization" w "3.0.3"
    val client_tests = "io.ktor" d "ktor-client-tests" w "3.0.3"
    val events = "io.ktor" d "ktor-events" w "3.0.3"
    val http = "io.ktor" d "ktor-http" w "3.0.3"
    val http_cio = "io.ktor" d "ktor-http-cio" w "3.0.3"
    val io = "io.ktor" d "ktor-io" w "3.0.3"
    val network = "io.ktor" d "ktor-network" w "3.0.3"
    val network_tls = "io.ktor" d "ktor-network-tls" w "3.0.3"
    val network_tls_certificates = "io.ktor" d "ktor-network-tls-certificates" w "3.0.3"
    val resources = "io.ktor" d "ktor-resources" w "3.0.3"
    val serialization = "io.ktor" d "ktor-serialization" w "3.0.3"
    val serialization_gson = "io.ktor" d "ktor-serialization-gson" w "3.0.3"
    val serialization_jackson = "io.ktor" d "ktor-serialization-jackson" w "3.0.3"
    val serialization_kotlinx = "io.ktor" d "ktor-serialization-kotlinx" w "3.0.3"
    val serialization_kotlinx_cbor = "io.ktor" d "ktor-serialization-kotlinx-cbor" w "3.0.3"
    val serialization_kotlinx_json = "io.ktor" d "ktor-serialization-kotlinx-json" w "3.0.3"
    val serialization_kotlinx_tests = "io.ktor" d "ktor-serialization-kotlinx-tests" w "3.0.3"
    val serialization_kotlinx_xml = "io.ktor" d "ktor-serialization-kotlinx-xml" w "3.0.3"
    val server = "io.ktor" d "ktor-server" w "3.0.3"
    val server_auth = "io.ktor" d "ktor-server-auth" w "3.0.3"
    val server_auth_jwt = "io.ktor" d "ktor-server-auth-jwt" w "3.0.3"
    val server_auth_ldap = "io.ktor" d "ktor-server-auth-ldap" w "3.0.3"
    val server_auto_head_response = "io.ktor" d "ktor-server-auto-head-response" w "3.0.3"
    val server_caching_headers = "io.ktor" d "ktor-server-caching-headers" w "3.0.3"
    val server_call_id = "io.ktor" d "ktor-server-call-id" w "3.0.3"
    val server_call_logging = "io.ktor" d "ktor-server-call-logging" w "3.0.3"
    val server_cio = "io.ktor" d "ktor-server-cio" w "3.0.3"
    val server_compression = "io.ktor" d "ktor-server-compression" w "3.0.3"
    val server_conditional_headers = "io.ktor" d "ktor-server-conditional-headers" w "3.0.3"
    val server_content_negotiation = "io.ktor" d "ktor-server-content-negotiation" w "3.0.3"
    val server_core = "io.ktor" d "ktor-server-core" w "3.0.3"
    val server_cors = "io.ktor" d "ktor-server-cors" w "3.0.3"
    val server_data_conversion = "io.ktor" d "ktor-server-data-conversion" w "3.0.3"
    val server_default_headers = "io.ktor" d "ktor-server-default-headers" w "3.0.3"
    val server_double_receive = "io.ktor" d "ktor-server-double-receive" w "3.0.3"
    val server_forwarded_header = "io.ktor" d "ktor-server-forwarded-header" w "3.0.3"
    val server_freemarker = "io.ktor" d "ktor-server-freemarker" w "3.0.3"
    val server_host_common = "io.ktor" d "ktor-server-host-common" w "3.0.3"
    val server_hsts = "io.ktor" d "ktor-server-hsts" w "3.0.3"
    val server_html_builder = "io.ktor" d "ktor-server-html-builder" w "3.0.3"
    val server_http_redirect = "io.ktor" d "ktor-server-http-redirect" w "3.0.3"
    val server_jetty = "io.ktor" d "ktor-server-jetty" w "3.0.3"
    val server_jte = "io.ktor" d "ktor-server-jte" w "3.0.3"
    val server_locations = "io.ktor" d "ktor-server-locations" w "2.3.13"
    val server_method_override = "io.ktor" d "ktor-server-method-override" w "3.0.3"
    val server_metrics = "io.ktor" d "ktor-server-metrics" w "3.0.3"
    val server_metrics_micrometer = "io.ktor" d "ktor-server-metrics-micrometer" w "3.0.3"
    val server_mustache = "io.ktor" d "ktor-server-mustache" w "3.0.3"
    val server_netty = "io.ktor" d "ktor-server-netty" w "3.0.3"
    val server_partial_content = "io.ktor" d "ktor-server-partial-content" w "3.0.3"
    val server_pebble = "io.ktor" d "ktor-server-pebble" w "3.0.3"
    val server_resources = "io.ktor" d "ktor-server-resources" w "3.0.3"
    val server_servlet = "io.ktor" d "ktor-server-servlet" w "3.0.3"
    val server_sessions = "io.ktor" d "ktor-server-sessions" w "3.0.3"
    val server_status_pages = "io.ktor" d "ktor-server-status-pages" w "3.0.3"
    val server_test_host = "io.ktor" d "ktor-server-test-host" w "3.0.3"
    val server_test_suites = "io.ktor" d "ktor-server-test-suites" w "2.3.13" w "3.0.0-beta-2"
    val server_thymeleaf = "io.ktor" d "ktor-server-thymeleaf" w "3.0.3"
    val server_tomcat = "io.ktor" d "ktor-server-tomcat" w "3.0.3"
    val server_velocity = "io.ktor" d "ktor-server-velocity" w "3.0.3"
    val server_webjars = "io.ktor" d "ktor-server-webjars" w "3.0.3"
    val server_websockets = "io.ktor" d "ktor-server-websockets" w "3.0.3"
    val test_dispatcher = "io.ktor" d "ktor-test-dispatcher" w "3.0.3"
    val utils = "io.ktor" d "ktor-utils" w "3.0.3"
    val websocket_serialization = "io.ktor" d "ktor-websocket-serialization" w "3.0.3"
    val websockets = "io.ktor" d "ktor-websockets" w "3.0.3"
  }
  object MockK {
...
object Org {
  ...
  object Http4k {
    val aws = "org.http4k" d "http4k-aws" w "5.46.0.0"
    val bom = "org.http4k" d "http4k-bom" w "5.46.0.0"
    val client_apache = "org.http4k" d "http4k-client-apache" w "5.46.0.0"
    val client_apache4 = "org.http4k" d "http4k-client-apache4" w "5.46.0.0"
    val client_apache4_async = "org.http4k" d "http4k-client-apache4-async" w "5.46.0.0"
    val client_apache_async = "org.http4k" d "http4k-client-apache-async" w "5.46.0.0"
    val client_jetty = "org.http4k" d "http4k-client-jetty" w "5.46.0.0"
    val client_okhttp = "org.http4k" d "http4k-client-okhttp" w "5.46.0.0"
    val client_websocket = "org.http4k" d "http4k-client-websocket" w "5.46.0.0"
    val cloudnative = "org.http4k" d "http4k-cloudnative" w "5.46.0.0"
    val contract = "org.http4k" d "http4k-contract" w "5.46.0.0"
    val core = "org.http4k" d "http4k-core" w "5.46.0.0"
    val format_argo = "org.http4k" d "http4k-format-argo" w "5.46.0.0"
    val format_core = "org.http4k" d "http4k-format-core" w "5.46.0.0"
    val format_gson = "org.http4k" d "http4k-format-gson" w "5.46.0.0"
    val format_jackson = "org.http4k" d "http4k-format-jackson" w "5.46.0.0"
    val format_jackson_xml = "org.http4k" d "http4k-format-jackson-xml" w "5.46.0.0"
    val format_jackson_yaml = "org.http4k" d "http4k-format-jackson-yaml" w "5.46.0.0"
    val format_klaxon = "org.http4k" d "http4k-format-klaxon" w "5.46.0.0"
    val format_kotlinx_serialization = "org.http4k" d "http4k-format-kotlinx-serialization" w "5.46.0.0"
    val format_moshi = "org.http4k" d "http4k-format-moshi" w "5.46.0.0"
    val format_xml = "org.http4k" d "http4k-format-xml" w "5.46.0.0"
    val graphql = "org.http4k" d "http4k-graphql" w "5.46.0.0"
    val incubator = "org.http4k" d "http4k-incubator" w "5.46.0.0"
    val jsonrpc = "org.http4k" d "http4k-jsonrpc" w "5.46.0.0"
    val metrics_micrometer = "org.http4k" d "http4k-metrics-micrometer" w "5.46.0.0"
    val multipart = "org.http4k" d "http4k-multipart" w "5.46.0.0"
    val opentelemetry = "org.http4k" d "http4k-opentelemetry" w "5.46.0.0"
    val realtime_core = "org.http4k" d "http4k-realtime-core" w "5.46.0.0"
    val resilience4j = "org.http4k" d "http4k-resilience4j" w "5.46.0.0"
    val security_oauth = "org.http4k" d "http4k-security-oauth" w "5.46.0.0"
    val server_apache = "org.http4k" d "http4k-server-apache" w "5.46.0.0"
    val server_apache4 = "org.http4k" d "http4k-server-apache4" w "5.46.0.0"
    val server_jetty = "org.http4k" d "http4k-server-jetty" w "5.46.0.0"
    val server_ktorcio = "org.http4k" d "http4k-server-ktorcio" w "5.46.0.0"
    val server_ktornetty = "org.http4k" d "http4k-server-ktornetty" w "5.46.0.0"
    val server_netty = "org.http4k" d "http4k-server-netty" w "5.46.0.0"
    val server_ratpack = "org.http4k" d "http4k-server-ratpack" w "5.46.0.0"
    val server_undertow = "org.http4k" d "http4k-server-undertow" w "5.46.0.0"
    val serverless_alibaba = "org.http4k" d "http4k-serverless-alibaba" w "5.46.0.0"
    val serverless_azure = "org.http4k" d "http4k-serverless-azure" w "5.46.0.0"
    val serverless_gcf = "org.http4k" d "http4k-serverless-gcf" w "5.46.0.0"
    val serverless_lambda = "org.http4k" d "http4k-serverless-lambda" w "5.46.0.0"
    val serverless_lambda_runtime = "org.http4k" d "http4k-serverless-lambda-runtime" w "5.46.0.0"
    val serverless_openwhisk = "org.http4k" d "http4k-serverless-openwhisk" w "5.46.0.0"
    val serverless_tencent = "org.http4k" d "http4k-serverless-tencent" w "5.46.0.0"
    val template_core = "org.http4k" d "http4k-template-core" w "5.46.0.0"
    val template_dust = "org.http4k" d "http4k-template-dust" w "4.48.0.0"
    val template_freemarker = "org.http4k" d "http4k-template-freemarker" w "5.46.0.0"
    val template_handlebars = "org.http4k" d "http4k-template-handlebars" w "5.46.0.0"
    val template_jade4j = "org.http4k" d "http4k-template-jade4j" w "5.12.2.1"
    val template_pebble = "org.http4k" d "http4k-template-pebble" w "5.46.0.0"
    val template_thymeleaf = "org.http4k" d "http4k-template-thymeleaf" w "5.46.0.0"
    val testing_approval = "org.http4k" d "http4k-testing-approval" w "5.46.0.0"
    val testing_chaos = "org.http4k" d "http4k-testing-chaos" w "5.46.0.0"
    val testing_hamkrest = "org.http4k" d "http4k-testing-hamkrest" w "5.46.0.0"
    val testing_kotest = "org.http4k" d "http4k-testing-kotest" w "5.46.0.0"
    val testing_servirtium = "org.http4k" d "http4k-testing-servirtium" w "5.46.0.0"
    val testing_strikt = "org.http4k" d "http4k-testing-strikt" w "5.46.0.0"
    val testing_webdriver = "org.http4k" d "http4k-testing-webdriver" w "5.46.0.0"
  }
  object JUnit {
    val bom = "org.junit" d "junit-bom" w "5.11.4" w "5.12.0-M1"
    object Jupiter {
      val junit_jupiter = "org.junit.jupiter" d "junit-jupiter" w "5.11.4" w "5.12.0-M1"
      val junit_jupiter_api = "org.junit.jupiter" d "junit-jupiter-api" w "5.11.4" w "5.12.0-M1"
      val junit_jupiter_engine = "org.junit.jupiter" d "junit-jupiter-engine" w "5.11.4" w "5.12.0-M1"
      val junit_jupiter_migrationsupport = "org.junit.jupiter" d "junit-jupiter-migrationsupport" w "5.11.4" w "5.12.0-M1"
      val junit_jupiter_params = "org.junit.jupiter" d "junit-jupiter-params" w "5.11.4" w "5.12.0-M1"
    }
  }
  object JetBrains {
    object AndroidX {
      object Lifecycle {
        val common = "org.jetbrains.androidx.lifecycle" d "lifecycle-common" w "2.8.4" w "2.9.0-alpha02"
        val common_js = "org.jetbrains.androidx.lifecycle" d "lifecycle-common-js" w "2.8.4" w "2.9.0-alpha02"
        val common_wasm_js = "org.jetbrains.androidx.lifecycle" d "lifecycle-common-wasm-js" w "2.8.4" w "2.9.0-alpha02"
        val runtime = "org.jetbrains.androidx.lifecycle" d "lifecycle-runtime" w "2.8.4" w "2.9.0-alpha02"
        val runtime_compose = "org.jetbrains.androidx.lifecycle" d "lifecycle-runtime-compose" w "2.8.4" w "2.9.0-alpha02"
        val runtime_compose_js = "org.jetbrains.androidx.lifecycle" d "lifecycle-runtime-compose-js" w "2.8.4" w "2.9.0-alpha02"
        val runtime_compose_wasm_js = "org.jetbrains.androidx.lifecycle" d "lifecycle-runtime-compose-wasm-js" w "2.8.4" w "2.9.0-alpha02"
        val runtime_js = "org.jetbrains.androidx.lifecycle" d "lifecycle-runtime-js" w "2.8.4" w "2.9.0-alpha02"
        val runtime_wasm_js = "org.jetbrains.androidx.lifecycle" d "lifecycle-runtime-wasm-js" w "2.8.4" w "2.9.0-alpha02"
        val viewmodel = "org.jetbrains.androidx.lifecycle" d "lifecycle-viewmodel" w "2.8.4" w "2.9.0-alpha02"
        val viewmodel_compose = "org.jetbrains.androidx.lifecycle" d "lifecycle-viewmodel-compose" w "2.8.4" w "2.9.0-alpha02"
        val viewmodel_compose_js = "org.jetbrains.androidx.lifecycle" d "lifecycle-viewmodel-compose-js" w "2.8.4" w "2.9.0-alpha02"
        val viewmodel_compose_wasm_js = "org.jetbrains.androidx.lifecycle" d "lifecycle-viewmodel-compose-wasm-js" w "2.8.4" w "2.9.0-alpha02"
        val viewmodel_js = "org.jetbrains.androidx.lifecycle" d "lifecycle-viewmodel-js" w "2.8.4" w "2.9.0-alpha02"
        val viewmodel_savedstate = "org.jetbrains.androidx.lifecycle" d "lifecycle-viewmodel-savedstate" w "2.8.4" w "2.9.0-alpha02"
        val viewmodel_savedstate_js = "org.jetbrains.androidx.lifecycle" d "lifecycle-viewmodel-savedstate-js" w "2.8.4" w "2.9.0-alpha02"
        val viewmodel_savedstate_wasm_js = "org.jetbrains.androidx.lifecycle" d "lifecycle-viewmodel-savedstate-wasm-js" w "2.8.4" w "2.9.0-alpha02"
        val viewmodel_wasm_js = "org.jetbrains.androidx.lifecycle" d "lifecycle-viewmodel-wasm-js" w "2.8.4" w "2.9.0-alpha02"
      }
    }
    object Compose {
      val full = "org.jetbrains.compose" d "compose-full" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
      val gradle_plugin = "org.jetbrains.compose" d "compose-gradle-plugin" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
      val preview_rpc = "org.jetbrains.compose" d "preview-rpc" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
      val preview_runtime_desktop = "org.jetbrains.compose" d "compose-preview-runtime-desktop" w "0.5.0-build228"
      object Animation {
        val animation = "org.jetbrains.compose.animation" d "animation" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val core = "org.jetbrains.compose.animation" d "animation-core" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val core_js = "org.jetbrains.compose.animation" d "animation-core-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val core_wasm_js = "org.jetbrains.compose.animation" d "animation-core-wasm-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val graphics = "org.jetbrains.compose.animation" d "animation-graphics" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val graphics_js = "org.jetbrains.compose.animation" d "animation-graphics-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val graphics_wasm_js = "org.jetbrains.compose.animation" d "animation-graphics-wasm-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val js = "org.jetbrains.compose.animation" d "animation-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val wasm_js = "org.jetbrains.compose.animation" d "animation-wasm-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
      }
      object Compiler {
      ...
      object Components {
        val animatedimage = "org.jetbrains.compose.components" d "components-animatedimage" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val resources = "org.jetbrains.compose.components" d "components-resources" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val resources_js = "org.jetbrains.compose.components" d "components-resources-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val resources_wasmjs = "org.jetbrains.compose.components" d "components-resources-wasmJs" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val splitpane = "org.jetbrains.compose.components" d "components-splitpane" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val ui_tooling_preview = "org.jetbrains.compose.components" d "components-ui-tooling-preview" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val ui_tooling_preview_js = "org.jetbrains.compose.components" d "components-ui-tooling-preview-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val ui_tooling_preview_wasmjs = "org.jetbrains.compose.components" d "components-ui-tooling-preview-wasmJs" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
      }
      object Desktop {
        val desktop = "org.jetbrains.compose.desktop" d "desktop" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val jvm = "org.jetbrains.compose.desktop" d "desktop-jvm" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
      }
      object Foundation {
        val foundation = "org.jetbrains.compose.foundation" d "foundation" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val js = "org.jetbrains.compose.foundation" d "foundation-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val layout = "org.jetbrains.compose.foundation" d "foundation-layout" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val layout_js = "org.jetbrains.compose.foundation" d "foundation-layout-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val layout_wasm_js = "org.jetbrains.compose.foundation" d "foundation-layout-wasm-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val wasm_js = "org.jetbrains.compose.foundation" d "foundation-wasm-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
      }
      object Html {
        val benchmark_core = "org.jetbrains.compose.html" d "html-benchmark-core" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val benchmark_core_js = "org.jetbrains.compose.html" d "html-benchmark-core-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val core = "org.jetbrains.compose.html" d "html-core" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val core_js = "org.jetbrains.compose.html" d "html-core-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val core_jvm = "org.jetbrains.compose.html" d "html-core-jvm" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val svg = "org.jetbrains.compose.html" d "html-svg" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val svg_js = "org.jetbrains.compose.html" d "html-svg-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val test_utils = "org.jetbrains.compose.html" d "html-test-utils" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val test_utils_js = "org.jetbrains.compose.html" d "html-test-utils-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
      }
      object Material {
        ...
        val js = "org.jetbrains.compose.material" d "material-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val material = "org.jetbrains.compose.material" d "material" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val navigation = "org.jetbrains.compose.material" d "material-navigation" w "1.7.0-beta02" w "1.7.0-beta02+build1807-release-1.7.0-beta02" w "1.8.0-alpha02"
        val navigation_js = "org.jetbrains.compose.material" d "material-navigation-js" w "1.7.0-beta02" w "1.7.0-beta02+build1807-release-1.7.0-beta02" w "1.8.0-alpha02"
        val navigation_wasm_js = "org.jetbrains.compose.material" d "material-navigation-wasm-js" w "1.7.0-beta02" w "1.7.0-beta02+build1807-release-1.7.0-beta02" w "1.8.0-alpha02"
        val ripple = "org.jetbrains.compose.material" d "material-ripple" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val ripple_js = "org.jetbrains.compose.material" d "material-ripple-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val ripple_wasm_js = "org.jetbrains.compose.material" d "material-ripple-wasm-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val wasm_js = "org.jetbrains.compose.material" d "material-wasm-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
      }
      object Material3 {
        val js = "org.jetbrains.compose.material3" d "material3-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val material3 = "org.jetbrains.compose.material3" d "material3" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val wasm_js = "org.jetbrains.compose.material3" d "material3-wasm-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val window_size_class = "org.jetbrains.compose.material3" d "material3-window-size-class" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val window_size_class_js = "org.jetbrains.compose.material3" d "material3-window-size-class-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val window_size_class_wasm_js = "org.jetbrains.compose.material3" d "material3-window-size-class-wasm-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
      }
      object Runtime {
        val js = "org.jetbrains.compose.runtime" d "runtime-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val runtime = "org.jetbrains.compose.runtime" d "runtime" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val saveable = "org.jetbrains.compose.runtime" d "runtime-saveable" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val saveable_js = "org.jetbrains.compose.runtime" d "runtime-saveable-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val saveable_wasm_js = "org.jetbrains.compose.runtime" d "runtime-saveable-wasm-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val wasm_js = "org.jetbrains.compose.runtime" d "runtime-wasm-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
      }
      object Ui {
        val geometry = "org.jetbrains.compose.ui" d "ui-geometry" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val geometry_js = "org.jetbrains.compose.ui" d "ui-geometry-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val geometry_wasm_js = "org.jetbrains.compose.ui" d "ui-geometry-wasm-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val graphics = "org.jetbrains.compose.ui" d "ui-graphics" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val graphics_js = "org.jetbrains.compose.ui" d "ui-graphics-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val graphics_wasm_js = "org.jetbrains.compose.ui" d "ui-graphics-wasm-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val js = "org.jetbrains.compose.ui" d "ui-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val test = "org.jetbrains.compose.ui" d "ui-test" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val test_js = "org.jetbrains.compose.ui" d "ui-test-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val test_junit4 = "org.jetbrains.compose.ui" d "ui-test-junit4" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val test_wasm_js = "org.jetbrains.compose.ui" d "ui-test-wasm-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val text = "org.jetbrains.compose.ui" d "ui-text" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val text_js = "org.jetbrains.compose.ui" d "ui-text-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val text_wasm_js = "org.jetbrains.compose.ui" d "ui-text-wasm-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val tooling = "org.jetbrains.compose.ui" d "ui-tooling" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val tooling_preview = "org.jetbrains.compose.ui" d "ui-tooling-preview" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val ui = "org.jetbrains.compose.ui" d "ui" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val unit = "org.jetbrains.compose.ui" d "ui-unit" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val unit_js = "org.jetbrains.compose.ui" d "ui-unit-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val unit_wasm_js = "org.jetbrains.compose.ui" d "ui-unit-wasm-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
        val wasm_js = "org.jetbrains.compose.ui" d "ui-wasm-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha02"
      }
    }
    object Exposed {
    ...
    object KotlinX {
      ...
      val dataframe = "org.jetbrains.kotlinx" d "dataframe" w "0.15.0" w "0.16.0-dev-5585"
      val dataframe_arrow = "org.jetbrains.kotlinx" d "dataframe-arrow" w "0.15.0" w "0.16.0-dev-5585"
      val dataframe_core = "org.jetbrains.kotlinx" d "dataframe-core" w "0.15.0" w "0.16.0-dev-5585"
      val dataframe_excel = "org.jetbrains.kotlinx" d "dataframe-excel" w "0.15.0" w "0.16.0-dev-5585"
    ...
    object Kotlin_Wrappers {
      val bom = "org.jetbrains.kotlin-wrappers" d "kotlin-wrappers-bom" w "2025.2.2"
      val kotlin_actions_toolkit = "org.jetbrains.kotlin-wrappers" d "kotlin-actions-toolkit" w "2025.2.2"
      val kotlin_browser = "org.jetbrains.kotlin-wrappers" d "kotlin-browser" w "2025.2.2"
      val kotlin_cesium = "org.jetbrains.kotlin-wrappers" d "kotlin-cesium" w "1.115.0-pre.711"
      val kotlin_css = "org.jetbrains.kotlin-wrappers" d "kotlin-css" w "2025.2.2"
      val kotlin_csstype = "org.jetbrains.kotlin-wrappers" d "kotlin-csstype" w "2025.2.2-3.1.3"
      val kotlin_emotion = "org.jetbrains.kotlin-wrappers" d "kotlin-emotion" w "2025.2.2"
      val kotlin_history = "org.jetbrains.kotlin-wrappers" d "kotlin-history" w "5.3.0-pre.506-compat"
      val kotlin_js = "org.jetbrains.kotlin-wrappers" d "kotlin-js" w "2025.2.2"
      ...
      val kotlin_node = "org.jetbrains.kotlin-wrappers" d "kotlin-node" w "2025.2.2-22.10.5"
      val kotlin_popper = "org.jetbrains.kotlin-wrappers" d "kotlin-popper" w "2.11.8-pre.792"
      val kotlin_react = "org.jetbrains.kotlin-wrappers" d "kotlin-react" w "2025.2.2-19.0.0"
      val kotlin_react_beautiful_dnd = "org.jetbrains.kotlin-wrappers" d "kotlin-react-beautiful-dnd" w "2025.2.2-13.1.1"
      val kotlin_react_core = "org.jetbrains.kotlin-wrappers" d "kotlin-react-core" w "2025.2.2-19.0.0"
      val kotlin_react_dom = "org.jetbrains.kotlin-wrappers" d "kotlin-react-dom" w "2025.2.2-19.0.0"
      val kotlin_react_dom_legacy = "org.jetbrains.kotlin-wrappers" d "kotlin-react-dom-legacy" w "2025.2.2-19.0.0"
      val kotlin_react_dom_test_utils = "org.jetbrains.kotlin-wrappers" d "kotlin-react-dom-test-utils" w "2025.2.2-19.0.0"
      val kotlin_react_legacy = "org.jetbrains.kotlin-wrappers" d "kotlin-react-legacy" w "2025.2.2-19.0.0"
      val kotlin_react_popper = "org.jetbrains.kotlin-wrappers" d "kotlin-react-popper" w "2025.2.2-2.3.0"
      val kotlin_react_redux = "org.jetbrains.kotlin-wrappers" d "kotlin-react-redux" w "7.2.6-pre.785"
      val kotlin_react_router = "org.jetbrains.kotlin-wrappers" d "kotlin-react-router" w "2025.2.2-6.28.2"
      val kotlin_react_router_dom = "org.jetbrains.kotlin-wrappers" d "kotlin-react-router-dom" w "2025.1.6-6.28.0"
      val kotlin_react_select = "org.jetbrains.kotlin-wrappers" d "kotlin-react-select" w "2025.2.2-5.10.0"
      val kotlin_react_use = "org.jetbrains.kotlin-wrappers" d "kotlin-react-use" w "2025.2.2"
      ...
      val kotlin_styled_next = "org.jetbrains.kotlin-wrappers" d "kotlin-styled-next" w "2025.2.2"
      val kotlin_tanstack_query_core = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-query-core" w "2025.2.2-5.66.0"
      val kotlin_tanstack_react_query = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-react-query" w "2025.2.2-5.66.0"
      val kotlin_tanstack_react_query_devtools = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-react-query-devtools" w "2025.2.2-5.66.0"
      val kotlin_tanstack_react_table = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-react-table" w "2025.2.2-8.20.6"
      val kotlin_tanstack_react_virtual = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-react-virtual" w "2025.2.2-3.12.0"
      val kotlin_tanstack_table_core = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-table-core" w "2025.2.2-8.20.5"
      val kotlin_tanstack_virtual_core = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-virtual-core" w "2025.2.2-3.12.0"
      val kotlin_typescript = "org.jetbrains.kotlin-wrappers" d "kotlin-typescript" w "2025.2.2-5.7.2"
      val kotlin_web = "org.jetbrains.kotlin-wrappers" d "kotlin-web" w "2025.2.2"
    }
  }
  object Kodein {
    object Di {
