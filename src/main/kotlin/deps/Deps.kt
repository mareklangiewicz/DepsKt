...
object Com {
    object Android {
        ...
        object Tools {
            ...
            val r8 = Dep("com.android.tools", "r8", Ver("8.2.47", 0))
            object Build {
    ...
    object GitHub {
        object Ajalt {
            object Mordant {
                val mordant = Dep("com.github.ajalt.mordant", "mordant", Ver("2.3.0", 0))
            }
        }
        object ChuckerTeam {
            object Chucker {
    ...
    object Google {
        ...
        object Android {
            ...
            object Horologist {
                val audio = Dep("com.google.android.horologist", "horologist-audio", Ver("0.6.3", 0))
                val audio_ui = Dep("com.google.android.horologist", "horologist-audio-ui", Ver("0.6.3", 0))
                val composables = Dep("com.google.android.horologist", "horologist-composables", Ver("0.6.3", 0))
                val compose_layout = Dep("com.google.android.horologist", "horologist-compose-layout", Ver("0.6.3", 0))
                val compose_tools = Dep("com.google.android.horologist", "horologist-compose-tools", Ver("0.6.3", 0))
                val datalayer = Dep("com.google.android.horologist", "horologist-datalayer", Ver("0.6.3", 0))
                val media = Dep("com.google.android.horologist", "horologist-media", Ver("0.6.3", 0))
                val media3_backend = Dep("com.google.android.horologist", "horologist-media3-backend", Ver("0.6.3", 0))
                val media_data = Dep("com.google.android.horologist", "horologist-media-data", Ver("0.6.3", 0))
                val media_ui = Dep("com.google.android.horologist", "horologist-media-ui", Ver("0.6.3", 0))
                val network_awareness = Dep("com.google.android.horologist", "horologist-network-awareness", Ver("0.6.3", 0))
                val tiles = Dep("com.google.android.horologist", "horologist-tiles", Ver("0.6.3", 0))
            }
            object Libraries {
                object Places {
    ...
    object Rickclephas {
        object Kmp {
            val nativecoroutines_annotations = Dep("com.rickclephas.kmp", "kmp-nativecoroutines-annotations", Ver("0.13.3", 0), Ver("1.0.0-ALPHA-25-kotlin-2.0.0-Beta4", 300))
            val nativecoroutines_compiler = Dep("com.rickclephas.kmp", "kmp-nativecoroutines-compiler", Ver("0.13.3", 0), Ver("1.0.0-ALPHA-25-kotlin-2.0.0-Beta4", 300))
            val nativecoroutines_compiler_embeddable = Dep("com.rickclephas.kmp", "kmp-nativecoroutines-compiler-embeddable", Ver("0.13.3", 0), Ver("1.0.0-ALPHA-25-kotlin-2.0.0-Beta4", 300))
            val nativecoroutines_core = Dep("com.rickclephas.kmp", "kmp-nativecoroutines-core", Ver("0.13.3", 0), Ver("1.0.0-ALPHA-25-kotlin-2.0.0-Beta4", 300))
            val nativecoroutines_gradle_plugin = Dep("com.rickclephas.kmp", "kmp-nativecoroutines-gradle-plugin", Ver("0.13.3", 0), Ver("1.0.0-ALPHA-25-kotlin-2.0.0-Beta4", 300))
        }
    }
    object Russhwolf {
    ...
    object SquareUp {
        ...
        object Okio {
            val okio = Dep("com.squareup.okio", "okio", Ver("3.8.0", 0))
        }
        object Picasso {
...
object Org {
    ...
    object Http4k {
        val aws = Dep("org.http4k", "http4k-aws", Ver("5.14.0.0", 0))
        val bom = Dep("org.http4k", "http4k-bom", Ver("5.14.0.0", 0))
        val client_apache = Dep("org.http4k", "http4k-client-apache", Ver("5.14.0.0", 0))
        val client_apache4 = Dep("org.http4k", "http4k-client-apache4", Ver("5.14.0.0", 0))
        val client_apache4_async = Dep("org.http4k", "http4k-client-apache4-async", Ver("5.14.0.0", 0))
        val client_apache_async = Dep("org.http4k", "http4k-client-apache-async", Ver("5.14.0.0", 0))
        val client_jetty = Dep("org.http4k", "http4k-client-jetty", Ver("5.14.0.0", 0))
        val client_okhttp = Dep("org.http4k", "http4k-client-okhttp", Ver("5.14.0.0", 0))
        val client_websocket = Dep("org.http4k", "http4k-client-websocket", Ver("5.14.0.0", 0))
        val cloudnative = Dep("org.http4k", "http4k-cloudnative", Ver("5.14.0.0", 0))
        val contract = Dep("org.http4k", "http4k-contract", Ver("5.14.0.0", 0))
        val core = Dep("org.http4k", "http4k-core", Ver("5.14.0.0", 0))
        val format_argo = Dep("org.http4k", "http4k-format-argo", Ver("5.14.0.0", 0))
        val format_core = Dep("org.http4k", "http4k-format-core", Ver("5.14.0.0", 0))
        val format_gson = Dep("org.http4k", "http4k-format-gson", Ver("5.14.0.0", 0))
        val format_jackson = Dep("org.http4k", "http4k-format-jackson", Ver("5.14.0.0", 0))
        val format_jackson_xml = Dep("org.http4k", "http4k-format-jackson-xml", Ver("5.14.0.0", 0))
        val format_jackson_yaml = Dep("org.http4k", "http4k-format-jackson-yaml", Ver("5.14.0.0", 0))
        val format_klaxon = Dep("org.http4k", "http4k-format-klaxon", Ver("5.14.0.0", 0))
        val format_kotlinx_serialization = Dep("org.http4k", "http4k-format-kotlinx-serialization", Ver("5.14.0.0", 0))
        val format_moshi = Dep("org.http4k", "http4k-format-moshi", Ver("5.14.0.0", 0))
        val format_xml = Dep("org.http4k", "http4k-format-xml", Ver("5.14.0.0", 0))
        val graphql = Dep("org.http4k", "http4k-graphql", Ver("5.14.0.0", 0))
        val incubator = Dep("org.http4k", "http4k-incubator", Ver("5.14.0.0", 0))
        val jsonrpc = Dep("org.http4k", "http4k-jsonrpc", Ver("5.14.0.0", 0))
        val metrics_micrometer = Dep("org.http4k", "http4k-metrics-micrometer", Ver("5.14.0.0", 0))
        val multipart = Dep("org.http4k", "http4k-multipart", Ver("5.14.0.0", 0))
        val opentelemetry = Dep("org.http4k", "http4k-opentelemetry", Ver("5.14.0.0", 0))
        val realtime_core = Dep("org.http4k", "http4k-realtime-core", Ver("5.14.0.0", 0))
        val resilience4j = Dep("org.http4k", "http4k-resilience4j", Ver("5.14.0.0", 0))
        val security_oauth = Dep("org.http4k", "http4k-security-oauth", Ver("5.14.0.0", 0))
        val server_apache = Dep("org.http4k", "http4k-server-apache", Ver("5.14.0.0", 0))
        val server_apache4 = Dep("org.http4k", "http4k-server-apache4", Ver("5.14.0.0", 0))
        val server_jetty = Dep("org.http4k", "http4k-server-jetty", Ver("5.14.0.0", 0))
        val server_ktorcio = Dep("org.http4k", "http4k-server-ktorcio", Ver("5.14.0.0", 0))
        val server_ktornetty = Dep("org.http4k", "http4k-server-ktornetty", Ver("5.14.0.0", 0))
        val server_netty = Dep("org.http4k", "http4k-server-netty", Ver("5.14.0.0", 0))
        val server_ratpack = Dep("org.http4k", "http4k-server-ratpack", Ver("5.14.0.0", 0))
        val server_undertow = Dep("org.http4k", "http4k-server-undertow", Ver("5.14.0.0", 0))
        val serverless_alibaba = Dep("org.http4k", "http4k-serverless-alibaba", Ver("5.14.0.0", 0))
        val serverless_azure = Dep("org.http4k", "http4k-serverless-azure", Ver("5.14.0.0", 0))
        val serverless_gcf = Dep("org.http4k", "http4k-serverless-gcf", Ver("5.14.0.0", 0))
        val serverless_lambda = Dep("org.http4k", "http4k-serverless-lambda", Ver("5.14.0.0", 0))
        val serverless_lambda_runtime = Dep("org.http4k", "http4k-serverless-lambda-runtime", Ver("5.14.0.0", 0))
        val serverless_openwhisk = Dep("org.http4k", "http4k-serverless-openwhisk", Ver("5.14.0.0", 0))
        val serverless_tencent = Dep("org.http4k", "http4k-serverless-tencent", Ver("5.14.0.0", 0))
        val template_core = Dep("org.http4k", "http4k-template-core", Ver("5.14.0.0", 0))
        val template_dust = Dep("org.http4k", "http4k-template-dust", Ver("4.48.0.0", 0))
        val template_freemarker = Dep("org.http4k", "http4k-template-freemarker", Ver("5.14.0.0", 0))
        val template_handlebars = Dep("org.http4k", "http4k-template-handlebars", Ver("5.14.0.0", 0))
        val template_jade4j = Dep("org.http4k", "http4k-template-jade4j", Ver("5.12.2.1", 0))
        val template_pebble = Dep("org.http4k", "http4k-template-pebble", Ver("5.14.0.0", 0))
        val template_thymeleaf = Dep("org.http4k", "http4k-template-thymeleaf", Ver("5.14.0.0", 0))
        val testing_approval = Dep("org.http4k", "http4k-testing-approval", Ver("5.14.0.0", 0))
        val testing_chaos = Dep("org.http4k", "http4k-testing-chaos", Ver("5.14.0.0", 0))
        val testing_hamkrest = Dep("org.http4k", "http4k-testing-hamkrest", Ver("5.14.0.0", 0))
        val testing_kotest = Dep("org.http4k", "http4k-testing-kotest", Ver("5.14.0.0", 0))
        val testing_servirtium = Dep("org.http4k", "http4k-testing-servirtium", Ver("5.14.0.0", 0))
        val testing_strikt = Dep("org.http4k", "http4k-testing-strikt", Ver("5.14.0.0", 0))
        val testing_webdriver = Dep("org.http4k", "http4k-testing-webdriver", Ver("5.14.0.0", 0))
    }
    object JUnit {
    ...
    object JetBrains {
        object Compose {
            val gradle_plugin = Dep("org.jetbrains.compose", "compose-gradle-plugin", Ver("1.6.0", 0), Ver("1.6.10-dev1498", 320))
            object Compiler {
                val compiler = Dep("org.jetbrains.compose.compiler", "compiler", Ver("1.5.10", 0))
            }
        }
        object Exposed {
        ...
        object KotlinX {
            ...
            val lincheck = Dep("org.jetbrains.kotlinx", "lincheck", Ver("2.26", 0))
            val lincheck_jvm = Dep("org.jetbrains.kotlinx", "lincheck-jvm", Ver("2.26", 0))
        ...
        object Kotlin_Wrappers {
            val bom = Dep("org.jetbrains.kotlin-wrappers", "kotlin-wrappers-bom", Ver("1.0.0-pre.713", 0))
            val kotlin_actions_toolkit = Dep("org.jetbrains.kotlin-wrappers", "kotlin-actions-toolkit", Ver("0.0.1-pre.713", 0))
            val kotlin_browser = Dep("org.jetbrains.kotlin-wrappers", "kotlin-browser", Ver("1.0.0-pre.712", 0), Ver("1.0.0-pre.713", 0))
            val kotlin_cesium = Dep("org.jetbrains.kotlin-wrappers", "kotlin-cesium", Ver("1.115.0-pre.711", 0))
            val kotlin_css = Dep("org.jetbrains.kotlin-wrappers", "kotlin-css", Ver("1.0.0-pre.712", 0), Ver("1.0.0-pre.713", 0))
            val kotlin_csstype = Dep("org.jetbrains.kotlin-wrappers", "kotlin-csstype", Ver("3.1.3-pre.713", 0))
            val kotlin_emotion = Dep("org.jetbrains.kotlin-wrappers", "kotlin-emotion", Ver("11.11.4-pre.712", 0), Ver("11.11.4-pre.713", 0))
            val kotlin_history = Dep("org.jetbrains.kotlin-wrappers", "kotlin-history", Ver("5.3.0-pre.506-compat", 0))
            val kotlin_js = Dep("org.jetbrains.kotlin-wrappers", "kotlin-js", Ver("1.0.0-pre.712", 0), Ver("1.0.0-pre.713", 0))
            ...
            val kotlin_node = Dep("org.jetbrains.kotlin-wrappers", "kotlin-node", Ver("20.11.5-pre.713", 0))
            val kotlin_popper = Dep("org.jetbrains.kotlin-wrappers", "kotlin-popper", Ver("2.11.8-pre.713", 0))
            val kotlin_react = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react", Ver("18.2.0-pre.713", 0))
            val kotlin_react_beautiful_dnd = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-beautiful-dnd", Ver("13.1.1-pre.713", 0))
            val kotlin_react_core = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-core", Ver("18.2.0-pre.713", 0))
            val kotlin_react_dom = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-dom", Ver("18.2.0-pre.712", 0), Ver("18.2.0-pre.713", 0))
            val kotlin_react_dom_legacy = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-dom-legacy", Ver("18.2.0-pre.713", 0))
            val kotlin_react_dom_test_utils = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-dom-test-utils", Ver("18.2.0-pre.713", 0))
            val kotlin_react_legacy = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-legacy", Ver("18.2.0-pre.713", 0))
            val kotlin_react_popper = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-popper", Ver("2.3.0-pre.713", 0))
            val kotlin_react_redux = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-redux", Ver("7.2.6-pre.713", 0))
            val kotlin_react_router = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-router", Ver("6.22.1-pre.713", 0))
            val kotlin_react_router_dom = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-router-dom", Ver("6.22.1-pre.712", 0), Ver("6.22.1-pre.713", 0))
            val kotlin_react_select = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-select", Ver("5.8.0-pre.713", 0))
            val kotlin_react_use = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-use", Ver("17.4.0-pre.713", 0))
            val kotlin_redux = Dep("org.jetbrains.kotlin-wrappers", "kotlin-redux", Ver("4.1.2-pre.713", 0))
            val kotlin_remix_run_router = Dep("org.jetbrains.kotlin-wrappers", "kotlin-remix-run-router", Ver("1.15.1-pre.713", 0))
            val kotlin_ring_ui = Dep("org.jetbrains.kotlin-wrappers", "kotlin-ring-ui", Ver("4.1.5-pre.713", 0))
            val kotlin_styled = Dep("org.jetbrains.kotlin-wrappers", "kotlin-styled", Ver("5.3.11-pre.713", 0))
            val kotlin_styled_next = Dep("org.jetbrains.kotlin-wrappers", "kotlin-styled-next", Ver("1.2.4-pre.713", 0))
            val kotlin_tanstack_query_core = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-query-core", Ver("5.24.2-pre.713", 0))
            val kotlin_tanstack_react_query = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-react-query", Ver("5.24.2-pre.713", 0))
            val kotlin_tanstack_react_query_devtools = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-react-query-devtools", Ver("5.24.2-pre.713", 0))
            val kotlin_tanstack_react_table = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-react-table", Ver("8.13.2-pre.713", 0))
            val kotlin_tanstack_react_virtual = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-react-virtual", Ver("3.1.3-pre.713", 0))
            val kotlin_tanstack_table_core = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-table-core", Ver("8.13.2-pre.713", 0))
            val kotlin_tanstack_virtual_core = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-virtual-core", Ver("3.1.3-pre.713", 0))
            val kotlin_typescript = Dep("org.jetbrains.kotlin-wrappers", "kotlin-typescript", Ver("5.4.2-pre.713", 0))
            val kotlin_web = Dep("org.jetbrains.kotlin-wrappers", "kotlin-web", Ver("1.0.0-pre.713", 0))
        }
    }
    object Kodein {
        object Di {
