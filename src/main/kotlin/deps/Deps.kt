...
object AndroidX {
  object Activity {
    val activity = "androidx.activity" d "activity" w "1.3.0-beta01" w "1.10.1" w "1.11.0-alpha01"
    val compose = "androidx.activity" d "activity-compose" w "1.3.0-beta01" w "1.10.1" w "1.11.0-alpha01"
    val ktx = "androidx.activity" d "activity-ktx" w "1.3.0-beta01" w "1.10.1" w "1.11.0-alpha01"
  }
  object Annotation {
  ...
  object AsyncLayoutInflater {
    val appcompat = "androidx.asynclayoutinflater" d "asynclayoutinflater-appcompat" w "1.1.0-beta01"
    val asynclayoutinflater = "androidx.asynclayoutinflater" d "asynclayoutinflater" w "1.0.0" w "1.1.0-beta01"
  }
  object AutoFill {
    val autofill = "androidx.autofill" d "autofill" w "1.1.0" w "1.3.0-rc01"
  }
  object Benchmark {
    val common = "androidx.benchmark" d "benchmark-common" w "1.1.0-alpha03" w "1.3.3" w "1.4.0-alpha09"
    val gradle_plugin = "androidx.benchmark" d "benchmark-gradle-plugin" w "1.3.3" w "1.4.0-alpha09"
    val junit4 = "androidx.benchmark" d "benchmark-junit4" w "1.1.0-alpha03" w "1.3.3" w "1.4.0-alpha09"
    val macro = "androidx.benchmark" d "benchmark-macro" w "1.1.0-alpha03" w "1.3.3" w "1.4.0-alpha09"
    val macro_junit4 = "androidx.benchmark" d "benchmark-macro-junit4" w "1.1.0-alpha03" w "1.3.3" w "1.4.0-alpha09"
  }
  object Biometric {
  ...
  object Compose {
    val bom = "androidx.compose" d "compose-bom" w "2025.03.00"
    object Animation {
      val animation = "androidx.compose.animation" d "animation" w "1.0.0-beta06" w "1.7.8" w "1.8.0-rc01"
      val core = "androidx.compose.animation" d "animation-core" w "1.0.0-beta06" w "1.7.8" w "1.8.0-rc01"
      val graphics = "androidx.compose.animation" d "animation-graphics" w "1.7.8" w "1.8.0-rc01"
    }
    object Compiler {
      val compiler = "androidx.compose.compiler" d "compiler" w "1.0.0-beta06" w "1.5.15"
    }
    object Foundation {
      val foundation = "androidx.compose.foundation" d "foundation" w "1.0.0-beta06" w "1.7.8" w "1.8.0-rc01"
      val layout = "androidx.compose.foundation" d "foundation-layout" w "1.0.0-beta06" w "1.7.8" w "1.8.0-rc01"
    }
    object Material {
      ...
      val material = "androidx.compose.material" d "material" w "1.0.0-beta06" w "1.7.8" w "1.8.0-rc01"
      val ripple = "androidx.compose.material" d "material-ripple" w "1.0.0-beta06" w "1.7.8" w "1.8.0-rc01"
    }
    object Material3 {
      val material3 = "androidx.compose.material3" d "material3" w "1.3.1" w "1.4.0-alpha10"
      val window_size_class = "androidx.compose.material3" d "material3-window-size-class" w "1.3.1" w "1.4.0-alpha10"
    }
    object Runtime {
      val dispatch = "androidx.compose.runtime" d "runtime-dispatch" w "1.0.0-alpha12"
      val livedata = "androidx.compose.runtime" d "runtime-livedata" w "1.7.8" w "1.8.0-rc01"
      val runtime = "androidx.compose.runtime" d "runtime" w "1.0.0-beta06" w "1.7.8" w "1.8.0-rc01"
      val rxjava2 = "androidx.compose.runtime" d "runtime-rxjava2" w "1.7.8" w "1.8.0-rc01"
      val rxjava3 = "androidx.compose.runtime" d "runtime-rxjava3" w "1.7.8" w "1.8.0-rc01"
      val saveable = "androidx.compose.runtime" d "runtime-saveable" w "1.0.0-beta06" w "1.7.8" w "1.8.0-rc01"
      val tracing = "androidx.compose.runtime" d "runtime-tracing" w "1.7.8" w "1.8.0-rc01"
    }
    object Ui {
      val geometry = "androidx.compose.ui" d "ui-geometry" w "1.0.0-beta06" w "1.7.8" w "1.8.0-rc01"
      val graphics = "androidx.compose.ui" d "ui-graphics" w "1.0.0-beta06" w "1.7.8" w "1.8.0-rc01"
      val test = "androidx.compose.ui" d "ui-test" w "1.0.0-beta06" w "1.7.8" w "1.8.0-rc01"
      val test_junit4 = "androidx.compose.ui" d "ui-test-junit4" w "1.0.0-beta06" w "1.7.8" w "1.8.0-rc01"
      val test_manifest = "androidx.compose.ui" d "ui-test-manifest" w "1.7.8" w "1.8.0-rc01"
      val text = "androidx.compose.ui" d "ui-text" w "1.0.0-beta06" w "1.7.8" w "1.8.0-rc01"
      val text_google_fonts = "androidx.compose.ui" d "ui-text-google-fonts" w "1.7.8" w "1.8.0-rc01"
      val tooling = "androidx.compose.ui" d "ui-tooling" w "1.7.8" w "1.8.0-rc01"
      val tooling_data = "androidx.compose.ui" d "ui-tooling-data" w "1.7.8" w "1.8.0-rc01"
      val tooling_preview = "androidx.compose.ui" d "ui-tooling-preview" w "1.7.8" w "1.8.0-rc01"
      val ui = "androidx.compose.ui" d "ui" w "1.0.0-beta06" w "1.7.8" w "1.8.0-rc01"
      val unit = "androidx.compose.ui" d "ui-unit" w "1.0.0-beta06" w "1.7.8" w "1.8.0-rc01"
      val util = "androidx.compose.ui" d "ui-util" w "1.0.0-beta06" w "1.7.8" w "1.8.0-rc01"
      val viewbinding = "androidx.compose.ui" d "ui-viewbinding" w "1.7.8" w "1.8.0-rc01"
    }
  }
  object Concurrent {
  ...
  object Core {
    ...
    val core = "androidx.core" d "core" w "1.15.0" w "1.16.0-beta01"
    val google_shortcuts = "androidx.core" d "core-google-shortcuts" w "1.1.0" w "1.2.0-alpha01"
    val ktx = "androidx.core" d "core-ktx" w "1.15.0" w "1.16.0-beta01"
  ...
  object DynamicAnimation {
    val dynamicanimation = "androidx.dynamicanimation" d "dynamicanimation" w "1.0.0" w "1.1.0-beta01"
    val ktx = "androidx.dynamicanimation" d "dynamicanimation-ktx" w "1.0.0-beta01"
  }
  object Emoji {
  ...
  object Lifecycle {
    val common = "androidx.lifecycle" d "lifecycle-common" w "2.8.7" w "2.9.0-alpha12"
    val common_java8 = "androidx.lifecycle" d "lifecycle-common-java8" w "2.8.7" w "2.9.0-alpha12"
    val compiler = "androidx.lifecycle" d "lifecycle-compiler" w "2.8.7" w "2.9.0-alpha12"
    val extensions = "androidx.lifecycle" d "lifecycle-extensions" w "2.2.0"
    val livedata = "androidx.lifecycle" d "lifecycle-livedata" w "2.8.7" w "2.9.0-alpha12"
    val livedata_ktx = "androidx.lifecycle" d "lifecycle-livedata-ktx" w "2.8.7" w "2.9.0-alpha12"
    val process = "androidx.lifecycle" d "lifecycle-process" w "2.8.7" w "2.9.0-alpha12"
    val reactivestreams = "androidx.lifecycle" d "lifecycle-reactivestreams" w "2.8.7" w "2.9.0-alpha12"
    val reactivestreams_ktx = "androidx.lifecycle" d "lifecycle-reactivestreams-ktx" w "2.8.7" w "2.9.0-alpha12"
    val runtime = "androidx.lifecycle" d "lifecycle-runtime" w "2.8.7" w "2.9.0-alpha12"
    val runtime_compose = "androidx.lifecycle" d "lifecycle-runtime-compose" w "2.8.7" w "2.9.0-alpha12"
    val runtime_ktx = "androidx.lifecycle" d "lifecycle-runtime-ktx" w "2.8.7" w "2.9.0-alpha12"
    val runtime_testing = "androidx.lifecycle" d "lifecycle-runtime-testing" w "2.8.7" w "2.9.0-alpha12"
    val service = "androidx.lifecycle" d "lifecycle-service" w "2.8.7" w "2.9.0-alpha12"
    val viewmodel = "androidx.lifecycle" d "lifecycle-viewmodel" w "2.8.7" w "2.9.0-alpha12"
    val viewmodel_compose = "androidx.lifecycle" d "lifecycle-viewmodel-compose" w "1.0.0-alpha06" w "2.8.7" w "2.9.0-alpha12"
    val viewmodel_ktx = "androidx.lifecycle" d "lifecycle-viewmodel-ktx" w "2.8.7" w "2.9.0-alpha12"
    val viewmodel_savedstate = "androidx.lifecycle" d "lifecycle-viewmodel-savedstate" w "2.8.7" w "2.9.0-alpha12"
  }
  object Loader {
  ...
  object Media3 {
    val cast = "androidx.media3" d "media3-cast" w "1.5.1" w "1.6.0-rc02"
    val common = "androidx.media3" d "media3-common" w "1.5.1" w "1.6.0-rc02"
    val database = "androidx.media3" d "media3-database" w "1.5.1" w "1.6.0-rc02"
    val datasource = "androidx.media3" d "media3-datasource" w "1.5.1" w "1.6.0-rc02"
    val datasource_cronet = "androidx.media3" d "media3-datasource-cronet" w "1.5.1" w "1.6.0-rc02"
    val datasource_okhttp = "androidx.media3" d "media3-datasource-okhttp" w "1.5.1" w "1.6.0-rc02"
    val datasource_rtmp = "androidx.media3" d "media3-datasource-rtmp" w "1.5.1" w "1.6.0-rc02"
    val decoder = "androidx.media3" d "media3-decoder" w "1.5.1" w "1.6.0-rc02"
    val exoplayer = "androidx.media3" d "media3-exoplayer" w "1.5.1" w "1.6.0-rc02"
    val exoplayer_dash = "androidx.media3" d "media3-exoplayer-dash" w "1.5.1" w "1.6.0-rc02"
    val exoplayer_hls = "androidx.media3" d "media3-exoplayer-hls" w "1.5.1" w "1.6.0-rc02"
    val exoplayer_ima = "androidx.media3" d "media3-exoplayer-ima" w "1.5.1" w "1.6.0-rc02"
    val exoplayer_rtsp = "androidx.media3" d "media3-exoplayer-rtsp" w "1.5.1" w "1.6.0-rc02"
    val exoplayer_workmanager = "androidx.media3" d "media3-exoplayer-workmanager" w "1.5.1" w "1.6.0-rc02"
    val extractor = "androidx.media3" d "media3-extractor" w "1.5.1" w "1.6.0-rc02"
    val session = "androidx.media3" d "media3-session" w "1.5.1" w "1.6.0-rc02"
    val test_utils = "androidx.media3" d "media3-test-utils" w "1.5.1" w "1.6.0-rc02"
    val test_utils_robolectric = "androidx.media3" d "media3-test-utils-robolectric" w "1.5.1" w "1.6.0-rc02"
    val transformer = "androidx.media3" d "media3-transformer" w "1.5.1" w "1.6.0-rc02"
    val ui = "androidx.media3" d "media3-ui" w "1.5.1" w "1.6.0-rc02"
    val ui_leanback = "androidx.media3" d "media3-ui-leanback" w "1.5.1" w "1.6.0-rc02"
  }
  object MediaRouter {
  ...
  object Navigation {
    val common = "androidx.navigation" d "navigation-common" w "2.4.0-alpha02" w "2.8.9" w "2.9.0-alpha08"
    val common_ktx = "androidx.navigation" d "navigation-common-ktx" w "2.4.0-alpha02" w "2.8.9" w "2.9.0-alpha08"
    val compose = "androidx.navigation" d "navigation-compose" w "2.4.0-alpha02" w "2.8.9" w "2.9.0-alpha08"
    val dynamic_features_fragment = "androidx.navigation" d "navigation-dynamic-features-fragment" w "2.8.9" w "2.9.0-alpha08"
    val fragment = "androidx.navigation" d "navigation-fragment" w "2.8.9" w "2.9.0-alpha08"
    val fragment_ktx = "androidx.navigation" d "navigation-fragment-ktx" w "2.8.9" w "2.9.0-alpha08"
    val runtime = "androidx.navigation" d "navigation-runtime" w "2.4.0-alpha02" w "2.8.9" w "2.9.0-alpha08"
    val runtime_ktx = "androidx.navigation" d "navigation-runtime-ktx" w "2.4.0-alpha02" w "2.8.9" w "2.9.0-alpha08"
    val safe_args_generator = "androidx.navigation" d "navigation-safe-args-generator" w "2.8.9" w "2.9.0-alpha08"
    val safe_args_gradle_plugin = "androidx.navigation" d "navigation-safe-args-gradle-plugin" w "2.8.9" w "2.9.0-alpha08"
    val testing = "androidx.navigation" d "navigation-testing" w "2.4.0-alpha02" w "2.8.9" w "2.9.0-alpha08"
    val ui = "androidx.navigation" d "navigation-ui" w "2.8.9" w "2.9.0-alpha08"
    val ui_ktx = "androidx.navigation" d "navigation-ui-ktx" w "2.8.9" w "2.9.0-alpha08"
  }
  object Paging {
  ...
  object Room {
    val common = "androidx.room" d "room-common" w "2.6.1" w "2.7.0-rc02"
    val compiler = "androidx.room" d "room-compiler" w "2.6.1" w "2.7.0-rc02"
    val guava = "androidx.room" d "room-guava" w "2.6.1" w "2.7.0-rc02"
    val ktx = "androidx.room" d "room-ktx" w "2.6.1" w "2.7.0-rc02"
    val paging = "androidx.room" d "room-paging" w "2.6.1" w "2.7.0-rc02"
    val paging_guava = "androidx.room" d "room-paging-guava" w "2.6.1" w "2.7.0-rc02"
    val paging_rxjava2 = "androidx.room" d "room-paging-rxjava2" w "2.6.1" w "2.7.0-rc02"
    val paging_rxjava3 = "androidx.room" d "room-paging-rxjava3" w "2.6.1" w "2.7.0-rc02"
    val runtime = "androidx.room" d "room-runtime" w "2.6.1" w "2.7.0-rc02"
    val rxjava2 = "androidx.room" d "room-rxjava2" w "2.6.1" w "2.7.0-rc02"
    val rxjava3 = "androidx.room" d "room-rxjava3" w "2.6.1" w "2.7.0-rc02"
    val testing = "androidx.room" d "room-testing" w "2.6.1" w "2.7.0-rc02"
  }
  object Savedstate {
    val ktx = "androidx.savedstate" d "savedstate-ktx" w "1.2.1" w "1.3.0-alpha10"
    val savedstate = "androidx.savedstate" d "savedstate" w "1.2.1" w "1.3.0-alpha10"
  }
  object Security {
  ...
  object Sqlite {
    val framework = "androidx.sqlite" d "sqlite-framework" w "2.4.0" w "2.5.0-rc02"
    val ktx = "androidx.sqlite" d "sqlite-ktx" w "2.4.0" w "2.5.0-rc02"
    val sqlite = "androidx.sqlite" d "sqlite" w "2.4.0" w "2.5.0-rc02"
  }
  object Startup {
  ...
  object Transition {
    val ktx = "androidx.transition" d "transition-ktx" w "1.5.1" w "1.6.0-beta01"
    val transition = "androidx.transition" d "transition" w "1.5.1" w "1.6.0-beta01"
  }
  object Tv {
  ...
  object Wear {
    ...
    object Compose {
      val foundation = "androidx.wear.compose" d "compose-foundation" w "1.0.0-alpha01" w "1.4.1" w "1.5.0-alpha11"
      val material = "androidx.wear.compose" d "compose-material" w "1.0.0-alpha01" w "1.4.1" w "1.5.0-alpha11"
      val navigation = "androidx.wear.compose" d "compose-navigation" w "1.4.1" w "1.5.0-alpha11"
    }
    object Tiles {
...
object Com {
  object Android {
    ...
    object Tools {
      ...
      object Build {
        val gradle = "com.android.tools.build" d "gradle" w "2.3.0" w "8.9.0" w "8.10.0-beta01" w "8.11.0-alpha01"
      }
    }
  }
  ...
  object Google {
    ...
    object Dagger {
      val android = "com.google.dagger" d "dagger-android" w "2.56"
      val android_processor = "com.google.dagger" d "dagger-android-processor" w "2.56"
      val android_support = "com.google.dagger" d "dagger-android-support" w "2.56"
      val compiler = "com.google.dagger" d "dagger-compiler" w "2.56"
      val dagger = "com.google.dagger" d "dagger" w "2.56"
      val grpc_server = "com.google.dagger" d "dagger-grpc-server" w "2.56"
      val grpc_server_annotations = "com.google.dagger" d "dagger-grpc-server-annotations" w "2.56"
      val grpc_server_processor = "com.google.dagger" d "dagger-grpc-server-processor" w "2.56"
      val gwt = "com.google.dagger" d "dagger-gwt" w "2.56"
      val hilt_android = "com.google.dagger" d "hilt-android" w "2.56"
      val hilt_android_compiler = "com.google.dagger" d "hilt-android-compiler" w "2.56"
      val hilt_android_gradle_plugin = "com.google.dagger" d "hilt-android-gradle-plugin" w "2.56"
      val hilt_android_testing = "com.google.dagger" d "hilt-android-testing" w "2.56"
      val hilt_compiler = "com.google.dagger" d "hilt-compiler" w "2.56"
      val producers = "com.google.dagger" d "dagger-producers" w "2.56"
      val spi = "com.google.dagger" d "dagger-spi" w "2.56"
    }
    object Firebase {
  ...
  object Rickclephas {
    object Kmp {
      val nativecoroutines_annotations = "com.rickclephas.kmp" d "kmp-nativecoroutines-annotations" w "0.13.3" w "1.0.0-ALPHA-40-kotlin-2.1.20-RC3"
      val nativecoroutines_compiler = "com.rickclephas.kmp" d "kmp-nativecoroutines-compiler" w "0.13.3" w "1.0.0-ALPHA-40-kotlin-2.1.20-RC3"
      val nativecoroutines_compiler_embeddable = "com.rickclephas.kmp" d "kmp-nativecoroutines-compiler-embeddable" w "0.13.3" w "1.0.0-ALPHA-40-kotlin-2.1.20-RC3"
      val nativecoroutines_core = "com.rickclephas.kmp" d "kmp-nativecoroutines-core" w "0.13.3" w "1.0.0-ALPHA-40-kotlin-2.1.20-RC3"
      val nativecoroutines_gradle_plugin = "com.rickclephas.kmp" d "kmp-nativecoroutines-gradle-plugin" w "0.13.3" w "1.0.0-ALPHA-40-kotlin-2.1.20-RC3"
    }
  }
  object Russhwolf {
...
object Org {
  ...
  object JUnit {
    val bom = "org.junit" d "junit-bom" w "5.12.1"
    object Jupiter {
      val junit_jupiter = "org.junit.jupiter" d "junit-jupiter" w "5.12.1"
      val junit_jupiter_api = "org.junit.jupiter" d "junit-jupiter-api" w "5.12.1"
      val junit_jupiter_engine = "org.junit.jupiter" d "junit-jupiter-engine" w "5.12.1"
      val junit_jupiter_migrationsupport = "org.junit.jupiter" d "junit-jupiter-migrationsupport" w "5.12.1"
      val junit_jupiter_params = "org.junit.jupiter" d "junit-jupiter-params" w "5.12.1"
    }
  }
  object JetBrains {
    object AndroidX {
      object Lifecycle {
        val common = "org.jetbrains.androidx.lifecycle" d "lifecycle-common" w "2.8.4" w "2.9.0-alpha04" w "2.9.0-alpha05"
        val common_js = "org.jetbrains.androidx.lifecycle" d "lifecycle-common-js" w "2.8.4" w "2.9.0-alpha04" w "2.9.0-alpha05"
        val common_wasm_js = "org.jetbrains.androidx.lifecycle" d "lifecycle-common-wasm-js" w "2.8.4" w "2.9.0-alpha04" w "2.9.0-alpha05"
        val runtime = "org.jetbrains.androidx.lifecycle" d "lifecycle-runtime" w "2.8.4" w "2.9.0-alpha04" w "2.9.0-alpha05"
        val runtime_compose = "org.jetbrains.androidx.lifecycle" d "lifecycle-runtime-compose" w "2.8.4" w "2.9.0-alpha04" w "2.9.0-alpha05"
        val runtime_compose_js = "org.jetbrains.androidx.lifecycle" d "lifecycle-runtime-compose-js" w "2.8.4" w "2.9.0-alpha04" w "2.9.0-alpha05"
        val runtime_compose_wasm_js = "org.jetbrains.androidx.lifecycle" d "lifecycle-runtime-compose-wasm-js" w "2.8.4" w "2.9.0-alpha04" w "2.9.0-alpha05"
        val runtime_js = "org.jetbrains.androidx.lifecycle" d "lifecycle-runtime-js" w "2.8.4" w "2.9.0-alpha04" w "2.9.0-alpha05"
        val runtime_wasm_js = "org.jetbrains.androidx.lifecycle" d "lifecycle-runtime-wasm-js" w "2.8.4" w "2.9.0-alpha04" w "2.9.0-alpha05"
        val viewmodel = "org.jetbrains.androidx.lifecycle" d "lifecycle-viewmodel" w "2.8.4" w "2.9.0-alpha04" w "2.9.0-alpha05"
        val viewmodel_compose = "org.jetbrains.androidx.lifecycle" d "lifecycle-viewmodel-compose" w "2.8.4" w "2.9.0-alpha04" w "2.9.0-alpha05"
        val viewmodel_compose_js = "org.jetbrains.androidx.lifecycle" d "lifecycle-viewmodel-compose-js" w "2.8.4" w "2.9.0-alpha04" w "2.9.0-alpha05"
        val viewmodel_compose_wasm_js = "org.jetbrains.androidx.lifecycle" d "lifecycle-viewmodel-compose-wasm-js" w "2.8.4" w "2.9.0-alpha04" w "2.9.0-alpha05"
        val viewmodel_js = "org.jetbrains.androidx.lifecycle" d "lifecycle-viewmodel-js" w "2.8.4" w "2.9.0-alpha04" w "2.9.0-alpha05"
        val viewmodel_savedstate = "org.jetbrains.androidx.lifecycle" d "lifecycle-viewmodel-savedstate" w "2.8.4" w "2.9.0-alpha04" w "2.9.0-alpha05"
        val viewmodel_savedstate_js = "org.jetbrains.androidx.lifecycle" d "lifecycle-viewmodel-savedstate-js" w "2.8.4" w "2.9.0-alpha04" w "2.9.0-alpha05"
        val viewmodel_savedstate_wasm_js = "org.jetbrains.androidx.lifecycle" d "lifecycle-viewmodel-savedstate-wasm-js" w "2.8.4" w "2.9.0-alpha04" w "2.9.0-alpha05"
        val viewmodel_wasm_js = "org.jetbrains.androidx.lifecycle" d "lifecycle-viewmodel-wasm-js" w "2.8.4" w "2.9.0-alpha04" w "2.9.0-alpha05"
      }
    }
    object Compose {
      val full = "org.jetbrains.compose" d "compose-full" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
      val gradle_plugin = "org.jetbrains.compose" d "compose-gradle-plugin" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
      val preview_rpc = "org.jetbrains.compose" d "preview-rpc" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
      val preview_runtime_desktop = "org.jetbrains.compose" d "compose-preview-runtime-desktop" w "0.5.0-build228"
      object Animation {
        val animation = "org.jetbrains.compose.animation" d "animation" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val core = "org.jetbrains.compose.animation" d "animation-core" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val core_js = "org.jetbrains.compose.animation" d "animation-core-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val core_wasm_js = "org.jetbrains.compose.animation" d "animation-core-wasm-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val graphics = "org.jetbrains.compose.animation" d "animation-graphics" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val graphics_js = "org.jetbrains.compose.animation" d "animation-graphics-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val graphics_wasm_js = "org.jetbrains.compose.animation" d "animation-graphics-wasm-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val js = "org.jetbrains.compose.animation" d "animation-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val wasm_js = "org.jetbrains.compose.animation" d "animation-wasm-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
      }
      object Compiler {
      ...
      object Components {
        val animatedimage = "org.jetbrains.compose.components" d "components-animatedimage" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val resources = "org.jetbrains.compose.components" d "components-resources" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val resources_js = "org.jetbrains.compose.components" d "components-resources-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val resources_wasmjs = "org.jetbrains.compose.components" d "components-resources-wasmJs" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val splitpane = "org.jetbrains.compose.components" d "components-splitpane" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val ui_tooling_preview = "org.jetbrains.compose.components" d "components-ui-tooling-preview" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val ui_tooling_preview_js = "org.jetbrains.compose.components" d "components-ui-tooling-preview-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val ui_tooling_preview_wasmjs = "org.jetbrains.compose.components" d "components-ui-tooling-preview-wasmJs" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
      }
      object Desktop {
        val desktop = "org.jetbrains.compose.desktop" d "desktop" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val jvm = "org.jetbrains.compose.desktop" d "desktop-jvm" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
      }
      object Foundation {
        val foundation = "org.jetbrains.compose.foundation" d "foundation" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val js = "org.jetbrains.compose.foundation" d "foundation-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val layout = "org.jetbrains.compose.foundation" d "foundation-layout" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val layout_js = "org.jetbrains.compose.foundation" d "foundation-layout-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val layout_wasm_js = "org.jetbrains.compose.foundation" d "foundation-layout-wasm-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val wasm_js = "org.jetbrains.compose.foundation" d "foundation-wasm-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
      }
      object Html {
        val benchmark_core = "org.jetbrains.compose.html" d "html-benchmark-core" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val benchmark_core_js = "org.jetbrains.compose.html" d "html-benchmark-core-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val core = "org.jetbrains.compose.html" d "html-core" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val core_js = "org.jetbrains.compose.html" d "html-core-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val core_jvm = "org.jetbrains.compose.html" d "html-core-jvm" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val svg = "org.jetbrains.compose.html" d "html-svg" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val svg_js = "org.jetbrains.compose.html" d "html-svg-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val test_utils = "org.jetbrains.compose.html" d "html-test-utils" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val test_utils_js = "org.jetbrains.compose.html" d "html-test-utils-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
      }
      object Material {
        ...
        val js = "org.jetbrains.compose.material" d "material-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val material = "org.jetbrains.compose.material" d "material" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val navigation = "org.jetbrains.compose.material" d "material-navigation" w "1.7.0-beta02" w "1.8.0-alpha04" w "1.8.0-beta01"
        val navigation_js = "org.jetbrains.compose.material" d "material-navigation-js" w "1.7.0-beta02" w "1.8.0-alpha04" w "1.8.0-beta01"
        val navigation_wasm_js = "org.jetbrains.compose.material" d "material-navigation-wasm-js" w "1.7.0-beta02" w "1.8.0-alpha04" w "1.8.0-beta01"
        val ripple = "org.jetbrains.compose.material" d "material-ripple" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val ripple_js = "org.jetbrains.compose.material" d "material-ripple-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val ripple_wasm_js = "org.jetbrains.compose.material" d "material-ripple-wasm-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val wasm_js = "org.jetbrains.compose.material" d "material-wasm-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
      }
      object Material3 {
        val js = "org.jetbrains.compose.material3" d "material3-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val material3 = "org.jetbrains.compose.material3" d "material3" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val wasm_js = "org.jetbrains.compose.material3" d "material3-wasm-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val window_size_class = "org.jetbrains.compose.material3" d "material3-window-size-class" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val window_size_class_js = "org.jetbrains.compose.material3" d "material3-window-size-class-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val window_size_class_wasm_js = "org.jetbrains.compose.material3" d "material3-window-size-class-wasm-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
      }
      object Runtime {
        val js = "org.jetbrains.compose.runtime" d "runtime-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val runtime = "org.jetbrains.compose.runtime" d "runtime" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val saveable = "org.jetbrains.compose.runtime" d "runtime-saveable" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val saveable_js = "org.jetbrains.compose.runtime" d "runtime-saveable-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val saveable_wasm_js = "org.jetbrains.compose.runtime" d "runtime-saveable-wasm-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val wasm_js = "org.jetbrains.compose.runtime" d "runtime-wasm-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
      }
      object Ui {
        val geometry = "org.jetbrains.compose.ui" d "ui-geometry" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val geometry_js = "org.jetbrains.compose.ui" d "ui-geometry-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val geometry_wasm_js = "org.jetbrains.compose.ui" d "ui-geometry-wasm-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val graphics = "org.jetbrains.compose.ui" d "ui-graphics" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val graphics_js = "org.jetbrains.compose.ui" d "ui-graphics-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val graphics_wasm_js = "org.jetbrains.compose.ui" d "ui-graphics-wasm-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val js = "org.jetbrains.compose.ui" d "ui-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val test = "org.jetbrains.compose.ui" d "ui-test" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val test_js = "org.jetbrains.compose.ui" d "ui-test-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val test_junit4 = "org.jetbrains.compose.ui" d "ui-test-junit4" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val test_wasm_js = "org.jetbrains.compose.ui" d "ui-test-wasm-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val text = "org.jetbrains.compose.ui" d "ui-text" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val text_js = "org.jetbrains.compose.ui" d "ui-text-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val text_wasm_js = "org.jetbrains.compose.ui" d "ui-text-wasm-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val tooling = "org.jetbrains.compose.ui" d "ui-tooling" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val tooling_preview = "org.jetbrains.compose.ui" d "ui-tooling-preview" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val ui = "org.jetbrains.compose.ui" d "ui" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val unit = "org.jetbrains.compose.ui" d "ui-unit" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val unit_js = "org.jetbrains.compose.ui" d "ui-unit-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val unit_wasm_js = "org.jetbrains.compose.ui" d "ui-unit-wasm-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
        val wasm_js = "org.jetbrains.compose.ui" d "ui-wasm-js" w "1.7.3" w "1.8.0+check" w "1.8.0-alpha04" w "1.8.0-beta01"
      }
    }
    object Exposed {
    ...
    object Kotlin {
      val allopen = "org.jetbrains.kotlin" d "kotlin-allopen" w "2.1.10" w "2.1.20-RC3"
      val android_extensions_runtime = "org.jetbrains.kotlin" d "kotlin-android-extensions-runtime" w "2.1.10" w "2.1.20-RC3"
      val atomicfu = "org.jetbrains.kotlin" d "atomicfu" w "2.1.10" w "2.1.20-RC3"
      val atomicfu_runtime = "org.jetbrains.kotlin" d "kotlin-atomicfu-runtime"
      val bom = "org.jetbrains.kotlin" d "kotlin-bom" w "2.1.10" w "2.1.20-RC3"
      val compiler = "org.jetbrains.kotlin" d "kotlin-compiler" w "2.1.10" w "2.1.20-RC3"
      val compiler_embeddable = "org.jetbrains.kotlin" d "kotlin-compiler-embeddable" w "1.4.0-dev-withExperimentalGoogleExtensions-20200720" w "2.1.10" w "2.1.20-RC3"
      val dom_api_compat = "org.jetbrains.kotlin" d "kotlin-dom-api-compat" w "2.1.10" w "2.1.20-RC3"
      val gradle_plugin = "org.jetbrains.kotlin" d "kotlin-gradle-plugin" w "2.1.10" w "2.1.20-RC3"
      val gradle_plugin_api = "org.jetbrains.kotlin" d "kotlin-gradle-plugin-api" w "2.1.10" w "2.1.20-RC3"
      val js_plain_objects = "org.jetbrains.kotlin" d "kotlin-js-plain-objects" w "2.1.10" w "2.1.20-RC3"
      val maven_plugin = "org.jetbrains.kotlin" d "kotlin-maven-plugin" w "2.1.10" w "2.1.20-RC3"
      val parcelize_runtime = "org.jetbrains.kotlin" d "kotlin-parcelize-runtime" w "2.1.10" w "2.1.20-RC3"
      val reflect = "org.jetbrains.kotlin" d "kotlin-reflect" w "2.1.10" w "2.1.20-RC3"
      val script_runtime = "org.jetbrains.kotlin" d "kotlin-script-runtime" w "2.1.10" w "2.1.20-RC3"
      val scripting_common = "org.jetbrains.kotlin" d "kotlin-scripting-common" w "2.1.10" w "2.1.20-RC3"
      val scripting_compiler = "org.jetbrains.kotlin" d "kotlin-scripting-compiler" w "2.1.10" w "2.1.20-RC3"
      val scripting_compiler_embeddable = "org.jetbrains.kotlin" d "kotlin-scripting-compiler-embeddable" w "2.1.10" w "2.1.20-RC3"
      val scripting_jvm = "org.jetbrains.kotlin" d "kotlin-scripting-jvm" w "2.1.10" w "2.1.20-RC3"
      val scripting_jvm_host = "org.jetbrains.kotlin" d "kotlin-scripting-jvm-host" w "2.1.10" w "2.1.20-RC3"
      val serialization = "org.jetbrains.kotlin" d "kotlin-serialization" w "2.1.10" w "2.1.20-RC3"
      val stdlib = "org.jetbrains.kotlin" d "kotlin-stdlib" w "2.1.10" w "2.1.20-RC3"
      val stdlib_common = "org.jetbrains.kotlin" d "kotlin-stdlib-common" w "2.1.10" w "2.1.20-RC3"
      val stdlib_jdk7 = "org.jetbrains.kotlin" d "kotlin-stdlib-jdk7" w "2.1.10" w "2.1.20-RC3"
      val stdlib_jdk8 = "org.jetbrains.kotlin" d "kotlin-stdlib-jdk8" w "2.1.10" w "2.1.20-RC3"
      val stdlib_js = "org.jetbrains.kotlin" d "kotlin-stdlib-js" w "2.1.10" w "2.1.20-RC3"
      val stdlib_wasm = "org.jetbrains.kotlin" d "kotlin-stdlib-wasm" w "1.9.10"
      val stdlib_wasm_js = "org.jetbrains.kotlin" d "kotlin-stdlib-wasm-js" w "2.1.10" w "2.1.20-RC3"
      val stdlib_wasm_wasi = "org.jetbrains.kotlin" d "kotlin-stdlib-wasm-wasi" w "2.1.10" w "2.1.20-RC3"
      val test = "org.jetbrains.kotlin" d "kotlin-test" w "2.1.10" w "2.1.20-RC3"
      val test_annotations_common = "org.jetbrains.kotlin" d "kotlin-test-annotations-common" w "2.1.10" w "2.1.20-RC3"
      val test_common = "org.jetbrains.kotlin" d "kotlin-test-common" w "2.1.10" w "2.1.20-RC3"
      val test_js = "org.jetbrains.kotlin" d "kotlin-test-js" w "2.1.10" w "2.1.20-RC3"
      val test_js_runner = "org.jetbrains.kotlin" d "kotlin-test-js-runner" w "2.0.21"
      val test_junit = "org.jetbrains.kotlin" d "kotlin-test-junit" w "2.1.10" w "2.1.20-RC3"
      val test_junit5 = "org.jetbrains.kotlin" d "kotlin-test-junit5" w "2.1.10" w "2.1.20-RC3"
      val test_testng = "org.jetbrains.kotlin" d "kotlin-test-testng" w "2.1.10" w "2.1.20-RC3"
      val test_wasm_js = "org.jetbrains.kotlin" d "kotlin-test-wasm-js" w "2.1.10" w "2.1.20-RC3"
    }
    object KotlinX {
      ...
      val dataframe = "org.jetbrains.kotlinx" d "dataframe" w "0.15.0" w "0.16.0-dev-6363"
      val dataframe_arrow = "org.jetbrains.kotlinx" d "dataframe-arrow" w "0.15.0" w "0.16.0-dev-6363"
      val dataframe_core = "org.jetbrains.kotlinx" d "dataframe-core" w "0.15.0" w "0.16.0-dev-6363"
      val dataframe_excel = "org.jetbrains.kotlinx" d "dataframe-excel" w "0.15.0" w "0.16.0-dev-6363"
    ...
    object Kotlin_Wrappers {
      val bom = "org.jetbrains.kotlin-wrappers" d "kotlin-wrappers-bom" w "2025.3.16"
      val kotlin_actions_toolkit = "org.jetbrains.kotlin-wrappers" d "kotlin-actions-toolkit" w "2025.3.16"
      val kotlin_browser = "org.jetbrains.kotlin-wrappers" d "kotlin-browser" w "2025.3.16"
      val kotlin_cesium = "org.jetbrains.kotlin-wrappers" d "kotlin-cesium" w "1.115.0-pre.711"
      val kotlin_css = "org.jetbrains.kotlin-wrappers" d "kotlin-css" w "2025.3.16"
      val kotlin_csstype = "org.jetbrains.kotlin-wrappers" d "kotlin-csstype" w "2025.3.16-3.1.3"
      val kotlin_emotion = "org.jetbrains.kotlin-wrappers" d "kotlin-emotion" w "2025.3.16"
      val kotlin_history = "org.jetbrains.kotlin-wrappers" d "kotlin-history" w "5.3.0-pre.506-compat"
      val kotlin_js = "org.jetbrains.kotlin-wrappers" d "kotlin-js" w "2025.3.16"
      ...
      val kotlin_node = "org.jetbrains.kotlin-wrappers" d "kotlin-node" w "2025.3.16-22.13.10"
      val kotlin_popper = "org.jetbrains.kotlin-wrappers" d "kotlin-popper" w "2.11.8-pre.792"
      val kotlin_react = "org.jetbrains.kotlin-wrappers" d "kotlin-react" w "2025.3.16-19.0.0"
      val kotlin_react_beautiful_dnd = "org.jetbrains.kotlin-wrappers" d "kotlin-react-beautiful-dnd" w "2025.3.16-13.1.1"
      val kotlin_react_core = "org.jetbrains.kotlin-wrappers" d "kotlin-react-core" w "2025.3.16-19.0.0"
      val kotlin_react_dom = "org.jetbrains.kotlin-wrappers" d "kotlin-react-dom" w "2025.3.16-19.0.0"
      val kotlin_react_dom_legacy = "org.jetbrains.kotlin-wrappers" d "kotlin-react-dom-legacy" w "2025.3.16-19.0.0"
      val kotlin_react_dom_test_utils = "org.jetbrains.kotlin-wrappers" d "kotlin-react-dom-test-utils" w "2025.3.16-19.0.0"
      val kotlin_react_legacy = "org.jetbrains.kotlin-wrappers" d "kotlin-react-legacy" w "2025.3.16-19.0.0"
      val kotlin_react_popper = "org.jetbrains.kotlin-wrappers" d "kotlin-react-popper" w "2025.3.16-2.3.0"
      val kotlin_react_redux = "org.jetbrains.kotlin-wrappers" d "kotlin-react-redux" w "7.2.6-pre.785"
      val kotlin_react_router = "org.jetbrains.kotlin-wrappers" d "kotlin-react-router" w "2025.3.16-6.28.2"
      val kotlin_react_router_dom = "org.jetbrains.kotlin-wrappers" d "kotlin-react-router-dom" w "2025.1.6-6.28.0"
      val kotlin_react_select = "org.jetbrains.kotlin-wrappers" d "kotlin-react-select" w "2025.3.16-5.10.1"
      val kotlin_react_use = "org.jetbrains.kotlin-wrappers" d "kotlin-react-use" w "2025.3.16"
      ...
      val kotlin_styled_next = "org.jetbrains.kotlin-wrappers" d "kotlin-styled-next" w "2025.3.16"
      val kotlin_tanstack_query_core = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-query-core" w "2025.3.16-5.68.0"
      val kotlin_tanstack_react_query = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-react-query" w "2025.3.16-5.68.0"
      val kotlin_tanstack_react_query_devtools = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-react-query-devtools" w "2025.3.16-5.68.0"
      val kotlin_tanstack_react_table = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-react-table" w "2025.3.16-8.21.2"
      val kotlin_tanstack_react_virtual = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-react-virtual" w "2025.3.16-3.13.3"
      val kotlin_tanstack_table_core = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-table-core" w "2025.3.16-8.21.2"
      val kotlin_tanstack_virtual_core = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-virtual-core" w "2025.3.16-3.13.3"
      val kotlin_typescript = "org.jetbrains.kotlin-wrappers" d "kotlin-typescript" w "2025.3.16-5.7.2"
      val kotlin_web = "org.jetbrains.kotlin-wrappers" d "kotlin-web" w "2025.3.16"
    }
  }
  object Kodein {
    object Di {
