...
object Com {
  ...
  object Google {
    ...
    object Android {
      ...
      object Horologist {
        val audio = "com.google.android.horologist" d "horologist-audio" w "0.6.11"
        val audio_ui = "com.google.android.horologist" d "horologist-audio-ui" w "0.6.11"
        val composables = "com.google.android.horologist" d "horologist-composables" w "0.6.11"
        val compose_layout = "com.google.android.horologist" d "horologist-compose-layout" w "0.6.11"
        val compose_tools = "com.google.android.horologist" d "horologist-compose-tools" w "0.6.11"
        val datalayer = "com.google.android.horologist" d "horologist-datalayer" w "0.6.11"
        val media = "com.google.android.horologist" d "horologist-media" w "0.6.11"
        val media3_backend = "com.google.android.horologist" d "horologist-media3-backend" w "0.6.11"
        val media_data = "com.google.android.horologist" d "horologist-media-data" w "0.6.11"
        val media_ui = "com.google.android.horologist" d "horologist-media-ui" w "0.6.11"
        val network_awareness = "com.google.android.horologist" d "horologist-network-awareness" w "0.6.11"
        val tiles = "com.google.android.horologist" d "horologist-tiles" w "0.6.11"
      }
      object Libraries {
        object Places {
  ...
  object SquareUp {
    ...
    object LeakCanary {
      val android = "com.squareup.leakcanary" d "leakcanary-android" w "2.14" w "3.0-alpha-4"
      val android_instrumentation = "com.squareup.leakcanary" d "leakcanary-android-instrumentation" w "2.14" w "3.0-alpha-4"
      val android_process = "com.squareup.leakcanary" d "leakcanary-android-process" w "2.14" w "3.0-alpha-4"
      val deobfuscation_gradle_plugin = "com.squareup.leakcanary" d "leakcanary-deobfuscation-gradle-plugin" w "2.14" w "3.0-alpha-4"
      val object_watcher = "com.squareup.leakcanary" d "leakcanary-object-watcher" w "2.14" w "3.0-alpha-4"
      val object_watcher_android = "com.squareup.leakcanary" d "leakcanary-object-watcher-android" w "2.14" w "3.0-alpha-4"
      val plumber_android = "com.squareup.leakcanary" d "plumber-android" w "2.14" w "3.0-alpha-4"
      val shark = "com.squareup.leakcanary" d "shark" w "2.14" w "3.0-alpha-4"
      val shark_android = "com.squareup.leakcanary" d "shark-android" w "2.14" w "3.0-alpha-4"
      val shark_cli = "com.squareup.leakcanary" d "shark-cli" w "2.14" w "3.0-alpha-4"
      val shark_graph = "com.squareup.leakcanary" d "shark-graph" w "2.14" w "3.0-alpha-4"
      val shark_hprof = "com.squareup.leakcanary" d "shark-hprof" w "2.14" w "3.0-alpha-4"
    }
    object Logcat {
...
object Org {
  ...
  object JetBrains {
    ...
    object Kotlin {
      val reflect = "org.jetbrains.kotlin" d "kotlin-reflect" w "1.9.24" w "2.0.0-RC3"
      val script_runtime = "org.jetbrains.kotlin" d "kotlin-script-runtime" w "1.9.24" w "2.0.0-RC3"
      val stdlib = "org.jetbrains.kotlin" d "kotlin-stdlib" w "1.9.24" w "2.0.0-RC3"
      val stdlib_common = "org.jetbrains.kotlin" d "kotlin-stdlib-common" w "1.9.24" w "2.0.0-RC3"
      val stdlib_jdk7 = "org.jetbrains.kotlin" d "kotlin-stdlib-jdk7" w "1.9.24" w "2.0.0-RC3"
      val stdlib_jdk8 = "org.jetbrains.kotlin" d "kotlin-stdlib-jdk8" w "1.9.24" w "2.0.0-RC3"
      val stdlib_js = "org.jetbrains.kotlin" d "kotlin-stdlib-js" w "1.9.24" w "2.0.0-RC3"
      val test = "org.jetbrains.kotlin" d "kotlin-test" w "1.9.24" w "2.0.0-RC3"
      val test_annotations_common = "org.jetbrains.kotlin" d "kotlin-test-annotations-common" w "1.9.24" w "2.0.0-RC3"
      val test_common = "org.jetbrains.kotlin" d "kotlin-test-common" w "1.9.24" w "2.0.0-RC3"
      val test_js = "org.jetbrains.kotlin" d "kotlin-test-js" w "1.9.24" w "2.0.0-RC3"
      val test_js_runner = "org.jetbrains.kotlin" d "kotlin-test-js-runner" w "1.9.24" w "2.0.0-RC3"
      val test_junit = "org.jetbrains.kotlin" d "kotlin-test-junit" w "1.9.24" w "2.0.0-RC3"
      val test_junit5 = "org.jetbrains.kotlin" d "kotlin-test-junit5" w "1.9.24" w "2.0.0-RC3"
      val test_testng = "org.jetbrains.kotlin" d "kotlin-test-testng" w "1.9.24" w "2.0.0-RC3"
    }
    object KotlinX {
      ...
      val coroutines_android = "org.jetbrains.kotlinx" d "kotlinx-coroutines-android" w "1.8.1"
      val coroutines_bom = "org.jetbrains.kotlinx" d "kotlinx-coroutines-bom" w "1.8.1"
      val coroutines_core = "org.jetbrains.kotlinx" d "kotlinx-coroutines-core" w "1.8.1"
      val coroutines_debug = "org.jetbrains.kotlinx" d "kotlinx-coroutines-debug" w "1.8.1"
      val coroutines_guava = "org.jetbrains.kotlinx" d "kotlinx-coroutines-guava" w "1.8.1"
      val coroutines_javafx = "org.jetbrains.kotlinx" d "kotlinx-coroutines-javafx" w "1.8.1"
      val coroutines_jdk8 = "org.jetbrains.kotlinx" d "kotlinx-coroutines-jdk8" w "1.8.1"
      val coroutines_jdk9 = "org.jetbrains.kotlinx" d "kotlinx-coroutines-jdk9" w "1.8.1"
      val coroutines_play_services = "org.jetbrains.kotlinx" d "kotlinx-coroutines-play-services" w "1.8.1"
      val coroutines_reactive = "org.jetbrains.kotlinx" d "kotlinx-coroutines-reactive" w "1.8.1"
      val coroutines_reactor = "org.jetbrains.kotlinx" d "kotlinx-coroutines-reactor" w "1.8.1"
      val coroutines_rx2 = "org.jetbrains.kotlinx" d "kotlinx-coroutines-rx2" w "1.8.1"
      val coroutines_rx3 = "org.jetbrains.kotlinx" d "kotlinx-coroutines-rx3" w "1.8.1"
      ...
      val dataframe = "org.jetbrains.kotlinx" d "dataframe" w "0.13.1" w "0.14.0-dev-3080"
      val dataframe_arrow = "org.jetbrains.kotlinx" d "dataframe-arrow" w "0.13.1" w "0.14.0-dev-3080"
      val dataframe_core = "org.jetbrains.kotlinx" d "dataframe-core" w "0.13.1" w "0.14.0-dev-3080"
      val dataframe_excel = "org.jetbrains.kotlinx" d "dataframe-excel" w "0.13.1" w "0.14.0-dev-3080"
    ...
    object Kotlin_Wrappers {
      val bom = "org.jetbrains.kotlin-wrappers" d "kotlin-wrappers-bom" w "1.0.0-pre.746" w "1.0.0-pre.747"
      val kotlin_actions_toolkit = "org.jetbrains.kotlin-wrappers" d "kotlin-actions-toolkit" w "0.0.1-pre.747"
      val kotlin_browser = "org.jetbrains.kotlin-wrappers" d "kotlin-browser" w "1.0.0-pre.746" w "1.0.0-pre.747"
      val kotlin_cesium = "org.jetbrains.kotlin-wrappers" d "kotlin-cesium" w "1.115.0-pre.711"
      val kotlin_css = "org.jetbrains.kotlin-wrappers" d "kotlin-css" w "1.0.0-pre.746" w "1.0.0-pre.747"
      val kotlin_csstype = "org.jetbrains.kotlin-wrappers" d "kotlin-csstype" w "3.1.3-pre.746" w "3.1.3-pre.747"
      val kotlin_emotion = "org.jetbrains.kotlin-wrappers" d "kotlin-emotion" w "11.11.4-pre.746" w "11.11.4-pre.747"
      val kotlin_history = "org.jetbrains.kotlin-wrappers" d "kotlin-history" w "5.3.0-pre.506-compat"
      val kotlin_js = "org.jetbrains.kotlin-wrappers" d "kotlin-js" w "1.0.0-pre.746" w "1.0.0-pre.747"
      ...
      val kotlin_node = "org.jetbrains.kotlin-wrappers" d "kotlin-node" w "20.11.30-pre.746" w "20.11.30-pre.747"
      val kotlin_popper = "org.jetbrains.kotlin-wrappers" d "kotlin-popper" w "2.11.8-pre.746" w "2.11.8-pre.747"
      val kotlin_react = "org.jetbrains.kotlin-wrappers" d "kotlin-react" w "18.3.1-pre.746" w "18.3.1-pre.747"
      val kotlin_react_beautiful_dnd = "org.jetbrains.kotlin-wrappers" d "kotlin-react-beautiful-dnd" w "13.1.1-pre.746" w "13.1.1-pre.747"
      val kotlin_react_core = "org.jetbrains.kotlin-wrappers" d "kotlin-react-core" w "18.3.1-pre.746" w "18.3.1-pre.747"
      val kotlin_react_dom = "org.jetbrains.kotlin-wrappers" d "kotlin-react-dom" w "18.3.1-pre.746" w "18.3.1-pre.747"
      val kotlin_react_dom_legacy = "org.jetbrains.kotlin-wrappers" d "kotlin-react-dom-legacy" w "18.3.1-pre.746" w "18.3.1-pre.747"
      val kotlin_react_dom_test_utils = "org.jetbrains.kotlin-wrappers" d "kotlin-react-dom-test-utils" w "18.3.1-pre.746" w "18.3.1-pre.747"
      val kotlin_react_legacy = "org.jetbrains.kotlin-wrappers" d "kotlin-react-legacy" w "18.3.1-pre.746" w "18.3.1-pre.747"
      val kotlin_react_popper = "org.jetbrains.kotlin-wrappers" d "kotlin-react-popper" w "2.3.0-pre.746" w "2.3.0-pre.747"
      val kotlin_react_redux = "org.jetbrains.kotlin-wrappers" d "kotlin-react-redux" w "7.2.6-pre.746" w "7.2.6-pre.747"
      val kotlin_react_router = "org.jetbrains.kotlin-wrappers" d "kotlin-react-router" w "6.23.0-pre.746" w "6.23.0-pre.747"
      val kotlin_react_router_dom = "org.jetbrains.kotlin-wrappers" d "kotlin-react-router-dom" w "6.23.0-pre.747"
      val kotlin_react_select = "org.jetbrains.kotlin-wrappers" d "kotlin-react-select" w "5.8.0-pre.746" w "5.8.0-pre.747"
      val kotlin_react_use = "org.jetbrains.kotlin-wrappers" d "kotlin-react-use" w "17.4.0-pre.746" w "17.4.0-pre.747"
      val kotlin_redux = "org.jetbrains.kotlin-wrappers" d "kotlin-redux" w "4.1.2-pre.746" w "4.1.2-pre.747"
      val kotlin_remix_run_router = "org.jetbrains.kotlin-wrappers" d "kotlin-remix-run-router" w "1.16.0-pre.746" w "1.16.0-pre.747"
      val kotlin_ring_ui = "org.jetbrains.kotlin-wrappers" d "kotlin-ring-ui" w "4.1.5-pre.746" w "4.1.5-pre.747"
      val kotlin_styled = "org.jetbrains.kotlin-wrappers" d "kotlin-styled" w "5.3.11-pre.717"
      val kotlin_styled_next = "org.jetbrains.kotlin-wrappers" d "kotlin-styled-next" w "1.2.4-pre.746" w "1.2.4-pre.747"
      val kotlin_tanstack_query_core = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-query-core" w "5.28.6-pre.746" w "5.28.6-pre.747"
      val kotlin_tanstack_react_query = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-react-query" w "5.28.6-pre.746" w "5.28.6-pre.747"
      val kotlin_tanstack_react_query_devtools = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-react-query-devtools" w "5.28.6-pre.746" w "5.28.6-pre.747"
      val kotlin_tanstack_react_table = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-react-table" w "8.16.0-pre.746" w "8.17.0-pre.747"
      val kotlin_tanstack_react_virtual = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-react-virtual" w "3.5.0-pre.746" w "3.5.0-pre.747"
      val kotlin_tanstack_table_core = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-table-core" w "8.16.0-pre.746" w "8.16.0-pre.747"
      val kotlin_tanstack_virtual_core = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-virtual-core" w "3.5.0-pre.746" w "3.5.0-pre.747"
      val kotlin_typescript = "org.jetbrains.kotlin-wrappers" d "kotlin-typescript" w "5.4.5-pre.746" w "5.4.5-pre.747"
...
object Pl {
  object MarekLangiewicz {
    ...
    val kommandjupyter = "pl.mareklangiewicz" d "kommandjupyter" w "0.0.59"
    val kommandjupyter_jvm = "pl.mareklangiewicz" d "kommandjupyter-jvm" w "0.0.59"
    val kommandline = "pl.mareklangiewicz" d "kommandline" w "0.0.59"
    val kommandline_js = "pl.mareklangiewicz" d "kommandline-js" w "0.0.59"
    val kommandline_jvm = "pl.mareklangiewicz" d "kommandline-jvm" w "0.0.59"
    val kommandsamples = "pl.mareklangiewicz" d "kommandsamples" w "0.0.59"
    val kommandsamples_js = "pl.mareklangiewicz" d "kommandsamples-js" w "0.0.59"
    val kommandsamples_jvm = "pl.mareklangiewicz" d "kommandsamples-jvm" w "0.0.59"
