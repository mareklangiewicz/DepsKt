...
object AndroidX {
  ...
  object Media3 {
    val cast = "androidx.media3" d "media3-cast" w "1.5.0"
    val common = "androidx.media3" d "media3-common" w "1.5.0"
    val database = "androidx.media3" d "media3-database" w "1.5.0"
    val datasource = "androidx.media3" d "media3-datasource" w "1.5.0"
    val datasource_cronet = "androidx.media3" d "media3-datasource-cronet" w "1.5.0"
    val datasource_okhttp = "androidx.media3" d "media3-datasource-okhttp" w "1.5.0"
    val datasource_rtmp = "androidx.media3" d "media3-datasource-rtmp" w "1.5.0"
    val decoder = "androidx.media3" d "media3-decoder" w "1.5.0"
    val exoplayer = "androidx.media3" d "media3-exoplayer" w "1.5.0"
    val exoplayer_dash = "androidx.media3" d "media3-exoplayer-dash" w "1.5.0"
    val exoplayer_hls = "androidx.media3" d "media3-exoplayer-hls" w "1.5.0"
    val exoplayer_ima = "androidx.media3" d "media3-exoplayer-ima" w "1.5.0"
    val exoplayer_rtsp = "androidx.media3" d "media3-exoplayer-rtsp" w "1.5.0"
    val exoplayer_workmanager = "androidx.media3" d "media3-exoplayer-workmanager" w "1.5.0"
    val extractor = "androidx.media3" d "media3-extractor" w "1.5.0"
    val session = "androidx.media3" d "media3-session" w "1.5.0"
    val test_utils = "androidx.media3" d "media3-test-utils" w "1.5.0"
    val test_utils_robolectric = "androidx.media3" d "media3-test-utils-robolectric" w "1.5.0"
    val transformer = "androidx.media3" d "media3-transformer" w "1.5.0"
    val ui = "androidx.media3" d "media3-ui" w "1.5.0"
    val ui_leanback = "androidx.media3" d "media3-ui-leanback" w "1.5.0"
  }
  object MediaRouter {
...
object Org {
  ...
  object JetBrains {
    ...
    object Kotlin {
      ...
      val script_runtime = "org.jetbrains.kotlin" d "kotlin-script-runtime" w "2.1.0"
      val stdlib = "org.jetbrains.kotlin" d "kotlin-stdlib" w "2.1.0"
      val stdlib_common = "org.jetbrains.kotlin" d "kotlin-stdlib-common" w "2.1.0"
      val stdlib_jdk7 = "org.jetbrains.kotlin" d "kotlin-stdlib-jdk7" w "2.1.0"
      val stdlib_jdk8 = "org.jetbrains.kotlin" d "kotlin-stdlib-jdk8" w "2.1.0"
      val stdlib_js = "org.jetbrains.kotlin" d "kotlin-stdlib-js" w "2.1.0"
      val test = "org.jetbrains.kotlin" d "kotlin-test" w "2.1.0"
      val test_annotations_common = "org.jetbrains.kotlin" d "kotlin-test-annotations-common" w "2.1.0"
      val test_common = "org.jetbrains.kotlin" d "kotlin-test-common" w "2.1.0"
      val test_js = "org.jetbrains.kotlin" d "kotlin-test-js" w "2.1.0"
      val test_js_runner = "org.jetbrains.kotlin" d "kotlin-test-js-runner" w "2.0.21"
      val test_junit = "org.jetbrains.kotlin" d "kotlin-test-junit" w "2.1.0"
      val test_junit5 = "org.jetbrains.kotlin" d "kotlin-test-junit5" w "2.1.0"
      val test_testng = "org.jetbrains.kotlin" d "kotlin-test-testng" w "2.1.0"
    }
    object KotlinX {
    ...
    object Kotlin_Wrappers {
      val bom = "org.jetbrains.kotlin-wrappers" d "kotlin-wrappers-bom" w "1.0.0-pre.853"
      val kotlin_actions_toolkit = "org.jetbrains.kotlin-wrappers" d "kotlin-actions-toolkit" w "1.0.0-pre.853"
      val kotlin_browser = "org.jetbrains.kotlin-wrappers" d "kotlin-browser" w "1.0.0-pre.853"
      val kotlin_cesium = "org.jetbrains.kotlin-wrappers" d "kotlin-cesium" w "1.115.0-pre.711"
      val kotlin_css = "org.jetbrains.kotlin-wrappers" d "kotlin-css" w "1.0.0-pre.853"
      val kotlin_csstype = "org.jetbrains.kotlin-wrappers" d "kotlin-csstype" w "3.1.3-pre.853"
      val kotlin_emotion = "org.jetbrains.kotlin-wrappers" d "kotlin-emotion" w "11.14.0-pre.853"
      val kotlin_history = "org.jetbrains.kotlin-wrappers" d "kotlin-history" w "5.3.0-pre.506-compat"
      val kotlin_js = "org.jetbrains.kotlin-wrappers" d "kotlin-js" w "1.0.0-pre.853"
      ...
      val kotlin_node = "org.jetbrains.kotlin-wrappers" d "kotlin-node" w "22.5.5-pre.853"
      val kotlin_popper = "org.jetbrains.kotlin-wrappers" d "kotlin-popper" w "2.11.8-pre.792"
      val kotlin_react = "org.jetbrains.kotlin-wrappers" d "kotlin-react" w "19.0.0-pre.853"
      val kotlin_react_beautiful_dnd = "org.jetbrains.kotlin-wrappers" d "kotlin-react-beautiful-dnd" w "13.1.1-pre.853"
      val kotlin_react_core = "org.jetbrains.kotlin-wrappers" d "kotlin-react-core" w "19.0.0-pre.853"
      val kotlin_react_dom = "org.jetbrains.kotlin-wrappers" d "kotlin-react-dom" w "19.0.0-pre.853"
      val kotlin_react_dom_legacy = "org.jetbrains.kotlin-wrappers" d "kotlin-react-dom-legacy" w "19.0.0-pre.853"
      val kotlin_react_dom_test_utils = "org.jetbrains.kotlin-wrappers" d "kotlin-react-dom-test-utils" w "19.0.0-pre.853"
      val kotlin_react_legacy = "org.jetbrains.kotlin-wrappers" d "kotlin-react-legacy" w "19.0.0-pre.853"
      val kotlin_react_popper = "org.jetbrains.kotlin-wrappers" d "kotlin-react-popper" w "2.3.0-pre.853"
      val kotlin_react_redux = "org.jetbrains.kotlin-wrappers" d "kotlin-react-redux" w "7.2.6-pre.785"
      val kotlin_react_router = "org.jetbrains.kotlin-wrappers" d "kotlin-react-router" w "6.28.0-pre.853"
      val kotlin_react_router_dom = "org.jetbrains.kotlin-wrappers" d "kotlin-react-router-dom" w "6.28.0-pre.853"
      val kotlin_react_select = "org.jetbrains.kotlin-wrappers" d "kotlin-react-select" w "5.8.3-pre.853"
      val kotlin_react_use = "org.jetbrains.kotlin-wrappers" d "kotlin-react-use" w "17.4.0-pre.853"
      val kotlin_redux = "org.jetbrains.kotlin-wrappers" d "kotlin-redux" w "4.1.2-pre.785"
      val kotlin_remix_run_router = "org.jetbrains.kotlin-wrappers" d "kotlin-remix-run-router" w "1.21.0-pre.853"
      ...
      val kotlin_styled_next = "org.jetbrains.kotlin-wrappers" d "kotlin-styled-next" w "1.2.4-pre.853"
      val kotlin_tanstack_query_core = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-query-core" w "5.62.7-pre.853"
      val kotlin_tanstack_react_query = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-react-query" w "5.62.7-pre.853"
      val kotlin_tanstack_react_query_devtools = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-react-query-devtools" w "5.62.7-pre.853"
      val kotlin_tanstack_react_table = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-react-table" w "8.20.5-pre.853"
      val kotlin_tanstack_react_virtual = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-react-virtual" w "3.11.1-pre.853"
      val kotlin_tanstack_table_core = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-table-core" w "8.20.5-pre.853"
      val kotlin_tanstack_virtual_core = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-virtual-core" w "3.10.9-pre.853"
      val kotlin_typescript = "org.jetbrains.kotlin-wrappers" d "kotlin-typescript" w "5.4.5-pre.853"
      val kotlin_web = "org.jetbrains.kotlin-wrappers" d "kotlin-web" w "1.0.0-pre.853"
    }
  }
  object Kodein {
    object Di {
