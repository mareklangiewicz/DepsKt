...
object Io {
  ...
  object Ktor {
    val client_android = "io.ktor" d "ktor-client-android" w "3.0.2"
    val client_apache = "io.ktor" d "ktor-client-apache" w "3.0.2"
    val client_auth = "io.ktor" d "ktor-client-auth" w "3.0.2"
    val client_cio = "io.ktor" d "ktor-client-cio" w "3.0.2"
    val client_content_negotiation = "io.ktor" d "ktor-client-content-negotiation" w "3.0.2"
    val client_content_negotiation_tests = "io.ktor" d "ktor-client-content-negotiation-tests" w "3.0.2"
    val client_core = "io.ktor" d "ktor-client-core" w "3.0.2"
    val client_curl = "io.ktor" d "ktor-client-curl" w "3.0.2"
    val client_darwin = "io.ktor" d "ktor-client-darwin" w "3.0.2"
    val client_encoding = "io.ktor" d "ktor-client-encoding" w "3.0.2"
    val client_gson = "io.ktor" d "ktor-client-gson" w "3.0.2"
    val client_jackson = "io.ktor" d "ktor-client-jackson" w "3.0.2"
    val client_java = "io.ktor" d "ktor-client-java" w "3.0.2"
    val client_jetty = "io.ktor" d "ktor-client-jetty" w "3.0.2"
    val client_json = "io.ktor" d "ktor-client-json" w "3.0.2"
    val client_json_tests = "io.ktor" d "ktor-client-json-tests" w "2.3.13"
    val client_logging = "io.ktor" d "ktor-client-logging" w "3.0.2"
    val client_mock = "io.ktor" d "ktor-client-mock" w "3.0.2"
    val client_okhttp = "io.ktor" d "ktor-client-okhttp" w "3.0.2"
    val client_resources = "io.ktor" d "ktor-client-resources" w "3.0.2"
    val client_serialization = "io.ktor" d "ktor-client-serialization" w "3.0.2"
    val client_tests = "io.ktor" d "ktor-client-tests" w "3.0.2"
    val events = "io.ktor" d "ktor-events" w "3.0.2"
    val http = "io.ktor" d "ktor-http" w "3.0.2"
    val http_cio = "io.ktor" d "ktor-http-cio" w "3.0.2"
    val io = "io.ktor" d "ktor-io" w "3.0.2"
    val network = "io.ktor" d "ktor-network" w "3.0.2"
    val network_tls = "io.ktor" d "ktor-network-tls" w "3.0.2"
    val network_tls_certificates = "io.ktor" d "ktor-network-tls-certificates" w "3.0.2"
    val resources = "io.ktor" d "ktor-resources" w "3.0.2"
    val serialization = "io.ktor" d "ktor-serialization" w "3.0.2"
    val serialization_gson = "io.ktor" d "ktor-serialization-gson" w "3.0.2"
    val serialization_jackson = "io.ktor" d "ktor-serialization-jackson" w "3.0.2"
    val serialization_kotlinx = "io.ktor" d "ktor-serialization-kotlinx" w "3.0.2"
    val serialization_kotlinx_cbor = "io.ktor" d "ktor-serialization-kotlinx-cbor" w "3.0.2"
    val serialization_kotlinx_json = "io.ktor" d "ktor-serialization-kotlinx-json" w "3.0.2"
    val serialization_kotlinx_tests = "io.ktor" d "ktor-serialization-kotlinx-tests" w "3.0.2"
    val serialization_kotlinx_xml = "io.ktor" d "ktor-serialization-kotlinx-xml" w "3.0.2"
    val server = "io.ktor" d "ktor-server" w "3.0.2"
    val server_auth = "io.ktor" d "ktor-server-auth" w "3.0.2"
    val server_auth_jwt = "io.ktor" d "ktor-server-auth-jwt" w "3.0.2"
    val server_auth_ldap = "io.ktor" d "ktor-server-auth-ldap" w "3.0.2"
    val server_auto_head_response = "io.ktor" d "ktor-server-auto-head-response" w "3.0.2"
    val server_caching_headers = "io.ktor" d "ktor-server-caching-headers" w "3.0.2"
    val server_call_id = "io.ktor" d "ktor-server-call-id" w "3.0.2"
    val server_call_logging = "io.ktor" d "ktor-server-call-logging" w "3.0.2"
    val server_cio = "io.ktor" d "ktor-server-cio" w "3.0.2"
    val server_compression = "io.ktor" d "ktor-server-compression" w "3.0.2"
    val server_conditional_headers = "io.ktor" d "ktor-server-conditional-headers" w "3.0.2"
    val server_content_negotiation = "io.ktor" d "ktor-server-content-negotiation" w "3.0.2"
    val server_core = "io.ktor" d "ktor-server-core" w "3.0.2"
    val server_cors = "io.ktor" d "ktor-server-cors" w "3.0.2"
    val server_data_conversion = "io.ktor" d "ktor-server-data-conversion" w "3.0.2"
    val server_default_headers = "io.ktor" d "ktor-server-default-headers" w "3.0.2"
    val server_double_receive = "io.ktor" d "ktor-server-double-receive" w "3.0.2"
    val server_forwarded_header = "io.ktor" d "ktor-server-forwarded-header" w "3.0.2"
    val server_freemarker = "io.ktor" d "ktor-server-freemarker" w "3.0.2"
    val server_host_common = "io.ktor" d "ktor-server-host-common" w "3.0.2"
    val server_hsts = "io.ktor" d "ktor-server-hsts" w "3.0.2"
    val server_html_builder = "io.ktor" d "ktor-server-html-builder" w "3.0.2"
    val server_http_redirect = "io.ktor" d "ktor-server-http-redirect" w "3.0.2"
    val server_jetty = "io.ktor" d "ktor-server-jetty" w "3.0.2"
    val server_jte = "io.ktor" d "ktor-server-jte" w "3.0.2"
    val server_locations = "io.ktor" d "ktor-server-locations" w "2.3.13"
    val server_method_override = "io.ktor" d "ktor-server-method-override" w "3.0.2"
    val server_metrics = "io.ktor" d "ktor-server-metrics" w "3.0.2"
    val server_metrics_micrometer = "io.ktor" d "ktor-server-metrics-micrometer" w "3.0.2"
    val server_mustache = "io.ktor" d "ktor-server-mustache" w "3.0.2"
    val server_netty = "io.ktor" d "ktor-server-netty" w "3.0.2"
    val server_partial_content = "io.ktor" d "ktor-server-partial-content" w "3.0.2"
    val server_pebble = "io.ktor" d "ktor-server-pebble" w "3.0.2"
    val server_resources = "io.ktor" d "ktor-server-resources" w "3.0.2"
    val server_servlet = "io.ktor" d "ktor-server-servlet" w "3.0.2"
    val server_sessions = "io.ktor" d "ktor-server-sessions" w "3.0.2"
    val server_status_pages = "io.ktor" d "ktor-server-status-pages" w "3.0.2"
    val server_test_host = "io.ktor" d "ktor-server-test-host" w "3.0.2"
    val server_test_suites = "io.ktor" d "ktor-server-test-suites" w "2.3.13" w "3.0.0-beta-2"
    val server_thymeleaf = "io.ktor" d "ktor-server-thymeleaf" w "3.0.2"
    val server_tomcat = "io.ktor" d "ktor-server-tomcat" w "3.0.2"
    val server_velocity = "io.ktor" d "ktor-server-velocity" w "3.0.2"
    val server_webjars = "io.ktor" d "ktor-server-webjars" w "3.0.2"
    val server_websockets = "io.ktor" d "ktor-server-websockets" w "3.0.2"
    val test_dispatcher = "io.ktor" d "ktor-test-dispatcher" w "3.0.2"
    val utils = "io.ktor" d "ktor-utils" w "3.0.2"
    val websocket_serialization = "io.ktor" d "ktor-websocket-serialization" w "3.0.2"
    val websockets = "io.ktor" d "ktor-websockets" w "3.0.2"
  }
  object MockK {
