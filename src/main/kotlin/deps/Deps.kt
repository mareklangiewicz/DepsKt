...
object AndroidX {
    ...
    object Benchmark {
        val common = Dep("androidx.benchmark", "benchmark-common", Ver("1.1.0-alpha03", 300), Ver("1.2.3", 0))
        val gradle_plugin = Dep("androidx.benchmark", "benchmark-gradle-plugin", Ver("1.2.3", 0))
        val junit4 = Dep("androidx.benchmark", "benchmark-junit4", Ver("1.1.0-alpha03", 300), Ver("1.2.3", 0))
        val macro = Dep("androidx.benchmark", "benchmark-macro", Ver("1.1.0-alpha03", 300), Ver("1.2.3", 0))
        val macro_junit4 = Dep("androidx.benchmark", "benchmark-macro-junit4", Ver("1.1.0-alpha03", 300), Ver("1.2.3", 0))
    }
    object Biometric {
    ...
    object Browser {
        val browser = Dep("androidx.browser", "browser", Ver("1.7.0", 0), Ver("1.8.0-beta02", 200))
    }
    object Camera {
    ...
    object Compose {
        val bom = Dep("androidx.compose", "compose-bom", Ver("2024.02.00", 0))
        object Animation {
            val animation = Dep("androidx.compose.animation", "animation", Ver("1.0.0-beta06", 200), Ver("1.6.1", 0), Ver("1.7.0-alpha02", 300))
            val core = Dep("androidx.compose.animation", "animation-core", Ver("1.0.0-beta06", 200), Ver("1.6.1", 0), Ver("1.7.0-alpha02", 300))
            val graphics = Dep("androidx.compose.animation", "animation-graphics", Ver("1.6.1", 0), Ver("1.7.0-alpha02", 300))
        }
        object Compiler {
            val compiler = Dep("androidx.compose.compiler", "compiler", Ver("1.0.0-beta06", 200), Ver("1.5.9", 0))
        }
        object Foundation {
            val foundation = Dep("androidx.compose.foundation", "foundation", Ver("1.0.0-beta06", 200), Ver("1.6.1", 0), Ver("1.7.0-alpha02", 300))
            val layout = Dep("androidx.compose.foundation", "foundation-layout", Ver("1.0.0-beta06", 200), Ver("1.6.1", 0), Ver("1.7.0-alpha02", 300))
        }
        object Material {
            val icons_core = Dep("androidx.compose.material", "material-icons-core", Ver("1.0.0-beta06", 200), Ver("1.6.1", 0), Ver("1.7.0-alpha02", 300))
            val icons_extended = Dep("androidx.compose.material", "material-icons-extended", Ver("1.0.0-beta06", 200), Ver("1.6.1", 0), Ver("1.7.0-alpha02", 300))
            val material = Dep("androidx.compose.material", "material", Ver("1.0.0-beta06", 200), Ver("1.6.1", 0), Ver("1.7.0-alpha02", 300))
            val ripple = Dep("androidx.compose.material", "material-ripple", Ver("1.0.0-beta06", 200), Ver("1.6.1", 0), Ver("1.7.0-alpha02", 300))
        }
        object Material3 {
            val material3 = Dep("androidx.compose.material3", "material3", Ver("1.2.0", 0))
            val window_size_class = Dep("androidx.compose.material3", "material3-window-size-class", Ver("1.2.0", 0))
        }
        object Runtime {
            val dispatch = Dep("androidx.compose.runtime", "runtime-dispatch", Ver("1.0.0-alpha12", 300))
            val livedata = Dep("androidx.compose.runtime", "runtime-livedata", Ver("1.6.1", 0), Ver("1.7.0-alpha02", 300))
            val runtime = Dep("androidx.compose.runtime", "runtime", Ver("1.0.0-beta06", 200), Ver("1.6.1", 0), Ver("1.7.0-alpha02", 300))
            val rxjava2 = Dep("androidx.compose.runtime", "runtime-rxjava2", Ver("1.6.1", 0), Ver("1.7.0-alpha02", 300))
            val rxjava3 = Dep("androidx.compose.runtime", "runtime-rxjava3", Ver("1.6.1", 0), Ver("1.7.0-alpha02", 300))
            val saveable = Dep("androidx.compose.runtime", "runtime-saveable", Ver("1.0.0-beta06", 200), Ver("1.6.1", 0), Ver("1.7.0-alpha02", 300))
            val tracing = Dep("androidx.compose.runtime", "runtime-tracing", Ver("1.0.0-beta01", 200))
        }
        object Ui {
            val geometry = Dep("androidx.compose.ui", "ui-geometry", Ver("1.0.0-beta06", 200), Ver("1.6.1", 0), Ver("1.7.0-alpha02", 300))
            val graphics = Dep("androidx.compose.ui", "ui-graphics", Ver("1.0.0-beta06", 200), Ver("1.6.1", 0), Ver("1.7.0-alpha02", 300))
            val test = Dep("androidx.compose.ui", "ui-test", Ver("1.0.0-beta06", 200), Ver("1.6.1", 0), Ver("1.7.0-alpha02", 300))
            val test_junit4 = Dep("androidx.compose.ui", "ui-test-junit4", Ver("1.0.0-beta06", 200), Ver("1.6.1", 0), Ver("1.7.0-alpha02", 300))
            val test_manifest = Dep("androidx.compose.ui", "ui-test-manifest", Ver("1.6.1", 0), Ver("1.7.0-alpha02", 300))
            val text = Dep("androidx.compose.ui", "ui-text", Ver("1.0.0-beta06", 200), Ver("1.6.1", 0), Ver("1.7.0-alpha02", 300))
            val text_google_fonts = Dep("androidx.compose.ui", "ui-text-google-fonts", Ver("1.6.1", 0), Ver("1.7.0-alpha02", 300))
            val tooling = Dep("androidx.compose.ui", "ui-tooling", Ver("1.6.1", 0), Ver("1.7.0-alpha02", 300))
            val tooling_data = Dep("androidx.compose.ui", "ui-tooling-data", Ver("1.6.1", 0), Ver("1.7.0-alpha02", 300))
            val tooling_preview = Dep("androidx.compose.ui", "ui-tooling-preview", Ver("1.6.1", 0), Ver("1.7.0-alpha02", 300))
            val ui = Dep("androidx.compose.ui", "ui", Ver("1.0.0-beta06", 200), Ver("1.6.1", 0), Ver("1.7.0-alpha02", 300))
            val unit = Dep("androidx.compose.ui", "ui-unit", Ver("1.0.0-beta06", 200), Ver("1.6.1", 0), Ver("1.7.0-alpha02", 300))
            val util = Dep("androidx.compose.ui", "ui-util", Ver("1.0.0-beta06", 200), Ver("1.6.1", 0), Ver("1.7.0-alpha02", 300))
            val viewbinding = Dep("androidx.compose.ui", "ui-viewbinding", Ver("1.6.1", 0), Ver("1.7.0-alpha02", 300))
        }
    }
    object Concurrent {
    ...
    object Hilt {
        val compiler = Dep("androidx.hilt", "hilt-compiler", Ver("1.1.0", 0), Ver("1.2.0-rc01", 100))
        val navigation_compose = Dep("androidx.hilt", "hilt-navigation-compose", Ver("1.0.0-alpha03", 300), Ver("1.1.0", 0), Ver("1.2.0-rc01", 100))
        val navigation_fragment = Dep("androidx.hilt", "hilt-navigation-fragment", Ver("1.1.0", 0), Ver("1.2.0-rc01", 100))
        val work = Dep("androidx.hilt", "hilt-work", Ver("1.1.0", 0), Ver("1.2.0-rc01", 100))
    }
    object Input {
    ...
    object Lifecycle {
        val common = Dep("androidx.lifecycle", "lifecycle-common", Ver("2.7.0", 0), Ver("2.8.0-alpha01", 300))
        val common_java8 = Dep("androidx.lifecycle", "lifecycle-common-java8", Ver("2.7.0", 0), Ver("2.8.0-alpha01", 300))
        val compiler = Dep("androidx.lifecycle", "lifecycle-compiler", Ver("2.7.0", 0), Ver("2.8.0-alpha01", 300))
        val extensions = Dep("androidx.lifecycle", "lifecycle-extensions", Ver("2.2.0", 0))
        val livedata = Dep("androidx.lifecycle", "lifecycle-livedata", Ver("2.7.0", 0), Ver("2.8.0-alpha01", 300))
        val livedata_ktx = Dep("androidx.lifecycle", "lifecycle-livedata-ktx", Ver("2.7.0", 0), Ver("2.8.0-alpha01", 300))
        val process = Dep("androidx.lifecycle", "lifecycle-process", Ver("2.7.0", 0), Ver("2.8.0-alpha01", 300))
        val reactivestreams = Dep("androidx.lifecycle", "lifecycle-reactivestreams", Ver("2.7.0", 0), Ver("2.8.0-alpha01", 300))
        val reactivestreams_ktx = Dep("androidx.lifecycle", "lifecycle-reactivestreams-ktx", Ver("2.7.0", 0), Ver("2.8.0-alpha01", 300))
        val runtime = Dep("androidx.lifecycle", "lifecycle-runtime", Ver("2.7.0", 0), Ver("2.8.0-alpha01", 300))
        val runtime_compose = Dep("androidx.lifecycle", "lifecycle-runtime-compose", Ver("2.7.0", 0), Ver("2.8.0-alpha01", 300))
        val runtime_ktx = Dep("androidx.lifecycle", "lifecycle-runtime-ktx", Ver("2.7.0", 0), Ver("2.8.0-alpha01", 300))
        val runtime_testing = Dep("androidx.lifecycle", "lifecycle-runtime-testing", Ver("2.7.0", 0), Ver("2.8.0-alpha01", 300))
        val service = Dep("androidx.lifecycle", "lifecycle-service", Ver("2.7.0", 0), Ver("2.8.0-alpha01", 300))
        val viewmodel = Dep("androidx.lifecycle", "lifecycle-viewmodel", Ver("2.7.0", 0), Ver("2.8.0-alpha01", 300))
        val viewmodel_compose = Dep("androidx.lifecycle", "lifecycle-viewmodel-compose", Ver("1.0.0-alpha06", 300), Ver("2.7.0", 0), Ver("2.8.0-alpha01", 300))
        val viewmodel_ktx = Dep("androidx.lifecycle", "lifecycle-viewmodel-ktx", Ver("2.7.0", 0), Ver("2.8.0-alpha01", 300))
        val viewmodel_savedstate = Dep("androidx.lifecycle", "lifecycle-viewmodel-savedstate", Ver("2.7.0", 0), Ver("2.8.0-alpha01", 300))
    }
    object Loader {
    ...
    object Media3 {
        val cast = Dep("androidx.media3", "media3-cast", Ver("1.2.1", 0), Ver("1.3.0-beta01", 200))
        val common = Dep("androidx.media3", "media3-common", Ver("1.2.1", 0), Ver("1.3.0-beta01", 200))
        val database = Dep("androidx.media3", "media3-database", Ver("1.2.1", 0), Ver("1.3.0-beta01", 200))
        val datasource = Dep("androidx.media3", "media3-datasource", Ver("1.2.1", 0), Ver("1.3.0-beta01", 200))
        val datasource_cronet = Dep("androidx.media3", "media3-datasource-cronet", Ver("1.2.1", 0), Ver("1.3.0-beta01", 200))
        val datasource_okhttp = Dep("androidx.media3", "media3-datasource-okhttp", Ver("1.2.1", 0), Ver("1.3.0-beta01", 200))
        val datasource_rtmp = Dep("androidx.media3", "media3-datasource-rtmp", Ver("1.2.1", 0), Ver("1.3.0-beta01", 200))
        val decoder = Dep("androidx.media3", "media3-decoder", Ver("1.2.1", 0), Ver("1.3.0-beta01", 200))
        val exoplayer = Dep("androidx.media3", "media3-exoplayer", Ver("1.2.1", 0), Ver("1.3.0-beta01", 200))
        val exoplayer_dash = Dep("androidx.media3", "media3-exoplayer-dash", Ver("1.2.1", 0), Ver("1.3.0-beta01", 200))
        val exoplayer_hls = Dep("androidx.media3", "media3-exoplayer-hls", Ver("1.2.1", 0), Ver("1.3.0-beta01", 200))
        val exoplayer_ima = Dep("androidx.media3", "media3-exoplayer-ima", Ver("1.2.1", 0), Ver("1.3.0-beta01", 200))
        val exoplayer_rtsp = Dep("androidx.media3", "media3-exoplayer-rtsp", Ver("1.2.1", 0), Ver("1.3.0-beta01", 200))
        val exoplayer_workmanager = Dep("androidx.media3", "media3-exoplayer-workmanager", Ver("1.2.1", 0), Ver("1.3.0-beta01", 200))
        val extractor = Dep("androidx.media3", "media3-extractor", Ver("1.2.1", 0), Ver("1.3.0-beta01", 200))
        val session = Dep("androidx.media3", "media3-session", Ver("1.2.1", 0), Ver("1.3.0-beta01", 200))
        val test_utils = Dep("androidx.media3", "media3-test-utils", Ver("1.2.1", 0), Ver("1.3.0-beta01", 200))
        val test_utils_robolectric = Dep("androidx.media3", "media3-test-utils-robolectric", Ver("1.2.1", 0), Ver("1.3.0-beta01", 200))
        val transformer = Dep("androidx.media3", "media3-transformer", Ver("1.2.1", 0), Ver("1.3.0-beta01", 200))
        val ui = Dep("androidx.media3", "media3-ui", Ver("1.2.1", 0), Ver("1.3.0-beta01", 200))
        val ui_leanback = Dep("androidx.media3", "media3-ui-leanback", Ver("1.2.1", 0), Ver("1.3.0-beta01", 200))
    }
    object MediaRouter {
        val mediarouter = Dep("androidx.mediarouter", "mediarouter", Ver("1.6.0", 0), Ver("1.7.0-alpha02", 300))
    }
    object Metrics {
    ...
    object Navigation {
        val common = Dep("androidx.navigation", "navigation-common", Ver("2.4.0-alpha02", 300), Ver("2.7.7", 0), Ver("2.8.0-alpha02", 300))
        val common_ktx = Dep("androidx.navigation", "navigation-common-ktx", Ver("2.4.0-alpha02", 300), Ver("2.7.7", 0), Ver("2.8.0-alpha02", 300))
        val compose = Dep("androidx.navigation", "navigation-compose", Ver("2.4.0-alpha02", 300), Ver("2.7.7", 0), Ver("2.8.0-alpha02", 300))
        val dynamic_features_fragment = Dep("androidx.navigation", "navigation-dynamic-features-fragment", Ver("2.7.7", 0), Ver("2.8.0-alpha02", 300))
        val fragment = Dep("androidx.navigation", "navigation-fragment", Ver("2.7.7", 0), Ver("2.8.0-alpha02", 300))
        val fragment_ktx = Dep("androidx.navigation", "navigation-fragment-ktx", Ver("2.7.7", 0), Ver("2.8.0-alpha02", 300))
        val runtime = Dep("androidx.navigation", "navigation-runtime", Ver("2.4.0-alpha02", 300), Ver("2.7.7", 0), Ver("2.8.0-alpha02", 300))
        val runtime_ktx = Dep("androidx.navigation", "navigation-runtime-ktx", Ver("2.4.0-alpha02", 300), Ver("2.7.7", 0), Ver("2.8.0-alpha02", 300))
        val safe_args_generator = Dep("androidx.navigation", "navigation-safe-args-generator", Ver("2.7.7", 0), Ver("2.8.0-alpha02", 300))
        val safe_args_gradle_plugin = Dep("androidx.navigation", "navigation-safe-args-gradle-plugin", Ver("2.7.7", 0), Ver("2.8.0-alpha02", 300))
        val testing = Dep("androidx.navigation", "navigation-testing", Ver("2.4.0-alpha02", 300), Ver("2.7.7", 0), Ver("2.8.0-alpha02", 300))
        val ui = Dep("androidx.navigation", "navigation-ui", Ver("2.7.7", 0), Ver("2.8.0-alpha02", 300))
        val ui_ktx = Dep("androidx.navigation", "navigation-ui-ktx", Ver("2.7.7", 0), Ver("2.8.0-alpha02", 300))
    }
    object Paging {
    ...
    object Test {
        ...
        object UiAutoMator {
            val uiautomator = Dep("androidx.test.uiautomator", "uiautomator", Ver("2.2.0", 0), Ver("2.3.0-rc01", 100))
        }
    }
    ...
    object Wear {
        ...
        object Compose {
            val foundation = Dep("androidx.wear.compose", "compose-foundation", Ver("1.0.0-alpha01", 300), Ver("1.3.0", 0), Ver("1.4.0-alpha02", 300))
            val material = Dep("androidx.wear.compose", "compose-material", Ver("1.0.0-alpha01", 300), Ver("1.3.0", 0), Ver("1.4.0-alpha02", 300))
            val navigation = Dep("androidx.wear.compose", "compose-navigation", Ver("1.3.0", 0), Ver("1.4.0-alpha02", 300))
        }
        object Tiles {
    ...
    object WebKit {
        val webkit = Dep("androidx.webkit", "webkit", Ver("1.10.0", 0), Ver("1.11.0-alpha01", 300))
    }
    object Window {
...
object Com {
    ...
    object Google {
        ...
        object Firebase {
            ...
            val appdistribution_gradle = Dep("com.google.firebase", "firebase-appdistribution-gradle", Ver("4.1.0", 0))
            ...
            val bom = Dep("com.google.firebase", "firebase-bom", Ver("32.7.2", 0))
            val config = Dep("com.google.firebase", "firebase-config", Ver("21.6.1", 0))
            val config_ktx = Dep("com.google.firebase", "firebase-config-ktx", Ver("21.6.1", 0))
            ...
            val firestore = Dep("com.google.firebase", "firebase-firestore", Ver("24.10.2", 0))
            val firestore_ktx = Dep("com.google.firebase", "firebase-firestore-ktx", Ver("24.10.2", 0))
        ...
        object Maps {
            object Android {
                val maps_compose = Dep("com.google.maps.android", "maps-compose", Ver("4.3.2", 0))
    ...
    object Rickclephas {
        object Kmp {
            val nativecoroutines_annotations = Dep("com.rickclephas.kmp", "kmp-nativecoroutines-annotations", Ver("0.13.3", 0), Ver("1.0.0-ALPHA-24-kotlin-2.0.0-Beta3", 300))
            val nativecoroutines_compiler = Dep("com.rickclephas.kmp", "kmp-nativecoroutines-compiler", Ver("0.13.3", 0), Ver("1.0.0-ALPHA-24-kotlin-2.0.0-Beta3", 300))
            val nativecoroutines_compiler_embeddable = Dep("com.rickclephas.kmp", "kmp-nativecoroutines-compiler-embeddable", Ver("0.13.3", 0), Ver("1.0.0-ALPHA-24-kotlin-2.0.0-Beta3", 300))
            val nativecoroutines_core = Dep("com.rickclephas.kmp", "kmp-nativecoroutines-core", Ver("0.13.3", 0), Ver("1.0.0-ALPHA-24-kotlin-2.0.0-Beta3", 300))
            val nativecoroutines_gradle_plugin = Dep("com.rickclephas.kmp", "kmp-nativecoroutines-gradle-plugin", Ver("0.13.3", 0), Ver("1.0.0-ALPHA-24-kotlin-2.0.0-Beta3", 300))
        }
    }
    object Russhwolf {
...
object Io {
    ...
    object GitHub {
        ...
        object TypeSafeGitHub {
            val github_workflows_kt = Dep("io.github.typesafegithub", "github-workflows-kt", Ver("1.11.0", 0))
        }
    }
    object Insert_koin {
...
object Org {
    ...
    object Http4k {
        ...
        val client_apache_async = Dep("org.http4k", "http4k-client-apache-async", Ver("5.13.7.0", 0))
        val client_jetty = Dep("org.http4k", "http4k-client-jetty", Ver("5.13.7.0", 0))
        val client_okhttp = Dep("org.http4k", "http4k-client-okhttp", Ver("5.13.7.0", 0))
        val client_websocket = Dep("org.http4k", "http4k-client-websocket", Ver("5.13.7.0", 0))
        val cloudnative = Dep("org.http4k", "http4k-cloudnative", Ver("5.13.7.0", 0))
        val contract = Dep("org.http4k", "http4k-contract", Ver("5.13.7.0", 0))
        val core = Dep("org.http4k", "http4k-core", Ver("5.13.7.0", 0))
        val format_argo = Dep("org.http4k", "http4k-format-argo", Ver("5.13.7.0", 0))
        val format_core = Dep("org.http4k", "http4k-format-core", Ver("5.13.7.0", 0))
        val format_gson = Dep("org.http4k", "http4k-format-gson", Ver("5.13.7.0", 0))
        val format_jackson = Dep("org.http4k", "http4k-format-jackson", Ver("5.13.7.0", 0))
        val format_jackson_xml = Dep("org.http4k", "http4k-format-jackson-xml", Ver("5.13.7.0", 0))
        val format_jackson_yaml = Dep("org.http4k", "http4k-format-jackson-yaml", Ver("5.13.7.0", 0))
        val format_klaxon = Dep("org.http4k", "http4k-format-klaxon", Ver("5.13.7.0", 0))
        val format_kotlinx_serialization = Dep("org.http4k", "http4k-format-kotlinx-serialization", Ver("5.13.7.0", 0))
        val format_moshi = Dep("org.http4k", "http4k-format-moshi", Ver("5.13.7.0", 0))
        val format_xml = Dep("org.http4k", "http4k-format-xml", Ver("5.13.7.0", 0))
        val graphql = Dep("org.http4k", "http4k-graphql", Ver("5.13.7.0", 0))
        val incubator = Dep("org.http4k", "http4k-incubator", Ver("5.13.7.0", 0))
        val jsonrpc = Dep("org.http4k", "http4k-jsonrpc", Ver("5.13.7.0", 0))
        val metrics_micrometer = Dep("org.http4k", "http4k-metrics-micrometer", Ver("5.13.7.0", 0))
        val multipart = Dep("org.http4k", "http4k-multipart", Ver("5.13.7.0", 0))
        val opentelemetry = Dep("org.http4k", "http4k-opentelemetry", Ver("5.13.7.0", 0))
        val realtime_core = Dep("org.http4k", "http4k-realtime-core", Ver("5.13.7.0", 0))
        val resilience4j = Dep("org.http4k", "http4k-resilience4j", Ver("5.13.7.0", 0))
        val security_oauth = Dep("org.http4k", "http4k-security-oauth", Ver("5.13.7.0", 0))
        val server_apache = Dep("org.http4k", "http4k-server-apache", Ver("5.13.7.0", 0))
        val server_apache4 = Dep("org.http4k", "http4k-server-apache4", Ver("5.13.7.0", 0))
        val server_jetty = Dep("org.http4k", "http4k-server-jetty", Ver("5.13.7.0", 0))
        val server_ktorcio = Dep("org.http4k", "http4k-server-ktorcio", Ver("5.13.7.0", 0))
        val server_ktornetty = Dep("org.http4k", "http4k-server-ktornetty", Ver("5.13.7.0", 0))
        val server_netty = Dep("org.http4k", "http4k-server-netty", Ver("5.13.7.0", 0))
        val server_ratpack = Dep("org.http4k", "http4k-server-ratpack", Ver("5.13.7.0", 0))
        val server_undertow = Dep("org.http4k", "http4k-server-undertow", Ver("5.13.7.0", 0))
        val serverless_alibaba = Dep("org.http4k", "http4k-serverless-alibaba", Ver("5.13.7.0", 0))
        val serverless_azure = Dep("org.http4k", "http4k-serverless-azure", Ver("5.13.7.0", 0))
        val serverless_gcf = Dep("org.http4k", "http4k-serverless-gcf", Ver("5.13.7.0", 0))
        val serverless_lambda = Dep("org.http4k", "http4k-serverless-lambda", Ver("5.13.7.0", 0))
        val serverless_lambda_runtime = Dep("org.http4k", "http4k-serverless-lambda-runtime", Ver("5.13.7.0", 0))
        val serverless_openwhisk = Dep("org.http4k", "http4k-serverless-openwhisk", Ver("5.13.7.0", 0))
        val serverless_tencent = Dep("org.http4k", "http4k-serverless-tencent", Ver("5.13.7.0", 0))
        val template_core = Dep("org.http4k", "http4k-template-core", Ver("5.13.7.0", 0))
        val template_dust = Dep("org.http4k", "http4k-template-dust", Ver("4.48.0.0", 0))
        val template_freemarker = Dep("org.http4k", "http4k-template-freemarker", Ver("5.13.7.0", 0))
        val template_handlebars = Dep("org.http4k", "http4k-template-handlebars", Ver("5.13.7.0", 0))
        val template_jade4j = Dep("org.http4k", "http4k-template-jade4j", Ver("5.12.2.1", 0))
        val template_pebble = Dep("org.http4k", "http4k-template-pebble", Ver("5.13.7.0", 0))
        val template_thymeleaf = Dep("org.http4k", "http4k-template-thymeleaf", Ver("5.13.7.0", 0))
        val testing_approval = Dep("org.http4k", "http4k-testing-approval", Ver("5.13.7.0", 0))
        val testing_chaos = Dep("org.http4k", "http4k-testing-chaos", Ver("5.13.7.0", 0))
        val testing_hamkrest = Dep("org.http4k", "http4k-testing-hamkrest", Ver("5.13.7.0", 0))
        val testing_kotest = Dep("org.http4k", "http4k-testing-kotest", Ver("5.13.7.0", 0))
        val testing_servirtium = Dep("org.http4k", "http4k-testing-servirtium", Ver("5.13.7.0", 0))
        val testing_strikt = Dep("org.http4k", "http4k-testing-strikt", Ver("5.13.7.0", 0))
        val testing_webdriver = Dep("org.http4k", "http4k-testing-webdriver", Ver("5.13.7.0", 0))
    }
    object JUnit {
    ...
    object JetBrains {
        ...
        object Exposed {
            val core = Dep("org.jetbrains.exposed", "exposed-core", Ver("0.47.0", 0))
            val dao = Dep("org.jetbrains.exposed", "exposed-dao", Ver("0.47.0", 0))
            val jdbc = Dep("org.jetbrains.exposed", "exposed-jdbc", Ver("0.47.0", 0))
        }
        object Kotlin {
        ...
        object KotlinX {
            ...
            val dataframe_excel = Dep("org.jetbrains.kotlinx", "dataframe-excel", Ver("0.12.1", 0), Ver("0.13.0-dev-2820", 320))
            ...
            val lincheck = Dep("org.jetbrains.kotlinx", "lincheck", Ver("2.25", 0))
            val lincheck_jvm = Dep("org.jetbrains.kotlinx", "lincheck-jvm", Ver("2.25", 0))
        ...
        object Kotlin_Wrappers {
            ...
            val kotlin_actions_toolkit = Dep("org.jetbrains.kotlin-wrappers", "kotlin-actions-toolkit", Ver("0.0.1-pre.697", 0), Ver("0.0.1-pre.698", 0))
            val kotlin_browser = Dep("org.jetbrains.kotlin-wrappers", "kotlin-browser", Ver("1.0.0-pre.697", 0), Ver("1.0.0-pre.698", 0))
            val kotlin_cesium = Dep("org.jetbrains.kotlin-wrappers", "kotlin-cesium", Ver("1.114.0-pre.697", 0), Ver("1.114.0-pre.698", 0))
            val kotlin_css = Dep("org.jetbrains.kotlin-wrappers", "kotlin-css", Ver("1.0.0-pre.697", 0), Ver("1.0.0-pre.698", 0))
            val kotlin_csstype = Dep("org.jetbrains.kotlin-wrappers", "kotlin-csstype", Ver("3.1.3-pre.697", 0), Ver("3.1.3-pre.698", 0))
            val kotlin_emotion = Dep("org.jetbrains.kotlin-wrappers", "kotlin-emotion", Ver("11.11.1-pre.697", 0), Ver("11.11.1-pre.698", 0))
            val kotlin_history = Dep("org.jetbrains.kotlin-wrappers", "kotlin-history", Ver("5.3.0-pre.506-compat", 0))
            val kotlin_js = Dep("org.jetbrains.kotlin-wrappers", "kotlin-js", Ver("1.0.0-pre.697", 0), Ver("1.0.0-pre.698", 0))
            ...
            val kotlin_node = Dep("org.jetbrains.kotlin-wrappers", "kotlin-node", Ver("20.11.5-pre.697", 0), Ver("20.11.5-pre.698", 0))
            val kotlin_popper = Dep("org.jetbrains.kotlin-wrappers", "kotlin-popper", Ver("2.11.8-pre.697", 0), Ver("2.11.8-pre.698", 0))
            val kotlin_react = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react", Ver("18.2.0-pre.697", 0), Ver("18.2.0-pre.698", 0))
            val kotlin_react_beautiful_dnd = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-beautiful-dnd", Ver("13.1.1-pre.697", 0), Ver("13.1.1-pre.698", 0))
            val kotlin_react_core = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-core", Ver("18.2.0-pre.698", 0))
            val kotlin_react_dom = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-dom", Ver("18.2.0-pre.697", 0), Ver("18.2.0-pre.698", 0))
            val kotlin_react_dom_legacy = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-dom-legacy", Ver("18.2.0-pre.697", 0), Ver("18.2.0-pre.698", 0))
            val kotlin_react_dom_test_utils = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-dom-test-utils", Ver("18.2.0-pre.697", 0), Ver("18.2.0-pre.698", 0))
            val kotlin_react_legacy = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-legacy", Ver("18.2.0-pre.697", 0))
            val kotlin_react_popper = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-popper", Ver("2.3.0-pre.697", 0))
            val kotlin_react_redux = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-redux", Ver("7.2.6-pre.697", 0))
            val kotlin_react_router = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-router", Ver("6.22.0-pre.697", 0))
            val kotlin_react_router_dom = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-router-dom", Ver("6.22.0-pre.697", 0))
            val kotlin_react_select = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-select", Ver("5.8.0-pre.697", 0))
            val kotlin_react_use = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-use", Ver("17.4.0-pre.697", 0))
            val kotlin_redux = Dep("org.jetbrains.kotlin-wrappers", "kotlin-redux", Ver("4.1.2-pre.697", 0))
            val kotlin_remix_run_router = Dep("org.jetbrains.kotlin-wrappers", "kotlin-remix-run-router", Ver("1.15.0-pre.697", 0))
            val kotlin_ring_ui = Dep("org.jetbrains.kotlin-wrappers", "kotlin-ring-ui", Ver("4.1.5-pre.697", 0))
            val kotlin_styled = Dep("org.jetbrains.kotlin-wrappers", "kotlin-styled", Ver("5.3.11-pre.697", 0))
            val kotlin_styled_next = Dep("org.jetbrains.kotlin-wrappers", "kotlin-styled-next", Ver("1.2.4-pre.697", 0))
            val kotlin_tanstack_query_core = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-query-core", Ver("5.20.1-pre.697", 0))
            val kotlin_tanstack_react_query = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-react-query", Ver("5.20.1-pre.697", 0))
            val kotlin_tanstack_react_query_devtools = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-react-query-devtools", Ver("5.20.1-pre.697", 0))
            val kotlin_tanstack_react_table = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-react-table", Ver("8.11.8-pre.697", 0))
            val kotlin_tanstack_react_virtual = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-react-virtual", Ver("3.0.4-pre.697", 0))
            val kotlin_tanstack_table_core = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-table-core", Ver("8.11.8-pre.697", 0))
            val kotlin_tanstack_virtual_core = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-virtual-core", Ver("3.0.4-pre.697", 0))
            val kotlin_typescript = Dep("org.jetbrains.kotlin-wrappers", "kotlin-typescript", Ver("5.3.3-pre.691", 0), Ver("5.4.0-beta-pre.697", 200))
            val kotlin_web = Dep("org.jetbrains.kotlin-wrappers", "kotlin-web", Ver("1.0.0-pre.697", 0))
        }
    }
    object Kodein {
        object Di {
    ...
    object Mockito {
        val android = Dep("org.mockito", "mockito-android", Ver("5.10.0", 0))
        val core = Dep("org.mockito", "mockito-core", Ver("5.10.0", 0))
        val errorprone = Dep("org.mockito", "mockito-errorprone", Ver("5.10.0", 0))
        val inline = Dep("org.mockito", "mockito-inline", Ver("5.2.0", 0))
        val junit_jupiter = Dep("org.mockito", "mockito-junit-jupiter", Ver("5.10.0", 0))
        object Kotlin {
    ...
    object SpringFramework {
        ...
        object Boot {
            val spring_boot_configuration_processor = Dep("org.springframework.boot", "spring-boot-configuration-processor", Ver("3.2.2", 0))
            val spring_boot_dependencies = Dep("org.springframework.boot", "spring-boot-dependencies", Ver("3.2.2", 0))
            val spring_boot_devtools = Dep("org.springframework.boot", "spring-boot-devtools", Ver("3.2.2", 0))
            val spring_boot_starter_activemq = Dep("org.springframework.boot", "spring-boot-starter-activemq", Ver("3.2.2", 0))
            val spring_boot_starter_actuator = Dep("org.springframework.boot", "spring-boot-starter-actuator", Ver("3.2.2", 0))
            val spring_boot_starter_amqp = Dep("org.springframework.boot", "spring-boot-starter-amqp", Ver("3.2.2", 0))
            val spring_boot_starter_artemis = Dep("org.springframework.boot", "spring-boot-starter-artemis", Ver("3.2.2", 0))
            val spring_boot_starter_batch = Dep("org.springframework.boot", "spring-boot-starter-batch", Ver("3.2.2", 0))
            val spring_boot_starter_cache = Dep("org.springframework.boot", "spring-boot-starter-cache", Ver("3.2.2", 0))
            val spring_boot_starter_data_cassandra = Dep("org.springframework.boot", "spring-boot-starter-data-cassandra", Ver("3.2.2", 0))
            val spring_boot_starter_data_cassandra_reactive = Dep("org.springframework.boot", "spring-boot-starter-data-cassandra-reactive", Ver("3.2.2", 0))
            val spring_boot_starter_data_couchbase = Dep("org.springframework.boot", "spring-boot-starter-data-couchbase", Ver("3.2.2", 0))
            val spring_boot_starter_data_couchbase_reactive = Dep("org.springframework.boot", "spring-boot-starter-data-couchbase-reactive", Ver("3.2.2", 0))
            val spring_boot_starter_data_elasticsearch = Dep("org.springframework.boot", "spring-boot-starter-data-elasticsearch", Ver("3.2.2", 0))
            val spring_boot_starter_data_jdbc = Dep("org.springframework.boot", "spring-boot-starter-data-jdbc", Ver("3.2.2", 0))
            val spring_boot_starter_data_jpa = Dep("org.springframework.boot", "spring-boot-starter-data-jpa", Ver("3.2.2", 0))
            val spring_boot_starter_data_ldap = Dep("org.springframework.boot", "spring-boot-starter-data-ldap", Ver("3.2.2", 0))
            val spring_boot_starter_data_mongodb = Dep("org.springframework.boot", "spring-boot-starter-data-mongodb", Ver("3.2.2", 0))
            val spring_boot_starter_data_mongodb_reactive = Dep("org.springframework.boot", "spring-boot-starter-data-mongodb-reactive", Ver("3.2.2", 0))
            val spring_boot_starter_data_neo4j = Dep("org.springframework.boot", "spring-boot-starter-data-neo4j", Ver("3.2.2", 0))
            val spring_boot_starter_data_r2dbc = Dep("org.springframework.boot", "spring-boot-starter-data-r2dbc", Ver("3.2.2", 0))
            val spring_boot_starter_data_redis = Dep("org.springframework.boot", "spring-boot-starter-data-redis", Ver("3.2.2", 0))
            val spring_boot_starter_data_redis_reactive = Dep("org.springframework.boot", "spring-boot-starter-data-redis-reactive", Ver("3.2.2", 0))
            val spring_boot_starter_data_rest = Dep("org.springframework.boot", "spring-boot-starter-data-rest", Ver("3.2.2", 0))
            val spring_boot_starter_data_solr = Dep("org.springframework.boot", "spring-boot-starter-data-solr", Ver("2.4.13", 0))
            val spring_boot_starter_freemarker = Dep("org.springframework.boot", "spring-boot-starter-freemarker", Ver("3.2.2", 0))
            val spring_boot_starter_groovy_templates = Dep("org.springframework.boot", "spring-boot-starter-groovy-templates", Ver("3.2.2", 0))
            val spring_boot_starter_hateoas = Dep("org.springframework.boot", "spring-boot-starter-hateoas", Ver("3.2.2", 0))
            val spring_boot_starter_integration = Dep("org.springframework.boot", "spring-boot-starter-integration", Ver("3.2.2", 0))
            val spring_boot_starter_jdbc = Dep("org.springframework.boot", "spring-boot-starter-jdbc", Ver("3.2.2", 0))
            val spring_boot_starter_jersey = Dep("org.springframework.boot", "spring-boot-starter-jersey", Ver("3.2.2", 0))
            val spring_boot_starter_jooq = Dep("org.springframework.boot", "spring-boot-starter-jooq", Ver("3.2.2", 0))
            val spring_boot_starter_mail = Dep("org.springframework.boot", "spring-boot-starter-mail", Ver("3.2.2", 0))
            val spring_boot_starter_mustache = Dep("org.springframework.boot", "spring-boot-starter-mustache", Ver("3.2.2", 0))
            val spring_boot_starter_oauth2_client = Dep("org.springframework.boot", "spring-boot-starter-oauth2-client", Ver("3.2.2", 0))
            val spring_boot_starter_oauth2_resource_server = Dep("org.springframework.boot", "spring-boot-starter-oauth2-resource-server", Ver("3.2.2", 0))
            val spring_boot_starter_quartz = Dep("org.springframework.boot", "spring-boot-starter-quartz", Ver("3.2.2", 0))
            val spring_boot_starter_rsocket = Dep("org.springframework.boot", "spring-boot-starter-rsocket", Ver("3.2.2", 0))
            val spring_boot_starter_security = Dep("org.springframework.boot", "spring-boot-starter-security", Ver("3.2.2", 0))
            val spring_boot_starter_test = Dep("org.springframework.boot", "spring-boot-starter-test", Ver("3.2.2", 0))
            val spring_boot_starter_thymeleaf = Dep("org.springframework.boot", "spring-boot-starter-thymeleaf", Ver("3.2.2", 0))
            val spring_boot_starter_validation = Dep("org.springframework.boot", "spring-boot-starter-validation", Ver("3.2.2", 0))
            val spring_boot_starter_web = Dep("org.springframework.boot", "spring-boot-starter-web", Ver("3.2.2", 0))
            val spring_boot_starter_web_services = Dep("org.springframework.boot", "spring-boot-starter-web-services", Ver("3.2.2", 0))
            val spring_boot_starter_webflux = Dep("org.springframework.boot", "spring-boot-starter-webflux", Ver("3.2.2", 0))
            val spring_boot_starter_websocket = Dep("org.springframework.boot", "spring-boot-starter-websocket", Ver("3.2.2", 0))
        }
        object Cloud {
...
object Pl {
    object MarekLangiewicz {
        ...
        val kground = Dep("pl.mareklangiewicz", "kground", Ver("0.0.38", 0))
        val kground_io = Dep("pl.mareklangiewicz", "kground-io", Ver("0.0.37", 0), Ver("0.0.38", 0))
        val kground_io_js = Dep("pl.mareklangiewicz", "kground-io-js", Ver("0.0.37", 0), Ver("0.0.38", 0))
        val kground_io_jvm = Dep("pl.mareklangiewicz", "kground-io-jvm", Ver("0.0.37", 0), Ver("0.0.38", 0))
        val kground_js = Dep("pl.mareklangiewicz", "kground-js", Ver("0.0.35", 0), Ver("0.0.38", 0))
        val kground_jvm = Dep("pl.mareklangiewicz", "kground-jvm", Ver("0.0.37", 0), Ver("0.0.38", 0))
        val kgroundx = Dep("pl.mareklangiewicz", "kgroundx", Ver("0.0.37", 0), Ver("0.0.38", 0))
        val kgroundx_io = Dep("pl.mareklangiewicz", "kgroundx-io", Ver("0.0.37", 0), Ver("0.0.38", 0))
        val kgroundx_io_js = Dep("pl.mareklangiewicz", "kgroundx-io-js", Ver("0.0.37", 0), Ver("0.0.38", 0))
        val kgroundx_io_jvm = Dep("pl.mareklangiewicz", "kgroundx-io-jvm", Ver("0.0.37", 0), Ver("0.0.38", 0))
        val kgroundx_js = Dep("pl.mareklangiewicz", "kgroundx-js", Ver("0.0.37", 0), Ver("0.0.38", 0))
        val kgroundx_jupyter = Dep("pl.mareklangiewicz", "kgroundx-jupyter", Ver("0.0.38", 0))
        val kgroundx_jupyter_jvm = Dep("pl.mareklangiewicz", "kgroundx-jupyter-jvm", Ver("0.0.37", 0), Ver("0.0.38", 0))
        val kgroundx_jvm = Dep("pl.mareklangiewicz", "kgroundx-jvm", Ver("0.0.37", 0), Ver("0.0.38", 0))
        val kgroundx_maintenance = Dep("pl.mareklangiewicz", "kgroundx-maintenance", Ver("0.0.37", 0), Ver("0.0.38", 0))
        val kgroundx_maintenance_js = Dep("pl.mareklangiewicz", "kgroundx-maintenance-js")
        val kgroundx_maintenance_jvm = Dep("pl.mareklangiewicz", "kgroundx-maintenance-jvm", Ver("0.0.37", 0), Ver("0.0.38", 0))
        val kommandjupyter = Dep("pl.mareklangiewicz", "kommandjupyter", Ver("0.0.43", 0), Ver("0.0.44", 0))
        val kommandjupyter_jvm = Dep("pl.mareklangiewicz", "kommandjupyter-jvm", Ver("0.0.43", 0), Ver("0.0.44", 0))
        val kommandline = Dep("pl.mareklangiewicz", "kommandline", Ver("0.0.43", 0), Ver("0.0.44", 0))
        val kommandline_js = Dep("pl.mareklangiewicz", "kommandline-js", Ver("0.0.43", 0), Ver("0.0.44", 0))
        val kommandline_jvm = Dep("pl.mareklangiewicz", "kommandline-jvm", Ver("0.0.43", 0), Ver("0.0.44", 0))
        val kommandsamples = Dep("pl.mareklangiewicz", "kommandsamples", Ver("0.0.43", 0), Ver("0.0.44", 0))
        val kommandsamples_js = Dep("pl.mareklangiewicz", "kommandsamples-js", Ver("0.0.43", 0), Ver("0.0.44", 0))
        val kommandsamples_jvm = Dep("pl.mareklangiewicz", "kommandsamples-jvm", Ver("0.0.43", 0), Ver("0.0.44", 0))
