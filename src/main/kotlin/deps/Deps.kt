...
object Com {
    ...
    object Google {
        object Accompanist {
            val appcompat_theme = Dep("com.google.accompanist", "accompanist-appcompat-theme", Ver("0.34.0", 0))
            val coil = Dep("com.google.accompanist", "accompanist-coil", Ver("0.15.0", 0))
            val drawablepainter = Dep("com.google.accompanist", "accompanist-drawablepainter", Ver("0.34.0", 0))
            val flowlayout = Dep("com.google.accompanist", "accompanist-flowlayout", Ver("0.34.0", 0))
            ...
            val insets_ui = Dep("com.google.accompanist", "accompanist-insets-ui", Ver("0.34.0", 0))
            val navigation_animation = Dep("com.google.accompanist", "accompanist-navigation-animation", Ver("0.34.0", 0))
            val navigation_material = Dep("com.google.accompanist", "accompanist-navigation-material", Ver("0.34.0", 0))
            val pager = Dep("com.google.accompanist", "accompanist-pager", Ver("0.34.0", 0))
            val pager_indicators = Dep("com.google.accompanist", "accompanist-pager-indicators", Ver("0.34.0", 0))
            val permissions = Dep("com.google.accompanist", "accompanist-permissions", Ver("0.34.0", 0))
            val picasso = Dep("com.google.accompanist", "accompanist-picasso", Ver("0.6.2", 0))
            val placeholder = Dep("com.google.accompanist", "accompanist-placeholder", Ver("0.34.0", 0))
            val placeholder_material = Dep("com.google.accompanist", "accompanist-placeholder-material", Ver("0.34.0", 0))
            val swiperefresh = Dep("com.google.accompanist", "accompanist-swiperefresh", Ver("0.34.0", 0))
            val systemuicontroller = Dep("com.google.accompanist", "accompanist-systemuicontroller", Ver("0.34.0", 0))
            val webview = Dep("com.google.accompanist", "accompanist-webview", Ver("0.34.0", 0))
        }
        object Ambient {
            object Crossdevice {
        ...
        object Truth {
            val parent = Dep("com.google.truth", "truth-parent", Ver("1.3.0", 0))
            val truth = Dep("com.google.truth", "truth", Ver("1.3.0", 0))
        }
    }
    object JakeWharton {
        object Confundus {
    ...
    object SquareUp {
        ...
        object Wire {
            val gradle_plugin = Dep("com.squareup.wire", "wire-gradle-plugin", Ver("4.9.5", 0))
            val grpc_client = Dep("com.squareup.wire", "wire-grpc-client", Ver("4.9.5", 0))
            val runtime = Dep("com.squareup.wire", "wire-runtime", Ver("4.9.5", 0))
        }
    }
}
object Io {
    ...
    object Insert_koin {
        val koin_android = Dep("io.insert-koin", "koin-android", Ver("3.5.3", 0), Ver("3.6.0-wasm-alpha1", 300))
        val koin_android_compat = Dep("io.insert-koin", "koin-android-compat", Ver("3.5.3", 0), Ver("3.6.0-wasm-alpha1", 300))
        val koin_androidx_compose = Dep("io.insert-koin", "koin-androidx-compose", Ver("3.5.3", 0), Ver("3.6.0-wasm-alpha1", 300))
        val koin_androidx_navigation = Dep("io.insert-koin", "koin-androidx-navigation", Ver("3.5.3", 0), Ver("3.6.0-wasm-alpha1", 300))
        val koin_androidx_workmanager = Dep("io.insert-koin", "koin-androidx-workmanager", Ver("3.5.3", 0), Ver("3.6.0-wasm-alpha1", 300))
        val koin_core = Dep("io.insert-koin", "koin-core", Ver("3.5.3", 0), Ver("3.6.0-wasm-alpha1", 300))
        val koin_ktor = Dep("io.insert-koin", "koin-ktor", Ver("3.5.3", 0), Ver("3.6.0-wasm-alpha1", 300))
        val koin_logger_slf4j = Dep("io.insert-koin", "koin-logger-slf4j", Ver("3.5.3", 0), Ver("3.6.0-wasm-alpha1", 300))
        val koin_test = Dep("io.insert-koin", "koin-test", Ver("3.5.3", 0), Ver("3.6.0-wasm-alpha1", 300))
        val koin_test_junit4 = Dep("io.insert-koin", "koin-test-junit4", Ver("3.5.3", 0), Ver("3.6.0-wasm-alpha1", 300))
        val koin_test_junit5 = Dep("io.insert-koin", "koin-test-junit5", Ver("3.5.3", 0), Ver("3.6.0-wasm-alpha1", 300))
    }
    object Kotest {
...
object Org {
    ...
    object JetBrains {
        object Compose {
            val gradle_plugin = Dep("org.jetbrains.compose", "compose-gradle-plugin", Ver("1.5.11", 0), Ver("1.6.0-beta01", 200))
            object Compiler {
                val compiler = Dep("org.jetbrains.compose.compiler", "compiler", Ver("1.5.7.1", 0), Ver("1.5.8-beta01", 200), Ver("1.5.8", 0))
            }
        }
        object Exposed {
        ...
        object KotlinX {
            ...
            val dataframe = Dep("org.jetbrains.kotlinx", "dataframe", Ver("0.12.1", 0), Ver("0.13.0-dev-2796", 320))
            val dataframe_arrow = Dep("org.jetbrains.kotlinx", "dataframe-arrow", Ver("0.12.1", 0), Ver("0.13.0-dev-2796", 320))
            val dataframe_core = Dep("org.jetbrains.kotlinx", "dataframe-core", Ver("0.12.1", 0), Ver("0.13.0-dev-2796", 320))
            val dataframe_excel = Dep("org.jetbrains.kotlinx", "dataframe-excel", Ver("0.12.1", 0), Ver("0.13.0-dev-2796", 320))
        ...
        object Kotlin_Wrappers {
            val bom = Dep("org.jetbrains.kotlin-wrappers", "kotlin-wrappers-bom", Ver("1.0.0-pre.691", 0))
            val kotlin_actions_toolkit = Dep("org.jetbrains.kotlin-wrappers", "kotlin-actions-toolkit", Ver("0.0.1-pre.691", 0))
            val kotlin_browser = Dep("org.jetbrains.kotlin-wrappers", "kotlin-browser", Ver("1.0.0-pre.691", 0))
            val kotlin_cesium = Dep("org.jetbrains.kotlin-wrappers", "kotlin-cesium", Ver("1.113.0-pre.691", 0))
            val kotlin_css = Dep("org.jetbrains.kotlin-wrappers", "kotlin-css", Ver("1.0.0-pre.691", 0))
            val kotlin_csstype = Dep("org.jetbrains.kotlin-wrappers", "kotlin-csstype", Ver("3.1.3-pre.691", 0))
            val kotlin_emotion = Dep("org.jetbrains.kotlin-wrappers", "kotlin-emotion", Ver("11.11.1-pre.691", 0))
            val kotlin_history = Dep("org.jetbrains.kotlin-wrappers", "kotlin-history", Ver("5.3.0-pre.506-compat", 0))
            val kotlin_js = Dep("org.jetbrains.kotlin-wrappers", "kotlin-js", Ver("1.0.0-pre.691", 0))
            ...
            val kotlin_node = Dep("org.jetbrains.kotlin-wrappers", "kotlin-node", Ver("20.11.5-pre.691", 0))
            val kotlin_popper = Dep("org.jetbrains.kotlin-wrappers", "kotlin-popper", Ver("2.11.8-pre.691", 0))
            val kotlin_react = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react", Ver("18.2.0-pre.691", 0))
            val kotlin_react_beautiful_dnd = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-beautiful-dnd", Ver("13.1.1-pre.691", 0))
            val kotlin_react_core = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-core", Ver("18.2.0-pre.691", 0))
            val kotlin_react_dom = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-dom", Ver("18.2.0-pre.691", 0))
            val kotlin_react_dom_legacy = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-dom-legacy", Ver("18.2.0-pre.691", 0))
            val kotlin_react_dom_test_utils = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-dom-test-utils", Ver("18.2.0-pre.691", 0))
            val kotlin_react_legacy = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-legacy", Ver("18.2.0-pre.691", 0))
            val kotlin_react_popper = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-popper", Ver("2.3.0-pre.691", 0))
            val kotlin_react_redux = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-redux", Ver("7.2.6-pre.691", 0))
            val kotlin_react_router = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-router", Ver("6.20.1-pre.691", 0))
            val kotlin_react_router_dom = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-router-dom", Ver("6.20.1-pre.691", 0))
            val kotlin_react_select = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-select", Ver("5.8.0-pre.691", 0))
            val kotlin_react_use = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-use", Ver("17.4.0-pre.691", 0))
            val kotlin_redux = Dep("org.jetbrains.kotlin-wrappers", "kotlin-redux", Ver("4.1.2-pre.691", 0))
            val kotlin_remix_run_router = Dep("org.jetbrains.kotlin-wrappers", "kotlin-remix-run-router", Ver("1.13.1-pre.691", 0))
            val kotlin_ring_ui = Dep("org.jetbrains.kotlin-wrappers", "kotlin-ring-ui", Ver("4.1.5-pre.691", 0))
            val kotlin_styled = Dep("org.jetbrains.kotlin-wrappers", "kotlin-styled", Ver("5.3.11-pre.691", 0))
            val kotlin_styled_next = Dep("org.jetbrains.kotlin-wrappers", "kotlin-styled-next", Ver("1.2.3-pre.691", 0))
            val kotlin_tanstack_query_core = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-query-core", Ver("5.17.19-pre.691", 0))
            val kotlin_tanstack_react_query = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-react-query", Ver("5.17.19-pre.691", 0))
            val kotlin_tanstack_react_query_devtools = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-react-query-devtools", Ver("5.17.19-pre.691", 0))
            val kotlin_tanstack_react_table = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-react-table", Ver("8.11.7-pre.691", 0))
            val kotlin_tanstack_react_virtual = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-react-virtual", Ver("3.0.2-pre.691", 0))
            val kotlin_tanstack_table_core = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-table-core", Ver("8.11.7-pre.691", 0))
            val kotlin_tanstack_virtual_core = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-virtual-core", Ver("3.0.2-pre.691", 0))
            val kotlin_typescript = Dep("org.jetbrains.kotlin-wrappers", "kotlin-typescript", Ver("5.3.3-pre.691", 0))
            val kotlin_web = Dep("org.jetbrains.kotlin-wrappers", "kotlin-web", Ver("1.0.0-pre.691", 0))
        }
    }
    object Kodein {
        object Di {
