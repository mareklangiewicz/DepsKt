...
object Com {
  ...
  object ApolloGraphQl {
    object Apollo3 {
      val apollo_adapters = "com.apollographql.apollo3" d "apollo-adapters" w "3.8.4" w "4.0.0-beta.7"
      val apollo_api = "com.apollographql.apollo3" d "apollo-api" w "3.8.4" w "4.0.0-beta.7"
      val apollo_ast = "com.apollographql.apollo3" d "apollo-ast" w "3.8.4" w "4.0.0-beta.7"
      val apollo_http_cache = "com.apollographql.apollo3" d "apollo-http-cache" w "3.8.4" w "4.0.0-beta.7"
      val apollo_idling_resource = "com.apollographql.apollo3" d "apollo-idling-resource" w "3.8.4" w "4.0.0-beta.7"
      val apollo_mockserver = "com.apollographql.apollo3" d "apollo-mockserver" w "3.8.4" w "4.0.0-beta.7"
      val apollo_normalized_cache = "com.apollographql.apollo3" d "apollo-normalized-cache" w "3.8.4" w "4.0.0-beta.7"
      val apollo_normalized_cache_sqlite = "com.apollographql.apollo3" d "apollo-normalized-cache-sqlite" w "3.8.4" w "4.0.0-beta.7"
      val apollo_runtime = "com.apollographql.apollo3" d "apollo-runtime" w "3.8.4" w "4.0.0-beta.7"
      val apollo_testing_support = "com.apollographql.apollo3" d "apollo-testing-support" w "3.8.4" w "4.0.0-beta.7"
    }
  }
  object GitHub {
    object Ajalt {
  ...
  object Google {
    ...
    object Maps {
      object Android {
        val maps_compose = "com.google.maps.android" d "maps-compose" w "5.0.2"
...
object Org {
  ...
  object Http4k {
    val aws = "org.http4k" d "http4k-aws" w "5.22.0.0"
    val bom = "org.http4k" d "http4k-bom" w "5.22.0.0"
    val client_apache = "org.http4k" d "http4k-client-apache" w "5.22.0.0"
    val client_apache4 = "org.http4k" d "http4k-client-apache4" w "5.22.0.0"
    val client_apache4_async = "org.http4k" d "http4k-client-apache4-async" w "5.22.0.0"
    val client_apache_async = "org.http4k" d "http4k-client-apache-async" w "5.22.0.0"
    val client_jetty = "org.http4k" d "http4k-client-jetty" w "5.22.0.0"
    val client_okhttp = "org.http4k" d "http4k-client-okhttp" w "5.22.0.0"
    val client_websocket = "org.http4k" d "http4k-client-websocket" w "5.22.0.0"
    val cloudnative = "org.http4k" d "http4k-cloudnative" w "5.22.0.0"
    val contract = "org.http4k" d "http4k-contract" w "5.22.0.0"
    val core = "org.http4k" d "http4k-core" w "5.22.0.0"
    val format_argo = "org.http4k" d "http4k-format-argo" w "5.22.0.0"
    val format_core = "org.http4k" d "http4k-format-core" w "5.22.0.0"
    val format_gson = "org.http4k" d "http4k-format-gson" w "5.22.0.0"
    val format_jackson = "org.http4k" d "http4k-format-jackson" w "5.22.0.0"
    val format_jackson_xml = "org.http4k" d "http4k-format-jackson-xml" w "5.22.0.0"
    val format_jackson_yaml = "org.http4k" d "http4k-format-jackson-yaml" w "5.22.0.0"
    val format_klaxon = "org.http4k" d "http4k-format-klaxon" w "5.22.0.0"
    val format_kotlinx_serialization = "org.http4k" d "http4k-format-kotlinx-serialization" w "5.22.0.0"
    val format_moshi = "org.http4k" d "http4k-format-moshi" w "5.22.0.0"
    val format_xml = "org.http4k" d "http4k-format-xml" w "5.22.0.0"
    val graphql = "org.http4k" d "http4k-graphql" w "5.22.0.0"
    val incubator = "org.http4k" d "http4k-incubator" w "5.22.0.0"
    val jsonrpc = "org.http4k" d "http4k-jsonrpc" w "5.22.0.0"
    val metrics_micrometer = "org.http4k" d "http4k-metrics-micrometer" w "5.22.0.0"
    val multipart = "org.http4k" d "http4k-multipart" w "5.22.0.0"
    val opentelemetry = "org.http4k" d "http4k-opentelemetry" w "5.22.0.0"
    val realtime_core = "org.http4k" d "http4k-realtime-core" w "5.22.0.0"
    val resilience4j = "org.http4k" d "http4k-resilience4j" w "5.22.0.0"
    val security_oauth = "org.http4k" d "http4k-security-oauth" w "5.22.0.0"
    val server_apache = "org.http4k" d "http4k-server-apache" w "5.22.0.0"
    val server_apache4 = "org.http4k" d "http4k-server-apache4" w "5.22.0.0"
    val server_jetty = "org.http4k" d "http4k-server-jetty" w "5.22.0.0"
    val server_ktorcio = "org.http4k" d "http4k-server-ktorcio" w "5.22.0.0"
    val server_ktornetty = "org.http4k" d "http4k-server-ktornetty" w "5.22.0.0"
    val server_netty = "org.http4k" d "http4k-server-netty" w "5.22.0.0"
    val server_ratpack = "org.http4k" d "http4k-server-ratpack" w "5.22.0.0"
    val server_undertow = "org.http4k" d "http4k-server-undertow" w "5.22.0.0"
    val serverless_alibaba = "org.http4k" d "http4k-serverless-alibaba" w "5.22.0.0"
    val serverless_azure = "org.http4k" d "http4k-serverless-azure" w "5.22.0.0"
    val serverless_gcf = "org.http4k" d "http4k-serverless-gcf" w "5.22.0.0"
    val serverless_lambda = "org.http4k" d "http4k-serverless-lambda" w "5.22.0.0"
    val serverless_lambda_runtime = "org.http4k" d "http4k-serverless-lambda-runtime" w "5.22.0.0"
    val serverless_openwhisk = "org.http4k" d "http4k-serverless-openwhisk" w "5.22.0.0"
    val serverless_tencent = "org.http4k" d "http4k-serverless-tencent" w "5.22.0.0"
    val template_core = "org.http4k" d "http4k-template-core" w "5.22.0.0"
    val template_dust = "org.http4k" d "http4k-template-dust" w "4.48.0.0"
    val template_freemarker = "org.http4k" d "http4k-template-freemarker" w "5.22.0.0"
    val template_handlebars = "org.http4k" d "http4k-template-handlebars" w "5.22.0.0"
    val template_jade4j = "org.http4k" d "http4k-template-jade4j" w "5.12.2.1"
    val template_pebble = "org.http4k" d "http4k-template-pebble" w "5.22.0.0"
    val template_thymeleaf = "org.http4k" d "http4k-template-thymeleaf" w "5.22.0.0"
    val testing_approval = "org.http4k" d "http4k-testing-approval" w "5.22.0.0"
    val testing_chaos = "org.http4k" d "http4k-testing-chaos" w "5.22.0.0"
    val testing_hamkrest = "org.http4k" d "http4k-testing-hamkrest" w "5.22.0.0"
    val testing_kotest = "org.http4k" d "http4k-testing-kotest" w "5.22.0.0"
    val testing_servirtium = "org.http4k" d "http4k-testing-servirtium" w "5.22.0.0"
    val testing_strikt = "org.http4k" d "http4k-testing-strikt" w "5.22.0.0"
    val testing_webdriver = "org.http4k" d "http4k-testing-webdriver" w "5.22.0.0"
  }
  object JUnit {
  ...
  object JetBrains {
    ...
    object Exposed {
      val core = "org.jetbrains.exposed" d "exposed-core" w "0.51.1"
      val dao = "org.jetbrains.exposed" d "exposed-dao" w "0.51.1"
    ...
    object KotlinX {
      ...
      val dataframe = "org.jetbrains.kotlinx" d "dataframe" w "0.13.1" w "0.14.0-dev-3199"
      val dataframe_arrow = "org.jetbrains.kotlinx" d "dataframe-arrow" w "0.13.1" w "0.14.0-dev-3199"
      val dataframe_core = "org.jetbrains.kotlinx" d "dataframe-core" w "0.13.1" w "0.14.0-dev-3199"
      val dataframe_excel = "org.jetbrains.kotlinx" d "dataframe-excel" w "0.13.1" w "0.14.0-dev-3199"
...
object Pl {
  object MarekLangiewicz {
    ...
    val kommandline_js = "pl.mareklangiewicz" d "kommandline-js" w "0.0.62"
    ...
    val uspek = "pl.mareklangiewicz" d "uspek" w "0.0.34" w "0.0.35"
    val uspek_js = "pl.mareklangiewicz" d "uspek-js" w "0.0.34" w "0.0.35"
    val uspek_jvm = "pl.mareklangiewicz" d "uspek-jvm" w "0.0.34" w "0.0.35"
    val uspek_linuxx64 = "pl.mareklangiewicz" d "uspek-linuxx64" w "0.0.34" w "0.0.35"
    val uspekx = "pl.mareklangiewicz" d "uspekx" w "0.0.34" w "0.0.35"
    val uspekx_js = "pl.mareklangiewicz" d "uspekx-js" w "0.0.34" w "0.0.35"
    val uspekx_junit4 = "pl.mareklangiewicz" d "uspekx-junit4" w "0.0.34" w "0.0.35"
    val uspekx_junit4_jvm = "pl.mareklangiewicz" d "uspekx-junit4-jvm" w "0.0.34" w "0.0.35"
    val uspekx_junit5 = "pl.mareklangiewicz" d "uspekx-junit5" w "0.0.34" w "0.0.35"
    val uspekx_junit5_jvm = "pl.mareklangiewicz" d "uspekx-junit5-jvm" w "0.0.34" w "0.0.35"
    val uspekx_jvm = "pl.mareklangiewicz" d "uspekx-jvm" w "0.0.34" w "0.0.35"
    val uspekx_linuxx64 = "pl.mareklangiewicz" d "uspekx-linuxx64" w "0.0.34" w "0.0.35"
