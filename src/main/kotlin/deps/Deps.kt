...
object Com {
  object Android {
    ...
    object Tools {
      ...
      object Build {
        val gradle = "com.android.tools.build" d "gradle" w "2.3.0" w "8.6.1" w "8.7.0-rc01" w "8.8.0-alpha04"
      }
    }
  }
...
object Org {
  ...
  object Http4k {
    val aws = "org.http4k" d "http4k-aws" w "5.32.1.0"
    val bom = "org.http4k" d "http4k-bom" w "5.32.1.0"
    val client_apache = "org.http4k" d "http4k-client-apache" w "5.32.1.0"
    val client_apache4 = "org.http4k" d "http4k-client-apache4" w "5.32.1.0"
    val client_apache4_async = "org.http4k" d "http4k-client-apache4-async" w "5.32.1.0"
    val client_apache_async = "org.http4k" d "http4k-client-apache-async" w "5.32.1.0"
    val client_jetty = "org.http4k" d "http4k-client-jetty" w "5.32.1.0"
    val client_okhttp = "org.http4k" d "http4k-client-okhttp" w "5.32.1.0"
    val client_websocket = "org.http4k" d "http4k-client-websocket" w "5.32.1.0"
    val cloudnative = "org.http4k" d "http4k-cloudnative" w "5.32.1.0"
    val contract = "org.http4k" d "http4k-contract" w "5.32.1.0"
    val core = "org.http4k" d "http4k-core" w "5.32.1.0"
    val format_argo = "org.http4k" d "http4k-format-argo" w "5.32.1.0"
    val format_core = "org.http4k" d "http4k-format-core" w "5.32.1.0"
    val format_gson = "org.http4k" d "http4k-format-gson" w "5.32.1.0"
    val format_jackson = "org.http4k" d "http4k-format-jackson" w "5.32.1.0"
    val format_jackson_xml = "org.http4k" d "http4k-format-jackson-xml" w "5.32.1.0"
    val format_jackson_yaml = "org.http4k" d "http4k-format-jackson-yaml" w "5.32.1.0"
    val format_klaxon = "org.http4k" d "http4k-format-klaxon" w "5.32.1.0"
    val format_kotlinx_serialization = "org.http4k" d "http4k-format-kotlinx-serialization" w "5.32.1.0"
    val format_moshi = "org.http4k" d "http4k-format-moshi" w "5.32.1.0"
    val format_xml = "org.http4k" d "http4k-format-xml" w "5.32.1.0"
    val graphql = "org.http4k" d "http4k-graphql" w "5.32.1.0"
    val incubator = "org.http4k" d "http4k-incubator" w "5.32.1.0"
    val jsonrpc = "org.http4k" d "http4k-jsonrpc" w "5.32.1.0"
    val metrics_micrometer = "org.http4k" d "http4k-metrics-micrometer" w "5.32.1.0"
    val multipart = "org.http4k" d "http4k-multipart" w "5.32.1.0"
    val opentelemetry = "org.http4k" d "http4k-opentelemetry" w "5.32.1.0"
    val realtime_core = "org.http4k" d "http4k-realtime-core" w "5.32.1.0"
    val resilience4j = "org.http4k" d "http4k-resilience4j" w "5.32.1.0"
    val security_oauth = "org.http4k" d "http4k-security-oauth" w "5.32.1.0"
    val server_apache = "org.http4k" d "http4k-server-apache" w "5.32.1.0"
    val server_apache4 = "org.http4k" d "http4k-server-apache4" w "5.32.1.0"
    val server_jetty = "org.http4k" d "http4k-server-jetty" w "5.32.1.0"
    val server_ktorcio = "org.http4k" d "http4k-server-ktorcio" w "5.32.1.0"
    val server_ktornetty = "org.http4k" d "http4k-server-ktornetty" w "5.32.1.0"
    val server_netty = "org.http4k" d "http4k-server-netty" w "5.32.1.0"
    val server_ratpack = "org.http4k" d "http4k-server-ratpack" w "5.32.1.0"
    val server_undertow = "org.http4k" d "http4k-server-undertow" w "5.32.1.0"
    val serverless_alibaba = "org.http4k" d "http4k-serverless-alibaba" w "5.32.1.0"
    val serverless_azure = "org.http4k" d "http4k-serverless-azure" w "5.32.1.0"
    val serverless_gcf = "org.http4k" d "http4k-serverless-gcf" w "5.32.1.0"
    val serverless_lambda = "org.http4k" d "http4k-serverless-lambda" w "5.32.1.0"
    val serverless_lambda_runtime = "org.http4k" d "http4k-serverless-lambda-runtime" w "5.32.1.0"
    val serverless_openwhisk = "org.http4k" d "http4k-serverless-openwhisk" w "5.32.1.0"
    val serverless_tencent = "org.http4k" d "http4k-serverless-tencent" w "5.32.1.0"
    val template_core = "org.http4k" d "http4k-template-core" w "5.32.1.0"
    val template_dust = "org.http4k" d "http4k-template-dust" w "4.48.0.0"
    val template_freemarker = "org.http4k" d "http4k-template-freemarker" w "5.32.1.0"
    val template_handlebars = "org.http4k" d "http4k-template-handlebars" w "5.32.1.0"
    val template_jade4j = "org.http4k" d "http4k-template-jade4j" w "5.12.2.1"
    val template_pebble = "org.http4k" d "http4k-template-pebble" w "5.32.1.0"
    val template_thymeleaf = "org.http4k" d "http4k-template-thymeleaf" w "5.32.1.0"
    val testing_approval = "org.http4k" d "http4k-testing-approval" w "5.32.1.0"
    val testing_chaos = "org.http4k" d "http4k-testing-chaos" w "5.32.1.0"
    val testing_hamkrest = "org.http4k" d "http4k-testing-hamkrest" w "5.32.1.0"
    val testing_kotest = "org.http4k" d "http4k-testing-kotest" w "5.32.1.0"
    val testing_servirtium = "org.http4k" d "http4k-testing-servirtium" w "5.32.1.0"
    val testing_strikt = "org.http4k" d "http4k-testing-strikt" w "5.32.1.0"
    val testing_webdriver = "org.http4k" d "http4k-testing-webdriver" w "5.32.1.0"
  }
  object JUnit {
  ...
  object JetBrains {
    ...
    object KotlinX {
      ...
      val dataframe = "org.jetbrains.kotlinx" d "dataframe" w "0.14.1" w "0.15.0-dev-4321"
      val dataframe_arrow = "org.jetbrains.kotlinx" d "dataframe-arrow" w "0.14.1" w "0.15.0-dev-4321"
      val dataframe_core = "org.jetbrains.kotlinx" d "dataframe-core" w "0.14.1" w "0.15.0-dev-4321"
      val dataframe_excel = "org.jetbrains.kotlinx" d "dataframe-excel" w "0.14.1" w "0.15.0-dev-4321"
    ...
    object Kotlin_Wrappers {
      val bom = "org.jetbrains.kotlin-wrappers" d "kotlin-wrappers-bom" w "1.0.0-pre.814"
      val kotlin_actions_toolkit = "org.jetbrains.kotlin-wrappers" d "kotlin-actions-toolkit" w "1.0.0-pre.814"
      val kotlin_browser = "org.jetbrains.kotlin-wrappers" d "kotlin-browser" w "1.0.0-pre.814"
      val kotlin_cesium = "org.jetbrains.kotlin-wrappers" d "kotlin-cesium" w "1.115.0-pre.711"
      val kotlin_css = "org.jetbrains.kotlin-wrappers" d "kotlin-css" w "1.0.0-pre.814"
      val kotlin_csstype = "org.jetbrains.kotlin-wrappers" d "kotlin-csstype" w "3.1.3-pre.814"
      val kotlin_emotion = "org.jetbrains.kotlin-wrappers" d "kotlin-emotion" w "11.13.3-pre.814"
      val kotlin_history = "org.jetbrains.kotlin-wrappers" d "kotlin-history" w "5.3.0-pre.506-compat"
      val kotlin_js = "org.jetbrains.kotlin-wrappers" d "kotlin-js" w "1.0.0-pre.814"
      ...
      val kotlin_node = "org.jetbrains.kotlin-wrappers" d "kotlin-node" w "22.5.4-pre.814"
      val kotlin_popper = "org.jetbrains.kotlin-wrappers" d "kotlin-popper" w "2.11.8-pre.792"
      val kotlin_react = "org.jetbrains.kotlin-wrappers" d "kotlin-react" w "18.3.1-pre.814"
      val kotlin_react_beautiful_dnd = "org.jetbrains.kotlin-wrappers" d "kotlin-react-beautiful-dnd" w "13.1.1-pre.814"
      val kotlin_react_core = "org.jetbrains.kotlin-wrappers" d "kotlin-react-core" w "18.3.1-pre.814"
      val kotlin_react_dom = "org.jetbrains.kotlin-wrappers" d "kotlin-react-dom" w "18.3.1-pre.814"
      val kotlin_react_dom_legacy = "org.jetbrains.kotlin-wrappers" d "kotlin-react-dom-legacy" w "18.3.1-pre.814"
      val kotlin_react_dom_test_utils = "org.jetbrains.kotlin-wrappers" d "kotlin-react-dom-test-utils" w "18.3.1-pre.814"
      val kotlin_react_legacy = "org.jetbrains.kotlin-wrappers" d "kotlin-react-legacy" w "18.3.1-pre.814"
      val kotlin_react_popper = "org.jetbrains.kotlin-wrappers" d "kotlin-react-popper" w "2.3.0-pre.814"
      val kotlin_react_redux = "org.jetbrains.kotlin-wrappers" d "kotlin-react-redux" w "7.2.6-pre.785"
      val kotlin_react_router = "org.jetbrains.kotlin-wrappers" d "kotlin-react-router" w "6.26.2-pre.814"
      val kotlin_react_router_dom = "org.jetbrains.kotlin-wrappers" d "kotlin-react-router-dom" w "6.26.2-pre.814"
      val kotlin_react_select = "org.jetbrains.kotlin-wrappers" d "kotlin-react-select" w "5.8.1-pre.814"
      val kotlin_react_use = "org.jetbrains.kotlin-wrappers" d "kotlin-react-use" w "17.4.0-pre.814"
      val kotlin_redux = "org.jetbrains.kotlin-wrappers" d "kotlin-redux" w "4.1.2-pre.785"
      val kotlin_remix_run_router = "org.jetbrains.kotlin-wrappers" d "kotlin-remix-run-router" w "1.19.2-pre.814"
      ...
      val kotlin_styled_next = "org.jetbrains.kotlin-wrappers" d "kotlin-styled-next" w "1.2.4-pre.814"
      val kotlin_tanstack_query_core = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-query-core" w "5.56.2-pre.814"
      val kotlin_tanstack_react_query = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-react-query" w "5.56.2-pre.814"
      val kotlin_tanstack_react_query_devtools = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-react-query-devtools" w "5.56.2-pre.814"
      val kotlin_tanstack_react_table = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-react-table" w "8.20.5-pre.814"
      val kotlin_tanstack_react_virtual = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-react-virtual" w "3.10.8-pre.814"
      val kotlin_tanstack_table_core = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-table-core" w "8.20.5-pre.814"
      val kotlin_tanstack_virtual_core = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-virtual-core" w "3.10.8-pre.814"
      val kotlin_typescript = "org.jetbrains.kotlin-wrappers" d "kotlin-typescript" w "5.4.5-pre.814"
      val kotlin_web = "org.jetbrains.kotlin-wrappers" d "kotlin-web" w "1.0.0-pre.814"
    }
  }
  object Kodein {
    object Di {
  ...
  object Mockito {
    val android = "org.mockito" d "mockito-android" w "5.14.0"
    val core = "org.mockito" d "mockito-core" w "5.14.0"
    val errorprone = "org.mockito" d "mockito-errorprone" w "5.14.0"
    val inline = "org.mockito" d "mockito-inline" w "5.2.0"
    val junit_jupiter = "org.mockito" d "mockito-junit-jupiter" w "5.14.0"
    object Kotlin {
...
object Pl {
  object MarekLangiewicz {
    val abcdk = "pl.mareklangiewicz" d "abcdk" w "0.0.26"
    ...
    val kground = "pl.mareklangiewicz" d "kground" w "0.0.82"
    val kground_io = "pl.mareklangiewicz" d "kground-io" w "0.0.82"
    val kground_io_js = "pl.mareklangiewicz" d "kground-io-js" w "0.0.82"
    val kground_io_jvm = "pl.mareklangiewicz" d "kground-io-jvm" w "0.0.82"
    val kground_js = "pl.mareklangiewicz" d "kground-js" w "0.0.82"
    val kground_jvm = "pl.mareklangiewicz" d "kground-jvm" w "0.0.82"
    val kgroundx = "pl.mareklangiewicz" d "kgroundx" w "0.0.82"
    val kgroundx_io = "pl.mareklangiewicz" d "kgroundx-io" w "0.0.82"
    val kgroundx_io_js = "pl.mareklangiewicz" d "kgroundx-io-js" w "0.0.82"
    val kgroundx_io_jvm = "pl.mareklangiewicz" d "kgroundx-io-jvm" w "0.0.82"
    val kgroundx_js = "pl.mareklangiewicz" d "kgroundx-js" w "0.0.82"
    val kgroundx_jupyter = "pl.mareklangiewicz" d "kgroundx-jupyter" w "0.0.82"
    val kgroundx_jupyter_jvm = "pl.mareklangiewicz" d "kgroundx-jupyter-jvm" w "0.0.82"
    val kgroundx_jvm = "pl.mareklangiewicz" d "kgroundx-jvm" w "0.0.82"
    val kgroundx_maintenance = "pl.mareklangiewicz" d "kgroundx-maintenance" w "0.0.82"
    val kgroundx_maintenance_js = "pl.mareklangiewicz" d "kgroundx-maintenance-js"
    val kgroundx_maintenance_jvm = "pl.mareklangiewicz" d "kgroundx-maintenance-jvm" w "0.0.82"
    val kommandjupyter = "pl.mareklangiewicz" d "kommandjupyter" w "0.0.84"
    val kommandjupyter_jvm = "pl.mareklangiewicz" d "kommandjupyter-jvm" w "0.0.84"
    val kommandline = "pl.mareklangiewicz" d "kommandline" w "0.0.84"
    val kommandline_js = "pl.mareklangiewicz" d "kommandline-js" w "0.0.84"
    val kommandline_jvm = "pl.mareklangiewicz" d "kommandline-jvm" w "0.0.84"
    val kommandsamples = "pl.mareklangiewicz" d "kommandsamples" w "0.0.84"
    val kommandsamples_js = "pl.mareklangiewicz" d "kommandsamples-js" w "0.0.84"
    val kommandsamples_jvm = "pl.mareklangiewicz" d "kommandsamples-jvm" w "0.0.84"
    ...
    val uwidgets = "pl.mareklangiewicz" d "uwidgets" w "0.0.30"
    val uwidgets_js = "pl.mareklangiewicz" d "uwidgets-js" w "0.0.30"
    val uwidgets_jvm = "pl.mareklangiewicz" d "uwidgets-jvm" w "0.0.30"
    val uwidgets_udemo = "pl.mareklangiewicz" d "uwidgets-udemo" w "0.0.30"
    val uwidgets_udemo_js = "pl.mareklangiewicz" d "uwidgets-udemo-js" w "0.0.30"
    val uwidgets_udemo_jvm = "pl.mareklangiewicz" d "uwidgets-udemo-jvm" w "0.0.30"
  }
}
