...
object Org {
  ...
  object Http4k {
    val aws = "org.http4k" d "http4k-aws" w "5.35.5.0"
    val bom = "org.http4k" d "http4k-bom" w "5.35.5.0"
    val client_apache = "org.http4k" d "http4k-client-apache" w "5.35.5.0"
    val client_apache4 = "org.http4k" d "http4k-client-apache4" w "5.35.5.0"
    val client_apache4_async = "org.http4k" d "http4k-client-apache4-async" w "5.35.5.0"
    val client_apache_async = "org.http4k" d "http4k-client-apache-async" w "5.35.5.0"
    val client_jetty = "org.http4k" d "http4k-client-jetty" w "5.35.5.0"
    val client_okhttp = "org.http4k" d "http4k-client-okhttp" w "5.35.5.0"
    val client_websocket = "org.http4k" d "http4k-client-websocket" w "5.35.5.0"
    val cloudnative = "org.http4k" d "http4k-cloudnative" w "5.35.5.0"
    val contract = "org.http4k" d "http4k-contract" w "5.35.5.0"
    val core = "org.http4k" d "http4k-core" w "5.35.5.0"
    val format_argo = "org.http4k" d "http4k-format-argo" w "5.35.5.0"
    val format_core = "org.http4k" d "http4k-format-core" w "5.35.5.0"
    val format_gson = "org.http4k" d "http4k-format-gson" w "5.35.5.0"
    val format_jackson = "org.http4k" d "http4k-format-jackson" w "5.35.5.0"
    val format_jackson_xml = "org.http4k" d "http4k-format-jackson-xml" w "5.35.5.0"
    val format_jackson_yaml = "org.http4k" d "http4k-format-jackson-yaml" w "5.35.5.0"
    val format_klaxon = "org.http4k" d "http4k-format-klaxon" w "5.35.5.0"
    val format_kotlinx_serialization = "org.http4k" d "http4k-format-kotlinx-serialization" w "5.35.5.0"
    val format_moshi = "org.http4k" d "http4k-format-moshi" w "5.35.5.0"
    val format_xml = "org.http4k" d "http4k-format-xml" w "5.35.5.0"
    val graphql = "org.http4k" d "http4k-graphql" w "5.35.5.0"
    val incubator = "org.http4k" d "http4k-incubator" w "5.35.5.0"
    val jsonrpc = "org.http4k" d "http4k-jsonrpc" w "5.35.5.0"
    val metrics_micrometer = "org.http4k" d "http4k-metrics-micrometer" w "5.35.5.0"
    val multipart = "org.http4k" d "http4k-multipart" w "5.35.5.0"
    val opentelemetry = "org.http4k" d "http4k-opentelemetry" w "5.35.5.0"
    val realtime_core = "org.http4k" d "http4k-realtime-core" w "5.35.5.0"
    val resilience4j = "org.http4k" d "http4k-resilience4j" w "5.35.5.0"
    val security_oauth = "org.http4k" d "http4k-security-oauth" w "5.35.5.0"
    val server_apache = "org.http4k" d "http4k-server-apache" w "5.35.5.0"
    val server_apache4 = "org.http4k" d "http4k-server-apache4" w "5.35.5.0"
    val server_jetty = "org.http4k" d "http4k-server-jetty" w "5.35.5.0"
    val server_ktorcio = "org.http4k" d "http4k-server-ktorcio" w "5.35.5.0"
    val server_ktornetty = "org.http4k" d "http4k-server-ktornetty" w "5.35.5.0"
    val server_netty = "org.http4k" d "http4k-server-netty" w "5.35.5.0"
    val server_ratpack = "org.http4k" d "http4k-server-ratpack" w "5.35.5.0"
    val server_undertow = "org.http4k" d "http4k-server-undertow" w "5.35.5.0"
    val serverless_alibaba = "org.http4k" d "http4k-serverless-alibaba" w "5.35.5.0"
    val serverless_azure = "org.http4k" d "http4k-serverless-azure" w "5.35.5.0"
    val serverless_gcf = "org.http4k" d "http4k-serverless-gcf" w "5.35.5.0"
    val serverless_lambda = "org.http4k" d "http4k-serverless-lambda" w "5.35.5.0"
    val serverless_lambda_runtime = "org.http4k" d "http4k-serverless-lambda-runtime" w "5.35.5.0"
    val serverless_openwhisk = "org.http4k" d "http4k-serverless-openwhisk" w "5.35.5.0"
    val serverless_tencent = "org.http4k" d "http4k-serverless-tencent" w "5.35.5.0"
    val template_core = "org.http4k" d "http4k-template-core" w "5.35.5.0"
    val template_dust = "org.http4k" d "http4k-template-dust" w "4.48.0.0"
    val template_freemarker = "org.http4k" d "http4k-template-freemarker" w "5.35.5.0"
    val template_handlebars = "org.http4k" d "http4k-template-handlebars" w "5.35.5.0"
    val template_jade4j = "org.http4k" d "http4k-template-jade4j" w "5.12.2.1"
    val template_pebble = "org.http4k" d "http4k-template-pebble" w "5.35.5.0"
    val template_thymeleaf = "org.http4k" d "http4k-template-thymeleaf" w "5.35.5.0"
    val testing_approval = "org.http4k" d "http4k-testing-approval" w "5.35.5.0"
    val testing_chaos = "org.http4k" d "http4k-testing-chaos" w "5.35.5.0"
    val testing_hamkrest = "org.http4k" d "http4k-testing-hamkrest" w "5.35.5.0"
    val testing_kotest = "org.http4k" d "http4k-testing-kotest" w "5.35.5.0"
    val testing_servirtium = "org.http4k" d "http4k-testing-servirtium" w "5.35.5.0"
    val testing_strikt = "org.http4k" d "http4k-testing-strikt" w "5.35.5.0"
    val testing_webdriver = "org.http4k" d "http4k-testing-webdriver" w "5.35.5.0"
  }
  object JUnit {
  ...
  object JetBrains {
    ...
    object KotlinX {
      ...
      val dataframe = "org.jetbrains.kotlinx" d "dataframe" w "0.14.2" w "0.15.0-dev-5126"
      val dataframe_arrow = "org.jetbrains.kotlinx" d "dataframe-arrow" w "0.14.2" w "0.15.0-dev-5126"
      val dataframe_core = "org.jetbrains.kotlinx" d "dataframe-core" w "0.14.2" w "0.15.0-dev-5126"
      val dataframe_excel = "org.jetbrains.kotlinx" d "dataframe-excel" w "0.14.2" w "0.15.0-dev-5126"
