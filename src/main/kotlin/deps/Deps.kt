...
object Org {
  ...
  object JetBrains {
    ...
    object Kotlin_Wrappers {
      val bom = "org.jetbrains.kotlin-wrappers" d "kotlin-wrappers-bom" w "1.0.0-pre.841"
      val kotlin_actions_toolkit = "org.jetbrains.kotlin-wrappers" d "kotlin-actions-toolkit" w "1.0.0-pre.841"
      val kotlin_browser = "org.jetbrains.kotlin-wrappers" d "kotlin-browser" w "1.0.0-pre.841"
      val kotlin_cesium = "org.jetbrains.kotlin-wrappers" d "kotlin-cesium" w "1.115.0-pre.711"
      val kotlin_css = "org.jetbrains.kotlin-wrappers" d "kotlin-css" w "1.0.0-pre.841"
      val kotlin_csstype = "org.jetbrains.kotlin-wrappers" d "kotlin-csstype" w "3.1.3-pre.841"
      val kotlin_emotion = "org.jetbrains.kotlin-wrappers" d "kotlin-emotion" w "11.13.5-pre.841"
      val kotlin_history = "org.jetbrains.kotlin-wrappers" d "kotlin-history" w "5.3.0-pre.506-compat"
      val kotlin_js = "org.jetbrains.kotlin-wrappers" d "kotlin-js" w "1.0.0-pre.841"
      ...
      val kotlin_node = "org.jetbrains.kotlin-wrappers" d "kotlin-node" w "22.5.5-pre.841"
      val kotlin_popper = "org.jetbrains.kotlin-wrappers" d "kotlin-popper" w "2.11.8-pre.792"
      val kotlin_react = "org.jetbrains.kotlin-wrappers" d "kotlin-react" w "18.3.1-pre.841"
      val kotlin_react_beautiful_dnd = "org.jetbrains.kotlin-wrappers" d "kotlin-react-beautiful-dnd" w "13.1.1-pre.841"
      val kotlin_react_core = "org.jetbrains.kotlin-wrappers" d "kotlin-react-core" w "18.3.1-pre.841"
      val kotlin_react_dom = "org.jetbrains.kotlin-wrappers" d "kotlin-react-dom" w "18.3.1-pre.841"
      val kotlin_react_dom_legacy = "org.jetbrains.kotlin-wrappers" d "kotlin-react-dom-legacy" w "18.3.1-pre.841"
      val kotlin_react_dom_test_utils = "org.jetbrains.kotlin-wrappers" d "kotlin-react-dom-test-utils" w "18.3.1-pre.841"
      val kotlin_react_legacy = "org.jetbrains.kotlin-wrappers" d "kotlin-react-legacy" w "18.3.1-pre.841"
      val kotlin_react_popper = "org.jetbrains.kotlin-wrappers" d "kotlin-react-popper" w "2.3.0-pre.841"
      val kotlin_react_redux = "org.jetbrains.kotlin-wrappers" d "kotlin-react-redux" w "7.2.6-pre.785"
      val kotlin_react_router = "org.jetbrains.kotlin-wrappers" d "kotlin-react-router" w "6.28.0-pre.841"
      val kotlin_react_router_dom = "org.jetbrains.kotlin-wrappers" d "kotlin-react-router-dom" w "6.28.0-pre.841"
      val kotlin_react_select = "org.jetbrains.kotlin-wrappers" d "kotlin-react-select" w "5.8.3-pre.841"
      val kotlin_react_use = "org.jetbrains.kotlin-wrappers" d "kotlin-react-use" w "17.4.0-pre.841"
      val kotlin_redux = "org.jetbrains.kotlin-wrappers" d "kotlin-redux" w "4.1.2-pre.785"
      val kotlin_remix_run_router = "org.jetbrains.kotlin-wrappers" d "kotlin-remix-run-router" w "1.21.0-pre.841"
      ...
      val kotlin_styled_next = "org.jetbrains.kotlin-wrappers" d "kotlin-styled-next" w "1.2.4-pre.841"
      val kotlin_tanstack_query_core = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-query-core" w "5.61.4-pre.841"
      val kotlin_tanstack_react_query = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-react-query" w "5.61.4-pre.841"
      val kotlin_tanstack_react_query_devtools = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-react-query-devtools" w "5.61.4-pre.841"
      val kotlin_tanstack_react_table = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-react-table" w "8.20.5-pre.841"
      val kotlin_tanstack_react_virtual = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-react-virtual" w "3.10.9-pre.841"
      val kotlin_tanstack_table_core = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-table-core" w "8.20.5-pre.841"
      val kotlin_tanstack_virtual_core = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-virtual-core" w "3.10.9-pre.841"
      val kotlin_typescript = "org.jetbrains.kotlin-wrappers" d "kotlin-typescript" w "5.4.5-pre.841"
      val kotlin_web = "org.jetbrains.kotlin-wrappers" d "kotlin-web" w "1.0.0-pre.841"
    }
  }
  object Kodein {
    object Di {
  ...
  object SpringFramework {
    ...
    object Cloud {
      val spring_cloud_bus = "org.springframework.cloud" d "spring-cloud-bus" w "4.1.3"
      val spring_cloud_cloudfoundry_discovery = "org.springframework.cloud" d "spring-cloud-cloudfoundry-discovery" w "3.1.4"
      val spring_cloud_config_server = "org.springframework.cloud" d "spring-cloud-config-server" w "4.1.4"
      val spring_cloud_dependencies = "org.springframework.cloud" d "spring-cloud-dependencies" w "2023.0.4"
      val spring_cloud_function_web = "org.springframework.cloud" d "spring-cloud-function-web" w "4.1.4"
      ...
      val spring_cloud_starter = "org.springframework.cloud" d "spring-cloud-starter" w "4.1.5"
      ...
      val spring_cloud_starter_circuitbreaker_reactor_resilience4j = "org.springframework.cloud" d "spring-cloud-starter-circuitbreaker-reactor-resilience4j" w "3.1.3"
      val spring_cloud_starter_config = "org.springframework.cloud" d "spring-cloud-starter-config" w "4.1.4"
      val spring_cloud_starter_consul_config = "org.springframework.cloud" d "spring-cloud-starter-consul-config" w "4.1.3"
      val spring_cloud_starter_consul_discovery = "org.springframework.cloud" d "spring-cloud-starter-consul-discovery" w "4.1.3"
      val spring_cloud_starter_contract_stub_runner = "org.springframework.cloud" d "spring-cloud-starter-contract-stub-runner" w "4.1.5"
      val spring_cloud_starter_contract_verifier = "org.springframework.cloud" d "spring-cloud-starter-contract-verifier" w "4.1.5"
      val spring_cloud_starter_gateway = "org.springframework.cloud" d "spring-cloud-starter-gateway" w "4.1.6"
      val spring_cloud_starter_loadbalancer = "org.springframework.cloud" d "spring-cloud-starter-loadbalancer" w "4.1.5"
      val spring_cloud_starter_netflix_eureka_client = "org.springframework.cloud" d "spring-cloud-starter-netflix-eureka-client" w "4.1.4"
      val spring_cloud_starter_netflix_eureka_server = "org.springframework.cloud" d "spring-cloud-starter-netflix-eureka-server" w "4.1.4"
      ...
      val spring_cloud_starter_openfeign = "org.springframework.cloud" d "spring-cloud-starter-openfeign" w "4.1.4"
      ...
      val spring_cloud_starter_task = "org.springframework.cloud" d "spring-cloud-starter-task" w "3.1.3"
      ...
      val spring_cloud_starter_zookeeper_config = "org.springframework.cloud" d "spring-cloud-starter-zookeeper-config" w "4.1.3"
      val spring_cloud_starter_zookeeper_discovery = "org.springframework.cloud" d "spring-cloud-starter-zookeeper-discovery" w "4.1.3"
      val spring_cloud_stream = "org.springframework.cloud" d "spring-cloud-stream" w "4.1.4"
      val spring_cloud_stream_binder_kafka = "org.springframework.cloud" d "spring-cloud-stream-binder-kafka" w "4.1.4"
      val spring_cloud_stream_binder_kafka_streams = "org.springframework.cloud" d "spring-cloud-stream-binder-kafka-streams" w "4.1.4"
      val spring_cloud_stream_binder_rabbit = "org.springframework.cloud" d "spring-cloud-stream-binder-rabbit" w "4.1.4"
    }
    object Data {
