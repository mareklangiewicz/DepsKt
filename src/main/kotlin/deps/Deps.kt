...
object Com {
  ...
  object Google {
    ...
    object Android {
      ...
      object Horologist {
        val audio = "com.google.android.horologist" d "horologist-audio" w "0.6.20" w "0.7.3-alpha"
        val audio_ui = "com.google.android.horologist" d "horologist-audio-ui" w "0.6.20" w "0.7.3-alpha"
        val composables = "com.google.android.horologist" d "horologist-composables" w "0.6.20" w "0.7.3-alpha"
        val compose_layout = "com.google.android.horologist" d "horologist-compose-layout" w "0.6.20" w "0.7.3-alpha"
        val compose_tools = "com.google.android.horologist" d "horologist-compose-tools" w "0.6.20" w "0.7.3-alpha"
        val datalayer = "com.google.android.horologist" d "horologist-datalayer" w "0.6.20" w "0.7.3-alpha"
        val media = "com.google.android.horologist" d "horologist-media" w "0.6.20" w "0.7.3-alpha"
        val media3_backend = "com.google.android.horologist" d "horologist-media3-backend" w "0.6.20" w "0.7.3-alpha"
        val media_data = "com.google.android.horologist" d "horologist-media-data" w "0.6.20" w "0.7.3-alpha"
        val media_ui = "com.google.android.horologist" d "horologist-media-ui" w "0.6.20" w "0.7.3-alpha"
        val network_awareness = "com.google.android.horologist" d "horologist-network-awareness" w "0.6.20" w "0.7.3-alpha"
        val tiles = "com.google.android.horologist" d "horologist-tiles" w "0.6.20" w "0.7.3-alpha"
      }
      object Libraries {
        object Places {
...
object Io {
  ...
  object Ktor {
    val client_android = "io.ktor" d "ktor-client-android" w "3.0.0"
    val client_apache = "io.ktor" d "ktor-client-apache" w "3.0.0"
    val client_auth = "io.ktor" d "ktor-client-auth" w "3.0.0"
    val client_cio = "io.ktor" d "ktor-client-cio" w "3.0.0"
    val client_content_negotiation = "io.ktor" d "ktor-client-content-negotiation" w "3.0.0"
    val client_content_negotiation_tests = "io.ktor" d "ktor-client-content-negotiation-tests" w "3.0.0"
    val client_core = "io.ktor" d "ktor-client-core" w "3.0.0"
    val client_curl = "io.ktor" d "ktor-client-curl" w "3.0.0"
    val client_darwin = "io.ktor" d "ktor-client-darwin" w "3.0.0"
    val client_encoding = "io.ktor" d "ktor-client-encoding" w "3.0.0"
    val client_gson = "io.ktor" d "ktor-client-gson" w "3.0.0"
    val client_jackson = "io.ktor" d "ktor-client-jackson" w "3.0.0"
    val client_java = "io.ktor" d "ktor-client-java" w "3.0.0"
    val client_jetty = "io.ktor" d "ktor-client-jetty" w "3.0.0"
    val client_json = "io.ktor" d "ktor-client-json" w "3.0.0"
    val client_json_tests = "io.ktor" d "ktor-client-json-tests" w "2.3.12"
    val client_logging = "io.ktor" d "ktor-client-logging" w "3.0.0"
    val client_mock = "io.ktor" d "ktor-client-mock" w "3.0.0"
    val client_okhttp = "io.ktor" d "ktor-client-okhttp" w "3.0.0"
    val client_resources = "io.ktor" d "ktor-client-resources" w "3.0.0"
    val client_serialization = "io.ktor" d "ktor-client-serialization" w "3.0.0"
    val client_tests = "io.ktor" d "ktor-client-tests" w "3.0.0"
    val events = "io.ktor" d "ktor-events" w "3.0.0"
    val http = "io.ktor" d "ktor-http" w "3.0.0"
    val http_cio = "io.ktor" d "ktor-http-cio" w "3.0.0"
    val io = "io.ktor" d "ktor-io" w "3.0.0"
    val network = "io.ktor" d "ktor-network" w "3.0.0"
    val network_tls = "io.ktor" d "ktor-network-tls" w "3.0.0"
    val network_tls_certificates = "io.ktor" d "ktor-network-tls-certificates" w "3.0.0"
    val resources = "io.ktor" d "ktor-resources" w "3.0.0"
    val serialization = "io.ktor" d "ktor-serialization" w "3.0.0"
    val serialization_gson = "io.ktor" d "ktor-serialization-gson" w "3.0.0"
    val serialization_jackson = "io.ktor" d "ktor-serialization-jackson" w "3.0.0"
    val serialization_kotlinx = "io.ktor" d "ktor-serialization-kotlinx" w "3.0.0"
    val serialization_kotlinx_cbor = "io.ktor" d "ktor-serialization-kotlinx-cbor" w "3.0.0"
    val serialization_kotlinx_json = "io.ktor" d "ktor-serialization-kotlinx-json" w "3.0.0"
    val serialization_kotlinx_tests = "io.ktor" d "ktor-serialization-kotlinx-tests" w "3.0.0"
    val serialization_kotlinx_xml = "io.ktor" d "ktor-serialization-kotlinx-xml" w "3.0.0"
    val server = "io.ktor" d "ktor-server" w "3.0.0"
    val server_auth = "io.ktor" d "ktor-server-auth" w "3.0.0"
    val server_auth_jwt = "io.ktor" d "ktor-server-auth-jwt" w "3.0.0"
    val server_auth_ldap = "io.ktor" d "ktor-server-auth-ldap" w "3.0.0"
    val server_auto_head_response = "io.ktor" d "ktor-server-auto-head-response" w "3.0.0"
    val server_caching_headers = "io.ktor" d "ktor-server-caching-headers" w "3.0.0"
    val server_call_id = "io.ktor" d "ktor-server-call-id" w "3.0.0"
    val server_call_logging = "io.ktor" d "ktor-server-call-logging" w "3.0.0"
    val server_cio = "io.ktor" d "ktor-server-cio" w "3.0.0"
    val server_compression = "io.ktor" d "ktor-server-compression" w "3.0.0"
    val server_conditional_headers = "io.ktor" d "ktor-server-conditional-headers" w "3.0.0"
    val server_content_negotiation = "io.ktor" d "ktor-server-content-negotiation" w "3.0.0"
    val server_core = "io.ktor" d "ktor-server-core" w "3.0.0"
    val server_cors = "io.ktor" d "ktor-server-cors" w "3.0.0"
    val server_data_conversion = "io.ktor" d "ktor-server-data-conversion" w "3.0.0"
    val server_default_headers = "io.ktor" d "ktor-server-default-headers" w "3.0.0"
    val server_double_receive = "io.ktor" d "ktor-server-double-receive" w "3.0.0"
    val server_forwarded_header = "io.ktor" d "ktor-server-forwarded-header" w "3.0.0"
    val server_freemarker = "io.ktor" d "ktor-server-freemarker" w "3.0.0"
    val server_host_common = "io.ktor" d "ktor-server-host-common" w "3.0.0"
    val server_hsts = "io.ktor" d "ktor-server-hsts" w "3.0.0"
    val server_html_builder = "io.ktor" d "ktor-server-html-builder" w "3.0.0"
    val server_http_redirect = "io.ktor" d "ktor-server-http-redirect" w "3.0.0"
    val server_jetty = "io.ktor" d "ktor-server-jetty" w "3.0.0"
    val server_jte = "io.ktor" d "ktor-server-jte" w "3.0.0"
    val server_locations = "io.ktor" d "ktor-server-locations" w "2.3.12"
    val server_method_override = "io.ktor" d "ktor-server-method-override" w "3.0.0"
    val server_metrics = "io.ktor" d "ktor-server-metrics" w "3.0.0"
    val server_metrics_micrometer = "io.ktor" d "ktor-server-metrics-micrometer" w "3.0.0"
    val server_mustache = "io.ktor" d "ktor-server-mustache" w "3.0.0"
    val server_netty = "io.ktor" d "ktor-server-netty" w "3.0.0"
    val server_partial_content = "io.ktor" d "ktor-server-partial-content" w "3.0.0"
    val server_pebble = "io.ktor" d "ktor-server-pebble" w "3.0.0"
    val server_resources = "io.ktor" d "ktor-server-resources" w "3.0.0"
    val server_servlet = "io.ktor" d "ktor-server-servlet" w "3.0.0"
    val server_sessions = "io.ktor" d "ktor-server-sessions" w "3.0.0"
    val server_status_pages = "io.ktor" d "ktor-server-status-pages" w "3.0.0"
    val server_test_host = "io.ktor" d "ktor-server-test-host" w "3.0.0"
    val server_test_suites = "io.ktor" d "ktor-server-test-suites" w "2.3.12" w "3.0.0-beta-2"
    val server_thymeleaf = "io.ktor" d "ktor-server-thymeleaf" w "3.0.0"
    val server_tomcat = "io.ktor" d "ktor-server-tomcat" w "3.0.0"
    val server_velocity = "io.ktor" d "ktor-server-velocity" w "3.0.0"
    val server_webjars = "io.ktor" d "ktor-server-webjars" w "3.0.0"
    val server_websockets = "io.ktor" d "ktor-server-websockets" w "3.0.0"
    val test_dispatcher = "io.ktor" d "ktor-test-dispatcher" w "3.0.0"
    val utils = "io.ktor" d "ktor-utils" w "3.0.0"
    val websocket_serialization = "io.ktor" d "ktor-websocket-serialization" w "3.0.0"
    val websockets = "io.ktor" d "ktor-websockets" w "3.0.0"
  }
  object MockK {
...
object Org {
  ...
  object Http4k {
    val aws = "org.http4k" d "http4k-aws" w "5.32.4.0"
    val bom = "org.http4k" d "http4k-bom" w "5.32.4.0"
    val client_apache = "org.http4k" d "http4k-client-apache" w "5.32.4.0"
    val client_apache4 = "org.http4k" d "http4k-client-apache4" w "5.32.4.0"
    val client_apache4_async = "org.http4k" d "http4k-client-apache4-async" w "5.32.4.0"
    val client_apache_async = "org.http4k" d "http4k-client-apache-async" w "5.32.4.0"
    val client_jetty = "org.http4k" d "http4k-client-jetty" w "5.32.4.0"
    val client_okhttp = "org.http4k" d "http4k-client-okhttp" w "5.32.4.0"
    val client_websocket = "org.http4k" d "http4k-client-websocket" w "5.32.4.0"
    val cloudnative = "org.http4k" d "http4k-cloudnative" w "5.32.4.0"
    val contract = "org.http4k" d "http4k-contract" w "5.32.4.0"
    val core = "org.http4k" d "http4k-core" w "5.32.4.0"
    val format_argo = "org.http4k" d "http4k-format-argo" w "5.32.4.0"
    val format_core = "org.http4k" d "http4k-format-core" w "5.32.4.0"
    val format_gson = "org.http4k" d "http4k-format-gson" w "5.32.4.0"
    val format_jackson = "org.http4k" d "http4k-format-jackson" w "5.32.4.0"
    val format_jackson_xml = "org.http4k" d "http4k-format-jackson-xml" w "5.32.4.0"
    val format_jackson_yaml = "org.http4k" d "http4k-format-jackson-yaml" w "5.32.4.0"
    val format_klaxon = "org.http4k" d "http4k-format-klaxon" w "5.32.4.0"
    val format_kotlinx_serialization = "org.http4k" d "http4k-format-kotlinx-serialization" w "5.32.4.0"
    val format_moshi = "org.http4k" d "http4k-format-moshi" w "5.32.4.0"
    val format_xml = "org.http4k" d "http4k-format-xml" w "5.32.4.0"
    val graphql = "org.http4k" d "http4k-graphql" w "5.32.4.0"
    val incubator = "org.http4k" d "http4k-incubator" w "5.32.4.0"
    val jsonrpc = "org.http4k" d "http4k-jsonrpc" w "5.32.4.0"
    val metrics_micrometer = "org.http4k" d "http4k-metrics-micrometer" w "5.32.4.0"
    val multipart = "org.http4k" d "http4k-multipart" w "5.32.4.0"
    val opentelemetry = "org.http4k" d "http4k-opentelemetry" w "5.32.4.0"
    val realtime_core = "org.http4k" d "http4k-realtime-core" w "5.32.4.0"
    val resilience4j = "org.http4k" d "http4k-resilience4j" w "5.32.4.0"
    val security_oauth = "org.http4k" d "http4k-security-oauth" w "5.32.4.0"
    val server_apache = "org.http4k" d "http4k-server-apache" w "5.32.4.0"
    val server_apache4 = "org.http4k" d "http4k-server-apache4" w "5.32.4.0"
    val server_jetty = "org.http4k" d "http4k-server-jetty" w "5.32.4.0"
    val server_ktorcio = "org.http4k" d "http4k-server-ktorcio" w "5.32.4.0"
    val server_ktornetty = "org.http4k" d "http4k-server-ktornetty" w "5.32.4.0"
    val server_netty = "org.http4k" d "http4k-server-netty" w "5.32.4.0"
    val server_ratpack = "org.http4k" d "http4k-server-ratpack" w "5.32.4.0"
    val server_undertow = "org.http4k" d "http4k-server-undertow" w "5.32.4.0"
    val serverless_alibaba = "org.http4k" d "http4k-serverless-alibaba" w "5.32.4.0"
    val serverless_azure = "org.http4k" d "http4k-serverless-azure" w "5.32.4.0"
    val serverless_gcf = "org.http4k" d "http4k-serverless-gcf" w "5.32.4.0"
    val serverless_lambda = "org.http4k" d "http4k-serverless-lambda" w "5.32.4.0"
    val serverless_lambda_runtime = "org.http4k" d "http4k-serverless-lambda-runtime" w "5.32.4.0"
    val serverless_openwhisk = "org.http4k" d "http4k-serverless-openwhisk" w "5.32.4.0"
    val serverless_tencent = "org.http4k" d "http4k-serverless-tencent" w "5.32.4.0"
    val template_core = "org.http4k" d "http4k-template-core" w "5.32.4.0"
    val template_dust = "org.http4k" d "http4k-template-dust" w "4.48.0.0"
    val template_freemarker = "org.http4k" d "http4k-template-freemarker" w "5.32.4.0"
    val template_handlebars = "org.http4k" d "http4k-template-handlebars" w "5.32.4.0"
    val template_jade4j = "org.http4k" d "http4k-template-jade4j" w "5.12.2.1"
    val template_pebble = "org.http4k" d "http4k-template-pebble" w "5.32.4.0"
    val template_thymeleaf = "org.http4k" d "http4k-template-thymeleaf" w "5.32.4.0"
    val testing_approval = "org.http4k" d "http4k-testing-approval" w "5.32.4.0"
    val testing_chaos = "org.http4k" d "http4k-testing-chaos" w "5.32.4.0"
    val testing_hamkrest = "org.http4k" d "http4k-testing-hamkrest" w "5.32.4.0"
    val testing_kotest = "org.http4k" d "http4k-testing-kotest" w "5.32.4.0"
    val testing_servirtium = "org.http4k" d "http4k-testing-servirtium" w "5.32.4.0"
    val testing_strikt = "org.http4k" d "http4k-testing-strikt" w "5.32.4.0"
  ...
  object JetBrains {
    ...
    object Kotlin_Wrappers {
      val bom = "org.jetbrains.kotlin-wrappers" d "kotlin-wrappers-bom" w "1.0.0-pre.817"
      val kotlin_actions_toolkit = "org.jetbrains.kotlin-wrappers" d "kotlin-actions-toolkit" w "1.0.0-pre.817"
      val kotlin_browser = "org.jetbrains.kotlin-wrappers" d "kotlin-browser" w "1.0.0-pre.817"
      val kotlin_cesium = "org.jetbrains.kotlin-wrappers" d "kotlin-cesium" w "1.115.0-pre.711"
      val kotlin_css = "org.jetbrains.kotlin-wrappers" d "kotlin-css" w "1.0.0-pre.817"
      val kotlin_csstype = "org.jetbrains.kotlin-wrappers" d "kotlin-csstype" w "3.1.3-pre.817"
      val kotlin_emotion = "org.jetbrains.kotlin-wrappers" d "kotlin-emotion" w "11.13.3-pre.817"
      val kotlin_history = "org.jetbrains.kotlin-wrappers" d "kotlin-history" w "5.3.0-pre.506-compat"
      val kotlin_js = "org.jetbrains.kotlin-wrappers" d "kotlin-js" w "1.0.0-pre.817"
      ...
      val kotlin_node = "org.jetbrains.kotlin-wrappers" d "kotlin-node" w "22.5.4-pre.817"
      val kotlin_popper = "org.jetbrains.kotlin-wrappers" d "kotlin-popper" w "2.11.8-pre.792"
      val kotlin_react = "org.jetbrains.kotlin-wrappers" d "kotlin-react" w "18.3.1-pre.817"
      val kotlin_react_beautiful_dnd = "org.jetbrains.kotlin-wrappers" d "kotlin-react-beautiful-dnd" w "13.1.1-pre.817"
      val kotlin_react_core = "org.jetbrains.kotlin-wrappers" d "kotlin-react-core" w "18.3.1-pre.817"
      val kotlin_react_dom = "org.jetbrains.kotlin-wrappers" d "kotlin-react-dom" w "18.3.1-pre.817"
      val kotlin_react_dom_legacy = "org.jetbrains.kotlin-wrappers" d "kotlin-react-dom-legacy" w "18.3.1-pre.817"
      val kotlin_react_dom_test_utils = "org.jetbrains.kotlin-wrappers" d "kotlin-react-dom-test-utils" w "18.3.1-pre.817"
      val kotlin_react_legacy = "org.jetbrains.kotlin-wrappers" d "kotlin-react-legacy" w "18.3.1-pre.817"
      val kotlin_react_popper = "org.jetbrains.kotlin-wrappers" d "kotlin-react-popper" w "2.3.0-pre.817"
      val kotlin_react_redux = "org.jetbrains.kotlin-wrappers" d "kotlin-react-redux" w "7.2.6-pre.785"
      val kotlin_react_router = "org.jetbrains.kotlin-wrappers" d "kotlin-react-router" w "6.26.2-pre.817"
      val kotlin_react_router_dom = "org.jetbrains.kotlin-wrappers" d "kotlin-react-router-dom" w "6.26.2-pre.817"
      val kotlin_react_select = "org.jetbrains.kotlin-wrappers" d "kotlin-react-select" w "5.8.1-pre.817"
      val kotlin_react_use = "org.jetbrains.kotlin-wrappers" d "kotlin-react-use" w "17.4.0-pre.817"
      val kotlin_redux = "org.jetbrains.kotlin-wrappers" d "kotlin-redux" w "4.1.2-pre.785"
      val kotlin_remix_run_router = "org.jetbrains.kotlin-wrappers" d "kotlin-remix-run-router" w "1.19.2-pre.817"
      ...
      val kotlin_styled_next = "org.jetbrains.kotlin-wrappers" d "kotlin-styled-next" w "1.2.4-pre.817"
      val kotlin_tanstack_query_core = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-query-core" w "5.56.2-pre.817"
      val kotlin_tanstack_react_query = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-react-query" w "5.56.2-pre.817"
      val kotlin_tanstack_react_query_devtools = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-react-query-devtools" w "5.56.2-pre.817"
      val kotlin_tanstack_react_table = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-react-table" w "8.20.5-pre.817"
      val kotlin_tanstack_react_virtual = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-react-virtual" w "3.10.8-pre.817"
      val kotlin_tanstack_table_core = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-table-core" w "8.20.5-pre.817"
      val kotlin_tanstack_virtual_core = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-virtual-core" w "3.10.8-pre.817"
      val kotlin_typescript = "org.jetbrains.kotlin-wrappers" d "kotlin-typescript" w "5.4.5-pre.817"
      val kotlin_web = "org.jetbrains.kotlin-wrappers" d "kotlin-web" w "1.0.0-pre.817"
    }
  }
  object Kodein {
    object Di {
