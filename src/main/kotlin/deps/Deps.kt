...
object Com {
  ...
  object Google {
    ...
    object Firebase {
      val analytics = "com.google.firebase" d "firebase-analytics" w "22.1.0"
      val analytics_ktx = "com.google.firebase" d "firebase-analytics-ktx" w "22.1.0"
      ...
      val bom = "com.google.firebase" d "firebase-bom" w "33.2.0"
      ...
      val messaging = "com.google.firebase" d "firebase-messaging" w "24.0.1"
      val messaging_directboot = "com.google.firebase" d "firebase-messaging-directboot" w "24.0.1"
      val messaging_ktx = "com.google.firebase" d "firebase-messaging-ktx" w "24.0.1"
...
object Org {
  ...
  object JetBrains {
    ...
    object Kotlin {
      ...
      val script_runtime = "org.jetbrains.kotlin" d "kotlin-script-runtime" w "2.0.20"
      val stdlib = "org.jetbrains.kotlin" d "kotlin-stdlib" w "2.0.20"
      val stdlib_common = "org.jetbrains.kotlin" d "kotlin-stdlib-common" w "2.0.20"
      val stdlib_jdk7 = "org.jetbrains.kotlin" d "kotlin-stdlib-jdk7" w "2.0.20"
      val stdlib_jdk8 = "org.jetbrains.kotlin" d "kotlin-stdlib-jdk8" w "2.0.20"
      val stdlib_js = "org.jetbrains.kotlin" d "kotlin-stdlib-js" w "2.0.20"
      val test = "org.jetbrains.kotlin" d "kotlin-test" w "2.0.20"
      val test_annotations_common = "org.jetbrains.kotlin" d "kotlin-test-annotations-common" w "2.0.20"
      val test_common = "org.jetbrains.kotlin" d "kotlin-test-common" w "2.0.20"
      val test_js = "org.jetbrains.kotlin" d "kotlin-test-js" w "2.0.20"
      val test_js_runner = "org.jetbrains.kotlin" d "kotlin-test-js-runner" w "2.0.20"
      val test_junit = "org.jetbrains.kotlin" d "kotlin-test-junit" w "2.0.20"
      val test_junit5 = "org.jetbrains.kotlin" d "kotlin-test-junit5" w "2.0.20"
      val test_testng = "org.jetbrains.kotlin" d "kotlin-test-testng" w "2.0.20"
    }
    object KotlinX {
      ...
      val dataframe = "org.jetbrains.kotlinx" d "dataframe" w "0.13.1" w "0.14.0-dev-3936"
      val dataframe_arrow = "org.jetbrains.kotlinx" d "dataframe-arrow" w "0.13.1" w "0.14.0-dev-3936"
      val dataframe_core = "org.jetbrains.kotlinx" d "dataframe-core" w "0.13.1" w "0.14.0-dev-3936"
      val dataframe_excel = "org.jetbrains.kotlinx" d "dataframe-excel" w "0.13.1" w "0.14.0-dev-3936"
  ...
  object SpringFramework {
    ...
    object Boot {
      val spring_boot_configuration_processor = "org.springframework.boot" d "spring-boot-configuration-processor" w "3.3.3"
      val spring_boot_dependencies = "org.springframework.boot" d "spring-boot-dependencies" w "3.3.3"
      val spring_boot_devtools = "org.springframework.boot" d "spring-boot-devtools" w "3.3.3"
      val spring_boot_starter_activemq = "org.springframework.boot" d "spring-boot-starter-activemq" w "3.3.3"
      val spring_boot_starter_actuator = "org.springframework.boot" d "spring-boot-starter-actuator" w "3.3.3"
      val spring_boot_starter_amqp = "org.springframework.boot" d "spring-boot-starter-amqp" w "3.3.3"
      val spring_boot_starter_artemis = "org.springframework.boot" d "spring-boot-starter-artemis" w "3.3.3"
      val spring_boot_starter_batch = "org.springframework.boot" d "spring-boot-starter-batch" w "3.3.3"
      val spring_boot_starter_cache = "org.springframework.boot" d "spring-boot-starter-cache" w "3.3.3"
      val spring_boot_starter_data_cassandra = "org.springframework.boot" d "spring-boot-starter-data-cassandra" w "3.3.3"
      val spring_boot_starter_data_cassandra_reactive = "org.springframework.boot" d "spring-boot-starter-data-cassandra-reactive" w "3.3.3"
      val spring_boot_starter_data_couchbase = "org.springframework.boot" d "spring-boot-starter-data-couchbase" w "3.3.3"
      val spring_boot_starter_data_couchbase_reactive = "org.springframework.boot" d "spring-boot-starter-data-couchbase-reactive" w "3.3.3"
      val spring_boot_starter_data_elasticsearch = "org.springframework.boot" d "spring-boot-starter-data-elasticsearch" w "3.3.3"
      val spring_boot_starter_data_jdbc = "org.springframework.boot" d "spring-boot-starter-data-jdbc" w "3.3.3"
      val spring_boot_starter_data_jpa = "org.springframework.boot" d "spring-boot-starter-data-jpa" w "3.3.3"
      val spring_boot_starter_data_ldap = "org.springframework.boot" d "spring-boot-starter-data-ldap" w "3.3.3"
      val spring_boot_starter_data_mongodb = "org.springframework.boot" d "spring-boot-starter-data-mongodb" w "3.3.3"
      val spring_boot_starter_data_mongodb_reactive = "org.springframework.boot" d "spring-boot-starter-data-mongodb-reactive" w "3.3.3"
      val spring_boot_starter_data_neo4j = "org.springframework.boot" d "spring-boot-starter-data-neo4j" w "3.3.3"
      val spring_boot_starter_data_r2dbc = "org.springframework.boot" d "spring-boot-starter-data-r2dbc" w "3.3.3"
      val spring_boot_starter_data_redis = "org.springframework.boot" d "spring-boot-starter-data-redis" w "3.3.3"
      val spring_boot_starter_data_redis_reactive = "org.springframework.boot" d "spring-boot-starter-data-redis-reactive" w "3.3.3"
      val spring_boot_starter_data_rest = "org.springframework.boot" d "spring-boot-starter-data-rest" w "3.3.3"
      val spring_boot_starter_data_solr = "org.springframework.boot" d "spring-boot-starter-data-solr" w "2.4.13"
      val spring_boot_starter_freemarker = "org.springframework.boot" d "spring-boot-starter-freemarker" w "3.3.3"
      val spring_boot_starter_groovy_templates = "org.springframework.boot" d "spring-boot-starter-groovy-templates" w "3.3.3"
      val spring_boot_starter_hateoas = "org.springframework.boot" d "spring-boot-starter-hateoas" w "3.3.3"
      val spring_boot_starter_integration = "org.springframework.boot" d "spring-boot-starter-integration" w "3.3.3"
      val spring_boot_starter_jdbc = "org.springframework.boot" d "spring-boot-starter-jdbc" w "3.3.3"
      val spring_boot_starter_jersey = "org.springframework.boot" d "spring-boot-starter-jersey" w "3.3.3"
      val spring_boot_starter_jooq = "org.springframework.boot" d "spring-boot-starter-jooq" w "3.3.3"
      val spring_boot_starter_mail = "org.springframework.boot" d "spring-boot-starter-mail" w "3.3.3"
      val spring_boot_starter_mustache = "org.springframework.boot" d "spring-boot-starter-mustache" w "3.3.3"
      val spring_boot_starter_oauth2_client = "org.springframework.boot" d "spring-boot-starter-oauth2-client" w "3.3.3"
      val spring_boot_starter_oauth2_resource_server = "org.springframework.boot" d "spring-boot-starter-oauth2-resource-server" w "3.3.3"
      val spring_boot_starter_quartz = "org.springframework.boot" d "spring-boot-starter-quartz" w "3.3.3"
      val spring_boot_starter_rsocket = "org.springframework.boot" d "spring-boot-starter-rsocket" w "3.3.3"
      val spring_boot_starter_security = "org.springframework.boot" d "spring-boot-starter-security" w "3.3.3"
      val spring_boot_starter_test = "org.springframework.boot" d "spring-boot-starter-test" w "3.3.3"
      val spring_boot_starter_thymeleaf = "org.springframework.boot" d "spring-boot-starter-thymeleaf" w "3.3.3"
      val spring_boot_starter_validation = "org.springframework.boot" d "spring-boot-starter-validation" w "3.3.3"
      val spring_boot_starter_web = "org.springframework.boot" d "spring-boot-starter-web" w "3.3.3"
      val spring_boot_starter_web_services = "org.springframework.boot" d "spring-boot-starter-web-services" w "3.3.3"
      val spring_boot_starter_webflux = "org.springframework.boot" d "spring-boot-starter-webflux" w "3.3.3"
      val spring_boot_starter_websocket = "org.springframework.boot" d "spring-boot-starter-websocket" w "3.3.3"
    }
    object Cloud {
