...
object AndroidX {
  ...
  object Compose {
    ...
    object Animation {
      val animation = "androidx.compose.animation" d "animation" w "1.0.0-beta06" w "1.6.8" w "1.7.0-beta03"
      val core = "androidx.compose.animation" d "animation-core" w "1.0.0-beta06" w "1.6.8" w "1.7.0-beta03"
      val graphics = "androidx.compose.animation" d "animation-graphics" w "1.6.8" w "1.7.0-beta03"
    }
    object Compiler {
      val compiler = "androidx.compose.compiler" d "compiler" w "1.0.0-beta06" w "1.5.14"
    }
    object Foundation {
      val foundation = "androidx.compose.foundation" d "foundation" w "1.0.0-beta06" w "1.6.8" w "1.7.0-beta03"
      val layout = "androidx.compose.foundation" d "foundation-layout" w "1.0.0-beta06" w "1.6.8" w "1.7.0-beta03"
    }
    object Material {
      val icons_core = "androidx.compose.material" d "material-icons-core" w "1.0.0-beta06" w "1.6.8" w "1.7.0-beta03"
      val icons_extended = "androidx.compose.material" d "material-icons-extended" w "1.0.0-beta06" w "1.6.8" w "1.7.0-beta03"
      val material = "androidx.compose.material" d "material" w "1.0.0-beta06" w "1.6.8" w "1.7.0-beta03"
      val ripple = "androidx.compose.material" d "material-ripple" w "1.0.0-beta06" w "1.6.8" w "1.7.0-beta03"
    }
    object Material3 {
      val material3 = "androidx.compose.material3" d "material3" w "1.2.1" w "1.3.0-beta03"
      val window_size_class = "androidx.compose.material3" d "material3-window-size-class" w "1.2.1" w "1.3.0-beta03"
    }
    object Runtime {
      val dispatch = "androidx.compose.runtime" d "runtime-dispatch" w "1.0.0-alpha12"
      val livedata = "androidx.compose.runtime" d "runtime-livedata" w "1.6.8" w "1.7.0-beta03"
      val runtime = "androidx.compose.runtime" d "runtime" w "1.0.0-beta06" w "1.6.8" w "1.7.0-beta03"
      val rxjava2 = "androidx.compose.runtime" d "runtime-rxjava2" w "1.6.8" w "1.7.0-beta03"
      val rxjava3 = "androidx.compose.runtime" d "runtime-rxjava3" w "1.6.8" w "1.7.0-beta03"
      val saveable = "androidx.compose.runtime" d "runtime-saveable" w "1.0.0-beta06" w "1.6.8" w "1.7.0-beta03"
      val tracing = "androidx.compose.runtime" d "runtime-tracing" w "1.0.0-beta01"
    }
    object Ui {
      val geometry = "androidx.compose.ui" d "ui-geometry" w "1.0.0-beta06" w "1.6.8" w "1.7.0-beta03"
      val graphics = "androidx.compose.ui" d "ui-graphics" w "1.0.0-beta06" w "1.6.8" w "1.7.0-beta03"
      val test = "androidx.compose.ui" d "ui-test" w "1.0.0-beta06" w "1.6.8" w "1.7.0-beta03"
      val test_junit4 = "androidx.compose.ui" d "ui-test-junit4" w "1.0.0-beta06" w "1.6.8" w "1.7.0-beta03"
      val test_manifest = "androidx.compose.ui" d "ui-test-manifest" w "1.6.8" w "1.7.0-beta03"
      val text = "androidx.compose.ui" d "ui-text" w "1.0.0-beta06" w "1.6.8" w "1.7.0-beta03"
      val text_google_fonts = "androidx.compose.ui" d "ui-text-google-fonts" w "1.6.8" w "1.7.0-beta03"
      val tooling = "androidx.compose.ui" d "ui-tooling" w "1.6.8" w "1.7.0-beta03"
      val tooling_data = "androidx.compose.ui" d "ui-tooling-data" w "1.6.8" w "1.7.0-beta03"
      val tooling_preview = "androidx.compose.ui" d "ui-tooling-preview" w "1.6.8" w "1.7.0-beta03"
      val ui = "androidx.compose.ui" d "ui" w "1.0.0-beta06" w "1.6.8" w "1.7.0-beta03"
      val unit = "androidx.compose.ui" d "ui-unit" w "1.0.0-beta06" w "1.6.8" w "1.7.0-beta03"
      val util = "androidx.compose.ui" d "ui-util" w "1.0.0-beta06" w "1.6.8" w "1.7.0-beta03"
      val viewbinding = "androidx.compose.ui" d "ui-viewbinding" w "1.6.8" w "1.7.0-beta03"
    }
  }
  object Concurrent {
  ...
  object Fragment {
    val fragment = "androidx.fragment" d "fragment" w "1.8.0"
    val ktx = "androidx.fragment" d "fragment-ktx" w "1.8.0"
    val testing = "androidx.fragment" d "fragment-testing" w "1.8.0"
  }
  object Games {
  ...
  object Lifecycle {
    val common = "androidx.lifecycle" d "lifecycle-common" w "2.8.2"
    val common_java8 = "androidx.lifecycle" d "lifecycle-common-java8" w "2.8.2"
    val compiler = "androidx.lifecycle" d "lifecycle-compiler" w "2.8.2"
    val extensions = "androidx.lifecycle" d "lifecycle-extensions" w "2.2.0"
    val livedata = "androidx.lifecycle" d "lifecycle-livedata" w "2.8.2"
    val livedata_ktx = "androidx.lifecycle" d "lifecycle-livedata-ktx" w "2.8.2"
    val process = "androidx.lifecycle" d "lifecycle-process" w "2.8.2"
    val reactivestreams = "androidx.lifecycle" d "lifecycle-reactivestreams" w "2.8.2"
    val reactivestreams_ktx = "androidx.lifecycle" d "lifecycle-reactivestreams-ktx" w "2.8.2"
    val runtime = "androidx.lifecycle" d "lifecycle-runtime" w "2.8.2"
    val runtime_compose = "androidx.lifecycle" d "lifecycle-runtime-compose" w "2.8.2"
    val runtime_ktx = "androidx.lifecycle" d "lifecycle-runtime-ktx" w "2.8.2"
    val runtime_testing = "androidx.lifecycle" d "lifecycle-runtime-testing" w "2.8.2"
    val service = "androidx.lifecycle" d "lifecycle-service" w "2.8.2"
    val viewmodel = "androidx.lifecycle" d "lifecycle-viewmodel" w "2.8.2"
    val viewmodel_compose = "androidx.lifecycle" d "lifecycle-viewmodel-compose" w "1.0.0-alpha06" w "2.8.2"
    val viewmodel_ktx = "androidx.lifecycle" d "lifecycle-viewmodel-ktx" w "2.8.2"
    val viewmodel_savedstate = "androidx.lifecycle" d "lifecycle-viewmodel-savedstate" w "2.8.2"
  }
  object Loader {
  ...
  object Navigation {
    val common = "androidx.navigation" d "navigation-common" w "2.4.0-alpha02" w "2.7.7" w "2.8.0-beta03"
    val common_ktx = "androidx.navigation" d "navigation-common-ktx" w "2.4.0-alpha02" w "2.7.7" w "2.8.0-beta03"
    val compose = "androidx.navigation" d "navigation-compose" w "2.4.0-alpha02" w "2.7.7" w "2.8.0-beta03"
    val dynamic_features_fragment = "androidx.navigation" d "navigation-dynamic-features-fragment" w "2.7.7" w "2.8.0-beta03"
    val fragment = "androidx.navigation" d "navigation-fragment" w "2.7.7" w "2.8.0-beta03"
    val fragment_ktx = "androidx.navigation" d "navigation-fragment-ktx" w "2.7.7" w "2.8.0-beta03"
    val runtime = "androidx.navigation" d "navigation-runtime" w "2.4.0-alpha02" w "2.7.7" w "2.8.0-beta03"
    val runtime_ktx = "androidx.navigation" d "navigation-runtime-ktx" w "2.4.0-alpha02" w "2.7.7" w "2.8.0-beta03"
    val safe_args_generator = "androidx.navigation" d "navigation-safe-args-generator" w "2.7.7" w "2.8.0-beta03"
    val safe_args_gradle_plugin = "androidx.navigation" d "navigation-safe-args-gradle-plugin" w "2.7.7" w "2.8.0-beta03"
    val testing = "androidx.navigation" d "navigation-testing" w "2.4.0-alpha02" w "2.7.7" w "2.8.0-beta03"
    val ui = "androidx.navigation" d "navigation-ui" w "2.7.7" w "2.8.0-beta03"
    val ui_ktx = "androidx.navigation" d "navigation-ui-ktx" w "2.7.7" w "2.8.0-beta03"
  }
  object Paging {
  ...
  object Google {
    ...
    object Android {
      ...
      object Material {
        ...
        val material = "com.google.android.material" d "material" w "1.12.0" w "1.13.0-alpha03"
      }
      object Play {
...
object Org {
  ...
  object Http4k {
    val aws = "org.http4k" d "http4k-aws" w "5.23.0.0"
    val bom = "org.http4k" d "http4k-bom" w "5.23.0.0"
    val client_apache = "org.http4k" d "http4k-client-apache" w "5.23.0.0"
    val client_apache4 = "org.http4k" d "http4k-client-apache4" w "5.23.0.0"
    ...
    val format_core = "org.http4k" d "http4k-format-core" w "5.23.0.0"
    val format_gson = "org.http4k" d "http4k-format-gson" w "5.23.0.0"
    val format_jackson = "org.http4k" d "http4k-format-jackson" w "5.23.0.0"
    val format_jackson_xml = "org.http4k" d "http4k-format-jackson-xml" w "5.23.0.0"
    val format_jackson_yaml = "org.http4k" d "http4k-format-jackson-yaml" w "5.23.0.0"
    val format_klaxon = "org.http4k" d "http4k-format-klaxon" w "5.23.0.0"
    val format_kotlinx_serialization = "org.http4k" d "http4k-format-kotlinx-serialization" w "5.23.0.0"
    val format_moshi = "org.http4k" d "http4k-format-moshi" w "5.23.0.0"
    val format_xml = "org.http4k" d "http4k-format-xml" w "5.23.0.0"
    val graphql = "org.http4k" d "http4k-graphql" w "5.23.0.0"
    val incubator = "org.http4k" d "http4k-incubator" w "5.23.0.0"
    ...
    val server_apache = "org.http4k" d "http4k-server-apache" w "5.23.0.0"
    val server_apache4 = "org.http4k" d "http4k-server-apache4" w "5.23.0.0"
    val server_jetty = "org.http4k" d "http4k-server-jetty" w "5.23.0.0"
    val server_ktorcio = "org.http4k" d "http4k-server-ktorcio" w "5.23.0.0"
    val server_ktornetty = "org.http4k" d "http4k-server-ktornetty" w "5.23.0.0"
    val server_netty = "org.http4k" d "http4k-server-netty" w "5.23.0.0"
    val server_ratpack = "org.http4k" d "http4k-server-ratpack" w "5.23.0.0"
    val server_undertow = "org.http4k" d "http4k-server-undertow" w "5.23.0.0"
    val serverless_alibaba = "org.http4k" d "http4k-serverless-alibaba" w "5.23.0.0"
    val serverless_azure = "org.http4k" d "http4k-serverless-azure" w "5.23.0.0"
    val serverless_gcf = "org.http4k" d "http4k-serverless-gcf" w "5.23.0.0"
    val serverless_lambda = "org.http4k" d "http4k-serverless-lambda" w "5.23.0.0"
    val serverless_lambda_runtime = "org.http4k" d "http4k-serverless-lambda-runtime" w "5.23.0.0"
    val serverless_openwhisk = "org.http4k" d "http4k-serverless-openwhisk" w "5.23.0.0"
    val serverless_tencent = "org.http4k" d "http4k-serverless-tencent" w "5.23.0.0"
    val template_core = "org.http4k" d "http4k-template-core" w "5.23.0.0"
    val template_dust = "org.http4k" d "http4k-template-dust" w "4.48.0.0"
    val template_freemarker = "org.http4k" d "http4k-template-freemarker" w "5.23.0.0"
    val template_handlebars = "org.http4k" d "http4k-template-handlebars" w "5.23.0.0"
    val template_jade4j = "org.http4k" d "http4k-template-jade4j" w "5.12.2.1"
    val template_pebble = "org.http4k" d "http4k-template-pebble" w "5.23.0.0"
    val template_thymeleaf = "org.http4k" d "http4k-template-thymeleaf" w "5.23.0.0"
    val testing_approval = "org.http4k" d "http4k-testing-approval" w "5.23.0.0"
    val testing_chaos = "org.http4k" d "http4k-testing-chaos" w "5.23.0.0"
    val testing_hamkrest = "org.http4k" d "http4k-testing-hamkrest" w "5.23.0.0"
    val testing_kotest = "org.http4k" d "http4k-testing-kotest" w "5.23.0.0"
    val testing_servirtium = "org.http4k" d "http4k-testing-servirtium" w "5.23.0.0"
    val testing_strikt = "org.http4k" d "http4k-testing-strikt" w "5.23.0.0"
    val testing_webdriver = "org.http4k" d "http4k-testing-webdriver" w "5.23.0.0"
  }
  object JUnit {
  ...
  object JetBrains {
    ...
    object KotlinX {
      ...
      val dataframe = "org.jetbrains.kotlinx" d "dataframe" w "0.13.1" w "0.14.0-dev-3370"
      val dataframe_arrow = "org.jetbrains.kotlinx" d "dataframe-arrow" w "0.13.1" w "0.14.0-dev-3370"
      val dataframe_core = "org.jetbrains.kotlinx" d "dataframe-core" w "0.13.1" w "0.14.0-dev-3370"
      val dataframe_excel = "org.jetbrains.kotlinx" d "dataframe-excel" w "0.13.1" w "0.14.0-dev-3370"
      ...
      val serialization_bom = "org.jetbrains.kotlinx" d "kotlinx-serialization-bom" w "1.7.0"
      val serialization_cbor = "org.jetbrains.kotlinx" d "kotlinx-serialization-cbor" w "1.7.0"
      val serialization_core = "org.jetbrains.kotlinx" d "kotlinx-serialization-core" w "1.7.0"
      val serialization_hocon = "org.jetbrains.kotlinx" d "kotlinx-serialization-hocon" w "1.6.3"
      val serialization_json = "org.jetbrains.kotlinx" d "kotlinx-serialization-json" w "1.7.0"
      val serialization_json_okio = "org.jetbrains.kotlinx" d "kotlinx-serialization-json-okio" w "1.7.0"
      val serialization_properties = "org.jetbrains.kotlinx" d "kotlinx-serialization-properties" w "1.7.0"
    ...
    object Kotlin_Wrappers {
      ...
      val kotlin_emotion = "org.jetbrains.kotlin-wrappers" d "kotlin-emotion" w "11.11.4-pre.758"
      val kotlin_history = "org.jetbrains.kotlin-wrappers" d "kotlin-history" w "5.3.0-pre.506-compat"
      val kotlin_js = "org.jetbrains.kotlin-wrappers" d "kotlin-js" w "1.0.0-pre.758"
      ...
      val kotlin_react_dom_legacy = "org.jetbrains.kotlin-wrappers" d "kotlin-react-dom-legacy" w "18.3.1-pre.758"
      val kotlin_react_dom_test_utils = "org.jetbrains.kotlin-wrappers" d "kotlin-react-dom-test-utils" w "18.3.1-pre.758"
      val kotlin_react_legacy = "org.jetbrains.kotlin-wrappers" d "kotlin-react-legacy" w "18.3.1-pre.758"
      val kotlin_react_popper = "org.jetbrains.kotlin-wrappers" d "kotlin-react-popper" w "2.3.0-pre.758"
      val kotlin_react_redux = "org.jetbrains.kotlin-wrappers" d "kotlin-react-redux" w "7.2.6-pre.758"
      val kotlin_react_router = "org.jetbrains.kotlin-wrappers" d "kotlin-react-router" w "6.23.1-pre.758"
      val kotlin_react_router_dom = "org.jetbrains.kotlin-wrappers" d "kotlin-react-router-dom" w "6.23.1-pre.758"
      val kotlin_react_select = "org.jetbrains.kotlin-wrappers" d "kotlin-react-select" w "5.8.0-pre.758"
      val kotlin_react_use = "org.jetbrains.kotlin-wrappers" d "kotlin-react-use" w "17.4.0-pre.758"
      val kotlin_redux = "org.jetbrains.kotlin-wrappers" d "kotlin-redux" w "4.1.2-pre.758"
      val kotlin_remix_run_router = "org.jetbrains.kotlin-wrappers" d "kotlin-remix-run-router" w "1.16.1-pre.758"
      val kotlin_ring_ui = "org.jetbrains.kotlin-wrappers" d "kotlin-ring-ui" w "4.1.5-pre.758"
      val kotlin_styled = "org.jetbrains.kotlin-wrappers" d "kotlin-styled" w "5.3.11-pre.717"
      val kotlin_styled_next = "org.jetbrains.kotlin-wrappers" d "kotlin-styled-next" w "1.2.4-pre.758"
      val kotlin_tanstack_query_core = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-query-core" w "5.45.0-pre.758"
      val kotlin_tanstack_react_query = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-react-query" w "5.45.0-pre.758"
      val kotlin_tanstack_react_query_devtools = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-react-query-devtools" w "5.28.6-pre.758"
      val kotlin_tanstack_react_table = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-react-table" w "8.17.3-pre.758"
      val kotlin_tanstack_react_virtual = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-react-virtual" w "3.5.1-pre.758"
      val kotlin_tanstack_table_core = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-table-core" w "8.17.3-pre.758"
      val kotlin_tanstack_virtual_core = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-virtual-core" w "3.5.1-pre.758"
      val kotlin_typescript = "org.jetbrains.kotlin-wrappers" d "kotlin-typescript" w "5.4.5-pre.758"
      val kotlin_web = "org.jetbrains.kotlin-wrappers" d "kotlin-web" w "1.0.0-pre.758"
    }
  }
  object Kodein {
    object Di {
...
object Pl {
  object MarekLangiewicz {
    val abcdk = "pl.mareklangiewicz" d "abcdk" w "0.0.23"
    ...
    val kground = "pl.mareklangiewicz" d "kground" w "0.0.59"
    val kground_io = "pl.mareklangiewicz" d "kground-io" w "0.0.59"
    val kground_io_js = "pl.mareklangiewicz" d "kground-io-js" w "0.0.59"
    val kground_io_jvm = "pl.mareklangiewicz" d "kground-io-jvm" w "0.0.59"
    val kground_js = "pl.mareklangiewicz" d "kground-js" w "0.0.59"
    val kground_jvm = "pl.mareklangiewicz" d "kground-jvm" w "0.0.59"
    val kgroundx = "pl.mareklangiewicz" d "kgroundx" w "0.0.59"
    val kgroundx_io = "pl.mareklangiewicz" d "kgroundx-io" w "0.0.59"
    val kgroundx_io_js = "pl.mareklangiewicz" d "kgroundx-io-js" w "0.0.59"
    val kgroundx_io_jvm = "pl.mareklangiewicz" d "kgroundx-io-jvm" w "0.0.59"
    val kgroundx_js = "pl.mareklangiewicz" d "kgroundx-js" w "0.0.59"
    val kgroundx_jupyter = "pl.mareklangiewicz" d "kgroundx-jupyter" w "0.0.59"
    val kgroundx_jupyter_jvm = "pl.mareklangiewicz" d "kgroundx-jupyter-jvm" w "0.0.59"
    val kgroundx_jvm = "pl.mareklangiewicz" d "kgroundx-jvm" w "0.0.59"
    val kgroundx_maintenance = "pl.mareklangiewicz" d "kgroundx-maintenance" w "0.0.59"
    val kgroundx_maintenance_js = "pl.mareklangiewicz" d "kgroundx-maintenance-js"
    val kgroundx_maintenance_jvm = "pl.mareklangiewicz" d "kgroundx-maintenance-jvm" w "0.0.59"
    val kommandjupyter = "pl.mareklangiewicz" d "kommandjupyter" w "0.0.65"
    val kommandjupyter_jvm = "pl.mareklangiewicz" d "kommandjupyter-jvm" w "0.0.65"
    val kommandline = "pl.mareklangiewicz" d "kommandline" w "0.0.65"
    val kommandline_js = "pl.mareklangiewicz" d "kommandline-js" w "0.0.65"
    val kommandline_jvm = "pl.mareklangiewicz" d "kommandline-jvm" w "0.0.65"
    val kommandsamples = "pl.mareklangiewicz" d "kommandsamples" w "0.0.65"
    val kommandsamples_js = "pl.mareklangiewicz" d "kommandsamples-js" w "0.0.65"
    val kommandsamples_jvm = "pl.mareklangiewicz" d "kommandsamples-jvm" w "0.0.65"
    ...
    val tuplek = "pl.mareklangiewicz" d "tuplek" w "0.0.16"
    val tuplek_js = "pl.mareklangiewicz" d "tuplek-js" w "0.0.16"
    val tuplek_jvm = "pl.mareklangiewicz" d "tuplek-jvm" w "0.0.16"
    val tuplek_linuxx64 = "pl.mareklangiewicz" d "tuplek-linuxx64" w "0.0.16"
    ...
    val uspek = "pl.mareklangiewicz" d "uspek" w "0.0.35"
    val uspek_js = "pl.mareklangiewicz" d "uspek-js" w "0.0.35"
    val uspek_jvm = "pl.mareklangiewicz" d "uspek-jvm" w "0.0.35"
    val uspek_linuxx64 = "pl.mareklangiewicz" d "uspek-linuxx64" w "0.0.35"
    val uspekx = "pl.mareklangiewicz" d "uspekx" w "0.0.35"
    val uspekx_js = "pl.mareklangiewicz" d "uspekx-js" w "0.0.35"
    val uspekx_junit4 = "pl.mareklangiewicz" d "uspekx-junit4" w "0.0.35"
    val uspekx_junit4_jvm = "pl.mareklangiewicz" d "uspekx-junit4-jvm" w "0.0.35"
    val uspekx_junit5 = "pl.mareklangiewicz" d "uspekx-junit5" w "0.0.35"
    ...
    val uwidgets = "pl.mareklangiewicz" d "uwidgets" w "0.0.19"
    val uwidgets_js = "pl.mareklangiewicz" d "uwidgets-js" w "0.0.19"
    val uwidgets_jvm = "pl.mareklangiewicz" d "uwidgets-jvm" w "0.0.19"
    val uwidgets_udemo = "pl.mareklangiewicz" d "uwidgets-udemo" w "0.0.19"
    val uwidgets_udemo_js = "pl.mareklangiewicz" d "uwidgets-udemo-js" w "0.0.19"
    val uwidgets_udemo_jvm = "pl.mareklangiewicz" d "uwidgets-udemo-jvm" w "0.0.19"
  }
}
