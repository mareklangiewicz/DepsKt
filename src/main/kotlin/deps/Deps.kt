...
object Com {
  ...
  object Google {
    ...
    object Android {
      ...
      object Horologist {
        val audio = "com.google.android.horologist" d "horologist-audio" w "0.6.15"
        val audio_ui = "com.google.android.horologist" d "horologist-audio-ui" w "0.6.15"
        val composables = "com.google.android.horologist" d "horologist-composables" w "0.6.15"
        val compose_layout = "com.google.android.horologist" d "horologist-compose-layout" w "0.6.15"
        val compose_tools = "com.google.android.horologist" d "horologist-compose-tools" w "0.6.15"
        val datalayer = "com.google.android.horologist" d "horologist-datalayer" w "0.6.15"
        val media = "com.google.android.horologist" d "horologist-media" w "0.6.15"
        val media3_backend = "com.google.android.horologist" d "horologist-media3-backend" w "0.6.15"
        val media_data = "com.google.android.horologist" d "horologist-media-data" w "0.6.15"
        val media_ui = "com.google.android.horologist" d "horologist-media-ui" w "0.6.15"
        val network_awareness = "com.google.android.horologist" d "horologist-network-awareness" w "0.6.15"
        val tiles = "com.google.android.horologist" d "horologist-tiles" w "0.6.15"
      }
      object Libraries {
        object Places {
...
object Org {
  ...
  object JetBrains {
    ...
    object KotlinX {
      ...
      val dataframe = "org.jetbrains.kotlinx" d "dataframe" w "0.13.1" w "0.14.0-dev-3652"
      val dataframe_arrow = "org.jetbrains.kotlinx" d "dataframe-arrow" w "0.13.1" w "0.14.0-dev-3652"
      val dataframe_core = "org.jetbrains.kotlinx" d "dataframe-core" w "0.13.1" w "0.14.0-dev-3652"
      val dataframe_excel = "org.jetbrains.kotlinx" d "dataframe-excel" w "0.13.1" w "0.14.0-dev-3652"
    ...
    object Kotlin_Wrappers {
      val bom = "org.jetbrains.kotlin-wrappers" d "kotlin-wrappers-bom" w "1.0.0-pre.774"
      val kotlin_actions_toolkit = "org.jetbrains.kotlin-wrappers" d "kotlin-actions-toolkit" w "0.0.1-pre.774"
      val kotlin_browser = "org.jetbrains.kotlin-wrappers" d "kotlin-browser" w "1.0.0-pre.774"
      val kotlin_cesium = "org.jetbrains.kotlin-wrappers" d "kotlin-cesium" w "1.115.0-pre.711"
      val kotlin_css = "org.jetbrains.kotlin-wrappers" d "kotlin-css" w "1.0.0-pre.774"
      val kotlin_csstype = "org.jetbrains.kotlin-wrappers" d "kotlin-csstype" w "3.1.3-pre.774"
      val kotlin_emotion = "org.jetbrains.kotlin-wrappers" d "kotlin-emotion" w "11.11.4-pre.774"
      val kotlin_history = "org.jetbrains.kotlin-wrappers" d "kotlin-history" w "5.3.0-pre.506-compat"
      val kotlin_js = "org.jetbrains.kotlin-wrappers" d "kotlin-js" w "1.0.0-pre.774"
      ...
      val kotlin_node = "org.jetbrains.kotlin-wrappers" d "kotlin-node" w "20.14.10-pre.774"
      val kotlin_popper = "org.jetbrains.kotlin-wrappers" d "kotlin-popper" w "2.11.8-pre.774"
      val kotlin_react = "org.jetbrains.kotlin-wrappers" d "kotlin-react" w "18.3.1-pre.774"
      val kotlin_react_beautiful_dnd = "org.jetbrains.kotlin-wrappers" d "kotlin-react-beautiful-dnd" w "13.1.1-pre.774"
      val kotlin_react_core = "org.jetbrains.kotlin-wrappers" d "kotlin-react-core" w "18.3.1-pre.774"
      val kotlin_react_dom = "org.jetbrains.kotlin-wrappers" d "kotlin-react-dom" w "18.3.1-pre.774"
      val kotlin_react_dom_legacy = "org.jetbrains.kotlin-wrappers" d "kotlin-react-dom-legacy" w "18.3.1-pre.774"
      val kotlin_react_dom_test_utils = "org.jetbrains.kotlin-wrappers" d "kotlin-react-dom-test-utils" w "18.3.1-pre.774"
      val kotlin_react_legacy = "org.jetbrains.kotlin-wrappers" d "kotlin-react-legacy" w "18.3.1-pre.774"
      val kotlin_react_popper = "org.jetbrains.kotlin-wrappers" d "kotlin-react-popper" w "2.3.0-pre.774"
      val kotlin_react_redux = "org.jetbrains.kotlin-wrappers" d "kotlin-react-redux" w "7.2.6-pre.774"
      val kotlin_react_router = "org.jetbrains.kotlin-wrappers" d "kotlin-react-router" w "6.23.1-pre.774"
      val kotlin_react_router_dom = "org.jetbrains.kotlin-wrappers" d "kotlin-react-router-dom" w "6.23.1-pre.774"
      val kotlin_react_select = "org.jetbrains.kotlin-wrappers" d "kotlin-react-select" w "5.8.0-pre.774"
      val kotlin_react_use = "org.jetbrains.kotlin-wrappers" d "kotlin-react-use" w "17.4.0-pre.774"
      val kotlin_redux = "org.jetbrains.kotlin-wrappers" d "kotlin-redux" w "4.1.2-pre.774"
      val kotlin_remix_run_router = "org.jetbrains.kotlin-wrappers" d "kotlin-remix-run-router" w "1.16.1-pre.774"
      val kotlin_ring_ui = "org.jetbrains.kotlin-wrappers" d "kotlin-ring-ui" w "4.1.5-pre.774"
      val kotlin_styled = "org.jetbrains.kotlin-wrappers" d "kotlin-styled" w "5.3.11-pre.717"
      val kotlin_styled_next = "org.jetbrains.kotlin-wrappers" d "kotlin-styled-next" w "1.2.4-pre.774"
      val kotlin_tanstack_query_core = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-query-core" w "5.50.1-pre.774"
      val kotlin_tanstack_react_query = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-react-query" w "5.50.1-pre.774"
      val kotlin_tanstack_react_query_devtools = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-react-query-devtools" w "5.50.1-pre.774"
      val kotlin_tanstack_react_table = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-react-table" w "8.19.2-pre.774"
      val kotlin_tanstack_react_virtual = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-react-virtual" w "3.8.1-pre.774"
      val kotlin_tanstack_table_core = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-table-core" w "8.19.2-pre.774"
      val kotlin_tanstack_virtual_core = "org.jetbrains.kotlin-wrappers" d "kotlin-tanstack-virtual-core" w "3.8.1-pre.774"
      val kotlin_typescript = "org.jetbrains.kotlin-wrappers" d "kotlin-typescript" w "5.4.5-pre.774"
      val kotlin_web = "org.jetbrains.kotlin-wrappers" d "kotlin-web" w "1.0.0-pre.774"
    }
  }
  object Kodein {
    object Di {
  ...
  object SpringFramework {
    ...
    object Boot {
      val spring_boot_configuration_processor = "org.springframework.boot" d "spring-boot-configuration-processor" w "3.3.1"
      val spring_boot_dependencies = "org.springframework.boot" d "spring-boot-dependencies" w "3.3.1"
      val spring_boot_devtools = "org.springframework.boot" d "spring-boot-devtools" w "3.3.1"
      val spring_boot_starter_activemq = "org.springframework.boot" d "spring-boot-starter-activemq" w "3.3.1"
      val spring_boot_starter_actuator = "org.springframework.boot" d "spring-boot-starter-actuator" w "3.3.1"
      val spring_boot_starter_amqp = "org.springframework.boot" d "spring-boot-starter-amqp" w "3.3.1"
      val spring_boot_starter_artemis = "org.springframework.boot" d "spring-boot-starter-artemis" w "3.3.1"
      val spring_boot_starter_batch = "org.springframework.boot" d "spring-boot-starter-batch" w "3.3.1"
      val spring_boot_starter_cache = "org.springframework.boot" d "spring-boot-starter-cache" w "3.3.1"
      val spring_boot_starter_data_cassandra = "org.springframework.boot" d "spring-boot-starter-data-cassandra" w "3.3.1"
      val spring_boot_starter_data_cassandra_reactive = "org.springframework.boot" d "spring-boot-starter-data-cassandra-reactive" w "3.3.1"
      val spring_boot_starter_data_couchbase = "org.springframework.boot" d "spring-boot-starter-data-couchbase" w "3.3.1"
      val spring_boot_starter_data_couchbase_reactive = "org.springframework.boot" d "spring-boot-starter-data-couchbase-reactive" w "3.3.1"
      val spring_boot_starter_data_elasticsearch = "org.springframework.boot" d "spring-boot-starter-data-elasticsearch" w "3.3.1"
      val spring_boot_starter_data_jdbc = "org.springframework.boot" d "spring-boot-starter-data-jdbc" w "3.3.1"
      val spring_boot_starter_data_jpa = "org.springframework.boot" d "spring-boot-starter-data-jpa" w "3.3.1"
      val spring_boot_starter_data_ldap = "org.springframework.boot" d "spring-boot-starter-data-ldap" w "3.3.1"
      val spring_boot_starter_data_mongodb = "org.springframework.boot" d "spring-boot-starter-data-mongodb" w "3.3.1"
      val spring_boot_starter_data_mongodb_reactive = "org.springframework.boot" d "spring-boot-starter-data-mongodb-reactive" w "3.3.1"
      val spring_boot_starter_data_neo4j = "org.springframework.boot" d "spring-boot-starter-data-neo4j" w "3.3.1"
      val spring_boot_starter_data_r2dbc = "org.springframework.boot" d "spring-boot-starter-data-r2dbc" w "3.3.1"
      val spring_boot_starter_data_redis = "org.springframework.boot" d "spring-boot-starter-data-redis" w "3.3.1"
      val spring_boot_starter_data_redis_reactive = "org.springframework.boot" d "spring-boot-starter-data-redis-reactive" w "3.3.1"
      val spring_boot_starter_data_rest = "org.springframework.boot" d "spring-boot-starter-data-rest" w "3.3.1"
      val spring_boot_starter_data_solr = "org.springframework.boot" d "spring-boot-starter-data-solr" w "2.4.13"
      val spring_boot_starter_freemarker = "org.springframework.boot" d "spring-boot-starter-freemarker" w "3.3.1"
      val spring_boot_starter_groovy_templates = "org.springframework.boot" d "spring-boot-starter-groovy-templates" w "3.3.1"
      val spring_boot_starter_hateoas = "org.springframework.boot" d "spring-boot-starter-hateoas" w "3.3.1"
      val spring_boot_starter_integration = "org.springframework.boot" d "spring-boot-starter-integration" w "3.3.1"
      val spring_boot_starter_jdbc = "org.springframework.boot" d "spring-boot-starter-jdbc" w "3.3.1"
      val spring_boot_starter_jersey = "org.springframework.boot" d "spring-boot-starter-jersey" w "3.3.1"
      val spring_boot_starter_jooq = "org.springframework.boot" d "spring-boot-starter-jooq" w "3.3.1"
      val spring_boot_starter_mail = "org.springframework.boot" d "spring-boot-starter-mail" w "3.3.1"
      val spring_boot_starter_mustache = "org.springframework.boot" d "spring-boot-starter-mustache" w "3.3.1"
      val spring_boot_starter_oauth2_client = "org.springframework.boot" d "spring-boot-starter-oauth2-client" w "3.3.1"
      val spring_boot_starter_oauth2_resource_server = "org.springframework.boot" d "spring-boot-starter-oauth2-resource-server" w "3.3.1"
      val spring_boot_starter_quartz = "org.springframework.boot" d "spring-boot-starter-quartz" w "3.3.1"
      val spring_boot_starter_rsocket = "org.springframework.boot" d "spring-boot-starter-rsocket" w "3.3.1"
      val spring_boot_starter_security = "org.springframework.boot" d "spring-boot-starter-security" w "3.3.1"
      val spring_boot_starter_test = "org.springframework.boot" d "spring-boot-starter-test" w "3.3.1"
      val spring_boot_starter_thymeleaf = "org.springframework.boot" d "spring-boot-starter-thymeleaf" w "3.3.1"
      val spring_boot_starter_validation = "org.springframework.boot" d "spring-boot-starter-validation" w "3.3.1"
      val spring_boot_starter_web = "org.springframework.boot" d "spring-boot-starter-web" w "3.3.1"
      val spring_boot_starter_web_services = "org.springframework.boot" d "spring-boot-starter-web-services" w "3.3.1"
      val spring_boot_starter_webflux = "org.springframework.boot" d "spring-boot-starter-webflux" w "3.3.1"
      val spring_boot_starter_websocket = "org.springframework.boot" d "spring-boot-starter-websocket" w "3.3.1"
    }
    object Cloud {
...
object Pl {
  object MarekLangiewicz {
    ...
    val kground = "pl.mareklangiewicz" d "kground" w "0.0.67"
    val kground_io = "pl.mareklangiewicz" d "kground-io" w "0.0.67"
    val kground_io_js = "pl.mareklangiewicz" d "kground-io-js" w "0.0.67"
    val kground_io_jvm = "pl.mareklangiewicz" d "kground-io-jvm" w "0.0.67"
    val kground_js = "pl.mareklangiewicz" d "kground-js" w "0.0.67"
    val kground_jvm = "pl.mareklangiewicz" d "kground-jvm" w "0.0.67"
    val kgroundx = "pl.mareklangiewicz" d "kgroundx" w "0.0.67"
    val kgroundx_io = "pl.mareklangiewicz" d "kgroundx-io" w "0.0.67"
    val kgroundx_io_js = "pl.mareklangiewicz" d "kgroundx-io-js" w "0.0.67"
    val kgroundx_io_jvm = "pl.mareklangiewicz" d "kgroundx-io-jvm" w "0.0.67"
    val kgroundx_js = "pl.mareklangiewicz" d "kgroundx-js" w "0.0.67"
    val kgroundx_jupyter = "pl.mareklangiewicz" d "kgroundx-jupyter" w "0.0.67"
    val kgroundx_jupyter_jvm = "pl.mareklangiewicz" d "kgroundx-jupyter-jvm" w "0.0.67"
    val kgroundx_jvm = "pl.mareklangiewicz" d "kgroundx-jvm" w "0.0.67"
    val kgroundx_maintenance = "pl.mareklangiewicz" d "kgroundx-maintenance" w "0.0.67"
    val kgroundx_maintenance_js = "pl.mareklangiewicz" d "kgroundx-maintenance-js"
    val kgroundx_maintenance_jvm = "pl.mareklangiewicz" d "kgroundx-maintenance-jvm" w "0.0.67"
    val kommandjupyter = "pl.mareklangiewicz" d "kommandjupyter" w "0.0.70"
    val kommandjupyter_jvm = "pl.mareklangiewicz" d "kommandjupyter-jvm" w "0.0.70"
    val kommandline = "pl.mareklangiewicz" d "kommandline" w "0.0.70"
    val kommandline_js = "pl.mareklangiewicz" d "kommandline-js" w "0.0.70"
    val kommandline_jvm = "pl.mareklangiewicz" d "kommandline-jvm" w "0.0.70"
    val kommandsamples = "pl.mareklangiewicz" d "kommandsamples" w "0.0.70"
    val kommandsamples_js = "pl.mareklangiewicz" d "kommandsamples-js" w "0.0.70"
    val kommandsamples_jvm = "pl.mareklangiewicz" d "kommandsamples-jvm" w "0.0.70"
    ...
    val uwidgets = "pl.mareklangiewicz" d "uwidgets" w "0.0.25"
    val uwidgets_js = "pl.mareklangiewicz" d "uwidgets-js" w "0.0.25"
    val uwidgets_jvm = "pl.mareklangiewicz" d "uwidgets-jvm" w "0.0.25"
    val uwidgets_udemo = "pl.mareklangiewicz" d "uwidgets-udemo" w "0.0.25"
    val uwidgets_udemo_js = "pl.mareklangiewicz" d "uwidgets-udemo-js" w "0.0.25"
    val uwidgets_udemo_jvm = "pl.mareklangiewicz" d "uwidgets-udemo-jvm" w "0.0.25"
  }
}
