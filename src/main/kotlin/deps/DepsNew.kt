...
object AndroidX {
    ...
    object Benchmark {
        val common = Dep("androidx.benchmark", "benchmark-common", Ver("1.1.1", 0), Ver("1.2.0-alpha13", 300))
        val gradle_plugin = Dep("androidx.benchmark", "benchmark-gradle-plugin", Ver("1.1.1", 0), Ver("1.2.0-alpha13", 300))
        val junit4 = Dep("androidx.benchmark", "benchmark-junit4", Ver("1.1.1", 0), Ver("1.2.0-alpha13", 300))
        val macro = Dep("androidx.benchmark", "benchmark-macro", Ver("1.1.1", 0), Ver("1.2.0-alpha13", 300))
        val macro_junit4 = Dep("androidx.benchmark", "benchmark-macro-junit4", Ver("1.1.1", 0), Ver("1.2.0-alpha13", 300))
    }
    object Biometric {
    ...
    object Compose {
        val bom = Dep("androidx.compose", "compose-bom", Ver("2023.04.01", 0))
        object Animation {
            val animation = Dep("androidx.compose.animation", "animation", Ver("1.4.2", 0), Ver("1.5.0-alpha03", 300))
            val core = Dep("androidx.compose.animation", "animation-core", Ver("1.4.2", 0), Ver("1.5.0-alpha03", 300))
            val graphics = Dep("androidx.compose.animation", "animation-graphics", Ver("1.4.2", 0), Ver("1.5.0-alpha03", 300))
        }
        object Compiler {
            val compiler = Dep("androidx.compose.compiler", "compiler", Ver("1.4.6", 0))
        }
        object Foundation {
            val foundation = Dep("androidx.compose.foundation", "foundation", Ver("1.4.2", 0), Ver("1.5.0-alpha03", 300))
            val layout = Dep("androidx.compose.foundation", "foundation-layout", Ver("1.4.2", 0), Ver("1.5.0-alpha03", 300))
        }
        object Material {
            val icons_core = Dep("androidx.compose.material", "material-icons-core", Ver("1.4.2", 0), Ver("1.5.0-alpha03", 300))
            val icons_extended = Dep("androidx.compose.material", "material-icons-extended", Ver("1.4.2", 0), Ver("1.5.0-alpha03", 300))
            val material = Dep("androidx.compose.material", "material", Ver("1.4.2", 0), Ver("1.5.0-alpha03", 300))
            val ripple = Dep("androidx.compose.material", "material-ripple", Ver("1.4.2", 0), Ver("1.5.0-alpha03", 300))
        }
        object Material3 {
        ...
        object Runtime {
            ...
            val livedata = Dep("androidx.compose.runtime", "runtime-livedata", Ver("1.4.2", 0), Ver("1.5.0-alpha03", 300))
            val runtime = Dep("androidx.compose.runtime", "runtime", Ver("1.4.2", 0), Ver("1.5.0-alpha03", 300))
            val rxjava2 = Dep("androidx.compose.runtime", "runtime-rxjava2", Ver("1.4.2", 0), Ver("1.5.0-alpha03", 300))
            val rxjava3 = Dep("androidx.compose.runtime", "runtime-rxjava3", Ver("1.4.2", 0), Ver("1.5.0-alpha03", 300))
            val saveable = Dep("androidx.compose.runtime", "runtime-saveable", Ver("1.4.2", 0), Ver("1.5.0-alpha03", 300))
            val tracing = Dep("androidx.compose.runtime", "runtime-tracing", Ver("1.0.0-alpha03", 300))
        }
        object Ui {
            val geometry = Dep("androidx.compose.ui", "ui-geometry", Ver("1.4.2", 0), Ver("1.5.0-alpha03", 300))
            val graphics = Dep("androidx.compose.ui", "ui-graphics", Ver("1.4.2", 0), Ver("1.5.0-alpha03", 300))
            val test = Dep("androidx.compose.ui", "ui-test", Ver("1.4.2", 0), Ver("1.5.0-alpha03", 300))
            val test_junit4 = Dep("androidx.compose.ui", "ui-test-junit4", Ver("1.4.2", 0), Ver("1.5.0-alpha03", 300))
            val test_manifest = Dep("androidx.compose.ui", "ui-test-manifest", Ver("1.4.2", 0), Ver("1.5.0-alpha03", 300))
            val text = Dep("androidx.compose.ui", "ui-text", Ver("1.4.2", 0), Ver("1.5.0-alpha03", 300))
            val text_google_fonts = Dep("androidx.compose.ui", "ui-text-google-fonts", Ver("1.4.2", 0), Ver("1.5.0-alpha03", 300))
            val tooling = Dep("androidx.compose.ui", "ui-tooling", Ver("1.4.2", 0), Ver("1.5.0-alpha03", 300))
            val tooling_data = Dep("androidx.compose.ui", "ui-tooling-data", Ver("1.4.2", 0), Ver("1.5.0-alpha03", 300))
            val tooling_preview = Dep("androidx.compose.ui", "ui-tooling-preview", Ver("1.4.2", 0), Ver("1.5.0-alpha03", 300))
            val ui = Dep("androidx.compose.ui", "ui", Ver("1.4.2", 0), Ver("1.5.0-alpha03", 300))
            val unit = Dep("androidx.compose.ui", "ui-unit", Ver("1.4.2", 0), Ver("1.5.0-alpha03", 300))
            val util = Dep("androidx.compose.ui", "ui-util", Ver("1.4.2", 0), Ver("1.5.0-alpha03", 300))
            val viewbinding = Dep("androidx.compose.ui", "ui-viewbinding", Ver("1.4.2", 0), Ver("1.5.0-alpha03", 300))
        }
    }
    object Concurrent {
    ...
    object MediaRouter {
        val mediarouter = Dep("androidx.mediarouter", "mediarouter", Ver("1.3.1", 0), Ver("1.4.0-rc01", 100), Ver("1.6.0-alpha03", 300))
    }
    object Metrics {
    ...
    object Paging {
        val common = Dep("androidx.paging", "paging-common", Ver("3.1.1", 0), Ver("3.2.0-alpha04", 300))
        val common_ktx = Dep("androidx.paging", "paging-common-ktx", Ver("3.1.1", 0), Ver("3.2.0-alpha04", 300))
        val compose = Dep("androidx.paging", "paging-compose", Ver("1.0.0-alpha18", 300))
        val guava = Dep("androidx.paging", "paging-guava", Ver("3.1.1", 0), Ver("3.2.0-alpha04", 300))
        val runtime = Dep("androidx.paging", "paging-runtime", Ver("3.1.1", 0), Ver("3.2.0-alpha04", 300))
        val runtime_ktx = Dep("androidx.paging", "paging-runtime-ktx", Ver("3.1.1", 0), Ver("3.2.0-alpha04", 300))
        val rxjava2 = Dep("androidx.paging", "paging-rxjava2", Ver("3.1.1", 0), Ver("3.2.0-alpha04", 300))
        val rxjava2_ktx = Dep("androidx.paging", "paging-rxjava2-ktx", Ver("3.1.1", 0), Ver("3.2.0-alpha04", 300))
        val rxjava3 = Dep("androidx.paging", "paging-rxjava3", Ver("3.1.1", 0), Ver("3.2.0-alpha04", 300))
        val testing = Dep("androidx.paging", "paging-testing", Ver("3.2.0-alpha04", 300))
    }
    object Palette {
    ...
    object Test {
        ...
        object Espresso {
            ...
            val device = Dep("androidx.test.espresso", "espresso-device", Ver("1.0.0-alpha04", 300))
    ...
    object Tracing {
        val ktx = Dep("androidx.tracing", "tracing-ktx", Ver("1.1.0", 0), Ver("1.2.0-beta03", 200))
        val perfetto = Dep("androidx.tracing", "tracing-perfetto", Ver("1.0.0-alpha14", 300))
...
object Com {
    object Android {
        ...
        object Tools {
            ...
            object Build {
                val gradle = Dep("com.android.tools.build", "gradle", Ver("2.3.0", 0), Ver("2.3.3", 0), Ver("2.4.0-alpha7", 300), Ver("2.5.0-alpha-preview-02", 400), Ver("8.0.0", 0), Ver("8.1.0-beta01", 200), Ver("8.2.0-alpha01", 300))
            }
        }
    }
    ...
    object Google {
        ...
        object Android {
            ...
            object Horologist {
                val audio = Dep("com.google.android.horologist", "horologist-audio", Ver("0.4.4", 0))
                val audio_ui = Dep("com.google.android.horologist", "horologist-audio-ui", Ver("0.4.4", 0))
                val composables = Dep("com.google.android.horologist", "horologist-composables", Ver("0.4.4", 0))
                val compose_layout = Dep("com.google.android.horologist", "horologist-compose-layout", Ver("0.4.4", 0))
                val compose_tools = Dep("com.google.android.horologist", "horologist-compose-tools", Ver("0.4.4", 0))
                val datalayer = Dep("com.google.android.horologist", "horologist-datalayer", Ver("0.4.4", 0))
                val media = Dep("com.google.android.horologist", "horologist-media", Ver("0.4.4", 0))
                val media3_backend = Dep("com.google.android.horologist", "horologist-media3-backend", Ver("0.4.4", 0))
                val media_data = Dep("com.google.android.horologist", "horologist-media-data", Ver("0.4.4", 0))
                val media_ui = Dep("com.google.android.horologist", "horologist-media-ui", Ver("0.4.4", 0))
                val network_awareness = Dep("com.google.android.horologist", "horologist-network-awareness", Ver("0.4.4", 0))
                val tiles = Dep("com.google.android.horologist", "horologist-tiles", Ver("0.4.4", 0))
            }
            object Libraries {
                object Places {
        ...
        object Firebase {
            ...
            val inappmessaging_display = Dep("com.google.firebase", "firebase-inappmessaging-display", Ver("20.3.1", 0))
            val inappmessaging_display_ktx = Dep("com.google.firebase", "firebase-inappmessaging-display-ktx", Ver("20.3.1", 0))
            val inappmessaging_ktx = Dep("com.google.firebase", "firebase-inappmessaging-ktx", Ver("20.3.1", 0))
            ...
            val perf = Dep("com.google.firebase", "firebase-perf", Ver("20.3.1", 0))
            val perf_ktx = Dep("com.google.firebase", "firebase-perf-ktx", Ver("20.3.1", 0))
            val perf_plugin = Dep("com.google.firebase", "perf-plugin", Ver("1.4.2", 0))
            val storage = Dep("com.google.firebase", "firebase-storage", Ver("20.1.0", 0))
            val storage_ktx = Dep("com.google.firebase", "firebase-storage-ktx", Ver("20.1.0", 0))
        }
        object Gms {
    ...
    object Rickclephas {
        object Kmp {
            val nativecoroutines_annotations = Dep("com.rickclephas.kmp", "kmp-nativecoroutines-annotations", Ver("0.13.3", 0), Ver("1.0.0-ALPHA-8", 300))
            val nativecoroutines_compiler = Dep("com.rickclephas.kmp", "kmp-nativecoroutines-compiler", Ver("0.13.3", 0), Ver("1.0.0-ALPHA-8", 300))
            val nativecoroutines_compiler_embeddable = Dep("com.rickclephas.kmp", "kmp-nativecoroutines-compiler-embeddable", Ver("0.13.3", 0), Ver("1.0.0-ALPHA-8", 300))
            val nativecoroutines_core = Dep("com.rickclephas.kmp", "kmp-nativecoroutines-core", Ver("0.13.3", 0), Ver("1.0.0-ALPHA-8", 300))
            val nativecoroutines_gradle_plugin = Dep("com.rickclephas.kmp", "kmp-nativecoroutines-gradle-plugin", Ver("0.13.3", 0), Ver("1.0.0-ALPHA-8", 300))
        }
    }
    object Russhwolf {
    ...
    object SquareUp {
        val kotlinpoet = Dep("com.squareup", "kotlinpoet", Ver("1.13.1", 0))
        val kotlinpoet_metadata = Dep("com.squareup", "kotlinpoet-metadata", Ver("1.13.1", 0))
        ...
        object Wire {
            val gradle_plugin = Dep("com.squareup.wire", "wire-gradle-plugin", Ver("4.5.6", 0))
            val grpc_client = Dep("com.squareup.wire", "wire-grpc-client", Ver("4.5.6", 0))
            val runtime = Dep("com.squareup.wire", "wire-runtime", Ver("4.5.6", 0))
        }
    }
}
object Io {
...
object Org {
    ...
    object Http4k {
        val aws = Dep("org.http4k", "http4k-aws", Ver("4.42.1.0", 0))
        val bom = Dep("org.http4k", "http4k-bom", Ver("4.42.1.0", 0))
        val client_apache = Dep("org.http4k", "http4k-client-apache", Ver("4.42.1.0", 0))
        val client_apache4 = Dep("org.http4k", "http4k-client-apache4", Ver("4.42.1.0", 0))
        val client_apache4_async = Dep("org.http4k", "http4k-client-apache4-async", Ver("4.42.1.0", 0))
        val client_apache_async = Dep("org.http4k", "http4k-client-apache-async", Ver("4.42.1.0", 0))
        val client_jetty = Dep("org.http4k", "http4k-client-jetty", Ver("4.42.1.0", 0))
        val client_okhttp = Dep("org.http4k", "http4k-client-okhttp", Ver("4.42.1.0", 0))
        val client_websocket = Dep("org.http4k", "http4k-client-websocket", Ver("4.42.1.0", 0))
        val cloudnative = Dep("org.http4k", "http4k-cloudnative", Ver("4.42.1.0", 0))
        val contract = Dep("org.http4k", "http4k-contract", Ver("4.42.1.0", 0))
        val core = Dep("org.http4k", "http4k-core", Ver("4.42.1.0", 0))
        val format_argo = Dep("org.http4k", "http4k-format-argo", Ver("4.42.1.0", 0))
        val format_core = Dep("org.http4k", "http4k-format-core", Ver("4.42.1.0", 0))
        val format_gson = Dep("org.http4k", "http4k-format-gson", Ver("4.42.1.0", 0))
        val format_jackson = Dep("org.http4k", "http4k-format-jackson", Ver("4.42.1.0", 0))
        val format_jackson_xml = Dep("org.http4k", "http4k-format-jackson-xml", Ver("4.42.1.0", 0))
        val format_jackson_yaml = Dep("org.http4k", "http4k-format-jackson-yaml", Ver("4.42.1.0", 0))
        val format_klaxon = Dep("org.http4k", "http4k-format-klaxon", Ver("4.42.1.0", 0))
        val format_kotlinx_serialization = Dep("org.http4k", "http4k-format-kotlinx-serialization", Ver("4.42.1.0", 0))
        val format_moshi = Dep("org.http4k", "http4k-format-moshi", Ver("4.42.1.0", 0))
        val format_xml = Dep("org.http4k", "http4k-format-xml", Ver("4.42.1.0", 0))
        val graphql = Dep("org.http4k", "http4k-graphql", Ver("4.42.1.0", 0))
        val incubator = Dep("org.http4k", "http4k-incubator", Ver("4.42.1.0", 0))
        val jsonrpc = Dep("org.http4k", "http4k-jsonrpc", Ver("4.42.1.0", 0))
        val metrics_micrometer = Dep("org.http4k", "http4k-metrics-micrometer", Ver("4.42.1.0", 0))
        val multipart = Dep("org.http4k", "http4k-multipart", Ver("4.42.1.0", 0))
        val opentelemetry = Dep("org.http4k", "http4k-opentelemetry", Ver("4.42.1.0", 0))
        val realtime_core = Dep("org.http4k", "http4k-realtime-core", Ver("4.42.1.0", 0))
        val resilience4j = Dep("org.http4k", "http4k-resilience4j", Ver("4.42.1.0", 0))
        val security_oauth = Dep("org.http4k", "http4k-security-oauth", Ver("4.42.1.0", 0))
        val server_apache = Dep("org.http4k", "http4k-server-apache", Ver("4.42.1.0", 0))
        val server_apache4 = Dep("org.http4k", "http4k-server-apache4", Ver("4.42.1.0", 0))
        val server_jetty = Dep("org.http4k", "http4k-server-jetty", Ver("4.42.1.0", 0))
        val server_ktorcio = Dep("org.http4k", "http4k-server-ktorcio", Ver("4.42.1.0", 0))
        val server_ktornetty = Dep("org.http4k", "http4k-server-ktornetty", Ver("4.42.1.0", 0))
        val server_netty = Dep("org.http4k", "http4k-server-netty", Ver("4.42.1.0", 0))
        val server_ratpack = Dep("org.http4k", "http4k-server-ratpack", Ver("4.42.1.0", 0))
        val server_undertow = Dep("org.http4k", "http4k-server-undertow", Ver("4.42.1.0", 0))
        val serverless_alibaba = Dep("org.http4k", "http4k-serverless-alibaba", Ver("4.42.1.0", 0))
        val serverless_azure = Dep("org.http4k", "http4k-serverless-azure", Ver("4.42.1.0", 0))
        val serverless_gcf = Dep("org.http4k", "http4k-serverless-gcf", Ver("4.42.1.0", 0))
        val serverless_lambda = Dep("org.http4k", "http4k-serverless-lambda", Ver("4.42.1.0", 0))
        val serverless_lambda_runtime = Dep("org.http4k", "http4k-serverless-lambda-runtime", Ver("4.42.1.0", 0))
        val serverless_openwhisk = Dep("org.http4k", "http4k-serverless-openwhisk", Ver("4.42.1.0", 0))
        val serverless_tencent = Dep("org.http4k", "http4k-serverless-tencent", Ver("4.42.1.0", 0))
        val template_core = Dep("org.http4k", "http4k-template-core", Ver("4.42.1.0", 0))
        val template_dust = Dep("org.http4k", "http4k-template-dust", Ver("4.42.1.0", 0))
        val template_freemarker = Dep("org.http4k", "http4k-template-freemarker", Ver("4.42.1.0", 0))
        val template_handlebars = Dep("org.http4k", "http4k-template-handlebars", Ver("4.42.1.0", 0))
        val template_jade4j = Dep("org.http4k", "http4k-template-jade4j", Ver("4.42.1.0", 0))
        val template_pebble = Dep("org.http4k", "http4k-template-pebble", Ver("4.42.1.0", 0))
        val template_thymeleaf = Dep("org.http4k", "http4k-template-thymeleaf", Ver("4.42.1.0", 0))
        val testing_approval = Dep("org.http4k", "http4k-testing-approval", Ver("4.42.1.0", 0))
        val testing_chaos = Dep("org.http4k", "http4k-testing-chaos", Ver("4.42.1.0", 0))
        val testing_hamkrest = Dep("org.http4k", "http4k-testing-hamkrest", Ver("4.42.1.0", 0))
        val testing_kotest = Dep("org.http4k", "http4k-testing-kotest", Ver("4.42.1.0", 0))
        val testing_servirtium = Dep("org.http4k", "http4k-testing-servirtium", Ver("4.42.1.0", 0))
        val testing_strikt = Dep("org.http4k", "http4k-testing-strikt", Ver("4.42.1.0", 0))
        val testing_webdriver = Dep("org.http4k", "http4k-testing-webdriver", Ver("4.42.1.0", 0))
    }
    object JUnit {
    ...
    object JetBrains {
        object Compose {
            val gradle_plugin = Dep("org.jetbrains.compose", "compose-gradle-plugin", Ver("1.4.0", 0))
        }
        object Exposed {
        ...
        object KotlinX {
            ...
            val coroutines_android = Dep("org.jetbrains.kotlinx", "kotlinx-coroutines-android", Ver("1.6.4", 0), Ver("1.7.0-RC", 100))
            val coroutines_bom = Dep("org.jetbrains.kotlinx", "kotlinx-coroutines-bom", Ver("1.6.4", 0), Ver("1.7.0-RC", 100))
            val coroutines_core = Dep("org.jetbrains.kotlinx", "kotlinx-coroutines-core", Ver("1.6.4", 0), Ver("1.7.0-RC", 100))
            val coroutines_debug = Dep("org.jetbrains.kotlinx", "kotlinx-coroutines-debug", Ver("1.6.4", 0), Ver("1.7.0-RC", 100))
            val coroutines_guava = Dep("org.jetbrains.kotlinx", "kotlinx-coroutines-guava", Ver("1.6.4", 0), Ver("1.7.0-RC", 100))
            val coroutines_javafx = Dep("org.jetbrains.kotlinx", "kotlinx-coroutines-javafx", Ver("1.6.4", 0), Ver("1.7.0-RC", 100))
            val coroutines_jdk8 = Dep("org.jetbrains.kotlinx", "kotlinx-coroutines-jdk8", Ver("1.6.4", 0), Ver("1.7.0-RC", 100))
            val coroutines_jdk9 = Dep("org.jetbrains.kotlinx", "kotlinx-coroutines-jdk9", Ver("1.6.4", 0), Ver("1.7.0-RC", 100))
            val coroutines_play_services = Dep("org.jetbrains.kotlinx", "kotlinx-coroutines-play-services", Ver("1.6.4", 0), Ver("1.7.0-RC", 100))
            val coroutines_reactive = Dep("org.jetbrains.kotlinx", "kotlinx-coroutines-reactive", Ver("1.6.4", 0), Ver("1.7.0-RC", 100))
            val coroutines_reactor = Dep("org.jetbrains.kotlinx", "kotlinx-coroutines-reactor", Ver("1.6.4", 0), Ver("1.7.0-RC", 100))
            val coroutines_rx2 = Dep("org.jetbrains.kotlinx", "kotlinx-coroutines-rx2", Ver("1.6.4", 0), Ver("1.7.0-RC", 100))
            val coroutines_rx3 = Dep("org.jetbrains.kotlinx", "kotlinx-coroutines-rx3", Ver("1.6.4", 0), Ver("1.7.0-RC", 100))
            val coroutines_slf4j = Dep("org.jetbrains.kotlinx", "kotlinx-coroutines-slf4j", Ver("1.6.4", 0), Ver("1.7.0-RC", 100))
            val coroutines_swing = Dep("org.jetbrains.kotlinx", "kotlinx-coroutines-swing", Ver("1.6.4", 0), Ver("1.7.0-RC", 100))
            val coroutines_test = Dep("org.jetbrains.kotlinx", "kotlinx-coroutines-test", Ver("1.6.4", 0), Ver("1.7.0-RC", 100))
        ...
        object Kotlin_Wrappers {
            val bom = Dep("org.jetbrains.kotlin-wrappers", "kotlin-wrappers-bom", Ver("1.0.0-pre.545", 0))
            val kotlin_actions_toolkit = Dep("org.jetbrains.kotlin-wrappers", "kotlin-actions-toolkit", Ver("0.0.1-pre.545", 0))
            val kotlin_browser = Dep("org.jetbrains.kotlin-wrappers", "kotlin-browser", Ver("1.0.0-pre.545", 0))
            val kotlin_cesium = Dep("org.jetbrains.kotlin-wrappers", "kotlin-cesium", Ver("1.104.0-pre.545", 0))
            val kotlin_css = Dep("org.jetbrains.kotlin-wrappers", "kotlin-css", Ver("1.0.0-pre.545", 0))
            val kotlin_csstype = Dep("org.jetbrains.kotlin-wrappers", "kotlin-csstype", Ver("3.1.2-pre.545", 0))
            val kotlin_emotion = Dep("org.jetbrains.kotlin-wrappers", "kotlin-emotion", Ver("11.10.8-pre.545", 0))
            val kotlin_history = Dep("org.jetbrains.kotlin-wrappers", "kotlin-history", Ver("5.3.0-pre.506-compat", 0))
            val kotlin_js = Dep("org.jetbrains.kotlin-wrappers", "kotlin-js", Ver("1.0.0-pre.545", 0))
            val kotlin_mui = Dep("org.jetbrains.kotlin-wrappers", "kotlin-mui", Ver("5.11.2-pre.545", 0))
            val kotlin_mui_icons = Dep("org.jetbrains.kotlin-wrappers", "kotlin-mui-icons", Ver("5.11.11-pre.545", 0))
            val kotlin_node = Dep("org.jetbrains.kotlin-wrappers", "kotlin-node", Ver("18.16.2-pre.545", 0))
            val kotlin_popper = Dep("org.jetbrains.kotlin-wrappers", "kotlin-popper", Ver("2.11.7-pre.545", 0))
            val kotlin_react = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react", Ver("18.2.0-pre.545", 0))
            val kotlin_react_beautiful_dnd = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-beautiful-dnd", Ver("13.1.1-pre.545", 0))
            val kotlin_react_core = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-core", Ver("18.2.0-pre.545", 0))
            val kotlin_react_dom = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-dom", Ver("18.2.0-pre.544", 0), Ver("18.2.0-pre.545", 0))
            val kotlin_react_dom_legacy = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-dom-legacy", Ver("18.2.0-pre.545", 0))
            val kotlin_react_dom_test_utils = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-dom-test-utils", Ver("18.2.0-pre.545", 0))
            val kotlin_react_legacy = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-legacy", Ver("18.2.0-pre.545", 0))
            val kotlin_react_popper = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-popper", Ver("2.3.0-pre.545", 0))
            val kotlin_react_redux = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-redux", Ver("7.2.6-pre.545", 0))
            val kotlin_react_router = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-router", Ver("6.11.0-pre.545", 0))
            val kotlin_react_router_dom = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-router-dom", Ver("6.11.0-pre.545", 0))
            val kotlin_react_select = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-select", Ver("5.7.2-pre.545", 0))
            val kotlin_react_use = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-use", Ver("17.4.0-pre.545", 0))
            val kotlin_redux = Dep("org.jetbrains.kotlin-wrappers", "kotlin-redux", Ver("4.1.2-pre.545", 0))
            val kotlin_remix_run_router = Dep("org.jetbrains.kotlin-wrappers", "kotlin-remix-run-router", Ver("1.6.0-pre.545", 0))
            val kotlin_ring_ui = Dep("org.jetbrains.kotlin-wrappers", "kotlin-ring-ui", Ver("4.1.5-pre.545", 0))
            val kotlin_styled = Dep("org.jetbrains.kotlin-wrappers", "kotlin-styled", Ver("5.3.9-pre.545", 0))
            val kotlin_styled_next = Dep("org.jetbrains.kotlin-wrappers", "kotlin-styled-next", Ver("1.2.2-pre.545", 0))
            val kotlin_tanstack_query_core = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-query-core", Ver("4.29.5-pre.545", 0))
            val kotlin_tanstack_react_query = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-react-query", Ver("4.29.5-pre.545", 0))
            val kotlin_tanstack_react_query_devtools = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-react-query-devtools", Ver("4.29.5-pre.545", 0))
            val kotlin_tanstack_react_table = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-react-table", Ver("8.8.5-pre.545", 0))
            val kotlin_tanstack_react_virtual = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-react-virtual", Ver("3.0.0-beta.54-pre.545", 200))
            val kotlin_tanstack_table_core = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-table-core", Ver("8.8.5-pre.545", 0))
            val kotlin_tanstack_virtual_core = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-virtual-core", Ver("3.0.0-beta.54-pre.545", 200))
            val kotlin_typescript = Dep("org.jetbrains.kotlin-wrappers", "kotlin-typescript", Ver("4.9.5-pre.545", 0))
            val kotlin_web = Dep("org.jetbrains.kotlin-wrappers", "kotlin-web", Ver("1.0.0-pre.545", 0))
        }
    }
    object Kodein {
        object Di {
