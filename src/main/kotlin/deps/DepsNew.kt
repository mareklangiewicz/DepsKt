...
object AndroidX {
    ...
    object Media3 {
        val cast = Dep("androidx.media3", "media3-cast", Ver("1.0.1", 0), Ver("1.1.0-alpha01", 300))
        val common = Dep("androidx.media3", "media3-common", Ver("1.0.1", 0), Ver("1.1.0-alpha01", 300))
        val database = Dep("androidx.media3", "media3-database", Ver("1.0.1", 0), Ver("1.1.0-alpha01", 300))
        val datasource = Dep("androidx.media3", "media3-datasource", Ver("1.0.1", 0), Ver("1.1.0-alpha01", 300))
        val datasource_cronet = Dep("androidx.media3", "media3-datasource-cronet", Ver("1.0.1", 0), Ver("1.1.0-alpha01", 300))
        val datasource_okhttp = Dep("androidx.media3", "media3-datasource-okhttp", Ver("1.0.1", 0), Ver("1.1.0-alpha01", 300))
        val datasource_rtmp = Dep("androidx.media3", "media3-datasource-rtmp", Ver("1.0.1", 0), Ver("1.1.0-alpha01", 300))
        val decoder = Dep("androidx.media3", "media3-decoder", Ver("1.0.1", 0), Ver("1.1.0-alpha01", 300))
        val exoplayer = Dep("androidx.media3", "media3-exoplayer", Ver("1.0.1", 0), Ver("1.1.0-alpha01", 300))
        val exoplayer_dash = Dep("androidx.media3", "media3-exoplayer-dash", Ver("1.0.1", 0), Ver("1.1.0-alpha01", 300))
        val exoplayer_hls = Dep("androidx.media3", "media3-exoplayer-hls", Ver("1.0.1", 0), Ver("1.1.0-alpha01", 300))
        val exoplayer_ima = Dep("androidx.media3", "media3-exoplayer-ima", Ver("1.0.1", 0), Ver("1.1.0-alpha01", 300))
        val exoplayer_rtsp = Dep("androidx.media3", "media3-exoplayer-rtsp", Ver("1.0.1", 0), Ver("1.1.0-alpha01", 300))
        val exoplayer_workmanager = Dep("androidx.media3", "media3-exoplayer-workmanager", Ver("1.0.1", 0), Ver("1.1.0-alpha01", 300))
        val extractor = Dep("androidx.media3", "media3-extractor", Ver("1.0.1", 0), Ver("1.1.0-alpha01", 300))
        val session = Dep("androidx.media3", "media3-session", Ver("1.0.1", 0), Ver("1.1.0-alpha01", 300))
        val test_utils = Dep("androidx.media3", "media3-test-utils", Ver("1.0.1", 0), Ver("1.1.0-alpha01", 300))
        val test_utils_robolectric = Dep("androidx.media3", "media3-test-utils-robolectric", Ver("1.0.1", 0), Ver("1.1.0-alpha01", 300))
        val transformer = Dep("androidx.media3", "media3-transformer", Ver("1.0.1", 0), Ver("1.1.0-alpha01", 300))
        val ui = Dep("androidx.media3", "media3-ui", Ver("1.0.1", 0), Ver("1.1.0-alpha01", 300))
        val ui_leanback = Dep("androidx.media3", "media3-ui-leanback", Ver("1.0.1", 0), Ver("1.1.0-alpha01", 300))
    }
    object MediaRouter {
...
object Com {
    object Android {
        ...
        object Tools {
            ...
            object Build {
                val gradle = Dep("com.android.tools.build", "gradle", Ver("2.3.0", 0), Ver("2.3.3", 0), Ver("2.4.0-alpha7", 300), Ver("2.5.0-alpha-preview-02", 400), Ver("8.0.1", 0), Ver("8.1.0-beta02", 200), Ver("8.2.0-alpha03", 300))
            }
        }
    }
    ...
    object Google {
        ...
        object Android {
            ...
            object Horologist {
                val audio = Dep("com.google.android.horologist", "horologist-audio", Ver("0.4.6", 0))
                val audio_ui = Dep("com.google.android.horologist", "horologist-audio-ui", Ver("0.4.6", 0))
                val composables = Dep("com.google.android.horologist", "horologist-composables", Ver("0.4.6", 0))
                val compose_layout = Dep("com.google.android.horologist", "horologist-compose-layout", Ver("0.4.6", 0))
                val compose_tools = Dep("com.google.android.horologist", "horologist-compose-tools", Ver("0.4.6", 0))
                val datalayer = Dep("com.google.android.horologist", "horologist-datalayer", Ver("0.4.6", 0))
                val media = Dep("com.google.android.horologist", "horologist-media", Ver("0.4.6", 0))
                val media3_backend = Dep("com.google.android.horologist", "horologist-media3-backend", Ver("0.4.6", 0))
                val media_data = Dep("com.google.android.horologist", "horologist-media-data", Ver("0.4.6", 0))
                val media_ui = Dep("com.google.android.horologist", "horologist-media-ui", Ver("0.4.6", 0))
                val network_awareness = Dep("com.google.android.horologist", "horologist-network-awareness", Ver("0.4.6", 0))
                val tiles = Dep("com.google.android.horologist", "horologist-tiles", Ver("0.4.6", 0))
            }
            object Libraries {
                object Places {
            ...
            object Material {
                ...
                val material = Dep("com.google.android.material", "material", Ver("1.9.0", 0), Ver("1.10.0-alpha02", 300))
            }
            object Play {
    ...
    object SquareUp {
        ...
        object LeakCanary {
            ...
            val deobfuscation_gradle_plugin = Dep("com.squareup.leakcanary", "leakcanary-deobfuscation-gradle-plugin", Ver("2.10", 0))
            val object_watcher = Dep("com.squareup.leakcanary", "leakcanary-object-watcher", Ver("2.10", 0))
            val object_watcher_android = Dep("com.squareup.leakcanary", "leakcanary-object-watcher-android", Ver("2.10", 0))
...
object Org {
    ...
    object Http4k {
        val aws = Dep("org.http4k", "http4k-aws", Ver("4.43.0.0", 0))
        val bom = Dep("org.http4k", "http4k-bom", Ver("4.43.0.0", 0))
        val client_apache = Dep("org.http4k", "http4k-client-apache", Ver("4.43.0.0", 0))
        val client_apache4 = Dep("org.http4k", "http4k-client-apache4", Ver("4.43.0.0", 0))
        val client_apache4_async = Dep("org.http4k", "http4k-client-apache4-async", Ver("4.43.0.0", 0))
        val client_apache_async = Dep("org.http4k", "http4k-client-apache-async", Ver("4.43.0.0", 0))
        val client_jetty = Dep("org.http4k", "http4k-client-jetty", Ver("4.43.0.0", 0))
        val client_okhttp = Dep("org.http4k", "http4k-client-okhttp", Ver("4.43.0.0", 0))
        val client_websocket = Dep("org.http4k", "http4k-client-websocket", Ver("4.43.0.0", 0))
        val cloudnative = Dep("org.http4k", "http4k-cloudnative", Ver("4.43.0.0", 0))
        val contract = Dep("org.http4k", "http4k-contract", Ver("4.43.0.0", 0))
        val core = Dep("org.http4k", "http4k-core", Ver("4.43.0.0", 0))
        val format_argo = Dep("org.http4k", "http4k-format-argo", Ver("4.43.0.0", 0))
        val format_core = Dep("org.http4k", "http4k-format-core", Ver("4.43.0.0", 0))
        val format_gson = Dep("org.http4k", "http4k-format-gson", Ver("4.43.0.0", 0))
        val format_jackson = Dep("org.http4k", "http4k-format-jackson", Ver("4.43.0.0", 0))
        val format_jackson_xml = Dep("org.http4k", "http4k-format-jackson-xml", Ver("4.43.0.0", 0))
        val format_jackson_yaml = Dep("org.http4k", "http4k-format-jackson-yaml", Ver("4.43.0.0", 0))
        val format_klaxon = Dep("org.http4k", "http4k-format-klaxon", Ver("4.43.0.0", 0))
        val format_kotlinx_serialization = Dep("org.http4k", "http4k-format-kotlinx-serialization", Ver("4.43.0.0", 0))
        val format_moshi = Dep("org.http4k", "http4k-format-moshi", Ver("4.43.0.0", 0))
        val format_xml = Dep("org.http4k", "http4k-format-xml", Ver("4.43.0.0", 0))
        val graphql = Dep("org.http4k", "http4k-graphql", Ver("4.43.0.0", 0))
        val incubator = Dep("org.http4k", "http4k-incubator", Ver("4.43.0.0", 0))
        val jsonrpc = Dep("org.http4k", "http4k-jsonrpc", Ver("4.43.0.0", 0))
        val metrics_micrometer = Dep("org.http4k", "http4k-metrics-micrometer", Ver("4.43.0.0", 0))
        val multipart = Dep("org.http4k", "http4k-multipart", Ver("4.43.0.0", 0))
        val opentelemetry = Dep("org.http4k", "http4k-opentelemetry", Ver("4.43.0.0", 0))
        val realtime_core = Dep("org.http4k", "http4k-realtime-core", Ver("4.43.0.0", 0))
        val resilience4j = Dep("org.http4k", "http4k-resilience4j", Ver("4.43.0.0", 0))
        val security_oauth = Dep("org.http4k", "http4k-security-oauth", Ver("4.43.0.0", 0))
        val server_apache = Dep("org.http4k", "http4k-server-apache", Ver("4.43.0.0", 0))
        val server_apache4 = Dep("org.http4k", "http4k-server-apache4", Ver("4.43.0.0", 0))
        val server_jetty = Dep("org.http4k", "http4k-server-jetty", Ver("4.43.0.0", 0))
        val server_ktorcio = Dep("org.http4k", "http4k-server-ktorcio", Ver("4.43.0.0", 0))
        val server_ktornetty = Dep("org.http4k", "http4k-server-ktornetty", Ver("4.43.0.0", 0))
        val server_netty = Dep("org.http4k", "http4k-server-netty", Ver("4.43.0.0", 0))
        val server_ratpack = Dep("org.http4k", "http4k-server-ratpack", Ver("4.43.0.0", 0))
        val server_undertow = Dep("org.http4k", "http4k-server-undertow", Ver("4.43.0.0", 0))
        val serverless_alibaba = Dep("org.http4k", "http4k-serverless-alibaba", Ver("4.43.0.0", 0))
        val serverless_azure = Dep("org.http4k", "http4k-serverless-azure", Ver("4.43.0.0", 0))
        val serverless_gcf = Dep("org.http4k", "http4k-serverless-gcf", Ver("4.43.0.0", 0))
        val serverless_lambda = Dep("org.http4k", "http4k-serverless-lambda", Ver("4.43.0.0", 0))
        val serverless_lambda_runtime = Dep("org.http4k", "http4k-serverless-lambda-runtime", Ver("4.43.0.0", 0))
        val serverless_openwhisk = Dep("org.http4k", "http4k-serverless-openwhisk", Ver("4.43.0.0", 0))
        val serverless_tencent = Dep("org.http4k", "http4k-serverless-tencent", Ver("4.43.0.0", 0))
        val template_core = Dep("org.http4k", "http4k-template-core", Ver("4.43.0.0", 0))
        val template_dust = Dep("org.http4k", "http4k-template-dust", Ver("4.43.0.0", 0))
        val template_freemarker = Dep("org.http4k", "http4k-template-freemarker", Ver("4.43.0.0", 0))
        val template_handlebars = Dep("org.http4k", "http4k-template-handlebars", Ver("4.43.0.0", 0))
        val template_jade4j = Dep("org.http4k", "http4k-template-jade4j", Ver("4.43.0.0", 0))
        val template_pebble = Dep("org.http4k", "http4k-template-pebble", Ver("4.43.0.0", 0))
        val template_thymeleaf = Dep("org.http4k", "http4k-template-thymeleaf", Ver("4.43.0.0", 0))
        val testing_approval = Dep("org.http4k", "http4k-testing-approval", Ver("4.43.0.0", 0))
        val testing_chaos = Dep("org.http4k", "http4k-testing-chaos", Ver("4.43.0.0", 0))
        val testing_hamkrest = Dep("org.http4k", "http4k-testing-hamkrest", Ver("4.43.0.0", 0))
        val testing_kotest = Dep("org.http4k", "http4k-testing-kotest", Ver("4.43.0.0", 0))
        val testing_servirtium = Dep("org.http4k", "http4k-testing-servirtium", Ver("4.43.0.0", 0))
        val testing_strikt = Dep("org.http4k", "http4k-testing-strikt", Ver("4.43.0.0", 0))
        val testing_webdriver = Dep("org.http4k", "http4k-testing-webdriver", Ver("4.43.0.0", 0))
    }
    object JUnit {
    ...
    object JetBrains {
        object Compose {
            val gradle_plugin = Dep("org.jetbrains.compose", "compose-gradle-plugin", Ver("1.4.0", 0), Ver("1.5.0-dev1043", 320))
        }
        object Exposed {
        ...
        object Kotlin_Wrappers {
            val bom = Dep("org.jetbrains.kotlin-wrappers", "kotlin-wrappers-bom", Ver("1.0.0-pre.549", 0))
            val kotlin_actions_toolkit = Dep("org.jetbrains.kotlin-wrappers", "kotlin-actions-toolkit", Ver("0.0.1-pre.549", 0))
            val kotlin_browser = Dep("org.jetbrains.kotlin-wrappers", "kotlin-browser", Ver("1.0.0-pre.549", 0))
            val kotlin_cesium = Dep("org.jetbrains.kotlin-wrappers", "kotlin-cesium", Ver("1.105.1-pre.549", 0))
            val kotlin_css = Dep("org.jetbrains.kotlin-wrappers", "kotlin-css", Ver("1.0.0-pre.549", 0))
            val kotlin_csstype = Dep("org.jetbrains.kotlin-wrappers", "kotlin-csstype", Ver("3.1.2-pre.549", 0))
            val kotlin_emotion = Dep("org.jetbrains.kotlin-wrappers", "kotlin-emotion", Ver("11.11.0-pre.549", 0))
            val kotlin_history = Dep("org.jetbrains.kotlin-wrappers", "kotlin-history", Ver("5.3.0-pre.506-compat", 0))
            val kotlin_js = Dep("org.jetbrains.kotlin-wrappers", "kotlin-js", Ver("1.0.0-pre.549", 0))
            val kotlin_mui = Dep("org.jetbrains.kotlin-wrappers", "kotlin-mui", Ver("5.11.2-pre.549", 0))
            val kotlin_mui_icons = Dep("org.jetbrains.kotlin-wrappers", "kotlin-mui-icons", Ver("5.11.11-pre.549", 0))
            val kotlin_node = Dep("org.jetbrains.kotlin-wrappers", "kotlin-node", Ver("18.16.3-pre.549", 0))
            val kotlin_popper = Dep("org.jetbrains.kotlin-wrappers", "kotlin-popper", Ver("2.11.7-pre.549", 0))
            val kotlin_react = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react", Ver("18.2.0-pre.549", 0))
            val kotlin_react_beautiful_dnd = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-beautiful-dnd", Ver("13.1.1-pre.549", 0))
            val kotlin_react_core = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-core", Ver("18.2.0-pre.549", 0))
            val kotlin_react_dom = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-dom", Ver("18.2.0-pre.549", 0))
            val kotlin_react_dom_legacy = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-dom-legacy", Ver("18.2.0-pre.549", 0))
            val kotlin_react_dom_test_utils = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-dom-test-utils", Ver("18.2.0-pre.549", 0))
            val kotlin_react_legacy = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-legacy", Ver("18.2.0-pre.549", 0))
            val kotlin_react_popper = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-popper", Ver("2.3.0-pre.549", 0))
            val kotlin_react_redux = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-redux", Ver("7.2.6-pre.549", 0))
            val kotlin_react_router = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-router", Ver("6.11.1-pre.549", 0))
            val kotlin_react_router_dom = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-router-dom", Ver("6.11.1-pre.549", 0))
            val kotlin_react_select = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-select", Ver("5.7.3-pre.549", 0))
            val kotlin_react_use = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-use", Ver("17.4.0-pre.549", 0))
            val kotlin_redux = Dep("org.jetbrains.kotlin-wrappers", "kotlin-redux", Ver("4.1.2-pre.549", 0))
            val kotlin_remix_run_router = Dep("org.jetbrains.kotlin-wrappers", "kotlin-remix-run-router", Ver("1.6.1-pre.549", 0))
            val kotlin_ring_ui = Dep("org.jetbrains.kotlin-wrappers", "kotlin-ring-ui", Ver("4.1.5-pre.549", 0))
            val kotlin_styled = Dep("org.jetbrains.kotlin-wrappers", "kotlin-styled", Ver("5.3.10-pre.549", 0))
            val kotlin_styled_next = Dep("org.jetbrains.kotlin-wrappers", "kotlin-styled-next", Ver("1.2.2-pre.549", 0))
            val kotlin_tanstack_query_core = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-query-core", Ver("4.29.5-pre.549", 0))
            val kotlin_tanstack_react_query = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-react-query", Ver("4.29.5-pre.549", 0))
            val kotlin_tanstack_react_query_devtools = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-react-query-devtools", Ver("4.29.5-pre.549", 0))
            val kotlin_tanstack_react_table = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-react-table", Ver("8.9.1-pre.549", 0))
            val kotlin_tanstack_react_virtual = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-react-virtual", Ver("3.0.0-beta.54-pre.549", 200))
            val kotlin_tanstack_table_core = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-table-core", Ver("8.9.1-pre.549", 0))
            val kotlin_tanstack_virtual_core = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-virtual-core", Ver("3.0.0-beta.54-pre.549", 200))
            val kotlin_typescript = Dep("org.jetbrains.kotlin-wrappers", "kotlin-typescript", Ver("4.9.5-pre.549", 0))
            val kotlin_web = Dep("org.jetbrains.kotlin-wrappers", "kotlin-web", Ver("1.0.0-pre.549", 0))
        }
    }
    object Kodein {
        object Di {
    ...
    object Robolectric {
        val robolectric = Dep("org.robolectric", "robolectric", Ver("4.10.2", 0))
    }
    ...
    object SpringFramework {
        ...
        object Boot {
            ...
            val spring_boot_starter_data_cassandra = Dep("org.springframework.boot", "spring-boot-starter-data-cassandra", Ver("3.0.6", 0))
            val spring_boot_starter_data_cassandra_reactive = Dep("org.springframework.boot", "spring-boot-starter-data-cassandra-reactive", Ver("3.0.6", 0))
            val spring_boot_starter_data_couchbase = Dep("org.springframework.boot", "spring-boot-starter-data-couchbase", Ver("3.0.6", 0))
            val spring_boot_starter_data_couchbase_reactive = Dep("org.springframework.boot", "spring-boot-starter-data-couchbase-reactive", Ver("3.0.6", 0))
            val spring_boot_starter_data_elasticsearch = Dep("org.springframework.boot", "spring-boot-starter-data-elasticsearch", Ver("3.0.6", 0))
            ...
            val spring_boot_starter_test = Dep("org.springframework.boot", "spring-boot-starter-test", Ver("3.0.6", 0))
        ...
        object Integration {
            val spring_integration_amqp = Dep("org.springframework.integration", "spring-integration-amqp", Ver("6.0.5", 0))
            val spring_integration_gemfire = Dep("org.springframework.integration", "spring-integration-gemfire", Ver("5.5.17", 0))
            val spring_integration_jdbc = Dep("org.springframework.integration", "spring-integration-jdbc", Ver("6.0.5", 0))
            val spring_integration_jms = Dep("org.springframework.integration", "spring-integration-jms", Ver("6.0.5", 0))
            val spring_integration_jpa = Dep("org.springframework.integration", "spring-integration-jpa", Ver("6.0.5", 0))
            val spring_integration_kafka = Dep("org.springframework.integration", "spring-integration-kafka", Ver("6.0.5", 0))
            val spring_integration_mail = Dep("org.springframework.integration", "spring-integration-mail", Ver("6.0.5", 0))
            val spring_integration_mongodb = Dep("org.springframework.integration", "spring-integration-mongodb", Ver("6.0.5", 0))
            val spring_integration_r2dbc = Dep("org.springframework.integration", "spring-integration-r2dbc", Ver("6.0.5", 0))
            val spring_integration_redis = Dep("org.springframework.integration", "spring-integration-redis", Ver("6.0.5", 0))
            val spring_integration_rsocket = Dep("org.springframework.integration", "spring-integration-rsocket", Ver("6.0.5", 0))
            val spring_integration_security = Dep("org.springframework.integration", "spring-integration-security", Ver("6.0.5", 0))
            val spring_integration_stomp = Dep("org.springframework.integration", "spring-integration-stomp", Ver("6.0.5", 0))
            val spring_integration_test = Dep("org.springframework.integration", "spring-integration-test", Ver("6.0.5", 0))
            val spring_integration_webflux = Dep("org.springframework.integration", "spring-integration-webflux", Ver("6.0.5", 0))
            val spring_integration_websocket = Dep("org.springframework.integration", "spring-integration-websocket", Ver("6.0.5", 0))
            val spring_integration_ws = Dep("org.springframework.integration", "spring-integration-ws", Ver("6.0.5", 0))
        }
        object Kafka {
            val spring_kafka = Dep("org.springframework.kafka", "spring-kafka", Ver("3.0.6", 0))
            val spring_kafka_test = Dep("org.springframework.kafka", "spring-kafka-test", Ver("3.0.6", 0))
        }
        object Restdocs {
            val spring_restdocs_webtestclient = Dep("org.springframework.restdocs", "spring-restdocs-webtestclient", Ver("3.0.0", 0))
        }
        object Security {
            val spring_security_messaging = Dep("org.springframework.security", "spring-security-messaging", Ver("6.0.3", 0))
            val spring_security_rsocket = Dep("org.springframework.security", "spring-security-rsocket", Ver("6.0.3", 0))
            val spring_security_test = Dep("org.springframework.security", "spring-security-test", Ver("6.0.3", 0))
        }
        object Session {
