...
object AndroidX {
    ...
    object Compose {
        ...
        object Compiler {
            val compiler = Dep("androidx.compose.compiler", "compiler", Ver("1.5.4", 0))
        }
        object Foundation {
...
object Com {
    object Android {
        ...
        object Tools {
            ...
            object Build {
                val gradle = Dep("com.android.tools.build", "gradle", Ver("2.3.0", 0), Ver("2.3.3", 0), Ver("2.4.0-alpha7", 300), Ver("2.5.0-alpha-preview-02", 400), Ver("8.1.3", 0), Ver("8.2.0-rc03", 100), Ver("8.3.0-alpha13", 300))
            }
        }
    }
    ...
    object Google {
        ...
        object Android {
            ...
            object Horologist {
                val audio = Dep("com.google.android.horologist", "horologist-audio", Ver("0.5.10", 0))
                val audio_ui = Dep("com.google.android.horologist", "horologist-audio-ui", Ver("0.5.10", 0))
                val composables = Dep("com.google.android.horologist", "horologist-composables", Ver("0.5.10", 0))
                val compose_layout = Dep("com.google.android.horologist", "horologist-compose-layout", Ver("0.5.10", 0))
                val compose_tools = Dep("com.google.android.horologist", "horologist-compose-tools", Ver("0.5.10", 0))
                val datalayer = Dep("com.google.android.horologist", "horologist-datalayer", Ver("0.5.10", 0))
                val media = Dep("com.google.android.horologist", "horologist-media", Ver("0.5.10", 0))
                val media3_backend = Dep("com.google.android.horologist", "horologist-media3-backend", Ver("0.5.10", 0))
                val media_data = Dep("com.google.android.horologist", "horologist-media-data", Ver("0.5.10", 0))
                val media_ui = Dep("com.google.android.horologist", "horologist-media-ui", Ver("0.5.10", 0))
                val network_awareness = Dep("com.google.android.horologist", "horologist-network-awareness", Ver("0.5.10", 0))
                val tiles = Dep("com.google.android.horologist", "horologist-tiles", Ver("0.5.10", 0))
            }
            object Libraries {
                object Places {
    ...
    object Rickclephas {
        object Kmp {
            val nativecoroutines_annotations = Dep("com.rickclephas.kmp", "kmp-nativecoroutines-annotations", Ver("0.13.3", 0), Ver("1.0.0-ALPHA-20", 300))
            val nativecoroutines_compiler = Dep("com.rickclephas.kmp", "kmp-nativecoroutines-compiler", Ver("0.13.3", 0), Ver("1.0.0-ALPHA-20", 300))
            val nativecoroutines_compiler_embeddable = Dep("com.rickclephas.kmp", "kmp-nativecoroutines-compiler-embeddable", Ver("0.13.3", 0), Ver("1.0.0-ALPHA-20", 300))
            val nativecoroutines_core = Dep("com.rickclephas.kmp", "kmp-nativecoroutines-core", Ver("0.13.3", 0), Ver("1.0.0-ALPHA-20", 300))
            val nativecoroutines_gradle_plugin = Dep("com.rickclephas.kmp", "kmp-nativecoroutines-gradle-plugin", Ver("0.13.3", 0), Ver("1.0.0-ALPHA-20", 300))
        }
    }
    object Russhwolf {
...
object Io {
    ...
    object GitHub {
        ...
        object TypeSafeGitHub {
            val github_workflows_kt = Dep("io.github.typesafegithub", "github-workflows-kt", Ver("1.5.0", 0))
        }
    }
    object Insert_koin {
    ...
    object Ktor {
        val client_android = Dep("io.ktor", "ktor-client-android", Ver("2.3.6", 0))
        val client_apache = Dep("io.ktor", "ktor-client-apache", Ver("2.3.6", 0))
        val client_auth = Dep("io.ktor", "ktor-client-auth", Ver("2.3.6", 0))
        val client_cio = Dep("io.ktor", "ktor-client-cio", Ver("2.3.6", 0))
        val client_content_negotiation = Dep("io.ktor", "ktor-client-content-negotiation", Ver("2.3.6", 0))
        val client_content_negotiation_tests = Dep("io.ktor", "ktor-client-content-negotiation-tests", Ver("2.3.6", 0))
        val client_core = Dep("io.ktor", "ktor-client-core", Ver("2.3.6", 0))
        val client_curl = Dep("io.ktor", "ktor-client-curl", Ver("2.3.6", 0))
        val client_darwin = Dep("io.ktor", "ktor-client-darwin", Ver("2.3.6", 0))
        val client_encoding = Dep("io.ktor", "ktor-client-encoding", Ver("2.3.6", 0))
        val client_gson = Dep("io.ktor", "ktor-client-gson", Ver("2.3.6", 0))
        val client_jackson = Dep("io.ktor", "ktor-client-jackson", Ver("2.3.6", 0))
        val client_java = Dep("io.ktor", "ktor-client-java", Ver("2.3.6", 0))
        val client_jetty = Dep("io.ktor", "ktor-client-jetty", Ver("2.3.6", 0))
        val client_json = Dep("io.ktor", "ktor-client-json", Ver("2.3.6", 0))
        val client_json_tests = Dep("io.ktor", "ktor-client-json-tests", Ver("2.3.6", 0))
        val client_logging = Dep("io.ktor", "ktor-client-logging", Ver("2.3.6", 0))
        val client_mock = Dep("io.ktor", "ktor-client-mock", Ver("2.3.6", 0))
        val client_okhttp = Dep("io.ktor", "ktor-client-okhttp", Ver("2.3.6", 0))
        val client_resources = Dep("io.ktor", "ktor-client-resources", Ver("2.3.6", 0))
        val client_serialization = Dep("io.ktor", "ktor-client-serialization", Ver("2.3.6", 0))
        val client_tests = Dep("io.ktor", "ktor-client-tests", Ver("2.3.6", 0))
        val events = Dep("io.ktor", "ktor-events", Ver("2.3.6", 0))
        val http = Dep("io.ktor", "ktor-http", Ver("2.3.6", 0))
        val http_cio = Dep("io.ktor", "ktor-http-cio", Ver("2.3.6", 0))
        val io = Dep("io.ktor", "ktor-io", Ver("2.3.6", 0))
        val network = Dep("io.ktor", "ktor-network", Ver("2.3.6", 0))
        val network_tls = Dep("io.ktor", "ktor-network-tls", Ver("2.3.6", 0))
        val network_tls_certificates = Dep("io.ktor", "ktor-network-tls-certificates", Ver("2.3.6", 0))
        val resources = Dep("io.ktor", "ktor-resources", Ver("2.3.6", 0))
        val serialization = Dep("io.ktor", "ktor-serialization", Ver("2.3.6", 0))
        val serialization_gson = Dep("io.ktor", "ktor-serialization-gson", Ver("2.3.6", 0))
        val serialization_jackson = Dep("io.ktor", "ktor-serialization-jackson", Ver("2.3.6", 0))
        val serialization_kotlinx = Dep("io.ktor", "ktor-serialization-kotlinx", Ver("2.3.6", 0))
        val serialization_kotlinx_cbor = Dep("io.ktor", "ktor-serialization-kotlinx-cbor", Ver("2.3.6", 0))
        val serialization_kotlinx_json = Dep("io.ktor", "ktor-serialization-kotlinx-json", Ver("2.3.6", 0))
        val serialization_kotlinx_tests = Dep("io.ktor", "ktor-serialization-kotlinx-tests", Ver("2.3.6", 0))
        val serialization_kotlinx_xml = Dep("io.ktor", "ktor-serialization-kotlinx-xml", Ver("2.3.6", 0))
        val server = Dep("io.ktor", "ktor-server", Ver("2.3.6", 0))
        val server_auth = Dep("io.ktor", "ktor-server-auth", Ver("2.3.6", 0))
        val server_auth_jwt = Dep("io.ktor", "ktor-server-auth-jwt", Ver("2.3.6", 0))
        val server_auth_ldap = Dep("io.ktor", "ktor-server-auth-ldap", Ver("2.3.6", 0))
        val server_auto_head_response = Dep("io.ktor", "ktor-server-auto-head-response", Ver("2.3.6", 0))
        val server_caching_headers = Dep("io.ktor", "ktor-server-caching-headers", Ver("2.3.6", 0))
        val server_call_id = Dep("io.ktor", "ktor-server-call-id", Ver("2.3.6", 0))
        val server_call_logging = Dep("io.ktor", "ktor-server-call-logging", Ver("2.3.6", 0))
        val server_cio = Dep("io.ktor", "ktor-server-cio", Ver("2.3.6", 0))
        val server_compression = Dep("io.ktor", "ktor-server-compression", Ver("2.3.6", 0))
        val server_conditional_headers = Dep("io.ktor", "ktor-server-conditional-headers", Ver("2.3.6", 0))
        val server_content_negotiation = Dep("io.ktor", "ktor-server-content-negotiation", Ver("2.3.6", 0))
        val server_core = Dep("io.ktor", "ktor-server-core", Ver("2.3.6", 0))
        val server_cors = Dep("io.ktor", "ktor-server-cors", Ver("2.3.6", 0))
        val server_data_conversion = Dep("io.ktor", "ktor-server-data-conversion", Ver("2.3.6", 0))
        val server_default_headers = Dep("io.ktor", "ktor-server-default-headers", Ver("2.3.6", 0))
        val server_double_receive = Dep("io.ktor", "ktor-server-double-receive", Ver("2.3.6", 0))
        val server_forwarded_header = Dep("io.ktor", "ktor-server-forwarded-header", Ver("2.3.6", 0))
        val server_freemarker = Dep("io.ktor", "ktor-server-freemarker", Ver("2.3.6", 0))
        val server_host_common = Dep("io.ktor", "ktor-server-host-common", Ver("2.3.6", 0))
        val server_hsts = Dep("io.ktor", "ktor-server-hsts", Ver("2.3.6", 0))
        val server_html_builder = Dep("io.ktor", "ktor-server-html-builder", Ver("2.3.6", 0))
        val server_http_redirect = Dep("io.ktor", "ktor-server-http-redirect", Ver("2.3.6", 0))
        val server_jetty = Dep("io.ktor", "ktor-server-jetty", Ver("2.3.6", 0))
        val server_jte = Dep("io.ktor", "ktor-server-jte", Ver("2.3.6", 0))
        val server_locations = Dep("io.ktor", "ktor-server-locations", Ver("2.3.6", 0))
        val server_method_override = Dep("io.ktor", "ktor-server-method-override", Ver("2.3.6", 0))
        val server_metrics = Dep("io.ktor", "ktor-server-metrics", Ver("2.3.6", 0))
        val server_metrics_micrometer = Dep("io.ktor", "ktor-server-metrics-micrometer", Ver("2.3.6", 0))
        val server_mustache = Dep("io.ktor", "ktor-server-mustache", Ver("2.3.6", 0))
        val server_netty = Dep("io.ktor", "ktor-server-netty", Ver("2.3.6", 0))
        val server_partial_content = Dep("io.ktor", "ktor-server-partial-content", Ver("2.3.6", 0))
        val server_pebble = Dep("io.ktor", "ktor-server-pebble", Ver("2.3.6", 0))
        val server_resources = Dep("io.ktor", "ktor-server-resources", Ver("2.3.6", 0))
        val server_servlet = Dep("io.ktor", "ktor-server-servlet", Ver("2.3.6", 0))
        val server_sessions = Dep("io.ktor", "ktor-server-sessions", Ver("2.3.6", 0))
        val server_status_pages = Dep("io.ktor", "ktor-server-status-pages", Ver("2.3.6", 0))
        val server_test_host = Dep("io.ktor", "ktor-server-test-host", Ver("2.3.6", 0))
        val server_test_suites = Dep("io.ktor", "ktor-server-test-suites", Ver("2.3.6", 0))
        val server_thymeleaf = Dep("io.ktor", "ktor-server-thymeleaf", Ver("2.3.6", 0))
        val server_tomcat = Dep("io.ktor", "ktor-server-tomcat", Ver("2.3.6", 0))
        val server_velocity = Dep("io.ktor", "ktor-server-velocity", Ver("2.3.6", 0))
        val server_webjars = Dep("io.ktor", "ktor-server-webjars", Ver("2.3.6", 0))
        val server_websockets = Dep("io.ktor", "ktor-server-websockets", Ver("2.3.6", 0))
        val test_dispatcher = Dep("io.ktor", "ktor-test-dispatcher", Ver("2.3.6", 0))
        val utils = Dep("io.ktor", "ktor-utils", Ver("2.3.6", 0))
        val websocket_serialization = Dep("io.ktor", "ktor-websocket-serialization", Ver("2.3.6", 0))
        val websockets = Dep("io.ktor", "ktor-websockets", Ver("2.3.6", 0))
    }
    object MockK {
...
object Org {
    ...
    object Http4k {
        val aws = Dep("org.http4k", "http4k-aws", Ver("5.10.2.0", 0))
        val bom = Dep("org.http4k", "http4k-bom", Ver("5.10.2.0", 0))
        val client_apache = Dep("org.http4k", "http4k-client-apache", Ver("5.10.2.0", 0))
        val client_apache4 = Dep("org.http4k", "http4k-client-apache4", Ver("5.10.2.0", 0))
        val client_apache4_async = Dep("org.http4k", "http4k-client-apache4-async", Ver("5.10.2.0", 0))
        val client_apache_async = Dep("org.http4k", "http4k-client-apache-async", Ver("5.10.2.0", 0))
        val client_jetty = Dep("org.http4k", "http4k-client-jetty", Ver("5.10.2.0", 0))
        val client_okhttp = Dep("org.http4k", "http4k-client-okhttp", Ver("5.10.2.0", 0))
        val client_websocket = Dep("org.http4k", "http4k-client-websocket", Ver("5.10.2.0", 0))
        val cloudnative = Dep("org.http4k", "http4k-cloudnative", Ver("5.10.2.0", 0))
        val contract = Dep("org.http4k", "http4k-contract", Ver("5.10.2.0", 0))
        val core = Dep("org.http4k", "http4k-core", Ver("5.10.2.0", 0))
        val format_argo = Dep("org.http4k", "http4k-format-argo", Ver("5.10.2.0", 0))
        val format_core = Dep("org.http4k", "http4k-format-core", Ver("5.10.2.0", 0))
        val format_gson = Dep("org.http4k", "http4k-format-gson", Ver("5.10.2.0", 0))
        val format_jackson = Dep("org.http4k", "http4k-format-jackson", Ver("5.10.2.0", 0))
        val format_jackson_xml = Dep("org.http4k", "http4k-format-jackson-xml", Ver("5.10.2.0", 0))
        val format_jackson_yaml = Dep("org.http4k", "http4k-format-jackson-yaml", Ver("5.10.2.0", 0))
        val format_klaxon = Dep("org.http4k", "http4k-format-klaxon", Ver("5.10.2.0", 0))
        val format_kotlinx_serialization = Dep("org.http4k", "http4k-format-kotlinx-serialization", Ver("5.10.2.0", 0))
        val format_moshi = Dep("org.http4k", "http4k-format-moshi", Ver("5.10.2.0", 0))
        val format_xml = Dep("org.http4k", "http4k-format-xml", Ver("5.10.2.0", 0))
        val graphql = Dep("org.http4k", "http4k-graphql", Ver("5.10.2.0", 0))
        val incubator = Dep("org.http4k", "http4k-incubator", Ver("5.10.2.0", 0))
        val jsonrpc = Dep("org.http4k", "http4k-jsonrpc", Ver("5.10.2.0", 0))
        val metrics_micrometer = Dep("org.http4k", "http4k-metrics-micrometer", Ver("5.10.2.0", 0))
        val multipart = Dep("org.http4k", "http4k-multipart", Ver("5.10.2.0", 0))
        val opentelemetry = Dep("org.http4k", "http4k-opentelemetry", Ver("5.10.2.0", 0))
        val realtime_core = Dep("org.http4k", "http4k-realtime-core", Ver("5.10.2.0", 0))
        val resilience4j = Dep("org.http4k", "http4k-resilience4j", Ver("5.10.2.0", 0))
        val security_oauth = Dep("org.http4k", "http4k-security-oauth", Ver("5.10.2.0", 0))
        val server_apache = Dep("org.http4k", "http4k-server-apache", Ver("5.10.2.0", 0))
        val server_apache4 = Dep("org.http4k", "http4k-server-apache4", Ver("5.10.2.0", 0))
        val server_jetty = Dep("org.http4k", "http4k-server-jetty", Ver("5.10.2.0", 0))
        val server_ktorcio = Dep("org.http4k", "http4k-server-ktorcio", Ver("5.10.2.0", 0))
        val server_ktornetty = Dep("org.http4k", "http4k-server-ktornetty", Ver("5.10.2.0", 0))
        val server_netty = Dep("org.http4k", "http4k-server-netty", Ver("5.10.2.0", 0))
        val server_ratpack = Dep("org.http4k", "http4k-server-ratpack", Ver("5.10.2.0", 0))
        val server_undertow = Dep("org.http4k", "http4k-server-undertow", Ver("5.10.2.0", 0))
        val serverless_alibaba = Dep("org.http4k", "http4k-serverless-alibaba", Ver("5.10.2.0", 0))
        val serverless_azure = Dep("org.http4k", "http4k-serverless-azure", Ver("5.10.2.0", 0))
        val serverless_gcf = Dep("org.http4k", "http4k-serverless-gcf", Ver("5.10.2.0", 0))
        val serverless_lambda = Dep("org.http4k", "http4k-serverless-lambda", Ver("5.10.2.0", 0))
        val serverless_lambda_runtime = Dep("org.http4k", "http4k-serverless-lambda-runtime", Ver("5.10.2.0", 0))
        val serverless_openwhisk = Dep("org.http4k", "http4k-serverless-openwhisk", Ver("5.10.2.0", 0))
        val serverless_tencent = Dep("org.http4k", "http4k-serverless-tencent", Ver("5.10.2.0", 0))
        val template_core = Dep("org.http4k", "http4k-template-core", Ver("5.10.2.0", 0))
        val template_dust = Dep("org.http4k", "http4k-template-dust", Ver("4.48.0.0", 0))
        val template_freemarker = Dep("org.http4k", "http4k-template-freemarker", Ver("5.10.2.0", 0))
        val template_handlebars = Dep("org.http4k", "http4k-template-handlebars", Ver("5.10.2.0", 0))
        val template_jade4j = Dep("org.http4k", "http4k-template-jade4j", Ver("5.10.2.0", 0))
        val template_pebble = Dep("org.http4k", "http4k-template-pebble", Ver("5.10.2.0", 0))
        val template_thymeleaf = Dep("org.http4k", "http4k-template-thymeleaf", Ver("5.10.2.0", 0))
        val testing_approval = Dep("org.http4k", "http4k-testing-approval", Ver("5.10.2.0", 0))
        val testing_chaos = Dep("org.http4k", "http4k-testing-chaos", Ver("5.10.2.0", 0))
        val testing_hamkrest = Dep("org.http4k", "http4k-testing-hamkrest", Ver("5.10.2.0", 0))
        val testing_kotest = Dep("org.http4k", "http4k-testing-kotest", Ver("5.10.2.0", 0))
        val testing_servirtium = Dep("org.http4k", "http4k-testing-servirtium", Ver("5.10.2.0", 0))
        val testing_strikt = Dep("org.http4k", "http4k-testing-strikt", Ver("5.10.2.0", 0))
        val testing_webdriver = Dep("org.http4k", "http4k-testing-webdriver", Ver("5.10.2.0", 0))
    }
    object JUnit {
    ...
    object JetBrains {
        object Compose {
            val gradle_plugin = Dep("org.jetbrains.compose", "compose-gradle-plugin", Ver("1.5.10", 0), Ver("1.6.0-dev1265", 320))
        }
        object Exposed {
        ...
        object Kotlin_Wrappers {
            val bom = Dep("org.jetbrains.kotlin-wrappers", "kotlin-wrappers-bom", Ver("1.0.0-pre.641", 0))
            val kotlin_actions_toolkit = Dep("org.jetbrains.kotlin-wrappers", "kotlin-actions-toolkit", Ver("0.0.1-pre.641", 0))
            val kotlin_browser = Dep("org.jetbrains.kotlin-wrappers", "kotlin-browser", Ver("1.0.0-pre.641", 0))
            val kotlin_cesium = Dep("org.jetbrains.kotlin-wrappers", "kotlin-cesium", Ver("1.111.0-pre.641", 0))
            val kotlin_css = Dep("org.jetbrains.kotlin-wrappers", "kotlin-css", Ver("1.0.0-pre.641", 0))
            val kotlin_csstype = Dep("org.jetbrains.kotlin-wrappers", "kotlin-csstype", Ver("3.1.2-pre.641", 0))
            val kotlin_emotion = Dep("org.jetbrains.kotlin-wrappers", "kotlin-emotion", Ver("11.11.1-pre.641", 0))
            val kotlin_history = Dep("org.jetbrains.kotlin-wrappers", "kotlin-history", Ver("5.3.0-pre.506-compat", 0))
            val kotlin_js = Dep("org.jetbrains.kotlin-wrappers", "kotlin-js", Ver("1.0.0-pre.641", 0))
            ...
            val kotlin_node = Dep("org.jetbrains.kotlin-wrappers", "kotlin-node", Ver("18.16.12-pre.641", 0))
            val kotlin_popper = Dep("org.jetbrains.kotlin-wrappers", "kotlin-popper", Ver("2.11.8-pre.641", 0))
            val kotlin_react = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react", Ver("18.2.0-pre.641", 0))
            val kotlin_react_beautiful_dnd = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-beautiful-dnd", Ver("13.1.1-pre.641", 0))
            val kotlin_react_core = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-core", Ver("18.2.0-pre.641", 0))
            val kotlin_react_dom = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-dom", Ver("18.2.0-pre.641", 0))
            val kotlin_react_dom_legacy = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-dom-legacy", Ver("18.2.0-pre.641", 0))
            val kotlin_react_dom_test_utils = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-dom-test-utils", Ver("18.2.0-pre.641", 0))
            val kotlin_react_legacy = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-legacy", Ver("18.2.0-pre.641", 0))
            val kotlin_react_popper = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-popper", Ver("2.3.0-pre.641", 0))
            val kotlin_react_redux = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-redux", Ver("7.2.6-pre.641", 0))
            val kotlin_react_router = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-router", Ver("6.17.0-pre.641", 0))
            val kotlin_react_router_dom = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-router-dom", Ver("6.17.0-pre.641", 0))
            val kotlin_react_select = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-select", Ver("5.7.5-pre.641", 0))
            val kotlin_react_use = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-use", Ver("17.4.0-pre.641", 0))
            val kotlin_redux = Dep("org.jetbrains.kotlin-wrappers", "kotlin-redux", Ver("4.1.2-pre.641", 0))
            val kotlin_remix_run_router = Dep("org.jetbrains.kotlin-wrappers", "kotlin-remix-run-router", Ver("1.10.0-pre.641", 0))
            val kotlin_ring_ui = Dep("org.jetbrains.kotlin-wrappers", "kotlin-ring-ui", Ver("4.1.5-pre.641", 0))
            val kotlin_styled = Dep("org.jetbrains.kotlin-wrappers", "kotlin-styled", Ver("5.3.11-pre.641", 0))
            val kotlin_styled_next = Dep("org.jetbrains.kotlin-wrappers", "kotlin-styled-next", Ver("1.2.3-pre.641", 0))
            val kotlin_tanstack_query_core = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-query-core", Ver("4.36.1-pre.641", 0))
            val kotlin_tanstack_react_query = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-react-query", Ver("4.36.1-pre.641", 0))
            val kotlin_tanstack_react_query_devtools = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-react-query-devtools", Ver("4.36.1-pre.641", 0))
            val kotlin_tanstack_react_table = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-react-table", Ver("8.10.0-pre.641", 0))
            val kotlin_tanstack_react_virtual = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-react-virtual", Ver("3.0.0-beta.68-pre.641", 200))
            val kotlin_tanstack_table_core = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-table-core", Ver("8.10.0-pre.641", 0))
            val kotlin_tanstack_virtual_core = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-virtual-core", Ver("3.0.0-beta.68-pre.641", 200))
            val kotlin_typescript = Dep("org.jetbrains.kotlin-wrappers", "kotlin-typescript", Ver("4.9.5-pre.641", 0))
            val kotlin_web = Dep("org.jetbrains.kotlin-wrappers", "kotlin-web", Ver("1.0.0-pre.641", 0))
        }
    }
    object Kodein {
        object Di {
...
object Pl {
    object MarekLangiewicz {
        ...
        val kground = Dep("pl.mareklangiewicz", "kground", Ver("0.0.13", 0))
        val kground_io = Dep("pl.mareklangiewicz", "kground-io", Ver("0.0.13", 0))
        val kground_io_js = Dep("pl.mareklangiewicz", "kground-io-js", Ver("0.0.13", 0))
        val kground_io_jvm = Dep("pl.mareklangiewicz", "kground-io-jvm", Ver("0.0.13", 0))
        val kground_js = Dep("pl.mareklangiewicz", "kground-js", Ver("0.0.13", 0))
        val kground_jvm = Dep("pl.mareklangiewicz", "kground-jvm", Ver("0.0.13", 0))
        val kgroundx = Dep("pl.mareklangiewicz", "kgroundx", Ver("0.0.13", 0))
        val kgroundx_io = Dep("pl.mareklangiewicz", "kgroundx-io", Ver("0.0.13", 0))
        val kgroundx_io_js = Dep("pl.mareklangiewicz", "kgroundx-io-js", Ver("0.0.13", 0))
        val kgroundx_io_jvm = Dep("pl.mareklangiewicz", "kgroundx-io-jvm", Ver("0.0.13", 0))
        val kgroundx_js = Dep("pl.mareklangiewicz", "kgroundx-js", Ver("0.0.13", 0))
        val kgroundx_jvm = Dep("pl.mareklangiewicz", "kgroundx-jvm", Ver("0.0.13", 0))
        val kgroundx_maintenance = Dep("pl.mareklangiewicz", "kgroundx-maintenance", Ver("0.0.13", 0))
        val kgroundx_maintenance_jvm = Dep("pl.mareklangiewicz", "kgroundx-maintenance-jvm", Ver("0.0.13", 0))
        val kommandjupyter = Dep("pl.mareklangiewicz", "kommandjupyter", Ver("0.0.29", 0))
        val kommandjupyter_jvm = Dep("pl.mareklangiewicz", "kommandjupyter-jvm", Ver("0.0.29", 0))
        val kommandline = Dep("pl.mareklangiewicz", "kommandline", Ver("0.0.29", 0))
        val kommandline_js = Dep("pl.mareklangiewicz", "kommandline-js", Ver("0.0.29", 0))
        val kommandline_jvm = Dep("pl.mareklangiewicz", "kommandline-jvm", Ver("0.0.29", 0))
        val kommandsamples = Dep("pl.mareklangiewicz", "kommandsamples", Ver("0.0.29", 0))
        val kommandsamples_js = Dep("pl.mareklangiewicz", "kommandsamples-js", Ver("0.0.29", 0))
        val kommandsamples_jvm = Dep("pl.mareklangiewicz", "kommandsamples-jvm", Ver("0.0.29", 0))
