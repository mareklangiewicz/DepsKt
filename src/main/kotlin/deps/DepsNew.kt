...
object AndroidX {
    ...
    object Compose {
        val bom = Dep("androidx.compose", "compose-bom", Ver("2023.09.02", 0))
        object Animation {
            val animation = Dep("androidx.compose.animation", "animation", Ver("1.5.2", 0), Ver("1.6.0-alpha06", 300))
            val core = Dep("androidx.compose.animation", "animation-core", Ver("1.5.2", 0), Ver("1.6.0-alpha06", 300))
            val graphics = Dep("androidx.compose.animation", "animation-graphics", Ver("1.5.2", 0), Ver("1.6.0-alpha06", 300))
        }
        object Compiler {
            val compiler = Dep("androidx.compose.compiler", "compiler", Ver("1.5.3", 0))
        }
        object Foundation {
            val foundation = Dep("androidx.compose.foundation", "foundation", Ver("1.5.2", 0), Ver("1.6.0-alpha06", 300))
            val layout = Dep("androidx.compose.foundation", "foundation-layout", Ver("1.5.2", 0), Ver("1.6.0-alpha06", 300))
        }
        object Material {
            val icons_core = Dep("androidx.compose.material", "material-icons-core", Ver("1.5.2", 0), Ver("1.6.0-alpha06", 300))
            val icons_extended = Dep("androidx.compose.material", "material-icons-extended", Ver("1.5.2", 0), Ver("1.6.0-alpha06", 300))
            val material = Dep("androidx.compose.material", "material", Ver("1.5.2", 0), Ver("1.6.0-alpha06", 300))
            val ripple = Dep("androidx.compose.material", "material-ripple", Ver("1.5.2", 0), Ver("1.6.0-alpha06", 300))
        }
        object Material3 {
        ...
        object Runtime {
            ...
            val livedata = Dep("androidx.compose.runtime", "runtime-livedata", Ver("1.5.2", 0), Ver("1.6.0-alpha06", 300))
            val runtime = Dep("androidx.compose.runtime", "runtime", Ver("1.5.2", 0), Ver("1.6.0-alpha06", 300))
            val rxjava2 = Dep("androidx.compose.runtime", "runtime-rxjava2", Ver("1.5.2", 0), Ver("1.6.0-alpha06", 300))
            val rxjava3 = Dep("androidx.compose.runtime", "runtime-rxjava3", Ver("1.5.2", 0), Ver("1.6.0-alpha06", 300))
            val saveable = Dep("androidx.compose.runtime", "runtime-saveable", Ver("1.5.2", 0), Ver("1.6.0-alpha06", 300))
            val tracing = Dep("androidx.compose.runtime", "runtime-tracing", Ver("1.0.0-alpha04", 300))
        }
        object Ui {
            val geometry = Dep("androidx.compose.ui", "ui-geometry", Ver("1.5.2", 0), Ver("1.6.0-alpha06", 300))
            val graphics = Dep("androidx.compose.ui", "ui-graphics", Ver("1.5.2", 0), Ver("1.6.0-alpha06", 300))
            val test = Dep("androidx.compose.ui", "ui-test", Ver("1.5.2", 0), Ver("1.6.0-alpha06", 300))
            val test_junit4 = Dep("androidx.compose.ui", "ui-test-junit4", Ver("1.5.2", 0), Ver("1.6.0-alpha06", 300))
            val test_manifest = Dep("androidx.compose.ui", "ui-test-manifest", Ver("1.5.2", 0), Ver("1.6.0-alpha06", 300))
            val text = Dep("androidx.compose.ui", "ui-text", Ver("1.5.2", 0), Ver("1.6.0-alpha06", 300))
            val text_google_fonts = Dep("androidx.compose.ui", "ui-text-google-fonts", Ver("1.5.2", 0), Ver("1.6.0-alpha06", 300))
            val tooling = Dep("androidx.compose.ui", "ui-tooling", Ver("1.5.2", 0), Ver("1.6.0-alpha06", 300))
            val tooling_data = Dep("androidx.compose.ui", "ui-tooling-data", Ver("1.5.2", 0), Ver("1.6.0-alpha06", 300))
            val tooling_preview = Dep("androidx.compose.ui", "ui-tooling-preview", Ver("1.5.2", 0), Ver("1.6.0-alpha06", 300))
            val ui = Dep("androidx.compose.ui", "ui", Ver("1.5.2", 0), Ver("1.6.0-alpha06", 300))
            val unit = Dep("androidx.compose.ui", "ui-unit", Ver("1.5.2", 0), Ver("1.6.0-alpha06", 300))
            val util = Dep("androidx.compose.ui", "ui-util", Ver("1.5.2", 0), Ver("1.6.0-alpha06", 300))
            val viewbinding = Dep("androidx.compose.ui", "ui-viewbinding", Ver("1.5.2", 0), Ver("1.6.0-alpha06", 300))
        }
    }
    object Concurrent {
    ...
    object Media3 {
        val cast = Dep("androidx.media3", "media3-cast", Ver("1.1.1", 0), Ver("1.2.0-alpha02", 300))
        val common = Dep("androidx.media3", "media3-common", Ver("1.1.1", 0), Ver("1.2.0-alpha02", 300))
        val database = Dep("androidx.media3", "media3-database", Ver("1.1.1", 0), Ver("1.2.0-alpha02", 300))
        val datasource = Dep("androidx.media3", "media3-datasource", Ver("1.1.1", 0), Ver("1.2.0-alpha02", 300))
        val datasource_cronet = Dep("androidx.media3", "media3-datasource-cronet", Ver("1.1.1", 0), Ver("1.2.0-alpha02", 300))
        val datasource_okhttp = Dep("androidx.media3", "media3-datasource-okhttp", Ver("1.1.1", 0), Ver("1.2.0-alpha02", 300))
        val datasource_rtmp = Dep("androidx.media3", "media3-datasource-rtmp", Ver("1.1.1", 0), Ver("1.2.0-alpha02", 300))
        val decoder = Dep("androidx.media3", "media3-decoder", Ver("1.1.1", 0), Ver("1.2.0-alpha02", 300))
        val exoplayer = Dep("androidx.media3", "media3-exoplayer", Ver("1.1.1", 0), Ver("1.2.0-alpha02", 300))
        val exoplayer_dash = Dep("androidx.media3", "media3-exoplayer-dash", Ver("1.1.1", 0), Ver("1.2.0-alpha02", 300))
        val exoplayer_hls = Dep("androidx.media3", "media3-exoplayer-hls", Ver("1.1.1", 0), Ver("1.2.0-alpha02", 300))
        val exoplayer_ima = Dep("androidx.media3", "media3-exoplayer-ima", Ver("1.1.1", 0), Ver("1.2.0-alpha02", 300))
        val exoplayer_rtsp = Dep("androidx.media3", "media3-exoplayer-rtsp", Ver("1.1.1", 0), Ver("1.2.0-alpha02", 300))
        val exoplayer_workmanager = Dep("androidx.media3", "media3-exoplayer-workmanager", Ver("1.1.1", 0), Ver("1.2.0-alpha02", 300))
        val extractor = Dep("androidx.media3", "media3-extractor", Ver("1.1.1", 0), Ver("1.2.0-alpha02", 300))
        val session = Dep("androidx.media3", "media3-session", Ver("1.1.1", 0), Ver("1.2.0-alpha02", 300))
        val test_utils = Dep("androidx.media3", "media3-test-utils", Ver("1.1.1", 0), Ver("1.2.0-alpha02", 300))
        val test_utils_robolectric = Dep("androidx.media3", "media3-test-utils-robolectric", Ver("1.1.1", 0), Ver("1.2.0-alpha02", 300))
        val transformer = Dep("androidx.media3", "media3-transformer", Ver("1.1.1", 0), Ver("1.2.0-alpha02", 300))
        val ui = Dep("androidx.media3", "media3-ui", Ver("1.1.1", 0), Ver("1.2.0-alpha02", 300))
        val ui_leanback = Dep("androidx.media3", "media3-ui-leanback", Ver("1.1.1", 0), Ver("1.2.0-alpha02", 300))
    }
    object MediaRouter {
...
object Co {
    object TouchLab {
        ...
        val stately_common = Dep("co.touchlab", "stately-common", Ver("2.0.4", 0))
        val stately_concurrency = Dep("co.touchlab", "stately-concurrency", Ver("2.0.4", 0))
        val stately_iso_collections = Dep("co.touchlab", "stately-iso-collections", Ver("2.0.4", 0))
        val stately_isolate = Dep("co.touchlab", "stately-isolate", Ver("2.0.4", 0))
    }
}
object Com {
    object Android {
        ...
        object Tools {
            ...
            object Build {
                val gradle = Dep("com.android.tools.build", "gradle", Ver("2.3.0", 0), Ver("2.3.3", 0), Ver("2.4.0-alpha7", 300), Ver("2.5.0-alpha-preview-02", 400), Ver("8.1.2", 0), Ver("8.2.0-beta06", 200), Ver("8.3.0-alpha06", 300))
            }
        }
    }
    ...
    object Google {
        ...
        object Maps {
            object Android {
                ...
                val maps_ktx = Dep("com.google.maps.android", "maps-ktx", Ver("4.0.0", 0))
                ...
                val maps_utils_ktx = Dep("com.google.maps.android", "maps-utils-ktx", Ver("4.0.0", 0))
            }
        }
        object MlKit {
    ...
    object SquareUp {
        ...
        object Wire {
            val gradle_plugin = Dep("com.squareup.wire", "wire-gradle-plugin", Ver("4.9.1", 0))
            val grpc_client = Dep("com.squareup.wire", "wire-grpc-client", Ver("4.9.1", 0))
            val runtime = Dep("com.squareup.wire", "wire-runtime", Ver("4.9.1", 0))
        }
    }
}
object Io {
    ...
    object GitHub {
        ...
        object TypeSafeGitHub {
            val github_workflows_kt = Dep("io.github.typesafegithub", "github-workflows-kt", Ver("1.1.0", 0), Ver("1.2.0", 0))
        }
    }
    object Insert_koin {
...
object Org {
    ...
    object Http4k {
        val aws = Dep("org.http4k", "http4k-aws", Ver("5.8.2.0", 0))
        val bom = Dep("org.http4k", "http4k-bom", Ver("5.8.2.0", 0))
        val client_apache = Dep("org.http4k", "http4k-client-apache", Ver("5.8.2.0", 0))
        val client_apache4 = Dep("org.http4k", "http4k-client-apache4", Ver("5.8.2.0", 0))
        val client_apache4_async = Dep("org.http4k", "http4k-client-apache4-async", Ver("5.8.2.0", 0))
        val client_apache_async = Dep("org.http4k", "http4k-client-apache-async", Ver("5.8.2.0", 0))
        val client_jetty = Dep("org.http4k", "http4k-client-jetty", Ver("5.8.2.0", 0))
        val client_okhttp = Dep("org.http4k", "http4k-client-okhttp", Ver("5.8.2.0", 0))
        val client_websocket = Dep("org.http4k", "http4k-client-websocket", Ver("5.8.2.0", 0))
        val cloudnative = Dep("org.http4k", "http4k-cloudnative", Ver("5.8.2.0", 0))
        val contract = Dep("org.http4k", "http4k-contract", Ver("5.8.2.0", 0))
        val core = Dep("org.http4k", "http4k-core", Ver("5.8.2.0", 0))
        val format_argo = Dep("org.http4k", "http4k-format-argo", Ver("5.8.2.0", 0))
        val format_core = Dep("org.http4k", "http4k-format-core", Ver("5.8.2.0", 0))
        val format_gson = Dep("org.http4k", "http4k-format-gson", Ver("5.8.2.0", 0))
        val format_jackson = Dep("org.http4k", "http4k-format-jackson", Ver("5.8.2.0", 0))
        val format_jackson_xml = Dep("org.http4k", "http4k-format-jackson-xml", Ver("5.8.2.0", 0))
        val format_jackson_yaml = Dep("org.http4k", "http4k-format-jackson-yaml", Ver("5.8.2.0", 0))
        val format_klaxon = Dep("org.http4k", "http4k-format-klaxon", Ver("5.8.2.0", 0))
        val format_kotlinx_serialization = Dep("org.http4k", "http4k-format-kotlinx-serialization", Ver("5.8.2.0", 0))
        val format_moshi = Dep("org.http4k", "http4k-format-moshi", Ver("5.8.2.0", 0))
        val format_xml = Dep("org.http4k", "http4k-format-xml", Ver("5.8.2.0", 0))
        val graphql = Dep("org.http4k", "http4k-graphql", Ver("5.8.2.0", 0))
        val incubator = Dep("org.http4k", "http4k-incubator", Ver("5.8.2.0", 0))
        val jsonrpc = Dep("org.http4k", "http4k-jsonrpc", Ver("5.8.2.0", 0))
        val metrics_micrometer = Dep("org.http4k", "http4k-metrics-micrometer", Ver("5.8.2.0", 0))
        val multipart = Dep("org.http4k", "http4k-multipart", Ver("5.8.2.0", 0))
        val opentelemetry = Dep("org.http4k", "http4k-opentelemetry", Ver("5.8.2.0", 0))
        val realtime_core = Dep("org.http4k", "http4k-realtime-core", Ver("5.8.2.0", 0))
        val resilience4j = Dep("org.http4k", "http4k-resilience4j", Ver("5.8.2.0", 0))
        val security_oauth = Dep("org.http4k", "http4k-security-oauth", Ver("5.8.2.0", 0))
        val server_apache = Dep("org.http4k", "http4k-server-apache", Ver("5.8.2.0", 0))
        val server_apache4 = Dep("org.http4k", "http4k-server-apache4", Ver("5.8.2.0", 0))
        val server_jetty = Dep("org.http4k", "http4k-server-jetty", Ver("5.8.2.0", 0))
        val server_ktorcio = Dep("org.http4k", "http4k-server-ktorcio", Ver("5.8.2.0", 0))
        val server_ktornetty = Dep("org.http4k", "http4k-server-ktornetty", Ver("5.8.2.0", 0))
        val server_netty = Dep("org.http4k", "http4k-server-netty", Ver("5.8.2.0", 0))
        val server_ratpack = Dep("org.http4k", "http4k-server-ratpack", Ver("5.8.2.0", 0))
        val server_undertow = Dep("org.http4k", "http4k-server-undertow", Ver("5.8.2.0", 0))
        val serverless_alibaba = Dep("org.http4k", "http4k-serverless-alibaba", Ver("5.8.2.0", 0))
        val serverless_azure = Dep("org.http4k", "http4k-serverless-azure", Ver("5.8.2.0", 0))
        val serverless_gcf = Dep("org.http4k", "http4k-serverless-gcf", Ver("5.8.2.0", 0))
        val serverless_lambda = Dep("org.http4k", "http4k-serverless-lambda", Ver("5.8.2.0", 0))
        val serverless_lambda_runtime = Dep("org.http4k", "http4k-serverless-lambda-runtime", Ver("5.8.2.0", 0))
        val serverless_openwhisk = Dep("org.http4k", "http4k-serverless-openwhisk", Ver("5.8.2.0", 0))
        val serverless_tencent = Dep("org.http4k", "http4k-serverless-tencent", Ver("5.8.2.0", 0))
        val template_core = Dep("org.http4k", "http4k-template-core", Ver("5.8.2.0", 0))
        val template_dust = Dep("org.http4k", "http4k-template-dust", Ver("4.48.0.0", 0))
        val template_freemarker = Dep("org.http4k", "http4k-template-freemarker", Ver("5.8.2.0", 0))
        val template_handlebars = Dep("org.http4k", "http4k-template-handlebars", Ver("5.8.2.0", 0))
        val template_jade4j = Dep("org.http4k", "http4k-template-jade4j", Ver("5.8.2.0", 0))
        val template_pebble = Dep("org.http4k", "http4k-template-pebble", Ver("5.8.2.0", 0))
        val template_thymeleaf = Dep("org.http4k", "http4k-template-thymeleaf", Ver("5.8.2.0", 0))
        val testing_approval = Dep("org.http4k", "http4k-testing-approval", Ver("5.8.2.0", 0))
        val testing_chaos = Dep("org.http4k", "http4k-testing-chaos", Ver("5.8.2.0", 0))
        val testing_hamkrest = Dep("org.http4k", "http4k-testing-hamkrest", Ver("5.8.2.0", 0))
        val testing_kotest = Dep("org.http4k", "http4k-testing-kotest", Ver("5.8.2.0", 0))
        val testing_servirtium = Dep("org.http4k", "http4k-testing-servirtium", Ver("5.8.2.0", 0))
        val testing_strikt = Dep("org.http4k", "http4k-testing-strikt", Ver("5.8.2.0", 0))
        val testing_webdriver = Dep("org.http4k", "http4k-testing-webdriver", Ver("5.8.2.0", 0))
    }
    object JUnit {
    ...
    object JetBrains {
        object Compose {
            val gradle_plugin = Dep("org.jetbrains.compose", "compose-gradle-plugin", Ver("1.5.2", 0), Ver("1.5.10-beta02", 200))
        }
        object Exposed {
            val core = Dep("org.jetbrains.exposed", "exposed-core", Ver("0.44.0", 0))
            val dao = Dep("org.jetbrains.exposed", "exposed-dao", Ver("0.44.0", 0))
            val jdbc = Dep("org.jetbrains.exposed", "exposed-jdbc", Ver("0.44.0", 0))
        }
        object Kotlin {
        ...
        object Kotlin_Wrappers {
            val bom = Dep("org.jetbrains.kotlin-wrappers", "kotlin-wrappers-bom", Ver("1.0.0-pre.628", 0))
            val kotlin_actions_toolkit = Dep("org.jetbrains.kotlin-wrappers", "kotlin-actions-toolkit", Ver("0.0.1-pre.628", 0))
            val kotlin_browser = Dep("org.jetbrains.kotlin-wrappers", "kotlin-browser", Ver("1.0.0-pre.628", 0))
            val kotlin_cesium = Dep("org.jetbrains.kotlin-wrappers", "kotlin-cesium", Ver("1.109.0-pre.628", 0))
            val kotlin_css = Dep("org.jetbrains.kotlin-wrappers", "kotlin-css", Ver("1.0.0-pre.628", 0))
            val kotlin_csstype = Dep("org.jetbrains.kotlin-wrappers", "kotlin-csstype", Ver("3.1.2-pre.628", 0))
            val kotlin_emotion = Dep("org.jetbrains.kotlin-wrappers", "kotlin-emotion", Ver("11.11.1-pre.628", 0))
            val kotlin_history = Dep("org.jetbrains.kotlin-wrappers", "kotlin-history", Ver("5.3.0-pre.506-compat", 0))
            val kotlin_js = Dep("org.jetbrains.kotlin-wrappers", "kotlin-js", Ver("1.0.0-pre.628", 0))
            val kotlin_mui = Dep("org.jetbrains.kotlin-wrappers", "kotlin-mui", Ver("5.14.7-pre.628", 0))
            val kotlin_mui_icons = Dep("org.jetbrains.kotlin-wrappers", "kotlin-mui-icons", Ver("5.14.7-pre.628", 0))
            val kotlin_node = Dep("org.jetbrains.kotlin-wrappers", "kotlin-node", Ver("18.16.12-pre.628", 0))
            val kotlin_popper = Dep("org.jetbrains.kotlin-wrappers", "kotlin-popper", Ver("2.11.8-pre.628", 0))
            val kotlin_react = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react", Ver("18.2.0-pre.628", 0))
            val kotlin_react_beautiful_dnd = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-beautiful-dnd", Ver("13.1.1-pre.628", 0))
            val kotlin_react_core = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-core", Ver("18.2.0-pre.628", 0))
            val kotlin_react_dom = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-dom", Ver("18.2.0-pre.628", 0))
            val kotlin_react_dom_legacy = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-dom-legacy", Ver("18.2.0-pre.627", 0), Ver("18.2.0-pre.628", 0))
            val kotlin_react_dom_test_utils = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-dom-test-utils", Ver("18.2.0-pre.628", 0))
            val kotlin_react_legacy = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-legacy", Ver("18.2.0-pre.628", 0))
            val kotlin_react_popper = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-popper", Ver("2.3.0-pre.628", 0))
            val kotlin_react_redux = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-redux", Ver("7.2.6-pre.628", 0))
            val kotlin_react_router = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-router", Ver("6.16.0-pre.628", 0))
            val kotlin_react_router_dom = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-router-dom", Ver("6.16.0-pre.628", 0))
            val kotlin_react_select = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-select", Ver("5.7.5-pre.628", 0))
            val kotlin_react_use = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-use", Ver("17.4.0-pre.628", 0))
            val kotlin_redux = Dep("org.jetbrains.kotlin-wrappers", "kotlin-redux", Ver("4.1.2-pre.628", 0))
            val kotlin_remix_run_router = Dep("org.jetbrains.kotlin-wrappers", "kotlin-remix-run-router", Ver("1.9.0-pre.628", 0))
            val kotlin_ring_ui = Dep("org.jetbrains.kotlin-wrappers", "kotlin-ring-ui", Ver("4.1.5-pre.628", 0))
            val kotlin_styled = Dep("org.jetbrains.kotlin-wrappers", "kotlin-styled", Ver("5.3.11-pre.628", 0))
            val kotlin_styled_next = Dep("org.jetbrains.kotlin-wrappers", "kotlin-styled-next", Ver("1.2.3-pre.628", 0))
            val kotlin_tanstack_query_core = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-query-core", Ver("4.35.3-pre.628", 0))
            val kotlin_tanstack_react_query = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-react-query", Ver("4.35.3-pre.628", 0))
            val kotlin_tanstack_react_query_devtools = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-react-query-devtools", Ver("4.35.3-pre.628", 0))
            val kotlin_tanstack_react_table = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-react-table", Ver("8.10.0-pre.628", 0))
            val kotlin_tanstack_react_virtual = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-react-virtual", Ver("3.0.0-beta.60-pre.628", 200))
            val kotlin_tanstack_table_core = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-table-core", Ver("8.10.0-pre.628", 0))
            val kotlin_tanstack_virtual_core = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-virtual-core", Ver("3.0.0-beta.60-pre.628", 200))
            val kotlin_typescript = Dep("org.jetbrains.kotlin-wrappers", "kotlin-typescript", Ver("4.9.5-pre.628", 0))
            val kotlin_web = Dep("org.jetbrains.kotlin-wrappers", "kotlin-web", Ver("1.0.0-pre.628", 0))
        }
    }
    object Kodein {
        object Di {
