...
object AndroidX {
    object Activity {
        val activity = Dep("androidx.activity", "activity", Ver("1.8.0", 0))
        val compose = Dep("androidx.activity", "activity-compose", Ver("1.8.0", 0))
        val ktx = Dep("androidx.activity", "activity-ktx", Ver("1.8.0", 0))
    }
    object Annotation {
    ...
    object Benchmark {
        val common = Dep("androidx.benchmark", "benchmark-common", Ver("1.1.1", 0), Ver("1.2.0-rc02", 100))
        val gradle_plugin = Dep("androidx.benchmark", "benchmark-gradle-plugin", Ver("1.1.1", 0), Ver("1.2.0-rc02", 100))
        val junit4 = Dep("androidx.benchmark", "benchmark-junit4", Ver("1.1.1", 0), Ver("1.2.0-rc02", 100))
        val macro = Dep("androidx.benchmark", "benchmark-macro", Ver("1.1.1", 0), Ver("1.2.0-rc02", 100))
        val macro_junit4 = Dep("androidx.benchmark", "benchmark-macro-junit4", Ver("1.1.1", 0), Ver("1.2.0-rc02", 100))
    }
    object Biometric {
    ...
    object Browser {
        val browser = Dep("androidx.browser", "browser", Ver("1.6.0", 0), Ver("1.7.0-alpha01", 300))
    }
    object Camera {
    ...
    object Collection {
        val collection = Dep("androidx.collection", "collection", Ver("1.3.0", 0), Ver("1.4.0-alpha01", 300))
        val ktx = Dep("androidx.collection", "collection-ktx", Ver("1.3.0", 0), Ver("1.4.0-alpha01", 300))
    }
    object Compose {
        val bom = Dep("androidx.compose", "compose-bom", Ver("2023.10.00", 0))
        object Animation {
            val animation = Dep("androidx.compose.animation", "animation", Ver("1.5.3", 0), Ver("1.6.0-alpha07", 300))
            val core = Dep("androidx.compose.animation", "animation-core", Ver("1.5.3", 0), Ver("1.6.0-alpha07", 300))
            val graphics = Dep("androidx.compose.animation", "animation-graphics", Ver("1.5.3", 0), Ver("1.6.0-alpha07", 300))
        }
        object Compiler {
            val compiler = Dep("androidx.compose.compiler", "compiler", Ver("1.5.3", 0))
        }
        object Foundation {
            val foundation = Dep("androidx.compose.foundation", "foundation", Ver("1.5.3", 0), Ver("1.6.0-alpha07", 300))
            val layout = Dep("androidx.compose.foundation", "foundation-layout", Ver("1.5.3", 0), Ver("1.6.0-alpha07", 300))
        }
        object Material {
            val icons_core = Dep("androidx.compose.material", "material-icons-core", Ver("1.5.3", 0), Ver("1.6.0-alpha07", 300))
            val icons_extended = Dep("androidx.compose.material", "material-icons-extended", Ver("1.5.3", 0), Ver("1.6.0-alpha07", 300))
            val material = Dep("androidx.compose.material", "material", Ver("1.5.3", 0), Ver("1.6.0-alpha07", 300))
            val ripple = Dep("androidx.compose.material", "material-ripple", Ver("1.5.3", 0), Ver("1.6.0-alpha07", 300))
        }
        object Material3 {
            val material3 = Dep("androidx.compose.material3", "material3", Ver("1.1.2", 0), Ver("1.2.0-alpha09", 300))
            val window_size_class = Dep("androidx.compose.material3", "material3-window-size-class", Ver("1.1.2", 0), Ver("1.2.0-alpha09", 300))
        }
        object Runtime {
            val dispatch = Dep("androidx.compose.runtime", "runtime-dispatch", Ver("1.0.0-alpha12", 300))
            val livedata = Dep("androidx.compose.runtime", "runtime-livedata", Ver("1.5.3", 0), Ver("1.6.0-alpha07", 300))
            val runtime = Dep("androidx.compose.runtime", "runtime", Ver("1.5.3", 0), Ver("1.6.0-alpha07", 300))
            val rxjava2 = Dep("androidx.compose.runtime", "runtime-rxjava2", Ver("1.5.3", 0), Ver("1.6.0-alpha07", 300))
            val rxjava3 = Dep("androidx.compose.runtime", "runtime-rxjava3", Ver("1.5.3", 0), Ver("1.6.0-alpha07", 300))
            val saveable = Dep("androidx.compose.runtime", "runtime-saveable", Ver("1.5.3", 0), Ver("1.6.0-alpha07", 300))
            val tracing = Dep("androidx.compose.runtime", "runtime-tracing", Ver("1.0.0-alpha04", 300))
        }
        object Ui {
            val geometry = Dep("androidx.compose.ui", "ui-geometry", Ver("1.5.3", 0), Ver("1.6.0-alpha07", 300))
            val graphics = Dep("androidx.compose.ui", "ui-graphics", Ver("1.5.3", 0), Ver("1.6.0-alpha07", 300))
            val test = Dep("androidx.compose.ui", "ui-test", Ver("1.5.3", 0), Ver("1.6.0-alpha07", 300))
            val test_junit4 = Dep("androidx.compose.ui", "ui-test-junit4", Ver("1.5.3", 0), Ver("1.6.0-alpha07", 300))
            val test_manifest = Dep("androidx.compose.ui", "ui-test-manifest", Ver("1.5.3", 0), Ver("1.6.0-alpha07", 300))
            val text = Dep("androidx.compose.ui", "ui-text", Ver("1.5.3", 0), Ver("1.6.0-alpha07", 300))
            val text_google_fonts = Dep("androidx.compose.ui", "ui-text-google-fonts", Ver("1.5.3", 0), Ver("1.6.0-alpha07", 300))
            val tooling = Dep("androidx.compose.ui", "ui-tooling", Ver("1.5.3", 0), Ver("1.6.0-alpha07", 300))
            val tooling_data = Dep("androidx.compose.ui", "ui-tooling-data", Ver("1.5.3", 0), Ver("1.6.0-alpha07", 300))
            val tooling_preview = Dep("androidx.compose.ui", "ui-tooling-preview", Ver("1.5.3", 0), Ver("1.6.0-alpha07", 300))
            val ui = Dep("androidx.compose.ui", "ui", Ver("1.5.3", 0), Ver("1.6.0-alpha07", 300))
            val unit = Dep("androidx.compose.ui", "ui-unit", Ver("1.5.3", 0), Ver("1.6.0-alpha07", 300))
            val util = Dep("androidx.compose.ui", "ui-util", Ver("1.5.3", 0), Ver("1.6.0-alpha07", 300))
            val viewbinding = Dep("androidx.compose.ui", "ui-viewbinding", Ver("1.5.3", 0), Ver("1.6.0-alpha07", 300))
        }
    }
    object Concurrent {
    ...
    object Fragment {
        val fragment = Dep("androidx.fragment", "fragment", Ver("1.6.1", 0), Ver("1.7.0-alpha06", 300))
        val ktx = Dep("androidx.fragment", "fragment-ktx", Ver("1.6.1", 0), Ver("1.7.0-alpha06", 300))
        val testing = Dep("androidx.fragment", "fragment-testing", Ver("1.6.1", 0), Ver("1.7.0-alpha06", 300))
    }
    object Games {
    ...
    object Health {
        ...
        object Connect {
            val client = Dep("androidx.health.connect", "connect-client", Ver("1.1.0-alpha05", 300))
        }
    }
    object Heifwriter {
    ...
    object Hilt {
        val compiler = Dep("androidx.hilt", "hilt-compiler", Ver("1.0.0", 0), Ver("1.1.0-beta01", 200))
        val navigation_compose = Dep("androidx.hilt", "hilt-navigation-compose", Ver("1.0.0", 0), Ver("1.1.0-beta01", 200))
        val navigation_fragment = Dep("androidx.hilt", "hilt-navigation-fragment", Ver("1.0.0", 0), Ver("1.1.0-beta01", 200))
        val work = Dep("androidx.hilt", "hilt-work", Ver("1.0.0", 0), Ver("1.1.0-beta01", 200))
    }
    object Input {
    ...
    object JavaScriptengine {
        val javascriptengine = Dep("androidx.javascriptengine", "javascriptengine", Ver("1.0.0-alpha06", 300))
    }
    object Leanback {
    ...
    object Navigation {
        val common = Dep("androidx.navigation", "navigation-common", Ver("2.7.4", 0))
        val common_ktx = Dep("androidx.navigation", "navigation-common-ktx", Ver("2.7.4", 0))
        val compose = Dep("androidx.navigation", "navigation-compose", Ver("2.7.4", 0))
        val dynamic_features_fragment = Dep("androidx.navigation", "navigation-dynamic-features-fragment", Ver("2.7.4", 0))
        val fragment = Dep("androidx.navigation", "navigation-fragment", Ver("2.7.4", 0))
        val fragment_ktx = Dep("androidx.navigation", "navigation-fragment-ktx", Ver("2.7.4", 0))
        val runtime = Dep("androidx.navigation", "navigation-runtime", Ver("2.7.4", 0))
        val runtime_ktx = Dep("androidx.navigation", "navigation-runtime-ktx", Ver("2.7.4", 0))
        val safe_args_generator = Dep("androidx.navigation", "navigation-safe-args-generator", Ver("2.7.4", 0))
        val safe_args_gradle_plugin = Dep("androidx.navigation", "navigation-safe-args-gradle-plugin", Ver("2.7.4", 0))
        val testing = Dep("androidx.navigation", "navigation-testing", Ver("2.7.4", 0))
        val ui = Dep("androidx.navigation", "navigation-ui", Ver("2.7.4", 0))
        val ui_ktx = Dep("androidx.navigation", "navigation-ui-ktx", Ver("2.7.4", 0))
    }
    object Paging {
    ...
    object Transition {
        val ktx = Dep("androidx.transition", "transition-ktx", Ver("1.4.1", 0), Ver("1.5.0-alpha04", 300))
        val transition = Dep("androidx.transition", "transition", Ver("1.4.1", 0), Ver("1.5.0-alpha04", 300))
    }
    object Tv {
    ...
    object Wear {
        ...
        object Compose {
            val foundation = Dep("androidx.wear.compose", "compose-foundation", Ver("1.2.0", 0), Ver("1.3.0-alpha07", 300))
            val material = Dep("androidx.wear.compose", "compose-material", Ver("1.2.0", 0), Ver("1.3.0-alpha07", 300))
            val navigation = Dep("androidx.wear.compose", "compose-navigation", Ver("1.2.0", 0), Ver("1.3.0-alpha07", 300))
        }
        object Tiles {
...
object Com {
    object Android {
        ...
        object Tools {
            ...
            object Build {
                val gradle = Dep("com.android.tools.build", "gradle", Ver("2.3.0", 0), Ver("2.3.3", 0), Ver("2.4.0-alpha7", 300), Ver("2.5.0-alpha-preview-02", 400), Ver("8.1.2", 0), Ver("8.2.0-beta06", 200), Ver("8.3.0-alpha07", 300))
            }
        }
    }
    object ApolloGraphQl {
        object Apollo3 {
            val apollo_adapters = Dep("com.apollographql.apollo3", "apollo-adapters", Ver("3.8.2", 0), Ver("4.0.0-beta.1", 200))
            val apollo_api = Dep("com.apollographql.apollo3", "apollo-api", Ver("3.8.2", 0), Ver("4.0.0-beta.1", 200))
            val apollo_ast = Dep("com.apollographql.apollo3", "apollo-ast", Ver("3.8.2", 0), Ver("4.0.0-beta.1", 200))
            val apollo_http_cache = Dep("com.apollographql.apollo3", "apollo-http-cache", Ver("3.8.2", 0), Ver("4.0.0-beta.1", 200))
            val apollo_idling_resource = Dep("com.apollographql.apollo3", "apollo-idling-resource", Ver("3.8.2", 0), Ver("4.0.0-beta.1", 200))
            val apollo_mockserver = Dep("com.apollographql.apollo3", "apollo-mockserver", Ver("3.8.2", 0), Ver("4.0.0-beta.1", 200))
            val apollo_normalized_cache = Dep("com.apollographql.apollo3", "apollo-normalized-cache", Ver("3.8.2", 0), Ver("4.0.0-beta.1", 200))
            val apollo_normalized_cache_sqlite = Dep("com.apollographql.apollo3", "apollo-normalized-cache-sqlite", Ver("3.8.2", 0), Ver("4.0.0-beta.1", 200))
            val apollo_runtime = Dep("com.apollographql.apollo3", "apollo-runtime", Ver("3.8.2", 0), Ver("4.0.0-beta.1", 200))
            val apollo_testing_support = Dep("com.apollographql.apollo3", "apollo-testing-support", Ver("3.8.2", 0), Ver("4.0.0-beta.1", 200))
        }
    }
    object GitHub {
        object ChuckerTeam {
    ...
    object Google {
        ...
        object Android {
            ...
            object Gms {
                ...
                val play_services_pay = Dep("com.google.android.gms", "play-services-pay", Ver("16.3.0", 0))
            ...
            object Material {
                ...
                val material = Dep("com.google.android.material", "material", Ver("1.10.0", 0), Ver("1.11.0-alpha03", 300))
            }
            object Play {
        ...
        object Maps {
            object Android {
                val maps_compose = Dep("com.google.maps.android", "maps-compose", Ver("3.1.0", 0))
    ...
    object Russhwolf {
        val multiplatform_settings = Dep("com.russhwolf", "multiplatform-settings", Ver("1.0.0", 0), Ver("1.1.0", 0))
        val multiplatform_settings_coroutines = Dep("com.russhwolf", "multiplatform-settings-coroutines", Ver("1.0.0", 0), Ver("1.1.0", 0))
        val multiplatform_settings_coroutines_native_mt = Dep("com.russhwolf", "multiplatform-settings-coroutines-native-mt", Ver("0.9", 0))
        val multiplatform_settings_datastore = Dep("com.russhwolf", "multiplatform-settings-datastore", Ver("1.0.0", 0), Ver("1.1.0", 0))
        val multiplatform_settings_no_arg = Dep("com.russhwolf", "multiplatform-settings-no-arg", Ver("1.0.0", 0), Ver("1.1.0", 0))
        val multiplatform_settings_serialization = Dep("com.russhwolf", "multiplatform-settings-serialization", Ver("1.0.0", 0), Ver("1.1.0", 0))
        val multiplatform_settings_test = Dep("com.russhwolf", "multiplatform-settings-test", Ver("1.1.0", 0))
    }
    object SquareUp {
...
object Io {
    ...
    object GitHub {
        ...
        object TypeSafeGitHub {
            val github_workflows_kt = Dep("io.github.typesafegithub", "github-workflows-kt", Ver("1.2.0", 0))
        }
    }
    object Insert_koin {
    ...
    object Ktor {
        val client_android = Dep("io.ktor", "ktor-client-android", Ver("2.3.5", 0))
        val client_apache = Dep("io.ktor", "ktor-client-apache", Ver("2.3.5", 0))
        val client_auth = Dep("io.ktor", "ktor-client-auth", Ver("2.3.5", 0))
        val client_cio = Dep("io.ktor", "ktor-client-cio", Ver("2.3.5", 0))
        val client_content_negotiation = Dep("io.ktor", "ktor-client-content-negotiation", Ver("2.3.5", 0))
        val client_content_negotiation_tests = Dep("io.ktor", "ktor-client-content-negotiation-tests", Ver("2.3.5", 0))
        val client_core = Dep("io.ktor", "ktor-client-core", Ver("2.3.5", 0))
        val client_curl = Dep("io.ktor", "ktor-client-curl", Ver("2.3.5", 0))
        val client_darwin = Dep("io.ktor", "ktor-client-darwin", Ver("2.3.5", 0))
        val client_encoding = Dep("io.ktor", "ktor-client-encoding", Ver("2.3.5", 0))
        val client_gson = Dep("io.ktor", "ktor-client-gson", Ver("2.3.5", 0))
        val client_jackson = Dep("io.ktor", "ktor-client-jackson", Ver("2.3.5", 0))
        val client_java = Dep("io.ktor", "ktor-client-java", Ver("2.3.5", 0))
        val client_jetty = Dep("io.ktor", "ktor-client-jetty", Ver("2.3.5", 0))
        val client_json = Dep("io.ktor", "ktor-client-json", Ver("2.3.5", 0))
        val client_json_tests = Dep("io.ktor", "ktor-client-json-tests", Ver("2.3.5", 0))
        val client_logging = Dep("io.ktor", "ktor-client-logging", Ver("2.3.5", 0))
        val client_mock = Dep("io.ktor", "ktor-client-mock", Ver("2.3.5", 0))
        val client_okhttp = Dep("io.ktor", "ktor-client-okhttp", Ver("2.3.5", 0))
        val client_resources = Dep("io.ktor", "ktor-client-resources", Ver("2.3.5", 0))
        val client_serialization = Dep("io.ktor", "ktor-client-serialization", Ver("2.3.5", 0))
        val client_tests = Dep("io.ktor", "ktor-client-tests", Ver("2.3.5", 0))
        val events = Dep("io.ktor", "ktor-events", Ver("2.3.5", 0))
        val http = Dep("io.ktor", "ktor-http", Ver("2.3.5", 0))
        val http_cio = Dep("io.ktor", "ktor-http-cio", Ver("2.3.5", 0))
        val io = Dep("io.ktor", "ktor-io", Ver("2.3.5", 0))
        val network = Dep("io.ktor", "ktor-network", Ver("2.3.5", 0))
        val network_tls = Dep("io.ktor", "ktor-network-tls", Ver("2.3.5", 0))
        val network_tls_certificates = Dep("io.ktor", "ktor-network-tls-certificates", Ver("2.3.5", 0))
        val resources = Dep("io.ktor", "ktor-resources", Ver("2.3.5", 0))
        val serialization = Dep("io.ktor", "ktor-serialization", Ver("2.3.5", 0))
        val serialization_gson = Dep("io.ktor", "ktor-serialization-gson", Ver("2.3.5", 0))
        val serialization_jackson = Dep("io.ktor", "ktor-serialization-jackson", Ver("2.3.5", 0))
        val serialization_kotlinx = Dep("io.ktor", "ktor-serialization-kotlinx", Ver("2.3.5", 0))
        val serialization_kotlinx_cbor = Dep("io.ktor", "ktor-serialization-kotlinx-cbor", Ver("2.3.5", 0))
        val serialization_kotlinx_json = Dep("io.ktor", "ktor-serialization-kotlinx-json", Ver("2.3.5", 0))
        val serialization_kotlinx_tests = Dep("io.ktor", "ktor-serialization-kotlinx-tests", Ver("2.3.5", 0))
        val serialization_kotlinx_xml = Dep("io.ktor", "ktor-serialization-kotlinx-xml", Ver("2.3.5", 0))
        val server = Dep("io.ktor", "ktor-server", Ver("2.3.5", 0))
        val server_auth = Dep("io.ktor", "ktor-server-auth", Ver("2.3.5", 0))
        val server_auth_jwt = Dep("io.ktor", "ktor-server-auth-jwt", Ver("2.3.5", 0))
        val server_auth_ldap = Dep("io.ktor", "ktor-server-auth-ldap", Ver("2.3.5", 0))
        val server_auto_head_response = Dep("io.ktor", "ktor-server-auto-head-response", Ver("2.3.5", 0))
        val server_caching_headers = Dep("io.ktor", "ktor-server-caching-headers", Ver("2.3.5", 0))
        val server_call_id = Dep("io.ktor", "ktor-server-call-id", Ver("2.3.5", 0))
        val server_call_logging = Dep("io.ktor", "ktor-server-call-logging", Ver("2.3.5", 0))
        val server_cio = Dep("io.ktor", "ktor-server-cio", Ver("2.3.5", 0))
        val server_compression = Dep("io.ktor", "ktor-server-compression", Ver("2.3.5", 0))
        val server_conditional_headers = Dep("io.ktor", "ktor-server-conditional-headers", Ver("2.3.5", 0))
        val server_content_negotiation = Dep("io.ktor", "ktor-server-content-negotiation", Ver("2.3.5", 0))
        val server_core = Dep("io.ktor", "ktor-server-core", Ver("2.3.5", 0))
        val server_cors = Dep("io.ktor", "ktor-server-cors", Ver("2.3.5", 0))
        val server_data_conversion = Dep("io.ktor", "ktor-server-data-conversion", Ver("2.3.5", 0))
        val server_default_headers = Dep("io.ktor", "ktor-server-default-headers", Ver("2.3.5", 0))
        val server_double_receive = Dep("io.ktor", "ktor-server-double-receive", Ver("2.3.5", 0))
        val server_forwarded_header = Dep("io.ktor", "ktor-server-forwarded-header", Ver("2.3.5", 0))
        val server_freemarker = Dep("io.ktor", "ktor-server-freemarker", Ver("2.3.5", 0))
        val server_host_common = Dep("io.ktor", "ktor-server-host-common", Ver("2.3.5", 0))
        val server_hsts = Dep("io.ktor", "ktor-server-hsts", Ver("2.3.5", 0))
        val server_html_builder = Dep("io.ktor", "ktor-server-html-builder", Ver("2.3.5", 0))
        val server_http_redirect = Dep("io.ktor", "ktor-server-http-redirect", Ver("2.3.5", 0))
        val server_jetty = Dep("io.ktor", "ktor-server-jetty", Ver("2.3.5", 0))
        val server_jte = Dep("io.ktor", "ktor-server-jte", Ver("2.3.5", 0))
        val server_locations = Dep("io.ktor", "ktor-server-locations", Ver("2.3.5", 0))
        val server_method_override = Dep("io.ktor", "ktor-server-method-override", Ver("2.3.5", 0))
        val server_metrics = Dep("io.ktor", "ktor-server-metrics", Ver("2.3.5", 0))
        val server_metrics_micrometer = Dep("io.ktor", "ktor-server-metrics-micrometer", Ver("2.3.5", 0))
        val server_mustache = Dep("io.ktor", "ktor-server-mustache", Ver("2.3.5", 0))
        val server_netty = Dep("io.ktor", "ktor-server-netty", Ver("2.3.5", 0))
        val server_partial_content = Dep("io.ktor", "ktor-server-partial-content", Ver("2.3.5", 0))
        val server_pebble = Dep("io.ktor", "ktor-server-pebble", Ver("2.3.5", 0))
        val server_resources = Dep("io.ktor", "ktor-server-resources", Ver("2.3.5", 0))
        val server_servlet = Dep("io.ktor", "ktor-server-servlet", Ver("2.3.5", 0))
        val server_sessions = Dep("io.ktor", "ktor-server-sessions", Ver("2.3.5", 0))
        val server_status_pages = Dep("io.ktor", "ktor-server-status-pages", Ver("2.3.5", 0))
        val server_test_host = Dep("io.ktor", "ktor-server-test-host", Ver("2.3.5", 0))
        val server_test_suites = Dep("io.ktor", "ktor-server-test-suites", Ver("2.3.5", 0))
        val server_thymeleaf = Dep("io.ktor", "ktor-server-thymeleaf", Ver("2.3.5", 0))
        val server_tomcat = Dep("io.ktor", "ktor-server-tomcat", Ver("2.3.5", 0))
        val server_velocity = Dep("io.ktor", "ktor-server-velocity", Ver("2.3.5", 0))
        val server_webjars = Dep("io.ktor", "ktor-server-webjars", Ver("2.3.5", 0))
        val server_websockets = Dep("io.ktor", "ktor-server-websockets", Ver("2.3.5", 0))
        val test_dispatcher = Dep("io.ktor", "ktor-test-dispatcher", Ver("2.3.5", 0))
        val utils = Dep("io.ktor", "ktor-utils", Ver("2.3.5", 0))
        val websocket_serialization = Dep("io.ktor", "ktor-websocket-serialization", Ver("2.3.5", 0))
        val websockets = Dep("io.ktor", "ktor-websockets", Ver("2.3.5", 0))
    }
    object MockK {
...
object Org {
    ...
    object Http4k {
        val aws = Dep("org.http4k", "http4k-aws", Ver("5.8.3.0", 0))
        val bom = Dep("org.http4k", "http4k-bom", Ver("5.8.3.0", 0))
        val client_apache = Dep("org.http4k", "http4k-client-apache", Ver("5.8.3.0", 0))
        val client_apache4 = Dep("org.http4k", "http4k-client-apache4", Ver("5.8.3.0", 0))
        val client_apache4_async = Dep("org.http4k", "http4k-client-apache4-async", Ver("5.8.3.0", 0))
        val client_apache_async = Dep("org.http4k", "http4k-client-apache-async", Ver("5.8.3.0", 0))
        val client_jetty = Dep("org.http4k", "http4k-client-jetty", Ver("5.8.3.0", 0))
        val client_okhttp = Dep("org.http4k", "http4k-client-okhttp", Ver("5.8.3.0", 0))
        val client_websocket = Dep("org.http4k", "http4k-client-websocket", Ver("5.8.3.0", 0))
        val cloudnative = Dep("org.http4k", "http4k-cloudnative", Ver("5.8.3.0", 0))
        val contract = Dep("org.http4k", "http4k-contract", Ver("5.8.3.0", 0))
        val core = Dep("org.http4k", "http4k-core", Ver("5.8.3.0", 0))
        val format_argo = Dep("org.http4k", "http4k-format-argo", Ver("5.8.3.0", 0))
        val format_core = Dep("org.http4k", "http4k-format-core", Ver("5.8.3.0", 0))
        val format_gson = Dep("org.http4k", "http4k-format-gson", Ver("5.8.3.0", 0))
        val format_jackson = Dep("org.http4k", "http4k-format-jackson", Ver("5.8.3.0", 0))
        val format_jackson_xml = Dep("org.http4k", "http4k-format-jackson-xml", Ver("5.8.3.0", 0))
        val format_jackson_yaml = Dep("org.http4k", "http4k-format-jackson-yaml", Ver("5.8.3.0", 0))
        val format_klaxon = Dep("org.http4k", "http4k-format-klaxon", Ver("5.8.3.0", 0))
        val format_kotlinx_serialization = Dep("org.http4k", "http4k-format-kotlinx-serialization", Ver("5.8.3.0", 0))
        val format_moshi = Dep("org.http4k", "http4k-format-moshi", Ver("5.8.3.0", 0))
        val format_xml = Dep("org.http4k", "http4k-format-xml", Ver("5.8.3.0", 0))
        val graphql = Dep("org.http4k", "http4k-graphql", Ver("5.8.3.0", 0))
        val incubator = Dep("org.http4k", "http4k-incubator", Ver("5.8.3.0", 0))
        val jsonrpc = Dep("org.http4k", "http4k-jsonrpc", Ver("5.8.3.0", 0))
        val metrics_micrometer = Dep("org.http4k", "http4k-metrics-micrometer", Ver("5.8.3.0", 0))
        val multipart = Dep("org.http4k", "http4k-multipart", Ver("5.8.3.0", 0))
        val opentelemetry = Dep("org.http4k", "http4k-opentelemetry", Ver("5.8.3.0", 0))
        val realtime_core = Dep("org.http4k", "http4k-realtime-core", Ver("5.8.3.0", 0))
        val resilience4j = Dep("org.http4k", "http4k-resilience4j", Ver("5.8.3.0", 0))
        val security_oauth = Dep("org.http4k", "http4k-security-oauth", Ver("5.8.3.0", 0))
        val server_apache = Dep("org.http4k", "http4k-server-apache", Ver("5.8.3.0", 0))
        val server_apache4 = Dep("org.http4k", "http4k-server-apache4", Ver("5.8.3.0", 0))
        val server_jetty = Dep("org.http4k", "http4k-server-jetty", Ver("5.8.3.0", 0))
        val server_ktorcio = Dep("org.http4k", "http4k-server-ktorcio", Ver("5.8.3.0", 0))
        val server_ktornetty = Dep("org.http4k", "http4k-server-ktornetty", Ver("5.8.3.0", 0))
        val server_netty = Dep("org.http4k", "http4k-server-netty", Ver("5.8.3.0", 0))
        val server_ratpack = Dep("org.http4k", "http4k-server-ratpack", Ver("5.8.3.0", 0))
        val server_undertow = Dep("org.http4k", "http4k-server-undertow", Ver("5.8.3.0", 0))
        val serverless_alibaba = Dep("org.http4k", "http4k-serverless-alibaba", Ver("5.8.3.0", 0))
        val serverless_azure = Dep("org.http4k", "http4k-serverless-azure", Ver("5.8.3.0", 0))
        val serverless_gcf = Dep("org.http4k", "http4k-serverless-gcf", Ver("5.8.3.0", 0))
        val serverless_lambda = Dep("org.http4k", "http4k-serverless-lambda", Ver("5.8.3.0", 0))
        val serverless_lambda_runtime = Dep("org.http4k", "http4k-serverless-lambda-runtime", Ver("5.8.3.0", 0))
        val serverless_openwhisk = Dep("org.http4k", "http4k-serverless-openwhisk", Ver("5.8.3.0", 0))
        val serverless_tencent = Dep("org.http4k", "http4k-serverless-tencent", Ver("5.8.3.0", 0))
        val template_core = Dep("org.http4k", "http4k-template-core", Ver("5.8.3.0", 0))
        val template_dust = Dep("org.http4k", "http4k-template-dust", Ver("4.48.0.0", 0))
        val template_freemarker = Dep("org.http4k", "http4k-template-freemarker", Ver("5.8.3.0", 0))
        val template_handlebars = Dep("org.http4k", "http4k-template-handlebars", Ver("5.8.3.0", 0))
        val template_jade4j = Dep("org.http4k", "http4k-template-jade4j", Ver("5.8.3.0", 0))
        val template_pebble = Dep("org.http4k", "http4k-template-pebble", Ver("5.8.3.0", 0))
        val template_thymeleaf = Dep("org.http4k", "http4k-template-thymeleaf", Ver("5.8.3.0", 0))
        val testing_approval = Dep("org.http4k", "http4k-testing-approval", Ver("5.8.3.0", 0))
        val testing_chaos = Dep("org.http4k", "http4k-testing-chaos", Ver("5.8.3.0", 0))
        val testing_hamkrest = Dep("org.http4k", "http4k-testing-hamkrest", Ver("5.8.3.0", 0))
        val testing_kotest = Dep("org.http4k", "http4k-testing-kotest", Ver("5.8.3.0", 0))
        val testing_servirtium = Dep("org.http4k", "http4k-testing-servirtium", Ver("5.8.3.0", 0))
        val testing_strikt = Dep("org.http4k", "http4k-testing-strikt", Ver("5.8.3.0", 0))
        val testing_webdriver = Dep("org.http4k", "http4k-testing-webdriver", Ver("5.8.3.0", 0))
    }
    object JUnit {
    ...
    object JetBrains {
        object Compose {
            val gradle_plugin = Dep("org.jetbrains.compose", "compose-gradle-plugin", Ver("1.5.3", 0), Ver("1.5.10-beta02", 200))
        }
        object Exposed {
        ...
        object Kotlin_Wrappers {
            val bom = Dep("org.jetbrains.kotlin-wrappers", "kotlin-wrappers-bom", Ver("1.0.0-pre.631", 0))
            val kotlin_actions_toolkit = Dep("org.jetbrains.kotlin-wrappers", "kotlin-actions-toolkit", Ver("0.0.1-pre.631", 0))
            val kotlin_browser = Dep("org.jetbrains.kotlin-wrappers", "kotlin-browser", Ver("1.0.0-pre.631", 0))
            val kotlin_cesium = Dep("org.jetbrains.kotlin-wrappers", "kotlin-cesium", Ver("1.110.0-pre.631", 0))
            val kotlin_css = Dep("org.jetbrains.kotlin-wrappers", "kotlin-css", Ver("1.0.0-pre.631", 0))
            val kotlin_csstype = Dep("org.jetbrains.kotlin-wrappers", "kotlin-csstype", Ver("3.1.2-pre.631", 0))
            val kotlin_emotion = Dep("org.jetbrains.kotlin-wrappers", "kotlin-emotion", Ver("11.11.1-pre.631", 0))
            val kotlin_history = Dep("org.jetbrains.kotlin-wrappers", "kotlin-history", Ver("5.3.0-pre.506-compat", 0))
            val kotlin_js = Dep("org.jetbrains.kotlin-wrappers", "kotlin-js", Ver("1.0.0-pre.631", 0))
            val kotlin_mui = Dep("org.jetbrains.kotlin-wrappers", "kotlin-mui", Ver("5.14.10-pre.631", 0))
            val kotlin_mui_icons = Dep("org.jetbrains.kotlin-wrappers", "kotlin-mui-icons", Ver("5.14.9-pre.631", 0))
            val kotlin_node = Dep("org.jetbrains.kotlin-wrappers", "kotlin-node", Ver("18.16.12-pre.631", 0))
            val kotlin_popper = Dep("org.jetbrains.kotlin-wrappers", "kotlin-popper", Ver("2.11.8-pre.631", 0))
            val kotlin_react = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react", Ver("18.2.0-pre.631", 0))
            val kotlin_react_beautiful_dnd = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-beautiful-dnd", Ver("13.1.1-pre.631", 0))
            val kotlin_react_core = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-core", Ver("18.2.0-pre.631", 0))
            val kotlin_react_dom = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-dom", Ver("18.2.0-pre.631", 0))
            val kotlin_react_dom_legacy = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-dom-legacy", Ver("18.2.0-pre.631", 0))
            val kotlin_react_dom_test_utils = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-dom-test-utils", Ver("18.2.0-pre.631", 0))
            val kotlin_react_legacy = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-legacy", Ver("18.2.0-pre.631", 0))
            val kotlin_react_popper = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-popper", Ver("2.3.0-pre.631", 0))
            val kotlin_react_redux = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-redux", Ver("7.2.6-pre.631", 0))
            val kotlin_react_router = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-router", Ver("6.16.0-pre.631", 0))
            val kotlin_react_router_dom = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-router-dom", Ver("6.16.0-pre.631", 0))
            val kotlin_react_select = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-select", Ver("5.7.5-pre.631", 0))
            val kotlin_react_use = Dep("org.jetbrains.kotlin-wrappers", "kotlin-react-use", Ver("17.4.0-pre.631", 0))
            val kotlin_redux = Dep("org.jetbrains.kotlin-wrappers", "kotlin-redux", Ver("4.1.2-pre.631", 0))
            val kotlin_remix_run_router = Dep("org.jetbrains.kotlin-wrappers", "kotlin-remix-run-router", Ver("1.9.0-pre.631", 0))
            val kotlin_ring_ui = Dep("org.jetbrains.kotlin-wrappers", "kotlin-ring-ui", Ver("4.1.5-pre.631", 0))
            val kotlin_styled = Dep("org.jetbrains.kotlin-wrappers", "kotlin-styled", Ver("5.3.11-pre.631", 0))
            val kotlin_styled_next = Dep("org.jetbrains.kotlin-wrappers", "kotlin-styled-next", Ver("1.2.3-pre.631", 0))
            val kotlin_tanstack_query_core = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-query-core", Ver("4.35.3-pre.631", 0))
            val kotlin_tanstack_react_query = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-react-query", Ver("4.35.3-pre.631", 0))
            val kotlin_tanstack_react_query_devtools = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-react-query-devtools", Ver("4.35.3-pre.631", 0))
            val kotlin_tanstack_react_table = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-react-table", Ver("8.10.0-pre.631", 0))
            val kotlin_tanstack_react_virtual = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-react-virtual", Ver("3.0.0-beta.60-pre.631", 200))
            val kotlin_tanstack_table_core = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-table-core", Ver("8.10.0-pre.631", 0))
            val kotlin_tanstack_virtual_core = Dep("org.jetbrains.kotlin-wrappers", "kotlin-tanstack-virtual-core", Ver("3.0.0-beta.60-pre.631", 200))
            val kotlin_typescript = Dep("org.jetbrains.kotlin-wrappers", "kotlin-typescript", Ver("4.9.5-pre.631", 0))
            val kotlin_web = Dep("org.jetbrains.kotlin-wrappers", "kotlin-web", Ver("1.0.0-pre.631", 0))
        }
    }
    object Kodein {
        object Di {
    ...
    object Mockito {
        val android = Dep("org.mockito", "mockito-android", Ver("5.6.0", 0))
        val core = Dep("org.mockito", "mockito-core", Ver("5.6.0", 0))
        val errorprone = Dep("org.mockito", "mockito-errorprone", Ver("5.6.0", 0))
        val inline = Dep("org.mockito", "mockito-inline", Ver("5.2.0", 0))
        val junit_jupiter = Dep("org.mockito", "mockito-junit-jupiter", Ver("5.6.0", 0))
        object Kotlin {
