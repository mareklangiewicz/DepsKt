...
FIXME LATER: delete old Deps and rename DepsNew to Deps (file and generated object)

Capital-first letter for groups object is better!!
    1.compatible with kotlin convention;
    2.no clashes with modules/Dep s properties;
    3.easier for user to search for the group (and not module);
    (but only first letter! - simple generation, no fancy word detection)
