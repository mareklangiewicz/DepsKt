...
object Vers {
   ...
   */
  val GradleDevelocityPlug = Ver("3.19.1")
   ...
   */
  val KotlinJupyterPlug = Ver("0.12.0-363")
   ...
   */
  val GradleShadowPlug = Ver("9.0.0-beta7")
   ...
   */
  val DepsPlug = Ver(0, 3, 68) // TODO make sure it's always synced with myLibDetails(version)
