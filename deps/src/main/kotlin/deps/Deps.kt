...
object AndroidX {
  ...
  object DataStore {
    val core = "androidx.datastore" d "datastore-core" w "1.2.1" w "1.3.0-alpha11"
    val core_okio = "androidx.datastore" d "datastore-core-okio" w "1.2.1" w "1.3.0-alpha11"
    val datastore = "androidx.datastore" d "datastore" w "1.2.1" w "1.3.0-alpha11"
    val preferences = "androidx.datastore" d "datastore-preferences" w "1.2.1" w "1.3.0-alpha11"
    val preferences_core = "androidx.datastore" d "datastore-preferences-core" w "1.2.1" w "1.3.0-alpha11"
    val preferences_rxjava2 = "androidx.datastore" d "datastore-preferences-rxJava2" w "1.2.1" w "1.3.0-alpha11"
    val preferences_rxjava3 = "androidx.datastore" d "datastore-preferences-rxJava3" w "1.2.1" w "1.3.0-alpha11"
    val rxjava2 = "androidx.datastore" d "datastore-rxJava2" w "1.2.1" w "1.3.0-alpha11"
    val rxjava3 = "androidx.datastore" d "datastore-rxJava3" w "1.2.1" w "1.3.0-alpha11"
  }
  object DocumentFile {
  ...
  object Room {
    val common = "androidx.room" d "room-common" w "2.8.5"
    val compiler = "androidx.room" d "room-compiler" w "2.8.5"
    val guava = "androidx.room" d "room-guava" w "2.8.5"
    val ktx = "androidx.room" d "room-ktx" w "2.8.5"
    val paging = "androidx.room" d "room-paging" w "2.8.5"
    val paging_guava = "androidx.room" d "room-paging-guava" w "2.8.5"
    val paging_rxjava2 = "androidx.room" d "room-paging-rxjava2" w "2.8.5"
    val paging_rxjava3 = "androidx.room" d "room-paging-rxjava3" w "2.8.5"
    val runtime = "androidx.room" d "room-runtime" w "2.8.5"
    val rxjava2 = "androidx.room" d "room-rxjava2" w "2.8.5"
    val rxjava3 = "androidx.room" d "room-rxjava3" w "2.8.5"
  ...
  object Sqlite {
    val framework = "androidx.sqlite" d "sqlite-framework" w "2.7.1" w "2.8.0-alpha01"
    val ktx = "androidx.sqlite" d "sqlite-ktx" w "2.7.1" w "2.8.0-alpha01"
    val sqlite = "androidx.sqlite" d "sqlite" w "2.7.1" w "2.8.0-alpha01"
  }
  object Startup {
...
object Com {
  object Android {
    ...
    object Tools {
      ...
      object Build {
        val gradle = "com.android.tools.build" d "gradle" w "2.3.0" w "9.4.1" w "9.5.0-alpha06"
      }
    }
  }
  ...
  object Google {
    ...
    object Android {
      ...
      object Gms {
        ...
        val play_services_base = "com.google.android.gms" d "play-services-base" w "18.11.0"
        val play_services_basement = "com.google.android.gms" d "play-services-basement" w "18.12.0"
    ...
    object Oboe {
      val oboe = "com.google.oboe" d "oboe" w "1.11.0"
    }
    object Truth {
  ...
  object SquareUp {
    ...
    object Wire {
      val gradle_plugin = "com.squareup.wire" d "wire-gradle-plugin" w "7.0.3"
      val grpc_client = "com.squareup.wire" d "wire-grpc-client" w "7.0.3"
      val runtime = "com.squareup.wire" d "wire-runtime" w "7.0.3"
    }
  }
}
object Io {
  ...
  object Ktor {
    val client_android = "io.ktor" d "ktor-client-android" w "3.6.0"
    val client_apache = "io.ktor" d "ktor-client-apache" w "3.6.0"
    val client_auth = "io.ktor" d "ktor-client-auth" w "3.6.0"
    val client_cio = "io.ktor" d "ktor-client-cio" w "3.6.0"
    val client_content_negotiation = "io.ktor" d "ktor-client-content-negotiation" w "3.6.0"
    val client_content_negotiation_tests = "io.ktor" d "ktor-client-content-negotiation-tests" w "3.0.3"
    val client_core = "io.ktor" d "ktor-client-core" w "3.6.0"
    val client_curl = "io.ktor" d "ktor-client-curl" w "3.6.0"
    val client_darwin = "io.ktor" d "ktor-client-darwin" w "3.6.0"
    val client_encoding = "io.ktor" d "ktor-client-encoding" w "3.6.0"
    val client_gson = "io.ktor" d "ktor-client-gson" w "3.6.0"
    val client_jackson = "io.ktor" d "ktor-client-jackson" w "3.6.0"
    val client_java = "io.ktor" d "ktor-client-java" w "3.6.0"
    val client_jetty = "io.ktor" d "ktor-client-jetty" w "3.6.0"
    val client_json = "io.ktor" d "ktor-client-json" w "3.6.0"
    val client_json_tests = "io.ktor" d "ktor-client-json-tests" w "2.3.13"
    val client_logging = "io.ktor" d "ktor-client-logging" w "3.6.0"
    val client_mock = "io.ktor" d "ktor-client-mock" w "3.6.0"
    val client_okhttp = "io.ktor" d "ktor-client-okhttp" w "3.6.0"
    val client_resources = "io.ktor" d "ktor-client-resources" w "3.6.0"
    val client_serialization = "io.ktor" d "ktor-client-serialization" w "3.6.0"
    val client_tests = "io.ktor" d "ktor-client-tests" w "3.0.3"
    val events = "io.ktor" d "ktor-events" w "3.6.0"
    val http = "io.ktor" d "ktor-http" w "3.6.0"
    val http_cio = "io.ktor" d "ktor-http-cio" w "3.6.0"
    val io = "io.ktor" d "ktor-io" w "3.6.0"
    val network = "io.ktor" d "ktor-network" w "3.6.0"
    val network_tls = "io.ktor" d "ktor-network-tls" w "3.6.0"
    val network_tls_certificates = "io.ktor" d "ktor-network-tls-certificates" w "3.6.0"
    val resources = "io.ktor" d "ktor-resources" w "3.6.0"
    val serialization = "io.ktor" d "ktor-serialization" w "3.6.0"
    val serialization_gson = "io.ktor" d "ktor-serialization-gson" w "3.6.0"
    val serialization_jackson = "io.ktor" d "ktor-serialization-jackson" w "3.6.0"
    val serialization_kotlinx = "io.ktor" d "ktor-serialization-kotlinx" w "3.6.0"
    val serialization_kotlinx_cbor = "io.ktor" d "ktor-serialization-kotlinx-cbor" w "3.6.0"
    val serialization_kotlinx_json = "io.ktor" d "ktor-serialization-kotlinx-json" w "3.6.0"
    val serialization_kotlinx_tests = "io.ktor" d "ktor-serialization-kotlinx-tests" w "3.1.1"
    val serialization_kotlinx_xml = "io.ktor" d "ktor-serialization-kotlinx-xml" w "3.6.0"
    val server = "io.ktor" d "ktor-server" w "3.6.0"
    val server_auth = "io.ktor" d "ktor-server-auth" w "3.6.0"
    val server_auth_jwt = "io.ktor" d "ktor-server-auth-jwt" w "3.6.0"
    val server_auth_ldap = "io.ktor" d "ktor-server-auth-ldap" w "3.6.0"
    val server_auto_head_response = "io.ktor" d "ktor-server-auto-head-response" w "3.6.0"
    val server_caching_headers = "io.ktor" d "ktor-server-caching-headers" w "3.6.0"
    val server_call_id = "io.ktor" d "ktor-server-call-id" w "3.6.0"
    val server_call_logging = "io.ktor" d "ktor-server-call-logging" w "3.6.0"
    val server_cio = "io.ktor" d "ktor-server-cio" w "3.6.0"
    val server_compression = "io.ktor" d "ktor-server-compression" w "3.6.0"
    val server_conditional_headers = "io.ktor" d "ktor-server-conditional-headers" w "3.6.0"
    val server_content_negotiation = "io.ktor" d "ktor-server-content-negotiation" w "3.6.0"
    val server_core = "io.ktor" d "ktor-server-core" w "3.6.0"
    val server_cors = "io.ktor" d "ktor-server-cors" w "3.6.0"
    val server_data_conversion = "io.ktor" d "ktor-server-data-conversion" w "3.6.0"
    val server_default_headers = "io.ktor" d "ktor-server-default-headers" w "3.6.0"
    val server_double_receive = "io.ktor" d "ktor-server-double-receive" w "3.6.0"
    val server_forwarded_header = "io.ktor" d "ktor-server-forwarded-header" w "3.6.0"
    val server_freemarker = "io.ktor" d "ktor-server-freemarker" w "3.6.0"
    val server_host_common = "io.ktor" d "ktor-server-host-common" w "3.6.0"
    val server_hsts = "io.ktor" d "ktor-server-hsts" w "3.6.0"
    val server_html_builder = "io.ktor" d "ktor-server-html-builder" w "3.6.0"
    val server_http_redirect = "io.ktor" d "ktor-server-http-redirect" w "3.6.0"
    val server_jetty = "io.ktor" d "ktor-server-jetty" w "3.6.0"
    val server_jte = "io.ktor" d "ktor-server-jte" w "3.6.0"
    val server_locations = "io.ktor" d "ktor-server-locations" w "2.3.13"
    val server_method_override = "io.ktor" d "ktor-server-method-override" w "3.6.0"
    val server_metrics = "io.ktor" d "ktor-server-metrics" w "3.6.0"
    val server_metrics_micrometer = "io.ktor" d "ktor-server-metrics-micrometer" w "3.6.0"
    val server_mustache = "io.ktor" d "ktor-server-mustache" w "3.6.0"
    val server_netty = "io.ktor" d "ktor-server-netty" w "3.6.0"
    val server_partial_content = "io.ktor" d "ktor-server-partial-content" w "3.6.0"
    val server_pebble = "io.ktor" d "ktor-server-pebble" w "3.6.0"
    val server_resources = "io.ktor" d "ktor-server-resources" w "3.6.0"
    val server_servlet = "io.ktor" d "ktor-server-servlet" w "3.6.0"
    val server_sessions = "io.ktor" d "ktor-server-sessions" w "3.6.0"
    val server_status_pages = "io.ktor" d "ktor-server-status-pages" w "3.6.0"
    val server_test_host = "io.ktor" d "ktor-server-test-host" w "3.6.0"
    val server_test_suites = "io.ktor" d "ktor-server-test-suites" w "2.3.13" w "3.0.0-beta-2"
    val server_thymeleaf = "io.ktor" d "ktor-server-thymeleaf" w "3.6.0"
    val server_tomcat = "io.ktor" d "ktor-server-tomcat" w "3.6.0"
    val server_velocity = "io.ktor" d "ktor-server-velocity" w "3.6.0"
    val server_webjars = "io.ktor" d "ktor-server-webjars" w "3.6.0"
    val server_websockets = "io.ktor" d "ktor-server-websockets" w "3.6.0"
    val test_dispatcher = "io.ktor" d "ktor-test-dispatcher" w "3.6.0"
    val utils = "io.ktor" d "ktor-utils" w "3.6.0"
    val websocket_serialization = "io.ktor" d "ktor-websocket-serialization" w "3.6.0"
    val websockets = "io.ktor" d "ktor-websockets" w "3.6.0"
  }
  object MockK {
...
object Org {
  ...
  object Http4k {
    ...
    val bom = "org.http4k" d "http4k-bom" w "6.60.0.0"
    val client_apache = "org.http4k" d "http4k-client-apache" w "6.60.0.0"
    val client_apache4 = "org.http4k" d "http4k-client-apache4" w "6.60.0.0"
    val client_apache4_async = "org.http4k" d "http4k-client-apache4-async" w "6.60.0.0"
    val client_apache_async = "org.http4k" d "http4k-client-apache-async" w "6.60.0.0"
    val client_jetty = "org.http4k" d "http4k-client-jetty" w "6.60.0.0"
    val client_okhttp = "org.http4k" d "http4k-client-okhttp" w "6.60.0.0"
    val client_websocket = "org.http4k" d "http4k-client-websocket" w "6.60.0.0"
    val cloudnative = "org.http4k" d "http4k-cloudnative" w "5.47.0.0"
    val contract = "org.http4k" d "http4k-contract" w "5.47.0.0"
    val core = "org.http4k" d "http4k-core" w "6.60.0.0"
    val format_argo = "org.http4k" d "http4k-format-argo" w "6.60.0.0"
    val format_core = "org.http4k" d "http4k-format-core" w "6.60.0.0"
    val format_gson = "org.http4k" d "http4k-format-gson" w "6.60.0.0"
    val format_jackson = "org.http4k" d "http4k-format-jackson" w "6.60.0.0"
    val format_jackson_xml = "org.http4k" d "http4k-format-jackson-xml" w "6.60.0.0"
    val format_jackson_yaml = "org.http4k" d "http4k-format-jackson-yaml" w "6.60.0.0"
    val format_klaxon = "org.http4k" d "http4k-format-klaxon" w "6.60.0.0"
    val format_kotlinx_serialization = "org.http4k" d "http4k-format-kotlinx-serialization" w "6.60.0.0"
    val format_moshi = "org.http4k" d "http4k-format-moshi" w "6.60.0.0"
    val format_xml = "org.http4k" d "http4k-format-xml" w "6.60.0.0"
    val graphql = "org.http4k" d "http4k-graphql" w "5.47.0.0"
    val incubator = "org.http4k" d "http4k-incubator" w "6.60.0.0"
    ...
    val multipart = "org.http4k" d "http4k-multipart" w "6.60.0.0"
    val opentelemetry = "org.http4k" d "http4k-opentelemetry" w "5.47.0.0"
    val realtime_core = "org.http4k" d "http4k-realtime-core" w "6.60.0.0"
    val resilience4j = "org.http4k" d "http4k-resilience4j" w "5.47.0.0"
    val security_oauth = "org.http4k" d "http4k-security-oauth" w "6.60.0.0"
    val server_apache = "org.http4k" d "http4k-server-apache" w "6.60.0.0"
    val server_apache4 = "org.http4k" d "http4k-server-apache4" w "6.60.0.0"
    val server_jetty = "org.http4k" d "http4k-server-jetty" w "6.60.0.0"
    val server_ktorcio = "org.http4k" d "http4k-server-ktorcio" w "6.60.0.0"
    val server_ktornetty = "org.http4k" d "http4k-server-ktornetty" w "6.60.0.0"
    val server_netty = "org.http4k" d "http4k-server-netty" w "6.60.0.0"
    val server_ratpack = "org.http4k" d "http4k-server-ratpack" w "6.60.0.0"
    val server_undertow = "org.http4k" d "http4k-server-undertow" w "6.60.0.0"
    val serverless_alibaba = "org.http4k" d "http4k-serverless-alibaba" w "6.60.0.0"
    val serverless_azure = "org.http4k" d "http4k-serverless-azure" w "6.60.0.0"
    val serverless_gcf = "org.http4k" d "http4k-serverless-gcf" w "6.60.0.0"
    val serverless_lambda = "org.http4k" d "http4k-serverless-lambda" w "6.60.0.0"
    val serverless_lambda_runtime = "org.http4k" d "http4k-serverless-lambda-runtime" w "6.60.0.0"
    val serverless_openwhisk = "org.http4k" d "http4k-serverless-openwhisk" w "6.60.0.0"
    val serverless_tencent = "org.http4k" d "http4k-serverless-tencent" w "6.60.0.0"
    val template_core = "org.http4k" d "http4k-template-core" w "6.60.0.0"
    val template_dust = "org.http4k" d "http4k-template-dust" w "4.48.2.0"
    val template_freemarker = "org.http4k" d "http4k-template-freemarker" w "6.60.0.0"
    val template_handlebars = "org.http4k" d "http4k-template-handlebars" w "6.60.0.0"
    val template_jade4j = "org.http4k" d "http4k-template-jade4j" w "5.12.2.1"
    val template_pebble = "org.http4k" d "http4k-template-pebble" w "6.60.0.0"
    val template_thymeleaf = "org.http4k" d "http4k-template-thymeleaf" w "6.60.0.0"
    val testing_approval = "org.http4k" d "http4k-testing-approval" w "6.60.0.0"
    val testing_chaos = "org.http4k" d "http4k-testing-chaos" w "6.60.0.0"
    val testing_hamkrest = "org.http4k" d "http4k-testing-hamkrest" w "6.60.0.0"
    val testing_kotest = "org.http4k" d "http4k-testing-kotest" w "6.60.0.0"
    val testing_servirtium = "org.http4k" d "http4k-testing-servirtium" w "6.60.0.0"
    val testing_strikt = "org.http4k" d "http4k-testing-strikt" w "6.60.0.0"
    val testing_webdriver = "org.http4k" d "http4k-testing-webdriver" w "6.60.0.0"
  }
  object JUnit {
  ...
  object JetBrains {
    ...
    object Compose {
      val full = "org.jetbrains.compose" d "compose-full" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
      val gradle_plugin = "org.jetbrains.compose" d "compose-gradle-plugin" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
      val preview_rpc = "org.jetbrains.compose" d "preview-rpc" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
      val preview_runtime_desktop = "org.jetbrains.compose" d "compose-preview-runtime-desktop" w "0.5.0-build228"
      object Animation {
        val animation = "org.jetbrains.compose.animation" d "animation" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val core = "org.jetbrains.compose.animation" d "animation-core" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val core_js = "org.jetbrains.compose.animation" d "animation-core-js" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val core_wasm_js = "org.jetbrains.compose.animation" d "animation-core-wasm-js" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val graphics = "org.jetbrains.compose.animation" d "animation-graphics" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val graphics_js = "org.jetbrains.compose.animation" d "animation-graphics-js" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val graphics_wasm_js = "org.jetbrains.compose.animation" d "animation-graphics-wasm-js" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val js = "org.jetbrains.compose.animation" d "animation-js" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val wasm_js = "org.jetbrains.compose.animation" d "animation-wasm-js" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
      }
      object Compiler {
      ...
      object Components {
        val animatedimage = "org.jetbrains.compose.components" d "components-animatedimage" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val resources = "org.jetbrains.compose.components" d "components-resources" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val resources_js = "org.jetbrains.compose.components" d "components-resources-js" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val resources_wasmjs = "org.jetbrains.compose.components" d "components-resources-wasmJs" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val splitpane = "org.jetbrains.compose.components" d "components-splitpane" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val ui_tooling_preview = "org.jetbrains.compose.components" d "components-ui-tooling-preview" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val ui_tooling_preview_js = "org.jetbrains.compose.components" d "components-ui-tooling-preview-js" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
      ...
      object Foundation {
        val foundation = "org.jetbrains.compose.foundation" d "foundation" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val js = "org.jetbrains.compose.foundation" d "foundation-js" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val layout = "org.jetbrains.compose.foundation" d "foundation-layout" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val layout_js = "org.jetbrains.compose.foundation" d "foundation-layout-js" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val layout_wasm_js = "org.jetbrains.compose.foundation" d "foundation-layout-wasm-js" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val wasm_js = "org.jetbrains.compose.foundation" d "foundation-wasm-js" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
      }
      object Html {
        val benchmark_core = "org.jetbrains.compose.html" d "html-benchmark-core" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val benchmark_core_js = "org.jetbrains.compose.html" d "html-benchmark-core-js" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val core = "org.jetbrains.compose.html" d "html-core" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val core_js = "org.jetbrains.compose.html" d "html-core-js" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val core_jvm = "org.jetbrains.compose.html" d "html-core-jvm" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val svg = "org.jetbrains.compose.html" d "html-svg" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val svg_js = "org.jetbrains.compose.html" d "html-svg-js" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val test_utils = "org.jetbrains.compose.html" d "html-test-utils" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val test_utils_js = "org.jetbrains.compose.html" d "html-test-utils-js" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
      }
      object Material {
        ...
        val js = "org.jetbrains.compose.material" d "material-js" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val material = "org.jetbrains.compose.material" d "material" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val navigation = "org.jetbrains.compose.material" d "material-navigation" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val navigation_js = "org.jetbrains.compose.material" d "material-navigation-js" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val navigation_wasm_js = "org.jetbrains.compose.material" d "material-navigation-wasm-js" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val ripple = "org.jetbrains.compose.material" d "material-ripple" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val ripple_js = "org.jetbrains.compose.material" d "material-ripple-js" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val ripple_wasm_js = "org.jetbrains.compose.material" d "material-ripple-wasm-js" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val wasm_js = "org.jetbrains.compose.material" d "material-wasm-js" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
      }
      object Material3 {
        val js = "org.jetbrains.compose.material3" d "material3-js" w "1.9.0" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val material3 = "org.jetbrains.compose.material3" d "material3" w "1.9.0" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val wasm_js = "org.jetbrains.compose.material3" d "material3-wasm-js" w "1.9.0" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val window_size_class = "org.jetbrains.compose.material3" d "material3-window-size-class" w "1.9.0" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val window_size_class_js = "org.jetbrains.compose.material3" d "material3-window-size-class-js" w "1.9.0" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val window_size_class_wasm_js = "org.jetbrains.compose.material3" d "material3-window-size-class-wasm-js" w "1.9.0" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
      }
      object Runtime {
      ...
      object Ui {
        val geometry = "org.jetbrains.compose.ui" d "ui-geometry" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val geometry_js = "org.jetbrains.compose.ui" d "ui-geometry-js" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val geometry_wasm_js = "org.jetbrains.compose.ui" d "ui-geometry-wasm-js" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val graphics = "org.jetbrains.compose.ui" d "ui-graphics" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val graphics_js = "org.jetbrains.compose.ui" d "ui-graphics-js" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val graphics_wasm_js = "org.jetbrains.compose.ui" d "ui-graphics-wasm-js" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val js = "org.jetbrains.compose.ui" d "ui-js" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val test = "org.jetbrains.compose.ui" d "ui-test" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val test_js = "org.jetbrains.compose.ui" d "ui-test-js" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val test_junit4 = "org.jetbrains.compose.ui" d "ui-test-junit4" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val test_wasm_js = "org.jetbrains.compose.ui" d "ui-test-wasm-js" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val text = "org.jetbrains.compose.ui" d "ui-text" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val text_js = "org.jetbrains.compose.ui" d "ui-text-js" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val text_wasm_js = "org.jetbrains.compose.ui" d "ui-text-wasm-js" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val tooling = "org.jetbrains.compose.ui" d "ui-tooling" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val tooling_preview = "org.jetbrains.compose.ui" d "ui-tooling-preview" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val ui = "org.jetbrains.compose.ui" d "ui" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val unit = "org.jetbrains.compose.ui" d "ui-unit" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val unit_js = "org.jetbrains.compose.ui" d "ui-unit-js" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val unit_wasm_js = "org.jetbrains.compose.ui" d "ui-unit-wasm-js" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
        val wasm_js = "org.jetbrains.compose.ui" d "ui-wasm-js" w "1.12.1" w "1.13.0-alpha01" w "1.13.0-alpha02.test"
      }
    }
    object Exposed {
    ...
    object Kotlin {
      val allopen = "org.jetbrains.kotlin" d "kotlin-allopen" w "2.4.20" w "2.5.0-Beta1"
      val android_extensions_runtime = "org.jetbrains.kotlin" d "kotlin-android-extensions-runtime" w "2.2.10"
      val atomicfu = "org.jetbrains.kotlin" d "atomicfu" w "2.4.20" w "2.5.0-Beta1"
      val atomicfu_runtime = "org.jetbrains.kotlin" d "kotlin-atomicfu-runtime"
      val bom = "org.jetbrains.kotlin" d "kotlin-bom" w "2.4.20" w "2.5.0-Beta1"
      val compiler = "org.jetbrains.kotlin" d "kotlin-compiler" w "2.4.20" w "2.5.0-Beta1"
      val compiler_embeddable = "org.jetbrains.kotlin" d "kotlin-compiler-embeddable" w "1.4.0-dev-withExperimentalGoogleExtensions-20200720" w "2.4.20" w "2.5.0-Beta1"
      val dom_api_compat = "org.jetbrains.kotlin" d "kotlin-dom-api-compat" w "2.4.20" w "2.5.0-Beta1"
      val gradle_plugin = "org.jetbrains.kotlin" d "kotlin-gradle-plugin" w "2.4.20" w "2.5.0-Beta1"
      val gradle_plugin_api = "org.jetbrains.kotlin" d "kotlin-gradle-plugin-api" w "2.4.20" w "2.5.0-Beta1"
      val js_plain_objects = "org.jetbrains.kotlin" d "kotlin-js-plain-objects" w "2.4.20" w "2.5.0-Beta1"
      val maven_plugin = "org.jetbrains.kotlin" d "kotlin-maven-plugin" w "2.4.20" w "2.5.0-Beta1"
      val parcelize_runtime = "org.jetbrains.kotlin" d "kotlin-parcelize-runtime" w "2.4.20" w "2.5.0-Beta1"
      val reflect = "org.jetbrains.kotlin" d "kotlin-reflect" w "2.4.20" w "2.5.0-Beta1"
      val script_runtime = "org.jetbrains.kotlin" d "kotlin-script-runtime" w "2.4.20" w "2.5.0-Beta1"
      val scripting_common = "org.jetbrains.kotlin" d "kotlin-scripting-common" w "2.4.20" w "2.5.0-Beta1"
      val scripting_compiler = "org.jetbrains.kotlin" d "kotlin-scripting-compiler" w "2.4.20" w "2.5.0-Beta1"
      val scripting_compiler_embeddable = "org.jetbrains.kotlin" d "kotlin-scripting-compiler-embeddable" w "2.4.20" w "2.5.0-Beta1"
      val scripting_jvm = "org.jetbrains.kotlin" d "kotlin-scripting-jvm" w "2.4.20" w "2.5.0-Beta1"
      val scripting_jvm_host = "org.jetbrains.kotlin" d "kotlin-scripting-jvm-host" w "2.4.20" w "2.5.0-Beta1"
      val serialization = "org.jetbrains.kotlin" d "kotlin-serialization" w "2.4.20" w "2.5.0-Beta1"
      val stdlib = "org.jetbrains.kotlin" d "kotlin-stdlib" w "2.4.20" w "2.5.0-Beta1"
      val stdlib_common = "org.jetbrains.kotlin" d "kotlin-stdlib-common" w "2.4.20" w "2.5.0-Beta1"
      val stdlib_jdk7 = "org.jetbrains.kotlin" d "kotlin-stdlib-jdk7" w "2.4.20" w "2.5.0-Beta1"
      val stdlib_jdk8 = "org.jetbrains.kotlin" d "kotlin-stdlib-jdk8" w "2.4.20" w "2.5.0-Beta1"
      val stdlib_js = "org.jetbrains.kotlin" d "kotlin-stdlib-js" w "2.4.20" w "2.5.0-Beta1"
      val stdlib_wasm = "org.jetbrains.kotlin" d "kotlin-stdlib-wasm" w "1.9.10"
      val stdlib_wasm_js = "org.jetbrains.kotlin" d "kotlin-stdlib-wasm-js" w "2.4.20" w "2.5.0-Beta1"
      val stdlib_wasm_wasi = "org.jetbrains.kotlin" d "kotlin-stdlib-wasm-wasi" w "2.4.20" w "2.5.0-Beta1"
      val test = "org.jetbrains.kotlin" d "kotlin-test" w "2.4.20" w "2.5.0-Beta1"
      val test_annotations_common = "org.jetbrains.kotlin" d "kotlin-test-annotations-common" w "2.4.20" w "2.5.0-Beta1"
      val test_common = "org.jetbrains.kotlin" d "kotlin-test-common" w "2.4.20" w "2.5.0-Beta1"
      val test_js = "org.jetbrains.kotlin" d "kotlin-test-js" w "2.4.20" w "2.5.0-Beta1"
      val test_js_runner = "org.jetbrains.kotlin" d "kotlin-test-js-runner" w "2.0.21"
      val test_junit = "org.jetbrains.kotlin" d "kotlin-test-junit" w "2.4.20" w "2.5.0-Beta1"
      val test_junit5 = "org.jetbrains.kotlin" d "kotlin-test-junit5" w "2.4.20" w "2.5.0-Beta1"
      val test_testng = "org.jetbrains.kotlin" d "kotlin-test-testng" w "2.4.20" w "2.5.0-Beta1"
      val test_wasm_js = "org.jetbrains.kotlin" d "kotlin-test-wasm-js" w "2.4.20" w "2.5.0-Beta1"
    }
    object KotlinX {
  ...
  object Slf4j {
    val api = "org.slf4j" d "slf4j-api" w "2.0.20" w "2.1.0-alpha1"
    val simple = "org.slf4j" d "slf4j-simple" w "2.0.20" w "2.1.0-alpha1"
  }
...
object Pl {
  object MarekLangiewicz {
    val abcdk = "pl.mareklangiewicz" d "abcdk" w "0.1.35"
    val abcdk_js = "pl.mareklangiewicz" d "abcdk-js" w "0.1.35"
    val abcdk_jvm = "pl.mareklangiewicz" d "abcdk-jvm" w "0.1.35"
    val abcdk_linuxx64 = "pl.mareklangiewicz" d "abcdk-linuxx64" w "0.1.35"
    val kground = "pl.mareklangiewicz" d "kground" w "0.1.35"
    val kground_io = "pl.mareklangiewicz" d "kground-io" w "0.1.35"
    val kground_io_js = "pl.mareklangiewicz" d "kground-io-js" w "0.1.35"
    val kground_io_jvm = "pl.mareklangiewicz" d "kground-io-jvm" w "0.1.35"
    val kground_io_linuxx64 = "pl.mareklangiewicz" d "kground-io-linuxx64" w "0.1.35"
    val kground_js = "pl.mareklangiewicz" d "kground-js" w "0.1.35"
    val kground_jvm = "pl.mareklangiewicz" d "kground-jvm" w "0.1.35"
    val kground_linuxx64 = "pl.mareklangiewicz" d "kground-linuxx64" w "0.1.35"
    val kgroundx = "pl.mareklangiewicz" d "kgroundx" w "0.1.35"
    val kgroundx_experiments = "pl.mareklangiewicz" d "kgroundx-experiments" w "0.1.35"
    val kgroundx_experiments_jvm = "pl.mareklangiewicz" d "kgroundx-experiments-jvm" w "0.1.35"
    val kgroundx_io = "pl.mareklangiewicz" d "kgroundx-io" w "0.1.35"
    val kgroundx_io_js = "pl.mareklangiewicz" d "kgroundx-io-js" w "0.1.35"
    val kgroundx_io_jvm = "pl.mareklangiewicz" d "kgroundx-io-jvm" w "0.1.35"
    val kgroundx_io_linuxx64 = "pl.mareklangiewicz" d "kgroundx-io-linuxx64" w "0.1.35"
    val kgroundx_js = "pl.mareklangiewicz" d "kgroundx-js" w "0.1.35"
    val kgroundx_jupyter = "pl.mareklangiewicz" d "kgroundx-jupyter" w "0.1.35"
    val kgroundx_jupyter_jvm = "pl.mareklangiewicz" d "kgroundx-jupyter-jvm" w "0.1.35"
    val kgroundx_jvm = "pl.mareklangiewicz" d "kgroundx-jvm" w "0.1.35"
    val kgroundx_linuxx64 = "pl.mareklangiewicz" d "kgroundx-linuxx64" w "0.1.35"
    val kgroundx_maintenance = "pl.mareklangiewicz" d "kgroundx-maintenance" w "0.1.35"
    val kgroundx_maintenance_jvm = "pl.mareklangiewicz" d "kgroundx-maintenance-jvm" w "0.1.35"
    val kgroundx_workflows = "pl.mareklangiewicz" d "kgroundx-workflows" w "0.1.35"
    val kgroundx_workflows_jvm = "pl.mareklangiewicz" d "kgroundx-workflows-jvm" w "0.1.35"
    val kommand_line = "pl.mareklangiewicz" d "kommand-line" w "0.1.35"
    val kommand_line_js = "pl.mareklangiewicz" d "kommand-line-js" w "0.1.35"
    val kommand_line_jvm = "pl.mareklangiewicz" d "kommand-line-jvm" w "0.1.35"
    val kommand_line_linuxx64 = "pl.mareklangiewicz" d "kommand-line-linuxx64" w "0.1.35"
    val kommand_samples = "pl.mareklangiewicz" d "kommand-samples" w "0.1.35"
    val kommand_samples_js = "pl.mareklangiewicz" d "kommand-samples-js" w "0.1.35"
    val kommand_samples_jvm = "pl.mareklangiewicz" d "kommand-samples-jvm" w "0.1.35"
    val kommand_samples_linuxx64 = "pl.mareklangiewicz" d "kommand-samples-linuxx64" w "0.1.35"
    ...
    val tuplek = "pl.mareklangiewicz" d "tuplek" w "0.1.35"
    val tuplek_js = "pl.mareklangiewicz" d "tuplek-js" w "0.1.35"
    val tuplek_jvm = "pl.mareklangiewicz" d "tuplek-jvm" w "0.1.35"
    val tuplek_linuxx64 = "pl.mareklangiewicz" d "tuplek-linuxx64" w "0.1.35"
    val upue = "pl.mareklangiewicz" d "upue" w "0.0.24"
    val upue_js = "pl.mareklangiewicz" d "upue-js" w "0.0.24"
    val upue_jvm = "pl.mareklangiewicz" d "upue-jvm" w "0.0.24"
    val upue_linuxx64 = "pl.mareklangiewicz" d "upue-linuxx64" w "0.0.24"
    val uspek = "pl.mareklangiewicz" d "uspek" w "0.0.46"
    val uspek_js = "pl.mareklangiewicz" d "uspek-js" w "0.0.46"
    val uspek_jvm = "pl.mareklangiewicz" d "uspek-jvm" w "0.0.46"
    val uspek_linuxx64 = "pl.mareklangiewicz" d "uspek-linuxx64" w "0.0.46"
    val uspekx = "pl.mareklangiewicz" d "uspekx" w "0.0.46"
    val uspekx_js = "pl.mareklangiewicz" d "uspekx-js" w "0.0.46"
    val uspekx_junit4 = "pl.mareklangiewicz" d "uspekx-junit4" w "0.0.46"
    val uspekx_junit4_jvm = "pl.mareklangiewicz" d "uspekx-junit4-jvm" w "0.0.46"
    val uspekx_junit5 = "pl.mareklangiewicz" d "uspekx-junit5" w "0.0.46"
    val uspekx_junit5_jvm = "pl.mareklangiewicz" d "uspekx-junit5-jvm" w "0.0.46"
    val uspekx_jvm = "pl.mareklangiewicz" d "uspekx-jvm" w "0.0.46"
    val uspekx_linuxx64 = "pl.mareklangiewicz" d "uspekx-linuxx64" w "0.0.46"
