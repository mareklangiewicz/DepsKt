...
object Vers {
   ...
   */
  val GradlePublishPlug = Ver("2.2.1")
   ...
   */
  val KotlinJupyterPlug = Ver("0.19.0-958")
   ...
   */
  val GradleShadowPlug = Ver("9.6.1")
   ...
   */
  val OsackyDoctorPlug = Ver("0.12.0")
   ...
   */
  val DepsPlug = Ver(0, 4, 52) // also sync it in ../../../../../settings.gradle.kts
