...
plugins {
  ...
  id("pl.mareklangiewicz.deps.settings") version "0.4.52" // https://plugins.gradle.org/search?term=mareklangiewicz
...
gradle.extLib = lib(
  info = myLibInfo(
    ...
    version = Ver(0, 4, 53), // also sync it in ./deps/src/main/kotlin/deps/Vers.kt
